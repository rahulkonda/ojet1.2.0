 ...
 * @private
 */
oj.DataSourceContentHandler.prototype._handleBeforeReplaceTransitionEnd = function(index, data, metadata, callback, event)
{
    var item, parentElement, position;
...
oj.DataSourceContentHandler.prototype.replaceItem = function(item, index, data, metadata, callback)
{
    ...
    {
        this.m_beforeReplaceTransitionEndListener = this._handleBeforeReplaceTransitionEnd.bind(this, index, data, metadata, callback);
    }
        ...
        if (this._isLoadMoreOnScroll())
        {
            ...
            this.m_domScrollerMaxCountFunc = function(result)
            {
                if (result != null)
                {
                    ...
                    self._handleFetchedData(result);
            ...
            this.m_domScroller = new oj.DomScroller(this.m_widget.getRootElement(), dataSource, {'fetchSize' : this._getFetchSize(), 'maxCount' : this._getMaxCount(), 'success': this.m_domScrollerMaxCountFunc});
        }
...
oj.TableDataSourceContentHandler.prototype.afterRenderItemForInsertEvent = function(item, context)
{
    ...
    {
        this.m_addTransitionEndListener = this._handleAddTransitionEnd.bind(this, context);
    }
    ...
    if (this.IsReady())
    {
        ...
        if (initFetch || forceFetch)
        {
            ...
            promise.then(function(value){ 
                         ...
                         function(reason){ self._handleFetchError(reason); });
            return;
        }
    }
 ...
 * @private
 */
oj.TableDataSourceContentHandler.prototype._handleAddTransitionEnd = function(context, event)
{
    ...
    this.m_widget.itemInsertComplete(elem.get(0), context);
};
...
oj.TableDataSourceContentHandler.prototype.afterRenderItemForChangeEvent = function(item, context)
{
    ...
    {
        this.m_afterReplaceTransitionEndListener = this._handleAfterReplaceTransitionEnd.bind(this, context);
    }
 ...
 * @private
 */
oj.TableDataSourceContentHandler.prototype._handleAfterReplaceTransitionEnd = function(context, event)
{
...
oj.TableDataSourceContentHandler.prototype.checkViewport = function()
{
    ...
    if (this.m_domScroller != null && this.m_dataSource.totalSize() > 0 && this.IsReady())
    {
        ...
        {
            fetchPromise.then(this.m_domScrollerMaxCountFunc, null);
        }
    }
};
...
/** @lends oj._ojListView.prototype */
{
    ...
    refresh: function()
    {
        // reset content and wai aria properties
        this._resetInternal();
