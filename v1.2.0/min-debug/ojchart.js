...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojdvt-base", "ojs/internal-deps/dvt/DvtChart"], function($oj$$51$$, $$$$46$$, $comp$$13$$, $base$$12$$, $dvt$$9$$) {
  $oj$$51$$.$__registerWidget$("oj.ojSparkChart", $$$$46$$.oj.dvtBaseComponent, {widgetEventPrefix:"oj", options:{}, $_CreateDvtComponent$:function($context$$148$$, $callback$$117$$, $callbackObj$$11$$) {
    return $dvt$$9$$.DvtSparkChart.newInstance($context$$148$$, $callback$$117$$, $callbackObj$$11$$);
    ...
    return new $oj$$51$$.$SparkChartDataItem$($auto$$15$$.getDataItem($itemIndex$$));
  ...
  $oj$$51$$.$__registerWidget$("oj.ojChart", $$$$46$$.oj.dvtBaseComponent, {widgetEventPrefix:"oj", options:{categoryFilter:null, categoryHighlight:null, optionChange:null, selectInput:null, viewportChange:null, viewportChangeInput:null, drill:null}, $_CreateDvtComponent$:function($context$$149$$, $callback$$118$$, $callbackObj$$12$$) {
    return $dvt$$9$$.DvtChart.newInstance($context$$149$$, $callback$$118$$, $callbackObj$$12$$);
    ...
    return $ret$$48$$;
  }, $_HandleEvent$:function($event$$512_selectPayload$$) {
    var $filterType_type$$96$$ = $event$$512_selectPayload$$ && $event$$512_selectPayload$$.getType ? $event$$512_selectPayload$$.getType() : null;
    if ($filterType_type$$96$$ === $dvt$$9$$.DvtSelectionEvent.TYPE || $filterType_type$$96$$ === $dvt$$9$$.DvtSelectionEvent.TYPE_INPUT) {
      var $selection$$14$$ = $event$$512_selectPayload$$.getSelection();
      if ($selection$$14$$) {
        ...
        $event$$512_selectPayload$$ = {endGroup:$event$$512_selectPayload$$.getEndGroup(), startGroup:$event$$512_selectPayload$$.getStartGroup(), xMax:$event$$512_selectPayload$$.getXMax(), xMin:$event$$512_selectPayload$$.getXMin(), yMax:$event$$512_selectPayload$$.getYMax(), yMin:$event$$512_selectPayload$$.getYMin()};
        $filterType_type$$96$$ === $dvt$$9$$.DvtSelectionEvent.TYPE ? this.$_UserOptionChange$("selection", $selectedItems$$6_viewportChangePayload$$1$$, $event$$512_selectPayload$$) : ($event$$512_selectPayload$$.items = $selectedItems$$6_viewportChangePayload$$1$$, this._trigger("selectInput", null, $event$$512_selectPayload$$));
      }
    } else {
      $filterType_type$$96$$ === $dvt$$9$$.DvtCategoryHideShowEvent.TYPE_HIDE || $filterType_type$$96$$ === $dvt$$9$$.DvtCategoryHideShowEvent.TYPE_SHOW ? ($filterType_type$$96$$ = $filterType_type$$96$$ === $dvt$$9$$.DvtCategoryHideShowEvent.TYPE_HIDE ? "out" : "in", this._trigger("categoryFilter", null, {category:$event$$512_selectPayload$$.getCategory(), type:$filterType_type$$96$$}), this.$_UserOptionChange$("hiddenCategories", $event$$512_selectPayload$$.hiddenCategories)) : $filterType_type$$96$$ === 
      $dvt$$9$$.DvtCategoryRolloverEvent.TYPE_OVER || $filterType_type$$96$$ === $dvt$$9$$.DvtCategoryRolloverEvent.TYPE_OUT ? (this._trigger("categoryHighlight", null, {categories:$event$$512_selectPayload$$.categories, type:$filterType_type$$96$$ === $dvt$$9$$.DvtCategoryRolloverEvent.TYPE_OVER ? "on" : "off"}), this.$_UserOptionChange$("highlightedCategories", $event$$512_selectPayload$$.categories)) : $filterType_type$$96$$ === $dvt$$9$$.DvtChartViewportChangeEvent.TYPE || $filterType_type$$96$$ === 
      $dvt$$9$$.DvtChartViewportChangeEvent.TYPE_INPUT ? ($selectedItems$$6_viewportChangePayload$$1$$ = {endGroup:$event$$512_selectPayload$$.getEndGroup(), startGroup:$event$$512_selectPayload$$.getStartGroup(), xMax:$event$$512_selectPayload$$.getXMax(), xMin:$event$$512_selectPayload$$.getXMin(), yMax:$event$$512_selectPayload$$.getYMax(), yMin:$event$$512_selectPayload$$.getYMin()}, $filterType_type$$96$$ === $dvt$$9$$.DvtChartViewportChangeEvent.TYPE && (this.options.xAxis || (this.options.xAxis = 
      {}), this.options.yAxis || (this.options.yAxis = {}), this.options.xAxis.viewportStartGroup = null, this.options.xAxis.viewportEndGroup = null, null != $event$$512_selectPayload$$.getXMin() && null != $event$$512_selectPayload$$.getXMax() && (this.options.xAxis.viewportMin = $event$$512_selectPayload$$.getXMin(), this.options.xAxis.viewportMax = $event$$512_selectPayload$$.getXMax()), null != $event$$512_selectPayload$$.getYMin() && null != $event$$512_selectPayload$$.getYMax() && (this.options.yAxis.viewportMin = 
      $event$$512_selectPayload$$.getYMin(), this.options.yAxis.viewportMax = $event$$512_selectPayload$$.getYMax())), this._trigger($filterType_type$$96$$ === $dvt$$9$$.DvtChartViewportChangeEvent.TYPE ? "viewportChange" : "viewportChangeInput", null, $selectedItems$$6_viewportChangePayload$$1$$)) : $filterType_type$$96$$ === $dvt$$9$$.DvtDrillEvent.TYPE ? this._trigger("drill", null, {id:$event$$512_selectPayload$$.getId(), series:$event$$512_selectPayload$$.getSeries(), group:$event$$512_selectPayload$$.getGroup()}) : 
      this._super($event$$512_selectPayload$$);
    }
  ...
  }, getContextByNode:function($context$$150_node$$103$$) {
    return($context$$150_node$$103$$ = this.getSubIdByNode($context$$150_node$$103$$)) && "oj-chart-tooltip" !== $context$$150_node$$103$$.subId ? $context$$150_node$$103$$ : null;
  }, $_GetComponentDeferredDataPaths$:function() {
