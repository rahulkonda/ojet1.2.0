...
define(["ojs/ojcore", "knockout", "promise"], function($oj$$23$$, $ko$$4$$) {
  ...
  (function() {
    ...
    function $_invokeViewModelMethod$$($model$$58$$, $handler$$49_key$$128_name$$110$$, $params$$24$$) {
      if (null != $model$$58$$ && ($handler$$49_key$$128_name$$110$$ = $oj$$23$$.$ModuleBinding$.$defaults$[$handler$$49_key$$128_name$$110$$], null != $handler$$49_key$$128_name$$110$$ && $model$$58$$ && ($handler$$49_key$$128_name$$110$$ = $model$$58$$[$handler$$49_key$$128_name$$110$$], "function" === typeof $handler$$49_key$$128_name$$110$$))) {
        var $data$$139$$ = void 0;
        ...
        return $ko$$4$$.ignoreDependencies($handler$$49_key$$128_name$$110$$, $model$$58$$, [$data$$139$$]);
      }
    }
    function $_getContainedNodes$$($container$$25_node$$76$$, $cacheHolder$$1$$, $endCommentNode$$) {
      var $childList$$ = [];
      for ($container$$25_node$$76$$ = $ko$$4$$.virtualElements.firstChild($container$$25_node$$76$$);null != $container$$25_node$$76$$ && $container$$25_node$$76$$ != $endCommentNode$$;$container$$25_node$$76$$ = $container$$25_node$$76$$.nextSibling) {
        $container$$25_node$$76$$ != $cacheHolder$$1$$ && $childList$$.push($container$$25_node$$76$$);
      }
      return $childList$$;
    }
    function $_getKoNodes$$($container$$26$$, $cacheHolder$$2$$) {
      var $nodes$$1$$ = [], $firstChild$$2$$ = $ko$$4$$.virtualElements.firstChild($container$$26$$);
      $_koNodesForEach$$($firstChild$$2$$, $cacheHolder$$2$$, function($node$$77$$) {
        $nodes$$1$$.push($node$$77$$);
      });
      return $nodes$$1$$;
    }
    function $_koNodesForEach$$($first$$6_node$$78$$, $cacheHolder$$3$$, $callback$$102$$) {
      for (;null != $first$$6_node$$78$$;) {
        var $next$$6$$ = $ko$$4$$.virtualElements.nextSibling($first$$6_node$$78$$), $type$$85$$ = $first$$6_node$$78$$.nodeType;
        $first$$6_node$$78$$ === $cacheHolder$$3$$ || 1 !== $type$$85$$ && 8 !== $type$$85$$ || $callback$$102$$($first$$6_node$$78$$);
        $first$$6_node$$78$$ = $next$$6$$;
      }
    }
    ...
    function $_getRequirePromise$$($module$$1$$) {
      return new Promise(function($resolve$$29$$) {
    ...
    function $_createNoFailPromise$$($promise$$5$$) {
      return $promise$$5$$ ? new Promise(function($resolve$$30$$) {
        $promise$$5$$.then($resolve$$30$$, $resolve$$30$$);
      }) : $promise$$5$$;
    }
        ...
        Promise.all([$viewPromise$$, $modelPromise$$, $attachPromise_unwrap$$, $modelAttachPromise$$, $currentAnimationPromise$$]).then(function($id$$34$$, $values$$12$$) {
          if ($id$$34$$ == $pendingViewId$$) {
            ...
            var $oldNodesRemoved$$ = !1, $removeOldDomNodes$$1_view$$3$$ = function $$removeOldDomNodes$$1_view$$3$$$($oldViewParent$$2$$) {
              ...
              if (!$fromCache$$) {
                var $childBindingContext$$ = $bindingContext$$35$$.createChildContext($model$$62$$, void 0, function($ctx$$2$$) {
                  $ctx$$2$$.$module = $model$$62$$;
                  $ctx$$2$$.$params = $params$$25$$;
                });
                $_koNodesForEach$$($nodes$$3$$[0], $cacheHolder$$4$$, function($node$$80$$) {
                  $ko$$4$$.applyBindings($childBindingContext$$, $node$$80$$);
                });
