...
define(["require", "ojL10n!ojtranslations/nls/ojtranslations"], function($require$$2$$, $ojt$$1$$) {
  ...
  var $_oldVal$$ = $_scope$$.oj, $oj$$ = $_scope$$.oj = {version:"1.2.0", build:"3", revision:"22069", noConflict:function $$_scope$$$oj$noConflict$() {
    $_scope$$.oj = $_oldVal$$;
  }};
  $oj$$.$Logger$ = {};
  ...
  $oj$$.$Translations$.$getTranslatedString$ = function $$oj$$$$Translations$$$getTranslatedString$$($key$$23$$, $var_args$$45$$) {
    ...
    return $oj$$.$Translations$.$applyParameters$($val$$12$$, $params$$2$$);
  };
