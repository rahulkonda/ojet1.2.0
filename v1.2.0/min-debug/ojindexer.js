...
define(["ojs/ojcore", "jquery", "hammerjs", "promise", "ojs/ojjquery-hammer", "ojs/ojcomponentcore"], function($oj$$34$$, $$$$31$$, $Hammer$$4$$) {
  (function() {
    $oj$$34$$.$__registerWidget$("oj.ojIndexer", $$$$31$$.oj.baseComponent, {defaultElement:"\x3cul\x3e", version:"1.2", widgetEventPrefix:"oj", options:{data:null}, _ComponentCreate:function() {
    ...
    }, _setOption:function($key$$141$$, $value$$256$$) {
      this._superApply(arguments);
      "data" == $key$$141$$ && this.refresh();
    }, widget:function() {
      ...
      var $prefixes$$, $i$$335$$, $j$$43$$, $node$$85$$, $includes$$;
      if (null == $locator$$37_prefix$$18$$) {
        return this.element ? this.element[0] : null;
      }
      if ("oj-indexer-prefix" === $locator$$37_prefix$$18$$.subId) {
        for ($locator$$37_prefix$$18$$ = $locator$$37_prefix$$18$$.prefix, $prefixes$$ = this.element.children("li"), $i$$335$$ = 0;$i$$335$$ < $prefixes$$.length;$i$$335$$++) {
          $node$$85$$ = $prefixes$$.get($i$$335$$);
          if ($$$$31$$($node$$85$$).attr("data-range") == $locator$$37_prefix$$18$$) {
            return $node$$85$$;
          }
          $includes$$ = $$$$31$$($node$$85$$).attr("data-includes");
          if (null != $includes$$) {
      ...
      return null;
    }, getSubIdByNode:function($node$$86_prefix$$19$$) {
      return null != $node$$86_prefix$$19$$ && ($node$$86_prefix$$19$$ = $$$$31$$($node$$86_prefix$$19$$).attr("data-range"), null != $node$$86_prefix$$19$$) ? {subId:"oj-indexer-prefix", prefix:$node$$86_prefix$$19$$} : null;
      ...
      var $key$$142$$, $text$$17$$;
      $key$$142$$ = $oj$$34$$.$DomUtils$.$isTouchSupported$() ? "ariaTouchInstructionText" : "ariaKeyboardInstructionText";
      $text$$17$$ = $$$$31$$(document.createElement("div"));
      $text$$17$$.prop("id", this.element.prop("id") + ":desc");
      $text$$17$$.addClass("oj-helper-hidden-accessible").text(this.$getTranslatedString$($key$$142$$));
      ...
      var $model$$64_prefixOthers$$, $root$$13$$, $last$$4_others_prefixes$$1$$, $availablePrefixes$$, $height$$27_max$$7_skip$$2$$, $first$$7_i$$336_itemHeight$$, $item$$112_prefix$$20$$;
      ...
      if (null != $model$$64_prefixOthers$$) {
        ...
        $first$$7_i$$336_itemHeight$$ = this.$_createItem$($last$$4_others_prefixes$$1$$[0], $availablePrefixes$$);
        $root$$13$$.append($first$$7_i$$336_itemHeight$$);
        $first$$7_i$$336_itemHeight$$ = $first$$7_i$$336_itemHeight$$.outerHeight();
        $height$$27_max$$7_skip$$2$$ = Math.floor($height$$27_max$$7_skip$$2$$ / $first$$7_i$$336_itemHeight$$);
        ...
        for ($first$$7_i$$336_itemHeight$$ = 1 + $height$$27_max$$7_skip$$2$$;$first$$7_i$$336_itemHeight$$ < $last$$4_others_prefixes$$1$$.length;$first$$7_i$$336_itemHeight$$ = $first$$7_i$$336_itemHeight$$ + $height$$27_max$$7_skip$$2$$ + 1) {
          1 < $height$$27_max$$7_skip$$2$$ ? ($item$$112_prefix$$20$$ = this.$_createSeparator$($last$$4_others_prefixes$$1$$, $first$$7_i$$336_itemHeight$$ - $height$$27_max$$7_skip$$2$$, $first$$7_i$$336_itemHeight$$ - 1), $root$$13$$.append($item$$112_prefix$$20$$)) : $first$$7_i$$336_itemHeight$$--, $item$$112_prefix$$20$$ = $last$$4_others_prefixes$$1$$[$first$$7_i$$336_itemHeight$$], $item$$112_prefix$$20$$ = this.$_createItem$($item$$112_prefix$$20$$, $availablePrefixes$$), $root$$13$$.append($item$$112_prefix$$20$$)
          ;
        }
      ...
      var $item$$113$$ = $$$$31$$(document.createElement("li"));
      $item$$113$$.attr("data-range", $prefix$$21$$).text($prefix$$21$$);
      null != $availablePrefixes$$1$$ && -1 == $availablePrefixes$$1$$.indexOf($prefix$$21$$) && $item$$113$$.addClass("oj-disabled");
      return $item$$113$$;
    }, $_createSeparator$:function($indexString$$, $from$$3_i$$337$$, $to$$3$$) {
      var $item$$114$$, $includes$$1$$ = "";
      $item$$114$$ = $$$$31$$(document.createElement("li"));
      for ($item$$114$$.addClass("oj-indexer-ellipsis").attr("data-range", $indexString$$[$from$$3_i$$337$$ + Math.round(($to$$3$$ - $from$$3_i$$337$$) / 2)]);$from$$3_i$$337$$ < $to$$3$$;$from$$3_i$$337$$++) {
        $includes$$1$$ = $includes$$1$$ + $indexString$$[$from$$3_i$$337$$] + "|";
      }
      $includes$$1$$ += $indexString$$[$to$$3$$];
      $item$$114$$.attr("data-includes", $includes$$1$$);
      return $item$$114$$;
    }, $_setup$:function() {
      var $self$$143$$ = this, $model$$65$$;
      this.element.uniqueId().addClass("oj-component-initnode").attr("tabIndex", 0);
      this._on(this.element, {click:function($event$$402$$) {
        $self$$143$$.$_handleClick$($event$$402$$);
      }, keydown:function($event$$403$$) {
        $self$$143$$.$_handleKeyDown$($event$$403$$);
      }, focus:function($event$$404$$) {
        $self$$143$$.$_handleFocus$($event$$404$$);
      }, blur:function($event$$405$$) {
        $self$$143$$.$_handleBlur$($event$$405$$);
      }});
    ...
    }, $_handleClick$:function($event$$406_target$$90$$) {
      0 === $event$$406_target$$90$$.button && ($event$$406_target$$90$$ = $$$$31$$($event$$406_target$$90$$.target), this.$_setCurrent$($event$$406_target$$90$$));
    ...
    }, $_handleKeyDown$:function($event$$409$$) {
      var $next$$7$$, $processed$$7$$ = !1;
      switch($event$$409$$.keyCode) {
        case 38:
      ...
      $processed$$7$$ && $event$$409$$.preventDefault();
    }, $_setFocus$:function($item$$115$$) {
      null != this.$m_current$ && this.$m_current$.removeClass("oj-focus");
      $item$$115$$.addClass("oj-focus");
      this.$_updateAriaProperties$($item$$115$$);
      this.$m_current$ = $item$$115$$;
      ...
      return $model$$66$$;
    }, $_setCurrent$:function($item$$116$$) {
      var $prefix$$22$$ = $item$$116$$.attr("data-range");
      $item$$116$$.attr("data-others") && ($prefix$$22$$ = $oj$$34$$.$IndexerModel$.PREFIX_OTHERS);
      this.$_setCurrentPrefix$($prefix$$22$$);
    }, $_setCurrentPrefix$:function($prefix$$23$$) {
      var $self$$144$$ = this, $item$$117$$;
      this.$_getIndexerModel$().setPrefix($prefix$$23$$).then(function($val$$51$$) {
        null != $val$$51$$ && ($item$$117$$ = $self$$144$$.$_findItem$($val$$51$$), null != $item$$117$$ && $self$$144$$.$_setFocus$($item$$117$$));
      });
    }, $_updateAriaProperties$:function($item$$118$$) {
      var $includes$$2_val$$52$$, $valueText$$ = "";
      $includes$$2_val$$52$$ = $item$$118$$.attr("data-includes");
      null != $includes$$2_val$$52$$ ? ($includes$$2_val$$52$$ = $includes$$2_val$$52$$.split("|"), 0 < $includes$$2_val$$52$$.length && ($valueText$$ = this.$getTranslatedString$("ariaInBetweenText", {first:$includes$$2_val$$52$$[0], second:$includes$$2_val$$52$$[$includes$$2_val$$52$$.length - 1]}))) : ($includes$$2_val$$52$$ = $item$$118$$.attr("data-range"), $valueText$$ = $includes$$2_val$$52$$ === $oj$$34$$.$IndexerModel$.PREFIX_OTHERS ? this.$getTranslatedString$("ariaOthersLabel") : $includes$$2_val$$52$$);
      $item$$118$$.hasClass("oj-disabled") && ($valueText$$ = $valueText$$ + ". " + this.$getTranslatedString$("ariaDisabledLabel"));
      this.element.attr("aria-valuetext", $valueText$$);
      this.element.attr("aria-valuenow", $item$$118$$.index());
    }, $_findItem$:function($prefix$$24$$) {
      var $children$$10$$, $i$$338$$, $item$$119$$, $value$$257$$, $includes$$3$$;
      $children$$10$$ = this.element.children();
      for ($i$$338$$ = 0;$i$$338$$ < $children$$10$$.length;$i$$338$$++) {
        if ($item$$119$$ = $children$$10$$.get($i$$338$$), $value$$257$$ = $$$$31$$($item$$119$$).attr("data-range"), $includes$$3$$ = $$$$31$$($item$$119$$).attr("data-includes"), null != $value$$257$$ && $value$$257$$ == $prefix$$24$$ || null != $includes$$3$$ && -1 < $includes$$3$$.indexOf($prefix$$24$$)) {
          return $$$$31$$($item$$119$$);
        }
      }
      return null;
    }, $_unregisterResizeListener$:function($element$$124$$) {
      $element$$124$$ && this.$_resizeHandler$ && $oj$$34$$.$DomUtils$.$removeResizeListener$($element$$124$$, this.$_resizeHandler$);
    }, $_registerResizeListener$:function($element$$125$$) {
      $element$$125$$ && (null == this.$_resizeHandler$ && (this.$_resizeHandler$ = this.$_handleResize$.bind(this)), $oj$$34$$.$DomUtils$.$addResizeListener$($element$$125$$, this.$_resizeHandler$));
    }, $_unregisterTouchHandler$:function($element$$126$$) {
      $$$$31$$($element$$126$$).off("panstart panmove panend");
    }, $_registerTouchHandler$:function($element$$127$$) {
      var $self$$145$$ = this, $options$$306$$, $target$$91$$, $x$$54$$, $y$$38$$, $currentTarget$$, $currentPrefix$$, $currentY$$, $previousY$$, $delta$$5$$, $range$$16$$, $index$$192$$, $prefix$$25$$;
      $options$$306$$ = {recognizers:[[$Hammer$$4$$.Pan, {direction:$Hammer$$4$$.DIRECTION_VERTICAL}]]};
      $$$$31$$($element$$127$$).$ojHammer$($options$$306$$).on("panstart", function($event$$410$$) {
        $target$$91$$ = $event$$410$$.gesture.target;
        $x$$54$$ = $self$$145$$.element[0].getBoundingClientRect().left + 5;
        $y$$38$$ = $target$$91$$.getBoundingClientRect().top;
        $self$$145$$.$_setCurrent$($$$$31$$($target$$91$$));
        $currentTarget$$ = $target$$91$$;
        $currentPrefix$$ = $target$$91$$.getAttribute("data-range");
        $currentY$$ = $y$$38$$;
      }).on("panmove", function($event$$411$$) {
        $previousY$$ = $currentY$$;
        $currentY$$ = $y$$38$$ + $event$$411$$.gesture.deltaY;
  ...
  $oj$$34$$.$ListViewIndexerModel$.prototype.$_getAvailablePrefixes$ = function $$oj$$34$$$$ListViewIndexerModel$$$$_getAvailablePrefixes$$() {
    ...
    if (null != $groupItems$$5$$) {
      for (var $prefixes$$3$$ = this.getIndexablePrefixes(), $i$$339$$ = 0;$i$$339$$ < $prefixes$$3$$.length;$i$$339$$++) {
        var $prefix$$26$$ = $prefixes$$3$$[$i$$339$$];
        $groupItems$$5$$.each(function() {
          if (0 == $$$$31$$(this).text().indexOf($prefix$$26$$)) {
            return $results$$11$$.push($prefix$$26$$), !1;
          }
        });
      }
    }
  ...
  $oj$$34$$.$ListViewIndexerModel$.prototype.$_setOtherPrefix$ = function $$oj$$34$$$$ListViewIndexerModel$$$$_setOtherPrefix$$() {
    var $prefixes$$4$$, $self$$146$$ = this, $match$$22$$, $groupItems$$6$$, $content$$34$$, $i$$340$$, $prefix$$28$$;
    $prefixes$$4$$ = this.getIndexablePrefixes();
    return new Promise(function($resolve$$33$$) {
      $match$$22$$ = null;
      $groupItems$$6$$ = $self$$146$$.$listview$.$_getGroupItemsCache$();
      null != $groupItems$$6$$ && $groupItems$$6$$.each(function() {
        $content$$34$$ = $$$$31$$(this).text();
        for ($i$$340$$ = 0;$i$$340$$ < $prefixes$$4$$.length;$i$$340$$++) {
          if ($prefix$$28$$ = $prefixes$$4$$[$i$$340$$], 0 == $content$$34$$.indexOf($prefix$$28$$)) {
            return!0;
          }
        }
        $match$$22$$ = this;
      ...
      $match$$22$$ ? ($self$$146$$.$listview$.$_scrollToGroupHeader$($match$$22$$), $resolve$$33$$($oj$$34$$.$IndexerModel$.PREFIX_OTHERS)) : $resolve$$33$$(null);
    });
  };
  $oj$$34$$.$ListViewIndexerModel$.prototype.$_setPrefix$ = function $$oj$$34$$$$ListViewIndexerModel$$$$_setPrefix$$($prefix$$29$$) {
    var $prefixes$$5$$, $index$$195$$, $self$$147$$ = this, $match$$23$$ = null, $groupHeader$$2$$;
    ...
    return new Promise(function($resolve$$34$$) {
      if (-1 == $index$$195$$) {
        ...
        for (;$index$$195$$ < $prefixes$$5$$.length;) {
          ...
          $groupHeader$$2$$ = $self$$147$$.$_findGroupHeader$($prefix$$29$$);
          if (null != $groupHeader$$2$$) {
            $self$$147$$.$listview$.$_scrollToGroupHeader$($groupHeader$$2$$);
            $match$$23$$ = $prefix$$29$$;
            break;
          }
          $index$$195$$++;
