...
define(["ojs/ojcore", "jquery", "ojs/ojdatasource-common"], function($oj$$26$$, $$$$24$$) {
  $oj$$26$$.$ArrayTableDataSource$ = function $$oj$$26$$$$ArrayTableDataSource$$($data$$140$$, $options$$279$$) {
    ...
    if (null != $data$$140$$ && void 0 !== $data$$140$$ && (this.$_idAttribute$ = null, null != $options$$279$$ && null != $options$$279$$.idAttribute && (this.$_idAttribute$ = $options$$279$$.idAttribute), this.$_data$ = $data$$140$$ instanceof Array ? $data$$140$$ : $data$$140$$(), this.$_totalSize$ = this.$_data$.length, !($data$$140$$ instanceof Array))) {
      ...
      $data$$140$$.subscribe(function($changes$$5$$) {
        var $i$$315$$, $rowArray$$3$$ = [], $indexArray$$2$$ = [];
        for ($i$$315$$ = 0;$i$$315$$ < $changes$$5$$.length;$i$$315$$++) {
          "deleted" === $changes$$5$$[$i$$315$$].status && $rowArray$$3$$.push($changes$$5$$[$i$$315$$].value);
        }
        $self$$137$$.remove($rowArray$$3$$, null);
        $rowArray$$3$$ = [];
        $indexArray$$2$$ = [];
        for ($i$$315$$ = 0;$i$$315$$ < $changes$$5$$.length;$i$$315$$++) {
          "added" === $changes$$5$$[$i$$315$$].status && ($rowArray$$3$$.push($changes$$5$$[$i$$315$$].value), $indexArray$$2$$.push($changes$$5$$[$i$$315$$].index));
        }
        $self$$137$$.add($rowArray$$3$$, {at:$indexArray$$2$$});
      }, null, "arrayChange");
    }
  ...
  $oj$$26$$.$ArrayTableDataSource$.prototype.at = function $$oj$$26$$$$ArrayTableDataSource$$$at$($index$$187$$) {
    this.$_checkDataLoaded$();
    var $row$$30$$;
    $row$$30$$ = 0 > $index$$187$$ || $index$$187$$ >= this.$_rows$.data.length ? null : {data:this.$_rows$.data[$index$$187$$], index:$index$$187$$, key:this.$_getId$(this.$_rows$.data[$index$$187$$])};
    return new Promise(function($resolve$$31$$) {
      $resolve$$31$$($row$$30$$);
    });
  };
  ...
  $oj$$26$$.$ArrayTableDataSource$.prototype.change = function $$oj$$26$$$$ArrayTableDataSource$$$change$($m$$20$$, $options$$282$$) {
    ...
    this.$_checkDataLoaded$();
    var $silent$$22$$ = $options$$282$$.silent, $i$$316$$, $row$$31$$, $key$$133$$, $changedRow$$, $rowArray$$4$$ = {data:[], keys:[], indexes:[]};
    $m$$20$$ instanceof Array || ($m$$20$$ = [$m$$20$$]);
    for ($i$$316$$ = 0;$i$$316$$ < $m$$20$$.length;$i$$316$$++) {
      $row$$31$$ = $m$$20$$[$i$$316$$], null != $row$$31$$ && ($key$$133$$ = this.$_getId$($row$$31$$), $changedRow$$ = this.$_getInternal$($key$$133$$, null), $rowArray$$4$$.data.push($row$$31$$), $rowArray$$4$$.keys.push($key$$133$$), $rowArray$$4$$.indexes.push($changedRow$$.index), this.$_rows$.data[$changedRow$$.index] = $row$$31$$);
    }
  ...
  $oj$$26$$.$ArrayTableDataSource$.prototype.sort = function $$oj$$26$$$$ArrayTableDataSource$$$sort$($criteria$$1$$) {
    ...
    this.$_checkDataLoaded$();
    var $key$$134$$ = $criteria$$1$$.key, $direction$$5$$ = $criteria$$1$$.direction, $comparator$$9$$ = null;
    "ascending" == $direction$$5$$ ? $comparator$$9$$ = function $$comparator$$9$$$($row$$32$$) {
      return $$$$24$$.isFunction($row$$32$$[$key$$134$$]) ? $row$$32$$[$key$$134$$]() : $row$$32$$[$key$$134$$];
    } : "descending" == $direction$$5$$ && ($comparator$$9$$ = function $$comparator$$9$$$($rowA$$, $rowB$$) {
      var $a$$103$$, $b$$64$$;
      $$$$24$$.isFunction($rowA$$[$key$$134$$]) ? ($a$$103$$ = $rowA$$[$key$$134$$](), $b$$64$$ = $rowB$$[$key$$134$$]()) : ($a$$103$$ = $rowA$$[$key$$134$$], $b$$64$$ = $rowB$$[$key$$134$$]);
      return $a$$103$$ === $b$$64$$ ? 0 : $a$$103$$ > $b$$64$$ ? -1 : 1;
    });
    this.comparator = $comparator$$9$$;
    this.direction = $direction$$5$$;
    var $self$$138$$ = this;
    return new Promise(function($resolve$$32$$) {
      $criteria$$1$$ = $criteria$$1$$ || {};
      if ($self$$138$$.$_hasComparator$()) {
        var $comparator$$10$$ = $self$$138$$.comparator;
        $self$$138$$.$_rows$.data.sort(function($a$$104$$, $b$$65$$) {
          return $oj$$26$$.$ArrayTableDataSource$.$_sortFunc$($a$$104$$, $b$$65$$, $comparator$$10$$, $self$$138$$);
        });
        $self$$138$$.$_sorted$ = !0;
        var $result$$54$$ = {header:$criteria$$1$$.key, direction:$criteria$$1$$.direction};
        $oj$$26$$.$TableDataSource$.$superclass$.handleEvent.call($self$$138$$, $oj$$26$$.$TableDataSource$.$EventType$.SORT, $result$$54$$);
        $resolve$$32$$($result$$54$$);
      }
    });
  };
  ...
  $oj$$26$$.$ArrayTableDataSource$.prototype.$_addToRowSet$ = function $$oj$$26$$$$ArrayTableDataSource$$$$_addToRowSet$$($m$$22$$, $index$$188$$, $i$$318_options$$287$$) {
    var $j$$40_key$$135$$, $row$$33$$;
    $i$$318_options$$287$$ = $i$$318_options$$287$$ || {};
    var $silent$$24$$ = $i$$318_options$$287$$.silent, $rowArray$$5$$ = {data:[], keys:[], indexes:[]};
    $m$$22$$ instanceof Array || ($m$$22$$ = [$m$$22$$]);
    null == $index$$188$$ || $index$$188$$ instanceof Array || ($index$$188$$ = [$index$$188$$]);
    for ($i$$318_options$$287$$ = 0;$i$$318_options$$287$$ < $m$$22$$.length;$i$$318_options$$287$$++) {
      if ($row$$33$$ = $m$$22$$[$i$$318_options$$287$$], null != $row$$33$$) {
        $j$$40_key$$135$$ = this.$_getId$($row$$33$$);
        $rowArray$$5$$.data.push($row$$33$$);
        ...
        if (!0 == this.$_sorted$ && 0 < this.$_rows$.data.length) {
          for ($j$$40_key$$135$$ = 0;$j$$40_key$$135$$ < this.$_rows$.data.length;$j$$40_key$$135$$++) {
            if (0 > $oj$$26$$.$ArrayTableDataSource$.$_sortFunc$($row$$33$$, this.$_rows$.data[$j$$40_key$$135$$], this.comparator, this)) {
              this.$_rows$.data.splice($j$$40_key$$135$$, 0, $row$$33$$);
              $rowArray$$5$$.indexes.push($j$$40_key$$135$$);
              break;
            } else {
              if ($j$$40_key$$135$$ == this.$_rows$.data.length - 1) {
                this.$_rows$.data.push($row$$33$$);
          ...
          null == $index$$188$$ ? (this.$_rows$.data.push($row$$33$$), $rowArray$$5$$.indexes.push(this.$_rows$.data.length - 1)) : (this.$_rows$.data.splice($index$$188$$[$i$$318_options$$287$$], 0, $row$$33$$), $rowArray$$5$$.indexes.push($index$$188$$[$i$$318_options$$287$$]));
        }
        this.$_totalSize$++;
  ...
  $oj$$26$$.$ArrayTableDataSource$.prototype.$_checkDataLoaded$ = function $$oj$$26$$$$ArrayTableDataSource$$$$_checkDataLoaded$$() {
    if (null == this.$_rows$ || null == this.$_rows$.data) {
  ...
  $oj$$26$$.$ArrayTableDataSource$.prototype.$_fetchInternal$ = function $$oj$$26$$$$ArrayTableDataSource$$$$_fetchInternal$$($options$$288$$) {
    ...
    this.$_checkDataLoaded$();
    var $pageSize$$2_result$$55$$;
    try {
      $pageSize$$2_result$$55$$ = 0 < $options$$288$$.pageSize ? $options$$288$$.pageSize : -1;
      this.$_startIndex$ || (this.$_startIndex$ = 0);
      this.$_startIndex$ = null == $options$$288$$.startIndex ? this.$_startIndex$ : $options$$288$$.startIndex;
      var $endIndex$$4$$ = $oj$$26$$.$ArrayTableDataSource$.$_getEndIndex$(this.$_rows$, this.$_startIndex$, $pageSize$$2_result$$55$$), $rowArray$$6$$ = [], $keyArray$$ = [], $i$$319$$;
      for ($i$$319$$ = this.$_startIndex$;$i$$319$$ <= $endIndex$$4$$;$i$$319$$++) {
        $rowArray$$6$$[$i$$319$$ - this.$_startIndex$] = this.$_rows$.data[$i$$319$$], $keyArray$$[$i$$319$$ - this.$_startIndex$] = this.$_getId$(this.$_rows$.data[$i$$319$$]);
      }
    } catch ($err$$22$$) {
      return this.$_endFetch$($options$$288$$, null, $err$$22$$), Promise.reject($err$$22$$);
    }
    $endIndex$$4$$ < this.$_startIndex$ && (this.$_startIndex$ = $endIndex$$4$$ + 1);
    $options$$288$$.pageSize = $pageSize$$2_result$$55$$;
    $options$$288$$.startIndex = this.$_startIndex$;
    $options$$288$$.refresh = !0;
    $pageSize$$2_result$$55$$ = {data:$rowArray$$6$$, keys:$keyArray$$, startIndex:this.$_startIndex$};
    this.$_endFetch$($options$$288$$, $pageSize$$2_result$$55$$, null);
    return Promise.resolve($pageSize$$2_result$$55$$);
  };
  $oj$$26$$.$ArrayTableDataSource$.prototype.$_getInternal$ = function $$oj$$26$$$$ArrayTableDataSource$$$$_getInternal$$($id$$40$$) {
    var $i$$320$$, $j$$41$$, $row$$34$$, $key$$136$$, $result$$56$$ = null;
    for ($i$$320$$ = 0;$i$$320$$ < this.$_rows$.data.length;$i$$320$$++) {
      if ($row$$34$$ = this.$_rows$.data[$i$$320$$], void 0 !== $row$$34$$) {
        if ($key$$136$$ = this.$_getId$($row$$34$$), $$$$24$$.isArray($key$$136$$) && $$$$24$$.isArray($id$$40$$)) {
          if ($key$$136$$.length == $id$$40$$.length) {
            var $equal$$ = !0;
            for ($j$$41$$ = 0;$j$$41$$ < $id$$40$$.length;$j$$41$$++) {
              if ($key$$136$$[$j$$41$$] != $id$$40$$[$j$$41$$]) {
                $equal$$ = !1;
                break;
              }
            }
            $equal$$ && ($result$$56$$ = {data:$row$$34$$, key:$key$$136$$, index:this.$_rows$.indexes[$i$$320$$]});
          }
        } else {
          $key$$136$$ == $id$$40$$ && ($result$$56$$ = {data:$row$$34$$, key:$key$$136$$, index:this.$_rows$.indexes[$i$$320$$]});
        }
      }
    }
    return $result$$56$$;
  ...
  $oj$$26$$.$ArrayTableDataSource$.prototype.$_realignRowIndices$ = function $$oj$$26$$$$ArrayTableDataSource$$$$_realignRowIndices$$() {
    for (var $i$$321$$ = 0;$i$$321$$ < this.$_rows$.data.length;$i$$321$$++) {
      this.$_rows$.indexes[$i$$321$$] = $i$$321$$;
    }
  };
  $oj$$26$$.$ArrayTableDataSource$.prototype.$_removeInternal$ = function $$oj$$26$$$$ArrayTableDataSource$$$$_removeInternal$$($m$$23$$, $options$$290$$) {
    var $i$$322$$, $deletedRow_key$$137_row$$35$$;
    $options$$290$$ = $options$$290$$ || {};
    var $silent$$25$$ = $options$$290$$.silent, $rowArray$$7$$ = {data:[], keys:[], indexes:[]};
    $m$$23$$ instanceof Array || ($m$$23$$ = [$m$$23$$]);
    var $sortedRowArray$$ = [];
    for ($i$$322$$ = 0;$i$$322$$ < $m$$23$$.length;$i$$322$$++) {
      $deletedRow_key$$137_row$$35$$ = $m$$23$$[$i$$322$$], null != $deletedRow_key$$137_row$$35$$ && ($deletedRow_key$$137_row$$35$$ = this.$_getId$($deletedRow_key$$137_row$$35$$), $deletedRow_key$$137_row$$35$$ = this.$_getInternal$($deletedRow_key$$137_row$$35$$, null), null != $deletedRow_key$$137_row$$35$$ && $sortedRowArray$$.push({data:$deletedRow_key$$137_row$$35$$.data, key:$deletedRow_key$$137_row$$35$$.key, index:$deletedRow_key$$137_row$$35$$.index}));
    }
    $sortedRowArray$$.sort(function($a$$105$$, $b$$66$$) {
      return $a$$105$$.index - $b$$66$$.index;
    });
    for ($i$$322$$ = 0;$i$$322$$ < $sortedRowArray$$.length;$i$$322$$++) {
      $rowArray$$7$$.data.push($sortedRowArray$$[$i$$322$$].data), $rowArray$$7$$.keys.push($sortedRowArray$$[$i$$322$$].key), $rowArray$$7$$.indexes.push($sortedRowArray$$[$i$$322$$].index);
    }
    for ($i$$322$$ = $rowArray$$7$$.indexes.length - 1;0 <= $i$$322$$;$i$$322$$--) {
      this.$_rows$.data.splice($rowArray$$7$$.indexes[$i$$322$$], 1), this.$_rows$.indexes.splice($rowArray$$7$$.indexes[$i$$322$$], 1), this.$_totalSize$--, this.$_realignRowIndices$();
    }
  ...
  $oj$$26$$.$ArrayTableDataSource$.prototype.$_endFetch$ = function $$oj$$26$$$$ArrayTableDataSource$$$$_endFetch$$($options$$292$$, $result$$57$$, $error$$37$$) {
    null != $error$$37$$ ? $oj$$26$$.$TableDataSource$.$superclass$.handleEvent.call(this, $oj$$26$$.$TableDataSource$.$EventType$.ERROR, $error$$37$$) : $options$$292$$.silent || $oj$$26$$.$TableDataSource$.$superclass$.handleEvent.call(this, $oj$$26$$.$TableDataSource$.$EventType$.SYNC, $result$$57$$);
  };
  ...
  $oj$$26$$.$ArrayTableDataSource$.$_getEndIndex$ = function $$oj$$26$$$$ArrayTableDataSource$$$_getEndIndex$$($rows$$6$$, $startIndex$$28$$, $pageSize$$3$$) {
  ...
  $oj$$26$$.$ArrayTableDataSource$.prototype.$_getRowArray$ = function $$oj$$26$$$$ArrayTableDataSource$$$$_getRowArray$$($values$$13$$) {
    var $endIndex$$6$$ = $values$$13$$.length - 1, $rowArray$$8$$ = {}, $i$$323$$, $prop$$64$$;
    $rowArray$$8$$.data = [];
    $rowArray$$8$$.indexes = [];
    this.$_attributes$ = null;
    for ($i$$323$$ = 0;$i$$323$$ <= $endIndex$$6$$;$i$$323$$++) {
      var $clonedRowValues$$ = {}, $rowValues$$ = $values$$13$$[$i$$323$$];
      for ($prop$$64$$ in $rowValues$$) {
        $rowValues$$.hasOwnProperty($prop$$64$$) && ($clonedRowValues$$[$prop$$64$$] = $rowValues$$[$prop$$64$$], 0 == $i$$323$$ && (null == this.$_attributes$ && (this.$_attributes$ = []), this.$_attributes$.push($prop$$64$$)));
      }
      $rowArray$$8$$.data[$i$$323$$] = $clonedRowValues$$;
      $rowArray$$8$$.indexes[$i$$323$$] = $i$$323$$;
    }
    return $rowArray$$8$$;
  };
  $oj$$26$$.$ArrayTableDataSource$.prototype.$_getId$ = function $$oj$$26$$$$ArrayTableDataSource$$$$_getId$$($errDetail$$8_row$$37$$) {
    var $id$$41$$, $idAttribute$$ = this.$_getIdAttr$($errDetail$$8_row$$37$$);
    if ($$$$24$$.isArray($idAttribute$$)) {
      var $i$$324$$;
      $id$$41$$ = [];
      for ($i$$324$$ = 0;$i$$324$$ < $idAttribute$$.length;$i$$324$$++) {
        if ($idAttribute$$[$i$$324$$] in $errDetail$$8_row$$37$$) {
          $id$$41$$[$i$$324$$] = $errDetail$$8_row$$37$$[$idAttribute$$[$i$$324$$]];
        } else {
          throw $errDetail$$8_row$$37$$ = $oj$$26$$.$Translations$.$applyParameters$($oj$$26$$.$ArrayTableDataSource$.$_LOGGER_MSG$._ERR_ARRAY_TABLE_DATASOURCE_IDATTR_NOT_IN_ROW, [$idAttribute$$[$i$$324$$]]), Error($errDetail$$8_row$$37$$);
        }
      }
    } else {
      if ($idAttribute$$ in $errDetail$$8_row$$37$$) {
        $id$$41$$ = $errDetail$$8_row$$37$$[$idAttribute$$];
      } else {
        throw $errDetail$$8_row$$37$$ = $oj$$26$$.$Translations$.$applyParameters$($oj$$26$$.$ArrayTableDataSource$.$_LOGGER_MSG$._ERR_ARRAY_TABLE_DATASOURCE_IDATTR_NOT_IN_ROW, [$idAttribute$$]), Error($errDetail$$8_row$$37$$);
      }
    }
    return $id$$41$$;
  };
  $oj$$26$$.$ArrayTableDataSource$.prototype.$_getIdAttr$ = function $$oj$$26$$$$ArrayTableDataSource$$$$_getIdAttr$$($row$$38$$) {
    if (null != this.$_idAttribute$) {
      return this.$_idAttribute$;
    }
    if (null == this.$_attributes$) {
      this.$_attributes$ = [];
      for (var $prop$$65$$ in $row$$38$$) {
        $row$$38$$.hasOwnProperty($prop$$65$$) && this.$_attributes$.push($prop$$65$$);
      }
    }
    return this.$_attributes$.hasOwnProperty("id") ? "id" : this.$_attributes$;
  };
  $oj$$26$$.$ArrayTableDataSource$.$_sortFunc$ = function $$oj$$26$$$$ArrayTableDataSource$$$_sortFunc$$($a$$106_attrs1$$2$$, $attrs2$$2_b$$67$$, $comparator$$12_i$$325$$, $self$$141$$) {
    var $keyA$$5_retVal$$16$$, $keyB$$5$$;
    if ($$$$24$$.isFunction($comparator$$12_i$$325$$)) {
      if (1 === $comparator$$12_i$$325$$.length) {
        $keyA$$5_retVal$$16$$ = $comparator$$12_i$$325$$.call($self$$141$$, $a$$106_attrs1$$2$$);
        $keyB$$5$$ = $comparator$$12_i$$325$$.call($self$$141$$, $attrs2$$2_b$$67$$);
        $a$$106_attrs1$$2$$ = $oj$$26$$.$StringUtils$.$isString$($keyA$$5_retVal$$16$$) ? $keyA$$5_retVal$$16$$.split(",") : [$keyA$$5_retVal$$16$$];
        $attrs2$$2_b$$67$$ = $oj$$26$$.$StringUtils$.$isString$($keyB$$5$$) ? $keyB$$5$$.split(",") : [$keyB$$5$$];
        for ($comparator$$12_i$$325$$ = 0;$comparator$$12_i$$325$$ < $a$$106_attrs1$$2$$.length;$comparator$$12_i$$325$$++) {
          if ($keyA$$5_retVal$$16$$ = $oj$$26$$.$ArrayTableDataSource$.$_compareKeys$($a$$106_attrs1$$2$$[$comparator$$12_i$$325$$], $attrs2$$2_b$$67$$[$comparator$$12_i$$325$$], $self$$141$$.direction), 0 !== $keyA$$5_retVal$$16$$) {
            return $keyA$$5_retVal$$16$$;
          }
        }
        return 0;
      }
      return $comparator$$12_i$$325$$.call($self$$141$$, $a$$106_attrs1$$2$$, $attrs2$$2_b$$67$$);
    }
    if ($oj$$26$$.$StringUtils$.$isString$($comparator$$12_i$$325$$)) {
      var $attrs$$21$$ = $comparator$$12_i$$325$$.split(",");
      for ($comparator$$12_i$$325$$ = 0;$comparator$$12_i$$325$$ < $attrs$$21$$.length;$comparator$$12_i$$325$$++) {
        if ($keyA$$5_retVal$$16$$ = $oj$$26$$.$ArrayTableDataSource$.$_getKey$($a$$106_attrs1$$2$$, $attrs$$21$$[$comparator$$12_i$$325$$]), $keyB$$5$$ = $oj$$26$$.$ArrayTableDataSource$.$_getKey$($attrs2$$2_b$$67$$, $attrs$$21$$[$comparator$$12_i$$325$$]), $keyA$$5_retVal$$16$$ = $oj$$26$$.$ArrayTableDataSource$.$_compareKeys$($keyA$$5_retVal$$16$$, $keyB$$5$$, $self$$141$$.direction), 0 !== $keyA$$5_retVal$$16$$) {
          return $keyA$$5_retVal$$16$$;
        }
      }
    }
