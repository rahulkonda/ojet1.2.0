...
define(["ojs/ojcore", "jquery", "ojs/ojdatasource-common", "ojs/ojmodel"], function($oj$$42$$) {
  ...
  $oj$$42$$.$CollectionHeaderSet$.prototype.getData = function $$oj$$42$$$$CollectionHeaderSet$$$getData$($index$$200$$, $level$$31$$) {
    var $model$$67$$;
    $oj$$42$$.$Assert$.assert($index$$200$$ <= this.$m_end$ && $index$$200$$ >= this.$m_start$, "index out of bounds");
    $oj$$42$$.$Assert$.assert(null == $level$$31$$ || 0 == $level$$31$$, "level out of bounds");
    if (null != this.$m_rowHeader$) {
      if (null == this.$m_models$) {
        return null;
      }
      $model$$67$$ = this.$m_models$[$index$$200$$ - this.$m_start$];
      return $model$$67$$.get(this.$m_rowHeader$);
    }
    return this.$m_headers$[$index$$200$$];
  };
  ...
  $oj$$42$$.$CollectionHeaderSet$.prototype.getMetadata = function $$oj$$42$$$$CollectionHeaderSet$$$getMetadata$($index$$201$$, $level$$32$$) {
    var $data$$153_model$$68$$;
    $oj$$42$$.$Assert$.assert($index$$201$$ <= this.$m_end$ && $index$$201$$ >= this.$m_start$, "index out of bounds");
    $oj$$42$$.$Assert$.assert(null == $level$$32$$ || 0 == $level$$32$$, "level out of bounds");
    if (null != this.$m_rowHeader$) {
      if (null == this.$m_models$) {
        return null;
      }
      $data$$153_model$$68$$ = this.$m_models$[$index$$201$$ - this.$m_start$];
      return{key:$oj$$42$$.$CollectionDataGridUtils$.$_getModelKey$($data$$153_model$$68$$)};
    }
    $data$$153_model$$68$$ = this.getData($index$$201$$, $level$$32$$);
  ...
  $oj$$42$$.$CollectionHeaderSet$.prototype.$getExtent$ = function $$oj$$42$$$$CollectionHeaderSet$$$$getExtent$$($index$$202$$, $level$$33$$) {
  ...
  $oj$$42$$.$CollectionHeaderSet$.prototype.$getDepth$ = function $$oj$$42$$$$CollectionHeaderSet$$$$getDepth$$($index$$203$$, $level$$34$$) {
  ...
  $oj$$42$$.$CollectionCellSet$.prototype.getData = function $$oj$$42$$$$CollectionCellSet$$$getData$($indexes$$8$$) {
    var $model$$69$$;
    $model$$69$$ = this.$_getModel$($indexes$$8$$);
    return null == $model$$69$$ ? null : $model$$69$$.get(this.$m_columns$[$indexes$$8$$.column]);
  };
  ...
  $oj$$42$$.$CollectionCellSet$.prototype.getMetadata = function $$oj$$42$$$$CollectionCellSet$$$getMetadata$($indexes$$9$$) {
    var $model$$70$$;
    $model$$70$$ = this.$_getModel$($indexes$$9$$);
    return null == $model$$70$$ ? null : {keys:{row:$oj$$42$$.$CollectionDataGridUtils$.$_getModelKey$($model$$70$$), column:this.$m_columns$[$indexes$$9$$.column]}};
  };
  ...
  $oj$$42$$.$CollectionCellSet$.prototype.$_getModel$ = function $$oj$$42$$$$CollectionCellSet$$$$_getModel$$($column$$23_indexes$$10$$) {
    ...
    $row$$39$$ = $column$$23_indexes$$10$$.row;
    $column$$23_indexes$$10$$ = $column$$23_indexes$$10$$.column;
    $oj$$42$$.$Assert$.assert($row$$39$$ >= this.$m_startRow$ && $row$$39$$ <= this.$m_endRow$ && $column$$23_indexes$$10$$ >= this.$m_startColumn$ && $column$$23_indexes$$10$$ <= this.$m_endColumn$);
    return this.$m_models$[$row$$39$$ - this.$m_startRow$];
  };
  $oj$$42$$.$CollectionCellSet$.prototype.$getCount$ = function $$oj$$42$$$$CollectionCellSet$$$$getCount$$($axis$$30$$) {
    return "row" === $axis$$30$$ ? Math.max(0, this.$m_endRow$ - this.$m_startRow$) : "column" === $axis$$30$$ ? Math.max(0, this.$m_endColumn$ - this.$m_startColumn$) : 0;
  };
  ...
  $oj$$42$$.$CollectionDataGridUtils$.$_getModelKey$ = function $$oj$$42$$$$CollectionDataGridUtils$$$_getModelKey$$($model$$71$$) {
    var $key$$145$$;
    $key$$145$$ = $model$$71$$.$GetId$();
    null == $key$$145$$ && ($key$$145$$ = $model$$71$$.$GetCid$());
    return $key$$145$$;
  };
  ...
  $oj$$42$$.$CollectionDataGridDataSource$.prototype.$getCount$ = function $$oj$$42$$$$CollectionDataGridDataSource$$$$getCount$$($axis$$31$$) {
    var $totalSize$$;
    void 0 == this.precision && (this.precision = {});
    if ("row" == $axis$$31$$) {
      $totalSize$$ = this.$_totalSize$();
      if (-1 === $totalSize$$ || 0 === $totalSize$$ && (!this.$_isDataAvailable$() || 0 < this.$_size$())) {
        return this.precision[$axis$$31$$] = "estimate", -1;
      }
      this.precision[$axis$$31$$] = "exact";
      return this.$_size$();
    }
    if ("column" == $axis$$31$$) {
      if (null != this.columns) {
        return this.precision[$axis$$31$$] = "exact", this.columns.length;
      }
      this.precision[$axis$$31$$] = "estimate";
      return-1;
    }
    return 0;
  };
  ...
  $oj$$42$$.$CollectionDataGridDataSource$.prototype.$getCountPrecision$ = function $$oj$$42$$$$CollectionDataGridDataSource$$$$getCountPrecision$$($axis$$32$$) {
    null != this.precision && null != this.precision[$axis$$32$$] || this.$getCount$($axis$$32$$);
    return this.precision[$axis$$32$$];
  };
  ...
  $oj$$42$$.$CollectionDataGridDataSource$.prototype.$fetchHeaders$ = function $$oj$$42$$$$CollectionDataGridDataSource$$$$fetchHeaders$$($headerRange$$1$$, $callbacks$$18$$, $callbackObjects$$4$$) {
    var $axis$$33$$, $callback$$114$$;
    null != $callbacks$$18$$ && ($axis$$33$$ = $headerRange$$1$$.axis, $callback$$114$$ = {}, $callback$$114$$.$headerRange$ = $headerRange$$1$$, $callback$$114$$.callbacks = $callbacks$$18$$, $callback$$114$$.$callbackObjects$ = $callbackObjects$$4$$, this.$pendingHeaderCallback$[$axis$$33$$] = $callback$$114$$);
  };
  ...
  $oj$$42$$.$CollectionDataGridDataSource$.prototype.$_handleHeaderFetchSuccess$ = function $$oj$$42$$$$CollectionDataGridDataSource$$$$_handleHeaderFetchSuccess$$($headerRange$$2$$, $callbacks$$19$$, $callbackObjects$$5$$, $actualRange_end$$16$$) {
    var $axis$$34$$, $start$$49$$, $count$$50$$, $headerSet$$;
    $axis$$34$$ = $headerRange$$2$$.axis;
    $start$$49$$ = $headerRange$$2$$.start;
    $count$$50$$ = $headerRange$$2$$.count;
    if ("column" === $axis$$34$$) {
      null != this.columns ? ($actualRange_end$$16$$ = Math.min(this.columns.length, $start$$49$$ + $count$$50$$), $headerSet$$ = new $oj$$42$$.$CollectionHeaderSet$($start$$49$$, $actualRange_end$$16$$, this.columns, void 0, this.$_sortInfo$)) : $headerSet$$ = new $oj$$42$$.$ArrayHeaderSet$($start$$49$$, $start$$49$$, $axis$$34$$, null);
    } else {
      if ("row" === $axis$$34$$) {
        ...
        $headerSet$$ = new $oj$$42$$.$ArrayHeaderSet$($start$$49$$, $start$$49$$, $axis$$34$$, null);
      }
    }
  ...
  $oj$$42$$.$CollectionDataGridDataSource$.prototype.$_getRanges$ = function $$oj$$42$$$$CollectionDataGridDataSource$$$$_getRanges$$($cellRanges$$) {
    var $i$$350$$, $cellRange$$2$$, $rowStart$$1$$, $rowCount$$6$$, $colStart$$, $colCount$$1$$;
    for ($i$$350$$ = 0;$i$$350$$ < $cellRanges$$.length;$i$$350$$ += 1) {
      $cellRange$$2$$ = $cellRanges$$[$i$$350$$], "row" === $cellRange$$2$$.axis ? ($rowStart$$1$$ = $cellRange$$2$$.start, $rowCount$$6$$ = $cellRange$$2$$.count) : "column" === $cellRange$$2$$.axis && ($colStart$$ = $cellRange$$2$$.start, $colCount$$1$$ = $cellRange$$2$$.count);
    }
  ...
  $oj$$42$$.$CollectionDataGridDataSource$.prototype.$_resolveModels$ = function $$oj$$42$$$$CollectionDataGridDataSource$$$$_resolveModels$$($i$$351_rowStart$$3$$, $rowEnd$$1$$, $set$$4$$, $ranges$$1$$, $callbacks$$21$$, $callbackObjects$$7$$) {
    var $promises$$;
    for ($promises$$ = [];$i$$351_rowStart$$3$$ < $rowEnd$$1$$;$i$$351_rowStart$$3$$++) {
      $promises$$.push(this.$collection$.at($i$$351_rowStart$$3$$, {deferred:!0}));
    }
  ...
  $oj$$42$$.$CollectionDataGridDataSource$.prototype.$_processPendingHeaderCallbacks$ = function $$oj$$42$$$$CollectionDataGridDataSource$$$$_processPendingHeaderCallbacks$$($axis$$35$$) {
    var $pendingCallback$$, $headerRange$$3$$, $callbacks$$23$$, $callbackObjects$$9$$, $actualRange$$2$$;
    $pendingCallback$$ = this.$pendingHeaderCallback$[$axis$$35$$];
    null != $pendingCallback$$ && ($headerRange$$3$$ = $pendingCallback$$.$headerRange$, $callbacks$$23$$ = $pendingCallback$$.callbacks, $callbackObjects$$9$$ = $pendingCallback$$.$callbackObjects$, "row" === $axis$$35$$ && ($actualRange$$2$$ = $pendingCallback$$.$actualRange$), this.$_handleHeaderFetchSuccess$($headerRange$$3$$, $callbacks$$23$$, $callbackObjects$$9$$, $actualRange$$2$$), this.$pendingHeaderCallback$[$axis$$35$$] = null);
  };
  ...
  $oj$$42$$.$CollectionDataGridDataSource$.prototype.$_fetchCells$ = function $$oj$$42$$$$CollectionDataGridDataSource$$$$_fetchCells$$($cellRanges$$4_ranges$$2$$) {
    ...
    this.$collection$.$setRangeLocal$($rowStart$$4$$, $cellRanges$$4_ranges$$2$$.rowCount).then(function($actual$$5$$) {
      ...
      void 0 === this.columns ? this.$collection$.at($rowStart$$4$$, {deferred:!0}).then(function($model$$72$$) {
        null != $model$$72$$ && this.$_setupColumns$($model$$72$$);
        this.$_fetchCellsComplete$();
      }.bind(this)) : this.$_fetchCellsComplete$();
    }.bind(this), function($e$$93$$) {
      this.$_fetchCellsError$($e$$93$$);
    }.bind(this));
  };
  ...
  $oj$$42$$.$CollectionDataGridDataSource$.prototype.keys = function $$oj$$42$$$$CollectionDataGridDataSource$$$keys$($indexes$$11$$) {
    var $rowIndex$$6$$, $columnIndex$$2$$, $rowKey$$30$$, $columnKey$$1$$, $self$$151$$;
    $rowIndex$$6$$ = $indexes$$11$$.row;
    $columnIndex$$2$$ = $indexes$$11$$.column;
    $self$$151$$ = this;
    return new Promise(function($resolve$$39$$) {
      $self$$151$$.$collection$.at($rowIndex$$6$$, {deferred:!0}).then(function($rowModel$$) {
        null == $rowModel$$ ? $resolve$$39$$({row:null, column:null}) : ($rowKey$$30$$ = $oj$$42$$.$CollectionDataGridUtils$.$_getModelKey$($rowModel$$), null == $self$$151$$.columns && $self$$151$$.$_setupColumns$($rowModel$$), $columnKey$$1$$ = $self$$151$$.columns[$columnIndex$$2$$], $resolve$$39$$({row:$rowKey$$30$$, column:$columnKey$$1$$}));
      }.bind($self$$151$$));
    });
  };
  ...
  $oj$$42$$.$CollectionDataGridDataSource$.prototype.$indexes$ = function $$oj$$42$$$$CollectionDataGridDataSource$$$$indexes$$($keys$$37$$) {
    var $rowKey$$31$$, $columnKey$$2$$, $columnIndex$$3$$, $self$$152$$;
    $rowKey$$31$$ = $keys$$37$$.row;
    $columnKey$$2$$ = $keys$$37$$.column;
    $self$$152$$ = this;
    return new Promise(function($resolve$$40$$) {
      $self$$152$$.$collection$.indexOf($rowKey$$31$$, {deferred:!0}).then(function($rowIndex$$7$$) {
        -1 === $rowIndex$$7$$ ? $resolve$$40$$({row:-1, column:-1}) : null == $self$$152$$.columns ? $self$$152$$.$collection$.at($rowIndex$$7$$, {deferred:!0}).then(function($model$$74$$) {
          $self$$152$$.$_setupColumns$($model$$74$$);
          $columnIndex$$3$$ = $self$$152$$.columns.indexOf($columnKey$$2$$);
          -1 === $columnIndex$$3$$ && ($rowIndex$$7$$ = -1);
          $resolve$$40$$({row:$rowIndex$$7$$, column:$columnIndex$$3$$});
        }.bind($self$$152$$)) : ($columnIndex$$3$$ = $self$$152$$.columns.indexOf($columnKey$$2$$), -1 === $columnIndex$$3$$ && ($rowIndex$$7$$ = -1), $resolve$$40$$({row:$rowIndex$$7$$, column:$columnIndex$$3$$}));
      }.bind($self$$152$$));
    });
  };
  ...
  $oj$$42$$.$CollectionDataGridDataSource$.prototype.sort = function $$oj$$42$$$$CollectionDataGridDataSource$$$sort$($axis$$37_criteria$$2$$, $callbacks$$27$$, $callbackObjects$$13$$) {
    var $comparator$$13$$, $direction$$8$$, $key$$146$$;
    null == $callbackObjects$$13$$ && ($callbackObjects$$13$$ = {});
    null == $axis$$37_criteria$$2$$ ? this.$_resetSortOrder$($callbacks$$27$$, $callbackObjects$$13$$) : ($direction$$8$$ = $axis$$37_criteria$$2$$.direction, $key$$146$$ = $axis$$37_criteria$$2$$.key, $axis$$37_criteria$$2$$ = $axis$$37_criteria$$2$$.axis, "column" === $axis$$37_criteria$$2$$ ? (this.$collection$.$IsVirtual$() ? (this.$collection$.comparator = $key$$146$$, this.$collection$.sortDirection = "ascending" === $direction$$8$$ ? 1 : -1) : ("ascending" === $direction$$8$$ && ($comparator$$13$$ = 
    function $$comparator$$13$$$($a$$111$$, $b$$69$$) {
      var $as$$, $bs$$;
      $a$$111$$ = $a$$111$$.get($key$$146$$);
      $b$$69$$ = $b$$69$$.get($key$$146$$);
      $as$$ = isNaN($a$$111$$);
      $bs$$ = isNaN($b$$69$$);
      $a$$111$$ instanceof Date && ($a$$111$$ = $a$$111$$.toISOString(), $as$$ = !0);
      $b$$69$$ instanceof Date && ($b$$69$$ = $b$$69$$.toISOString(), $bs$$ = !0);
      return $as$$ && $bs$$ ? $a$$111$$ < $b$$69$$ ? -1 : $a$$111$$ === $b$$69$$ ? 0 : 1 : $as$$ ? 1 : $bs$$ ? -1 : $a$$111$$ - $b$$69$$;
    }), "descending" === $direction$$8$$ && ($comparator$$13$$ = function $$comparator$$13$$$($a$$112$$, $b$$70$$) {
      var $as$$1$$, $bs$$1$$;
      $a$$112$$ = $a$$112$$.get($key$$146$$);
      $b$$70$$ = $b$$70$$.get($key$$146$$);
      $as$$1$$ = isNaN($a$$112$$);
      $bs$$1$$ = isNaN($b$$70$$);
      $a$$112$$ instanceof Date && ($a$$112$$ = $a$$112$$.toISOString());
      $b$$70$$ instanceof Date && ($b$$70$$ = $b$$70$$.toISOString());
      return $as$$1$$ && $bs$$1$$ ? $a$$112$$ > $b$$70$$ ? -1 : $a$$112$$ === $b$$70$$ ? 0 : 1 : $as$$1$$ ? -1 : $bs$$1$$ ? 1 : $b$$70$$ - $a$$112$$;
    }), this.$collection$.comparator = $comparator$$13$$), this.$collection$.sort(), this.$_setSortInfo$($key$$146$$), null != $callbacks$$27$$ && null != $callbacks$$27$$.success && $callbacks$$27$$.success.call($callbackObjects$$13$$.success)) : null != $callbacks$$27$$ && null != $callbacks$$27$$.error && $callbacks$$27$$.error.call($callbackObjects$$13$$.error, "Axis value not supported"));
  };
  ...
  $oj$$42$$.$CollectionDataGridDataSource$.prototype.$_setSortInfo$ = function $$oj$$42$$$$CollectionDataGridDataSource$$$$_setSortInfo$$($key$$147$$) {
    ...
    null == $key$$147$$ && "function" === typeof $comparator$$14$$ ? this.$_sortInfo$ = {} : (this.$_sortInfo$ = {}, this.$_sortInfo$.axis = "column", this.$_sortInfo$.direction = $direction$$9$$, this.$_sortInfo$.key = null == $key$$147$$ ? $comparator$$14$$ : null);
  };
  ...
  $oj$$42$$.$CollectionDataGridDataSource$.prototype.$_getModelEvent$ = function $$oj$$42$$$$CollectionDataGridDataSource$$$$_getModelEvent$$($operation$$4$$, $rowKey$$32$$, $columnKey$$3$$, $rowIndex$$8$$, $columnIndex$$4$$) {
    var $event$$464$$ = {source:this};
    $event$$464$$.operation = $operation$$4$$;
    $event$$464$$.keys = {row:$rowKey$$32$$, column:$columnKey$$3$$};
    $event$$464$$.indexes = {row:$rowIndex$$8$$, column:$columnIndex$$4$$};
    return $event$$464$$;
  };
  $oj$$42$$.$CollectionDataGridDataSource$.prototype.$_handleModelAdded$ = function $$oj$$42$$$$CollectionDataGridDataSource$$$$_handleModelAdded$$($model$$75$$) {
    var $event$$465$$, $rowKey$$33$$;
    this.$collection$.indexOf($model$$75$$, {deferred:!0}).then(function($index$$204$$) {
      $rowKey$$33$$ = $oj$$42$$.$CollectionDataGridUtils$.$_getModelKey$($model$$75$$);
      $event$$465$$ = this.$_getModelEvent$("insert", $rowKey$$33$$, null, $index$$204$$, -1);
      this.handleEvent("change", $event$$465$$);
    }.bind(this));
  };
  $oj$$42$$.$CollectionDataGridDataSource$.prototype.$_handleModelDeleted$ = function $$oj$$42$$$$CollectionDataGridDataSource$$$$_handleModelDeleted$$($model$$76$$, $collection$$33$$, $args$$20$$) {
    this.handleEvent("change", this.$_getModelEvent$("delete", $oj$$42$$.$CollectionDataGridUtils$.$_getModelKey$($model$$76$$), null, $args$$20$$.index, -1));
  };
  $oj$$42$$.$CollectionDataGridDataSource$.prototype.$_handleModelChanged$ = function $$oj$$42$$$$CollectionDataGridDataSource$$$$_handleModelChanged$$($model$$77$$) {
    var $event$$467$$, $rowKey$$35$$;
    this.$collection$.indexOf($model$$77$$, {deferred:!0}).then(function($index$$205$$) {
      $rowKey$$35$$ = $oj$$42$$.$CollectionDataGridUtils$.$_getModelKey$($model$$77$$);
      $event$$467$$ = this.$_getModelEvent$("update", $rowKey$$35$$, null, $index$$205$$, -1);
      this.handleEvent("change", $event$$467$$);
    }.bind(this));
  };
