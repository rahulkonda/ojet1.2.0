...
define(["ojs/ojcore", "jquery"], function($oj$$22$$, $$$$21$$) {
  ...
  $oj$$22$$.$_TouchProxy$.prototype.$_touchHandler$ = function $$oj$$22$$$$_TouchProxy$$$$_touchHandler$$($event$$341$$, $simulatedType$$) {
    if (!(1 < $event$$341$$.originalEvent.touches.length)) {
      "touchstart" != $event$$341$$.type && "touchend" != $event$$341$$.type && $event$$341$$.preventDefault();
      var $touch$$ = $event$$341$$.originalEvent.changedTouches[0], $simulatedEvent$$ = document.createEvent("MouseEvent");
  ...
  $oj$$22$$.$_TouchProxy$.prototype.$_touchStart$ = function $$oj$$22$$$$_TouchProxy$$$$_touchStart$$($event$$342$$) {
    this.$_touchHandled$ || (this.$_touchHandled$ = !0, this.$_touchMoved$ = !1, this.$_touchHandler$($event$$342$$, "mouseover"), this.$_touchHandler$($event$$342$$, "mousemove"), this.$_touchHandler$($event$$342$$, "mousedown"));
  };
  $oj$$22$$.$_TouchProxy$.prototype.$_touchMove$ = function $$oj$$22$$$$_TouchProxy$$$$_touchMove$$($event$$343$$) {
    this.$_touchHandled$ && (this.$_touchMoved$ = !0, this.$_touchHandler$($event$$343$$, "mousemove"));
  };
  $oj$$22$$.$_TouchProxy$.prototype.$_touchEnd$ = function $$oj$$22$$$$_TouchProxy$$$$_touchEnd$$($event$$344$$) {
    this.$_touchHandled$ && (this.$_touchHandler$($event$$344$$, "mouseup"), this.$_touchHandler$($event$$344$$, "mouseout"), this.$_touchMoved$ || "touchend" != $event$$344$$.type || this.$_touchHandler$($event$$344$$, "click"), this.$_touchHandled$ = !1);
  };
