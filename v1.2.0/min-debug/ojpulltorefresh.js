...
define(["ojs/ojcore", "jquery", "hammerjs", "promise", "ojs/ojjquery-hammer", "ojs/ojcomponentcore"], function($oj$$31$$, $$$$28$$) {
  ...
  $oj$$31$$.$PullToRefreshUtils$.$setupPullToRefresh$ = function $$oj$$31$$$$PullToRefreshUtils$$$setupPullToRefresh$$($element$$121$$, $refreshFunc$$, $options$$300$$) {
    var $outer$$, $content$$23$$, $panel$$, $threshold$$1$$, $start$$45$$, $height$$25$$, $icon$$5$$, $iconOffset$$, $lastIconClass$$, $title$$9$$, $ratio$$, $iconClass$$;
    ...
    $panel$$ = $$$$28$$($element$$121$$);
    $panel$$.prepend($outer$$);
    $panel$$.on("touchstart.pulltorefresh", function($event$$383$$) {
      null == $$$$28$$.data($content$$23$$[0], "data-pullstart") && 0 === $panel$$[0].scrollTop && ($oj$$31$$.$PullToRefreshUtils$.$_handlePull$($event$$383$$, $content$$23$$, $options$$300$$), $icon$$5$$ = $content$$23$$.find(".oj-pulltorefresh-icon"), 0 < $icon$$5$$.length && ($iconOffset$$ = $icon$$5$$.parent().outerHeight(!0)), $options$$300$$ && !isNaN($options$$300$$.threshold) && ($threshold$$1$$ = parseInt($options$$300$$.threshold, 10)), $threshold$$1$$ = isNaN($threshold$$1$$) ? $content$$23$$.outerHeight(!0) : 
      Math.max(0, Math.min($threshold$$1$$, $content$$23$$.outerHeight(!0))), $content$$23$$.css("height", 0), $content$$23$$.removeClass("oj-pulltorefresh-transition"), $$$$28$$.data($content$$23$$[0], "data-pullstart", $event$$383$$.originalEvent.touches[0].clientY));
    }).on("touchmove.pulltorefresh", function($event$$384$$) {
      $start$$45$$ = $$$$28$$.data($content$$23$$[0], "data-pullstart");
      null != $start$$45$$ && ($height$$25$$ = $event$$384$$.originalEvent.touches[0].clientY - parseInt($start$$45$$, 10), 0 > $height$$25$$ || ($event$$384$$.preventDefault(), null != $$$$28$$.data($content$$23$$[0], "data-loading") ? $content$$23$$.css("height", Math.max($height$$25$$, $threshold$$1$$)) : ($content$$23$$.css("height", $height$$25$$), $oj$$31$$.$PullToRefreshUtils$.$_fireEvent$($event$$384$$, "pull", $content$$23$$, $height$$25$$), null != $icon$$5$$ && 0 < $icon$$5$$.length && 
      ($lastIconClass$$ = $$$$28$$.data($content$$23$$[0], "data-lasticonclass"), null != $lastIconClass$$ && $icon$$5$$.removeClass($lastIconClass$$), $ratio$$ = 10 * Math.round($height$$25$$ / $threshold$$1$$ * 10), 100 <= $ratio$$ ? ($iconClass$$ = "oj-pulltorefresh-icon-full", $title$$9$$ = $oj$$31$$.$Translations$.$getTranslatedString$("oj-pullToRefresh.titleIconFull")) : ($iconClass$$ = "oj-pulltorefresh-icon-" + $ratio$$ + "-percent", $title$$9$$ = $oj$$31$$.$Translations$.$getTranslatedString$("oj-pullToRefresh.titleIcon" + 
      $ratio$$ + "percent")), $icon$$5$$.addClass($iconClass$$), $icon$$5$$.attr("title", $title$$9$$), $$$$28$$.data($content$$23$$[0], "data-lasticonclass", $iconClass$$), $oj$$31$$.$PullToRefreshUtils$.$_showHideDefaultText$($content$$23$$, $height$$25$$ > $iconOffset$$)))));
    }).on("touchcancel.pulltorefresh", function() {
      $oj$$31$$.$PullToRefreshUtils$.$_cleanup$($content$$23$$);
    }).on("touchend.pulltorefresh", function($event$$386$$) {
      $start$$45$$ = $$$$28$$.data($content$$23$$[0], "data-pullstart");
      null != $start$$45$$ && null == $$$$28$$.data($content$$23$$[0], "data-loading") && ($content$$23$$.outerHeight() < $threshold$$1$$ ? ($content$$23$$.addClass("oj-pulltorefresh-transition").css("height", 0), $oj$$31$$.$PullToRefreshUtils$.$_cleanup$($content$$23$$)) : $oj$$31$$.$PullToRefreshUtils$.$_handleRelease$($event$$386$$, $content$$23$$, $refreshFunc$$));
    });
  };
  $goog$exportPath_$$("PullToRefreshUtils.setupPullToRefresh", $oj$$31$$.$PullToRefreshUtils$.$setupPullToRefresh$, $oj$$31$$);
  $oj$$31$$.$PullToRefreshUtils$.$_handlePull$ = function $$oj$$31$$$$PullToRefreshUtils$$$_handlePull$$($event$$387$$, $content$$24$$, $options$$301$$) {
    var $primaryText$$, $secondaryText$$;
    $oj$$31$$.$PullToRefreshUtils$.$_fireEvent$($event$$387$$, "pull", $content$$24$$, 0);
  ...
  $oj$$31$$.$PullToRefreshUtils$.$_handleRelease$ = function $$oj$$31$$$$PullToRefreshUtils$$$_handleRelease$$($event$$388$$, $content$$25$$, $refreshFunc$$1$$) {
    var $height$$26$$, $icon$$7$$, $lastIconClass$$1$$, $listener$$37$$;
    $height$$26$$ = $$$$28$$.data($content$$25$$[0], "data-panelheight");
    $content$$25$$.addClass("oj-pulltorefresh-transition").css("height", $height$$26$$);
    $oj$$31$$.$PullToRefreshUtils$.$_fireEvent$($event$$388$$, "release", $content$$25$$, $height$$26$$);
    $$$$28$$.data($content$$25$$[0], "data-loading", !0);
    $icon$$7$$ = $content$$25$$.find(".oj-pulltorefresh-icon");
    0 < $icon$$7$$.length && ($lastIconClass$$1$$ = $$$$28$$.data($content$$25$$[0], "data-lasticonclass"), null != $lastIconClass$$1$$ && $icon$$7$$.removeClass($lastIconClass$$1$$), $icon$$7$$.addClass("oj-pulltorefresh-icon-full"));
    $refreshFunc$$1$$().then(function() {
      $listener$$37$$ = function $$listener$$37$$$() {
        $oj$$31$$.$PullToRefreshUtils$.$_fireEvent$($event$$388$$, "complete", $content$$25$$, $height$$26$$);
  ...
  $oj$$31$$.$PullToRefreshUtils$.$tearDownPullToRefresh$ = function $$oj$$31$$$$PullToRefreshUtils$$$tearDownPullToRefresh$$($element$$122$$) {
    $$$$28$$($element$$122$$).children().first().remove();
    $$$$28$$($element$$122$$).off(".pulltorefresh");
  };
  $goog$exportPath_$$("PullToRefreshUtils.tearDownPullToRefresh", $oj$$31$$.$PullToRefreshUtils$.$tearDownPullToRefresh$, $oj$$31$$);
  $oj$$31$$.$PullToRefreshUtils$.$_fireEvent$ = function $$oj$$31$$$$PullToRefreshUtils$$$_fireEvent$$($originalEvent$$3$$, $event$$389_key$$139$$, $content$$26$$, $distance$$) {
    $event$$389_key$$139$$ = $$$$28$$.Event("oj" + $event$$389_key$$139$$);
    $event$$389_key$$139$$.originalEvent = $originalEvent$$3$$;
    $content$$26$$.trigger($event$$389_key$$139$$, {content:$content$$26$$, distance:$distance$$});
  };
  ...
  $oj$$31$$.$PullToRefreshUtils$.$_renderAccessibleLink$ = function $$oj$$31$$$$PullToRefreshUtils$$$_renderAccessibleLink$$($panel$$1$$, $refreshFunc$$2$$, $options$$302$$) {
    ...
    }).blur(function($event$$390$$) {
      null != $event$$390$$.relatedTarget && $link$$4$$.css("position", "");
    }).click(function($event$$391$$) {
      $content$$29$$ = $panel$$1$$.children().last();
      $oj$$31$$.$PullToRefreshUtils$.$_handlePull$($event$$391$$, $content$$29$$, $options$$302$$);
      $oj$$31$$.$PullToRefreshUtils$.$_handleRelease$($event$$391$$, $content$$29$$, $refreshFunc$$2$$);
      $refreshFunc$$2$$();
    });
