...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore"], function($oj$$77$$, $$$$71$$) {
  function $ConveyorBeltCommon$$($agentName$$1_elem$$146$$, $orientation$$, $contentParent$$, $bRtl$$, $buttonInfo$$, $callbackInfo$$2$$) {
    this.$_elem$ = $agentName$$1_elem$$146$$;
    ...
    $agentName$$1_elem$$146$$ = navigator.userAgent.toLowerCase();
    if (-1 !== $agentName$$1_elem$$146$$.indexOf("gecko/")) {
      this.$_bAgentGecko$ = !0;
    } else {
      if (-1 !== $agentName$$1_elem$$146$$.indexOf("opera")) {
        this.$_bAgentOpera$ = !0;
      } else {
        if (-1 !== $agentName$$1_elem$$146$$.indexOf("applewebkit") || -1 !== $agentName$$1_elem$$146$$.indexOf("safari")) {
  ...
  $ConveyorBeltCommon$$.prototype.$setup$ = function $$ConveyorBeltCommon$$$$$setup$$($bInit$$1$$) {
    ...
    if ($bInit$$1$$) {
      ...
      this.$_mouseWheelListener$ = function $this$$_mouseWheelListener$$($event$$631$$) {
        $self$$210$$.$_handleMouseWheel$($event$$631$$);
      };
      ...
      this.$_touchStartListener$ = function $this$$_touchStartListener$$($event$$632$$) {
        $self$$210$$.$_handleTouchStart$($event$$632$$);
      };
      $ConveyorBeltCommon$$.$_addBubbleEventListener$(this.$_overflowContainer$, "touchstart", this.$_touchStartListener$);
      this.$_touchMoveListener$ = function $this$$_touchMoveListener$$($event$$633$$) {
        $self$$210$$.$_handleTouchMove$($event$$633$$);
      };
      $ConveyorBeltCommon$$.$_addBubbleEventListener$(this.$_overflowContainer$, "touchmove", this.$_touchMoveListener$);
      this.$_touchEndListener$ = function $this$$_touchEndListener$$($event$$634$$) {
        $self$$210$$.$_handleTouchEnd$($event$$634$$);
      };
  ...
  $ConveyorBeltCommon$$.prototype.destroy = function $$ConveyorBeltCommon$$$$destroy$() {
    var $elem$$147$$ = this.$_elem$;
    $ConveyorBeltCommon$$.$_removeBubbleEventListener$($elem$$147$$, "mousewheel", this.$_mouseWheelListener$);
    $ConveyorBeltCommon$$.$_removeBubbleEventListener$($elem$$147$$, "wheel", this.$_mouseWheelListener$);
    ...
    this.$_removeResizeListenerFunc$ && this.$_handleResizeFunc$ && (this.$_removeResizeListenerFunc$.call(this.$_callbackObj$, $elem$$147$$, this.$_handleResizeFunc$), this.$_removeResizeListenerFunc$.call(this.$_callbackObj$, this.$_contentContainer$, this.$_handleResizeFunc$));
    this.$_handleResizeFunc$ = null;
    $ConveyorBeltCommon$$.$_reparentChildrenFromTable$(this.$_contentTableDiv$, $elem$$147$$);
    this.$_arContentElements$ = null;
    this.$_tableDiv$ ? $elem$$147$$.removeChild(this.$_tableDiv$) : ($elem$$147$$.removeChild(this.$_overflowContainer$), $elem$$147$$.removeChild(this.$_vertDivNextButton$), $elem$$147$$.removeChild(this.$_vertDivPrevButton$));
  ...
  $ConveyorBeltCommon$$.$_reparentChildrenToTable$ = function $$ConveyorBeltCommon$$$$_reparentChildrenToTable$$($fromNode_fromNodeChildren$$, $toTable$$, $bHoriz$$) {
    ...
    for ($fromNode_fromNodeChildren$$ = $fromNode_fromNodeChildren$$.childNodes;0 < $fromNode_fromNodeChildren$$.length;) {
      ...
      var $child$$23$$ = $fromNode_fromNodeChildren$$[0];
      if (1 === $child$$23$$.nodeType) {
        $bHoriz$$ || ($tableRow$$ = $ConveyorBeltCommon$$.$_createTableRowDiv$(), $toTable$$.appendChild($tableRow$$));
        var $tableCell$$ = $ConveyorBeltCommon$$.$_createTableCellDiv$();
        $tableCell$$.appendChild($child$$23$$);
        $tableRow$$.appendChild($tableCell$$);
        $arElements$$.push($child$$23$$);
      } else {
        $bHoriz$$ ? $tableRow$$.appendChild($child$$23$$) : $toTable$$.appendChild($child$$23$$);
      }
    }
    return $arElements$$;
  };
  ...
  $ConveyorBeltCommon$$.$_getComputedStyle$ = function $$ConveyorBeltCommon$$$$_getComputedStyle$$($elem$$148$$) {
    var $defView$$1$$ = $elem$$148$$.ownerDocument.defaultView, $computedStyle$$3$$ = null;
    return $computedStyle$$3$$ = $defView$$1$$ ? $defView$$1$$.getComputedStyle($elem$$148$$, null) : $elem$$148$$.currentStyle;
  };
  $ConveyorBeltCommon$$.$_getElemInnerWidth$ = function $$ConveyorBeltCommon$$$$_getElemInnerWidth$$($computedStyle$$4_elem$$149$$) {
    $computedStyle$$4_elem$$149$$ = $ConveyorBeltCommon$$.$_getComputedStyle$($computedStyle$$4_elem$$149$$);
    return $ConveyorBeltCommon$$.$_getCSSLengthAsInt$($computedStyle$$4_elem$$149$$.width);
  };
  $ConveyorBeltCommon$$.$_getElemInnerHeight$ = function $$ConveyorBeltCommon$$$$_getElemInnerHeight$$($computedStyle$$5_elem$$150$$) {
    $computedStyle$$5_elem$$150$$ = $ConveyorBeltCommon$$.$_getComputedStyle$($computedStyle$$5_elem$$150$$);
    return $ConveyorBeltCommon$$.$_getCSSLengthAsInt$($computedStyle$$5_elem$$150$$.height);
  };
  ...
  $ConveyorBeltCommon$$.$_addBubbleEventListener$ = function $$ConveyorBeltCommon$$$$_addBubbleEventListener$$($node$$167$$, $type$$106$$, $listener$$42$$) {
    $node$$167$$.addEventListener ? $node$$167$$.addEventListener($type$$106$$, $listener$$42$$, !1) : $node$$167$$.attachEvent && $node$$167$$.attachEvent("on" + $type$$106$$, $listener$$42$$);
  };
  $ConveyorBeltCommon$$.$_removeBubbleEventListener$ = function $$ConveyorBeltCommon$$$$_removeBubbleEventListener$$($node$$168$$, $type$$107$$, $listener$$43$$) {
    $node$$168$$.removeEventListener ? $node$$168$$.removeEventListener($type$$107$$, $listener$$43$$, !1) : $node$$168$$.detachEvent && $node$$168$$.detachEvent("on" + $type$$107$$, $listener$$43$$);
  };
  $ConveyorBeltCommon$$.$_getWheelDelta$ = function $$ConveyorBeltCommon$$$$_getWheelDelta$$($event$$635$$) {
    var $wheelDelta$$ = 0;
    return $wheelDelta$$ = null != $event$$635$$.wheelDelta ? $event$$635$$.wheelDelta : null != $event$$635$$.deltaY ? -$event$$635$$.deltaY : -$event$$635$$.detail;
  };
  ...
  $ConveyorBeltCommon$$.$_wrapAndRestrictSize$ = function $$ConveyorBeltCommon$$$$_wrapAndRestrictSize$$($elem$$151$$, $parentElem$$5$$, $bWidth$$, $bHeight$$) {
    var $wrapperDiv$$ = document.createElement("div"), $wrapperDivStyle$$ = $wrapperDiv$$.style;
    $wrapperDivStyle$$.display = "inline-block";
    $wrapperDiv$$.appendChild($elem$$151$$);
  ...
  $ConveyorBeltCommon$$.prototype.$_createInnerContainers$ = function $$ConveyorBeltCommon$$$$$_createInnerContainers$$() {
    var $self$$211$$ = this, $bHoriz$$3_overflowHeight$$ = this.$_isHorizontal$(), $overflowContainer$$ = document.createElement("div");
    ...
    var $elem$$152$$ = this.$_elem$, $contentContainer$$2_contentHeight$$ = document.createElement("div");
    ...
    if ($bHoriz$$3_overflowHeight$$) {
      ...
      var $i$$475_tableCellDivNextButtonStyle$$ = $numContentChildren_tableCellDivNextButton$$1$$.style;
      $arContentElements_tableCellDivPrevButton$$.style.verticalAlign = "top";
      $i$$475_tableCellDivNextButtonStyle$$.verticalAlign = "top";
    ...
    $arContentElements_tableCellDivPrevButton$$ = $ConveyorBeltCommon$$.$_reparentChildrenToTable$($elem$$152$$, $contentTableDiv_tableRowDiv$$1_vertDivNextButton$$1$$, $bHoriz$$3_overflowHeight$$);
    if (this.$_contentParent$) {
      for ($arContentElements_tableCellDivPrevButton$$ = [], $contentChildren_tableCellDivOverflow$$ = this.$_contentParent$.children, $numContentChildren_tableCellDivNextButton$$1$$ = $contentChildren_tableCellDivOverflow$$.length, $i$$475_tableCellDivNextButtonStyle$$ = 0;$i$$475_tableCellDivNextButtonStyle$$ < $numContentChildren_tableCellDivNextButton$$1$$;$i$$475_tableCellDivNextButtonStyle$$++) {
        var $child$$24$$ = $contentChildren_tableCellDivOverflow$$[$i$$475_tableCellDivNextButtonStyle$$];
        1 === $child$$24$$.nodeType && $arContentElements_tableCellDivPrevButton$$.push($child$$24$$);
      }
    }
    ...
    $contentContainerStyle_tableDiv$$1_vertDivPrevButton$$ ? $elem$$152$$.appendChild($contentContainerStyle_tableDiv$$1_vertDivPrevButton$$) : (this.$_vertDivPrevButton$ = $contentContainerStyle_tableDiv$$1_vertDivPrevButton$$ = document.createElement("div"), this.$_vertDivNextButton$ = $contentTableDiv_tableRowDiv$$1_vertDivNextButton$$1$$ = document.createElement("div"), $elem$$152$$.appendChild($contentContainerStyle_tableDiv$$1_vertDivPrevButton$$), $elem$$152$$.appendChild($overflowContainer$$), 
    $elem$$152$$.appendChild($contentTableDiv_tableRowDiv$$1_vertDivNextButton$$1$$));
  ...
  $ConveyorBeltCommon$$.prototype.$_createPrevButton$ = function $$ConveyorBeltCommon$$$$$_createPrevButton$$($buttonId_prevButtonStyle$$1$$, $bHoriz$$4_buttonStyleClass$$, $icon$$12$$) {
    var $self$$212$$ = this, $prevButton$$1$$ = document.createElement("div");
    ...
    $icon$$12$$ && $prevButton$$1$$.appendChild($icon$$12$$);
  };
  $ConveyorBeltCommon$$.prototype.$_createNextButton$ = function $$ConveyorBeltCommon$$$$$_createNextButton$$($buttonId$$1_nextButtonStyle$$1$$, $bHoriz$$5_buttonStyleClass$$1$$, $icon$$13$$) {
    var $self$$213$$ = this, $nextButton$$2$$ = document.createElement("div");
    ...
    $icon$$13$$ && $nextButton$$2$$.appendChild($icon$$13$$);
  };
  ...
  $ConveyorBeltCommon$$.prototype.$_measureContents$ = function $$ConveyorBeltCommon$$$$$_measureContents$$() {
    ...
    if (this.$_getContentParent$().hasChildNodes() && $bHoriz$$6_contentTableDiv$$1$$ && $arContentElements$$1$$ && 0 < $arContentElements$$1$$.length) {
      for (var $bHoriz$$6_contentTableDiv$$1$$ = this.$_isHorizontal$(), $contentWidth$$1$$ = 0, $contentWidth$$1$$ = this.$_contentContainer$.offsetWidth, $startOffset$$ = 0, $prevSizeObj$$ = null, $i$$476$$ = 0;$i$$476$$ < $arContentElements$$1$$.length;$i$$476$$++) {
        var $child$$25_childParent$$ = $arContentElements$$1$$[$i$$476$$];
        if (1 === $child$$25_childParent$$.nodeType) {
          var $overlap_ww$$ = $child$$25_childParent$$.offsetWidth, $hh$$ = $child$$25_childParent$$.offsetHeight, $sizeObj$$1$$ = {$w$:$overlap_ww$$, $h$:$hh$$, id:$child$$25_childParent$$.id};
          if ($bHoriz$$6_contentTableDiv$$1$$) {
            var $offLeft_offTop$$ = $child$$25_childParent$$.offsetLeft;
            this.$_contentParent$ || 0 !== $offLeft_offTop$$ || ($child$$25_childParent$$ = $child$$25_childParent$$.parentNode, $offLeft_offTop$$ = $child$$25_childParent$$.offsetLeft);
            $sizeObj$$1$$.start = this.$_bRtl$ ? $contentWidth$$1$$ - ($offLeft_offTop$$ + $overlap_ww$$) : $offLeft_offTop$$;
            0 === $i$$476$$ && ($startOffset$$ = $sizeObj$$1$$.start);
            ...
            $offLeft_offTop$$ = $child$$25_childParent$$.offsetTop, this.$_contentParent$ || 0 !== $offLeft_offTop$$ || ($child$$25_childParent$$ = $child$$25_childParent$$.parentNode, $offLeft_offTop$$ = $child$$25_childParent$$.offsetTop), $sizeObj$$1$$.start = $offLeft_offTop$$, $totalSize$$9$$.$w$ = Math.max($totalSize$$9$$.$w$, $overlap_ww$$), $totalSize$$9$$.$h$ = $sizeObj$$1$$.start + $hh$$, $sizeObj$$1$$.end = $totalSize$$9$$.$h$ - 1;
          }
    ...
    if (!this.$_isEmpty$()) {
      ...
      if ($bImmediate$$3$$ || !$scrollFunc$$ || $scroll$$5$$ === this.$_getCurrScroll$()) {
        ...
        $scrollFunc$$.call(this.$_callbackObj$, this.$_overflowContainer$, this.$_convertScrollLogicalToBrowser$($scroll$$5$$), Math.abs(this.$_getCurrScroll$() - $scroll$$5$$) / $ConveyorBeltCommon$$.$_SCROLL_SPEED$, function() {
          $self$$214$$.$_onScrollAnimEnd$($scroll$$5$$);
        });
      }
    }
  };
  ...
  $ConveyorBeltCommon$$.prototype.$_handleMouseWheel$ = function $$ConveyorBeltCommon$$$$$_handleMouseWheel$$($event$$639$$) {
    var $bConsumeEvent$$ = this.$_bScrolling$;
    if (this.$_needsScroll$() && !this.$_bScrolling$) {
      var $wheelDelta$$1$$ = $ConveyorBeltCommon$$.$_getWheelDelta$($event$$639$$);
    ...
    $bConsumeEvent$$ && ($event$$639$$.preventDefault(), $event$$639$$.stopPropagation());
  };
  $ConveyorBeltCommon$$.prototype.$_handleTouchStart$ = function $$ConveyorBeltCommon$$$$$_handleTouchStart$$($event$$640_eventTouches$$2_firstTouch$$5$$) {
    $event$$640_eventTouches$$2_firstTouch$$5$$ = $event$$640_eventTouches$$2_firstTouch$$5$$.touches;
    this.$_needsScroll$() && !this.$_bScrolling$ && 1 === $event$$640_eventTouches$$2_firstTouch$$5$$.length && (this.$_bTouch$ = !0, $event$$640_eventTouches$$2_firstTouch$$5$$ = $event$$640_eventTouches$$2_firstTouch$$5$$[0], this.$_touchStartCoord$ = this.$_isHorizontal$() ? $event$$640_eventTouches$$2_firstTouch$$5$$.pageX : $event$$640_eventTouches$$2_firstTouch$$5$$.pageY, this.$_touchStartScroll$ = this.$_getCurrScroll$(), this.$_touchStartNextScroll$ = this.$_calcNextScroll$(), this.$_touchStartPrevScroll$ = 
  ...
  $ConveyorBeltCommon$$.prototype.$_handleTouchMove$ = function $$ConveyorBeltCommon$$$$$_handleTouchMove$$($event$$641$$) {
    var $bHoriz$$7$$ = this.$_isHorizontal$(), $diff$$1_firstTouch$$6$$ = $event$$641$$.touches[0], $diff$$1_firstTouch$$6$$ = ($bHoriz$$7$$ ? $diff$$1_firstTouch$$6$$.pageX : $diff$$1_firstTouch$$6$$.pageY) - this.$_touchStartCoord$, $bNext$$2$$ = $bHoriz$$7$$ && this.$_bRtl$ ? 0 < $diff$$1_firstTouch$$6$$ : 0 > $diff$$1_firstTouch$$6$$, $canScrollInSwipeDirection$$1_overflowContainer$$7$$ = $bNext$$2$$ && this.$_touchStartNextButtonShown$ || !$bNext$$2$$ && this.$_touchStartPrevButtonShown$;
    ...
    this.$_scrolledForThisTouch$ && ($event$$641$$.preventDefault(), $event$$641$$.stopPropagation());
  };
  ...
  $ConveyorBeltCommon$$.prototype.$_setExternalScrollTimeout$ = function $$ConveyorBeltCommon$$$$$_setExternalScrollTimeout$$() {
    ...
    window.setTimeout(function() {
      $self$$215$$ && ($self$$215$$.$_bExternalScroll$ = !0);
    }, 0);
  };
  ...
  $ConveyorBeltCommon$$.prototype.$_calcStartScroll$ = function $$ConveyorBeltCommon$$$$$_calcStartScroll$$($index$$295$$) {
    return this.$_getSizes$()[$index$$295$$].start;
  };
  $ConveyorBeltCommon$$.prototype.$_calcEndScroll$ = function $$ConveyorBeltCommon$$$$$_calcEndScroll$$($index$$296$$) {
    return this.$_getSizes$()[$index$$296$$].end - this.$_getCurrViewportSize$() + 1;
  };
  $ConveyorBeltCommon$$.prototype.$_calcFirstVisibleItemIndex$ = function $$ConveyorBeltCommon$$$$$_calcFirstVisibleItemIndex$$() {
    var $i$$477$$ = this.$_calcItemIndex$(this.$_getCurrScroll$());
    return 0 > $i$$477$$ ? 0 : $i$$477$$;
  };
  $ConveyorBeltCommon$$.prototype.$_calcLastVisibleItemIndex$ = function $$ConveyorBeltCommon$$$$$_calcLastVisibleItemIndex$$() {
    var $i$$478$$ = this.$_calcItemIndex$(this.$_getCurrScroll$() + this.$_getCurrViewportSize$() - 1), $sizes$$5$$ = this.$_getSizes$();
    return 0 > $i$$478$$ ? $sizes$$5$$.length - 1 : $i$$478$$;
  };
  $ConveyorBeltCommon$$.prototype.$_calcPrevVisibleItemIndex$ = function $$ConveyorBeltCommon$$$$$_calcPrevVisibleItemIndex$$() {
    var $i$$479$$ = this.$_calcItemIndex$(this.$_getCurrScroll$() - 1);
    return 0 > $i$$479$$ ? 0 : $i$$479$$;
  };
  $ConveyorBeltCommon$$.prototype.$_calcNextVisibleItemIndex$ = function $$ConveyorBeltCommon$$$$$_calcNextVisibleItemIndex$$() {
    var $i$$480$$ = this.$_calcItemIndex$(this.$_getCurrScroll$() + this.$_getCurrViewportSize$()), $sizes$$6$$ = this.$_getSizes$();
    return 0 > $i$$480$$ ? $sizes$$6$$.length - 1 : $i$$480$$;
  };
  $ConveyorBeltCommon$$.prototype.$_calcItemIndex$ = function $$ConveyorBeltCommon$$$$$_calcItemIndex$$($scroll$$10$$) {
    for (var $sizes$$7$$ = this.$_getSizes$(), $i$$481$$ = 0;$i$$481$$ < $sizes$$7$$.length;$i$$481$$++) {
      if ($scroll$$10$$ <= $sizes$$7$$[$i$$481$$].end) {
        return $i$$481$$;
      }
    }
    return-1;
  ...
  (function() {
    $oj$$77$$.$__registerWidget$("oj.ojConveyorBelt", $$$$71$$.oj.baseComponent, {defaultElement:"\x3cdiv\x3e", widgetEventPrefix:"oj", options:{orientation:"horizontal", contentParent:null}, _ComponentCreate:function() {
      this._super();
      this.element.addClass("oj-conveyorbelt oj-component");
      this.options.disabled && $oj$$77$$.$Logger$.warn($_WARNING_DISABLED_OPTION$$2$$);
      this.$_setup$(!0);
    }, refresh:function() {
      this._super();
      ...
      if (this.$_canCalculateSizes$()) {
        ...
        var $elem$$162_oldIsInit$$2$$ = this.element, $options$$403$$ = this.options;
        if ($children$$31_isInit$$2$$ && !this.$_cbCommon$) {
          ...
          $callbackInfo$$3_prevStyleClass$$.$addResizeListener$ = $oj$$77$$.$DomUtils$.$addResizeListener$;
          $callbackInfo$$3_prevStyleClass$$.$removeResizeListener$ = $oj$$77$$.$DomUtils$.$removeResizeListener$;
          "enabled" !== $oj$$77$$.$Config$.$getAutomationMode$() && ($callbackInfo$$3_prevStyleClass$$.$scrollFunc$ = $animateScrollFunc_contentParentElem$$);
          ...
          this.$_cbCommon$ = new $ConveyorBeltCommon$$($elem$$162_oldIsInit$$2$$[0], $orientation$$1$$, $animateScrollFunc_contentParentElem$$, this.$_bRTL$, $buttonInfo$$1$$, $callbackInfo$$3_prevStyleClass$$);
        }
        this.$_cbCommon$.$setup$($children$$31_isInit$$2$$);
        $children$$31_isInit$$2$$ && ($children$$31_isInit$$2$$ = $elem$$162_oldIsInit$$2$$.find(".oj-conveyorbelt-overflow-indicator"), this.$_setupButtonMouseStyles$($children$$31_isInit$$2$$));
      } else {
        $elem$$162_oldIsInit$$2$$ = !1, this.$_needsSetup$ && ($elem$$162_oldIsInit$$2$$ = this.$_needsSetup$[0]), this.$_needsSetup$ = [$children$$31_isInit$$2$$ || $elem$$162_oldIsInit$$2$$];
      }
    }, _destroy:function() {
      this.$_destroyCBCommon$();
      this.element.removeClass("oj-conveyorbelt oj-component");
      this._super();
    }, _setOption:function($key$$189$$, $value$$298$$, $flags$$55$$) {
      var $bRecreate$$2$$ = !1;
      switch($key$$189$$) {
        ...
        case "orientation":
          ...
          break;
        case "disabled":
          $oj$$77$$.$Logger$.warn($_WARNING_DISABLED_OPTION$$2$$);
      }
      $bRecreate$$2$$ && this.$_destroyCBCommon$();
      this._super($key$$189$$, $value$$298$$, $flags$$55$$);
      ...
      var $div$$13$$ = document.createElement("div"), $elem$$165_style$$31$$ = $div$$13$$.style;
      $elem$$165_style$$31$$.width = "10px";
      $elem$$165_style$$31$$.height = "10px";
      $elem$$165_style$$31$$ = this.element[0];
      $elem$$165_style$$31$$.appendChild($div$$13$$);
      var $bCanCalcSizes$$2$$ = !1;
      try {
        $bCanCalcSizes$$2$$ = 0 < $div$$13$$.offsetWidth && 0 < $div$$13$$.offsetHeight;
      } catch ($e$$142$$) {
      }
      $elem$$165_style$$31$$.removeChild($div$$13$$);
      return $bCanCalcSizes$$2$$;
    }, $_setupButtonMouseStyles$:function($element$$144$$) {
      $element$$144$$.on("mousedown" + this.eventNamespace, function($event$$644$$) {
        $$$$71$$($event$$644$$.currentTarget).addClass("oj-active");
      }).on("mouseup" + this.eventNamespace, function($event$$645$$) {
        $$$$71$$($event$$645$$.currentTarget).removeClass("oj-active");
      }).on("mouseenter" + this.eventNamespace, function($currTarget$$6_event$$646$$) {
        $currTarget$$6_event$$646$$ = $currTarget$$6_event$$646$$.currentTarget;
        $$$$71$$($currTarget$$6_event$$646$$).addClass("oj-hover");
        $$$$71$$($currTarget$$6_event$$646$$).removeClass("oj-default");
      }).on("mouseleave" + this.eventNamespace, function($currTarget$$7_event$$647$$) {
        $currTarget$$7_event$$647$$ = $currTarget$$7_event$$647$$.currentTarget;
        $$$$71$$($currTarget$$7_event$$647$$).removeClass("oj-hover");
        $$$$71$$($currTarget$$7_event$$647$$).removeClass("oj-active");
        $$$$71$$($currTarget$$7_event$$647$$).addClass("oj-default");
      });
      ...
      return $span$$3$$;
    }, $_animateScrollLeft$:function($elem$$166$$, $value$$299$$, $duration$$12$$, $onEndFunc$$1$$) {
      var $props$$24$$ = {};
      $props$$24$$.scrollLeft = $value$$299$$;
      $$$$71$$($elem$$166$$).animate($props$$24$$, $duration$$12$$, "swing", $onEndFunc$$1$$);
    }, $_animateScrollTop$:function($elem$$167$$, $value$$300$$, $duration$$13$$, $onEndFunc$$2$$) {
      var $props$$25$$ = {};
      $props$$25$$.scrollTop = $value$$300$$;
      $$$$71$$($elem$$167$$).animate($props$$25$$, $duration$$13$$, "swing", $onEndFunc$$2$$);
