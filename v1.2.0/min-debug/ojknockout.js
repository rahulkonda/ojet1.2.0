...
define(["ojs/ojcore", "jquery", "knockout"], function($oj$$7$$, $$$$7$$, $ko$$1$$) {
  ...
  function $_extractValueFromChangeEvent$$($event$$58$$, $eventData$$1$$) {
    var $nameVal$$ = {};
    $nameVal$$.value = $eventData$$1$$.value;
    return $nameVal$$;
  }
  function $_extractOptionChange$$($event$$59$$, $eventData$$2$$) {
  ...
  function $_getDataLayerRenderer$$($bindingContext$$2$$, $template$$2$$) {
    return function($context$$44$$) {
      ...
      $ko$$1$$.renderTemplate($template$$2$$, $model$$56$$, null, $context$$44$$.parentElement);
      return null;
    };
  }
  ...
  function $_getDiagramNodeRenderer$$($bindingContext$$4$$, $template$$4$$) {
    return function($context$$45$$) {
      var $model$$57$$ = $bindingContext$$4$$.createChildContext($context$$45$$.data);
      $ko$$1$$.renderTemplate($template$$4$$, $model$$57$$, null, $context$$45$$.parentElement);
      return null;
    };
  }
  function $_replaceComponentBindingWithV2$$($node$$25$$, $bindingContext$$7$$, $accessorMap$$, $wrapped$$1$$) {
    if (null == $accessorMap$$) {
      return null;
    }
    var $bindingName$$1$$ = $_findOwnBinding$$($accessorMap$$);
    null != $bindingName$$1$$ && ($accessorMap$$ = $_modifyOjComponentBinding$$($node$$25$$, $bindingName$$1$$, $wrapped$$1$$, $bindingContext$$7$$, $accessorMap$$));
    return $accessorMap$$;
  }
  function $_findOwnBinding$$($accessorMap$$1_keys$$7$$) {
    $accessorMap$$1_keys$$7$$ = Object.keys($accessorMap$$1_keys$$7$$);
    for (var $i$$125$$ = -0;$i$$125$$ < $accessorMap$$1_keys$$7$$.length;$i$$125$$++) {
      var $key$$41$$ = $accessorMap$$1_keys$$7$$[$i$$125$$];
  ...
  function $_modifyOjComponentBinding$$($info$$1_node$$26$$, $bindingName$$2$$, $bindingList_wrapped$$2$$, $bindingContext$$8$$, $accessorMap$$2$$) {
    $info$$1_node$$26$$ = $_getBindingValueInfo$$($info$$1_node$$26$$, $bindingName$$2$$, $bindingList_wrapped$$2$$, $bindingContext$$8$$);
    $bindingList_wrapped$$2$$ = $info$$1_node$$26$$.$attrList$;
    if (null == $bindingList_wrapped$$2$$) {
      return $accessorMap$$2$$;
    }
    var $bindingMap$$ = {};
    $_keyValueArrayForEach$$($bindingList_wrapped$$2$$, function($key$$42$$, $value$$152$$) {
      $bindingMap$$[$key$$42$$] = $value$$152$$;
    });
    $accessorMap$$2$$ = $oj$$7$$.$CollectionUtils$.$copyInto$({}, $accessorMap$$2$$);
    $accessorMap$$2$$[$bindingName$$2$$] = $_getOjComponent2BindingAccessor$$($bindingContext$$8$$, $bindingMap$$, $info$$1_node$$26$$.$bindingExpr$);
    return $accessorMap$$2$$;
  }
  function $_getOjComponent2BindingAccessor$$($bindingContext$$9$$, $attributeMap$$, $bindingExpr$$) {
    function $accessorFunc$$() {
      var $accessor$$ = {};
      Object.keys($attributeMap$$).forEach(function($option$$22$$) {
        var $getter$$1$$ = $oj$$7$$.$ComponentBinding$.$_createEvaluator$($attributeMap$$[$option$$22$$]).bind(null, $bindingContext$$9$$);
  ...
  function $_getBindingString$$($match$$14_node$$27$$, $wrapped$$3$$, $bindingContext$$10$$) {
    var $func$$6$$ = $wrapped$$3$$.getBindingsString;
    if ($func$$6$$) {
      return $func$$6$$.call($wrapped$$3$$, $match$$14_node$$27$$, $bindingContext$$10$$);
    }
  ...
  function $_getBindingValueInfo$$($bindingString_keyValueArray_node$$28$$, $bindingName$$3$$, $wrapped$$4$$, $bindingContext$$11$$) {
    var $list$$ = null;
    $bindingString_keyValueArray_node$$28$$ = $_getBindingString$$($bindingString_keyValueArray_node$$28$$, $wrapped$$4$$, $bindingContext$$11$$);
    $bindingString_keyValueArray_node$$28$$ = $ko$$1$$.jsonExpressionRewriting.parseObjectLiteral($bindingString_keyValueArray_node$$28$$);
    var $selfVal$$ = null;
    $_keyValueArrayForEach$$($bindingString_keyValueArray_node$$28$$, function($key$$43$$, $value$$153$$) {
      return $key$$43$$ === $bindingName$$3$$ ? ($selfVal$$ = $value$$153$$, !0) : !1;
    });
  ...
  function $_keyValueArrayForEach$$($array$$14$$, $callback$$83$$) {
    for (var $i$$126$$ = 0;$i$$126$$ < $array$$14$$.length;$i$$126$$++) {
      var $entry_value$$154$$ = $array$$14$$[$i$$126$$], $key$$44$$ = $entry_value$$154$$.key, $entry_value$$154$$ = $entry_value$$154$$.value;
      if (null != $key$$44$$ && null != $entry_value$$154$$ && $callback$$83$$($key$$44$$.trim(), $entry_value$$154$$.trim())) {
        break;
      }
    }
  }
  function $_defineWrappedMethod$$($wrapped$$5$$, $target$$76$$, $name$$83$$, $postprocessMethod$$) {
    var $delegate$$ = $wrapped$$5$$[$name$$83$$];
    null != $delegate$$ && ($target$$76$$[$name$$83$$] = function $$target$$76$$$$name$$83$$$() {
  ...
  function $_getDataGridHeaderRenderer$$($bindingContext$$12$$, $template$$5$$) {
    return function($context$$46$$) {
      var $parent$$5$$, $childContext$$1$$;
      $parent$$5$$ = $context$$46$$.parentElement;
      $childContext$$1$$ = $bindingContext$$12$$.createChildContext($context$$46$$.data, null, function($binding$$1$$) {
        $binding$$1$$.$key = $context$$46$$.key;
        $binding$$1$$.$metadata = $context$$46$$.metadata;
        $binding$$1$$.$headerContext = $context$$46$$;
      });
      $ko$$1$$.renderTemplate($template$$5$$, $childContext$$1$$, null, $parent$$5$$);
      return null;
    };
  }
  function $_getDataGridCellRenderer$$($bindingContext$$13$$, $template$$6$$) {
    return function($context$$47$$) {
      var $parent$$6$$, $childContext$$2$$;
      $parent$$6$$ = $context$$47$$.parentElement;
      $childContext$$2$$ = $bindingContext$$13$$.createChildContext($context$$47$$.data, null, function($binding$$2$$) {
        $binding$$2$$.$keys = $context$$47$$.keys;
        $binding$$2$$.$metadata = $context$$47$$.metadata;
        $binding$$2$$.$cellContext = $context$$47$$;
      });
      $ko$$1$$.renderTemplate($template$$6$$, $childContext$$2$$, null, $parent$$6$$);
      return null;
    };
  }
  function $_getTableColumnTemplateRenderer$$($bindingContext$$14$$, $type$$76$$, $template$$7$$) {
    var $rendererOption$$ = {};
    (function($template$$8$$, $type$$77$$) {
      $rendererOption$$ = function $$rendererOption$$$($params$$13$$) {
        var $childContext$$3$$ = null, $parentElement$$ = null;
        "header" == $type$$77$$ ? ($childContext$$3$$ = $bindingContext$$14$$.extend({$columnIndex:$params$$13$$.columnIndex, $headerContext:$params$$13$$.headerContext, $data:$params$$13$$.data}), $parentElement$$ = $params$$13$$.headerContext.parentElement) : "cell" == $type$$77$$ && ($childContext$$3$$ = $bindingContext$$14$$.createChildContext($params$$13$$.row, null, function($binding$$3$$) {
        ...
        "footer" == $type$$77$$ && ($childContext$$3$$ = $bindingContext$$14$$.extend({$columnIndex:$params$$13$$.columnIndex, $footerContext:$params$$13$$.footerContext}), $parentElement$$ = $params$$13$$.footerContext.parentElement);
        $ko$$1$$.renderTemplate($template$$8$$, $childContext$$3$$, null, $parentElement$$, "replaceNode");
      };
    })($template$$7$$, $type$$76$$);
  ...
  function $_getTableRowTemplateRenderer$$($bindingContext$$15$$, $template$$9$$) {
    return function($params$$14$$) {
      var $childContext$$4$$ = $bindingContext$$15$$.createChildContext($params$$14$$.row, null, function($binding$$4$$) {
        $binding$$4$$.$rowContext = $params$$14$$.rowContext;
      });
      $ko$$1$$.renderTemplate($template$$9$$, $childContext$$4$$, null, $params$$14$$.rowContext.parentElement, "replaceNode");
    };
  }
  function $_getListViewItemRenderer$$($bindingContext$$16$$, $template$$10$$) {
    return function($context$$48$$) {
      var $parent$$7$$, $childContext$$5$$;
      $parent$$7$$ = $context$$48$$.parentElement;
      $childContext$$5$$ = $bindingContext$$16$$.createChildContext($context$$48$$.data, null, function($binding$$5$$) {
        $binding$$5$$.$itemContext = $context$$48$$;
      });
      $ko$$1$$.renderTemplate($template$$10$$, $childContext$$5$$, null, $parent$$7$$, "replaceNode");
      return null;
    };
  }
  function $_handleListViewManagedAttributes$$($name$$84_template$$11$$, $value$$155$$, $bindingContext$$17$$) {
    return "item" == $name$$84_template$$11$$ ? ($name$$84_template$$11$$ = $value$$155$$.template, null != $name$$84_template$$11$$ && ($value$$155$$.renderer = $_getListViewItemRenderer$$($bindingContext$$17$$, $name$$84_template$$11$$)), {item:$value$$155$$}) : null;
  }
    ...
    for (var $eventInfos_writablePropMap$$ = {"^slider$":[{event:"slidechange", getter:$_extractValueFromChangeEvent$$}], "^oj*":[{event:"ojoptionchange", getter:$_extractOptionChange$$}]}, $cachedWriterFunctionEvaluators$$ = {}, $i$$130_keys$$8$$ = Object.keys($eventInfos_writablePropMap$$), $info$$2_k$$7$$ = 0;$info$$2_k$$7$$ < $i$$130_keys$$8$$.length;$info$$2_k$$7$$++) {
      ...
      if ($ctx$$1$$.$componentName$.match($pattern$$12$$)) {
        ...
        for ($i$$130_keys$$8$$ = 0;$i$$130_keys$$8$$ < $eventInfos_writablePropMap$$.length;$i$$130_keys$$8$$++) {
          $info$$2_k$$7$$ = $eventInfos_writablePropMap$$[$i$$130_keys$$8$$], $jelem$$6$$.on($info$$2_k$$7$$.event + $oj$$7$$.$ComponentBinding$.$_HANDLER_NAMESPACE$, {$getter$:$info$$2_k$$7$$.getter}, function($evt$$19$$, $data$$52$$) {
            $evt$$19$$.stopPropagation();
            var $nameValues$$ = $evt$$19$$.data.$getter$($evt$$19$$, $data$$52$$), $accessor$$1$$ = $ctx$$1$$.$valueAccessor$(), $name$$88$$;
  ...
  $oj$$7$$.$ComponentBinding$.$getDefaultInstance$().$setupManagedAttributes$({attributes:["areaLayers", "pointDataLayers"], init:function($name$$93$$, $value$$161$$, $element$$48$$, $widgetConstructor$$2$$, $valueAccessor$$5$$, $allBindingsAccessor$$5$$, $bindingContext$$24$$) {
    return $_handleManagedAttributes$$($name$$93$$, $value$$161$$, $bindingContext$$24$$);
  }, update:function($name$$94$$, $value$$162$$, $element$$49$$, $widgetConstructor$$3$$, $valueAccessor$$6$$, $allBindingsAccessor$$6$$, $bindingContext$$25$$) {
    return $_handleManagedAttributes$$($name$$94$$, $value$$162$$, $bindingContext$$25$$);
  }, "for":"ojThematicMap"});
  $ko$$1$$.bindingHandlers.ojContextMenu = {update:function $$ko$$1$$$bindingHandlers$ojContextMenu$update$($element$$50$$, $valueAccessor$$7$$) {
    function $launch$$1$$($event$$62$$, $eventType$$29_openOptions$$1$$, $pressHold$$1$$) {
      ...
      "touchstart" === $doubleOpenType$$1$$ && "contextmenu" === $event$$62$$.type || "contextmenu" === $doubleOpenType$$1$$ && "touchstart" === $event$$62$$.type ? ($doubleOpenType$$1$$ = null, clearTimeout($doubleOpenTimer$$1$$)) : !$event$$62$$.isDefaultPrevented() && ($eventType$$29_openOptions$$1$$ = {launcher:$$element$$, initialFocus:"menu", position:{mouse:{my:"start top", at:"start bottom", of:$event$$62$$}, touch:{my:"start\x3e40 center", at:"start bottom", of:$event$$62$$, collision:"flipfit"}, 
      keyboard:{my:"start top", at:"start bottom", of:"launcher"}}[$eventType$$29_openOptions$$1$$]}, $menu$$3$$.$__openingContextMenu$ = !0, $menu$$3$$.open($event$$62$$, $eventType$$29_openOptions$$1$$), $menu$$3$$.$__openingContextMenu$ = !1, $getContextMenuNode$$().is(":visible") && ($event$$62$$.preventDefault(), document.addEventListener("keyup", $preventKeyUpEventIfMenuOpen$$), "touchstart" === $event$$62$$.type || "contextmenu" === $event$$62$$.type)) && ($doubleOpenType$$1$$ = $event$$62$$.type, 
      $doubleOpenTimer$$1$$ = setTimeout(function() {
        $doubleOpenType$$1$$ = null;
      }, 300));
    }
    function $preventKeyUpEventIfMenuOpen$$($event$$61$$) {
      121 == $event$$61$$.which && $event$$61$$.shiftKey && $getContextMenuNode$$().is(":visible") && $event$$61$$.preventDefault();
    }
    ...
    var $$element$$ = $$$$7$$($element$$50$$), $$menu$$, $_menu$$, $pressHoldTimer$$, $isPressHold$$1$$ = !1, $touchInProgress$$1$$ = !1, $doubleOpenTimer$$1$$, $doubleOpenType$$1$$ = null, $clickListener$$;
    ...
    "string" !== $$$$7$$.type($menuSelector$$) && ($menuSelector$$ = $element$$50$$.getAttribute("contextmenu")) && ($menuSelector$$ = "#" + $menuSelector$$);
    $clickListener$$ = function $$clickListener$$$($event$$64$$) {
      if ($isPressHold$$1$$) {
        return $event$$64$$.preventDefault(), $event$$64$$.stopPropagation(), $isPressHold$$1$$ = !1;
      }
    };
    $element$$50$$.addEventListener("click", $clickListener$$, !0);
    $$element$$.on("touchstart.ojContextMenu mousedown.ojContextMenu keydown.ojContextMenu ", function($event$$65$$) {
      if ("mousedown" !== $event$$65$$.type || !$getContextMenu$$().$__contextMenuPressHoldJustEnded$()) {
        return $isPressHold$$1$$ = !1, "touchstart" === $event$$65$$.type && ($touchInProgress$$1$$ = !0, $pressHoldTimer$$ = setTimeout($launch$$1$$.bind(void 0, $event$$65$$, "touch", !0), 750)), !0;
      }
    }).on("touchend.ojContextMenu touchcancel.ojContextMenu", function() {
      $touchInProgress$$1$$ = !1;
      clearTimeout($pressHoldTimer$$);
      return!0;
    }).on("keydown.ojContextMenu contextmenu.ojContextMenu", function($event$$67$$) {
      ("contextmenu" === $event$$67$$.type || 121 == $event$$67$$.which && $event$$67$$.shiftKey) && $launch$$1$$($event$$67$$, $touchInProgress$$1$$ ? "touch" : "keydown" === $event$$67$$.type ? "keyboard" : "mouse", !1);
      return!0;
  ...
  $ComponentChangeTracker$$.prototype.$addChange$ = function $$ComponentChangeTracker$$$$$addChange$$($property$$17$$, $value$$163$$) {
    this.$_isSuspended$($property$$17$$) || this.$_disposed$ || (this.$_changes$[$property$$17$$] = $value$$163$$, this.$_queue$.$registerComponentChanges$(this));
  };
  ...
  (function _wrapKnockoutBindingProvider() {
    ...
    $_defineWrappedMethod$$($wrapped$$, $custom$$2_provider$$, "getBindings", function($node$$24_ret$$21$$, $bindingContext$$6_bindingName$$, $wrappedReturn$$) {
      $node$$24_ret$$21$$ = $wrappedReturn$$;
      $bindingContext$$6_bindingName$$ = $_findOwnBinding$$($wrappedReturn$$);
      null != $bindingContext$$6_bindingName$$ && ($oj$$7$$.$Logger$.error("%s binding is not compatible with bidding providers not implementing getBindingAccessors()", $bindingContext$$6_bindingName$$), $node$$24_ret$$21$$ = $oj$$7$$.$CollectionUtils$.$copyInto$({}, $wrappedReturn$$), delete $node$$24_ret$$21$$[$bindingContext$$6_bindingName$$]);
      return $node$$24_ret$$21$$;
    });
    $_defineWrappedMethod$$($wrapped$$, $custom$$2_provider$$, "getBindingAccessors", $_replaceComponentBindingWithV2$$);
  })();
  $oj$$7$$.$ComponentBinding$.$getDefaultInstance$().$setupManagedAttributes$({attributes:["header", "cell"], init:function($cellTemplate_column_name$$97_row$$, $value$$168$$, $columnTemplate_element$$53_rowTemplate$$, $widgetConstructor$$6$$, $valueAccessor$$10$$, $allBindingsAccessor$$9$$, $bindingContext$$29$$) {
    if ("header" === $cellTemplate_column_name$$97_row$$) {
      return $cellTemplate_column_name$$97_row$$ = $value$$168$$.row, null != $cellTemplate_column_name$$97_row$$ && ($columnTemplate_element$$53_rowTemplate$$ = $cellTemplate_column_name$$97_row$$.template, null != $columnTemplate_element$$53_rowTemplate$$ && ($cellTemplate_column_name$$97_row$$.renderer = $_getDataGridHeaderRenderer$$($bindingContext$$29$$, $columnTemplate_element$$53_rowTemplate$$))), $cellTemplate_column_name$$97_row$$ = $value$$168$$.column, null != $cellTemplate_column_name$$97_row$$ && 
      ($columnTemplate_element$$53_rowTemplate$$ = $cellTemplate_column_name$$97_row$$.template, null != $columnTemplate_element$$53_rowTemplate$$ && ($cellTemplate_column_name$$97_row$$.renderer = $_getDataGridHeaderRenderer$$($bindingContext$$29$$, $columnTemplate_element$$53_rowTemplate$$))), {header:$value$$168$$};
    }
    if ("cell" === $cellTemplate_column_name$$97_row$$) {
      return $cellTemplate_column_name$$97_row$$ = $value$$168$$.template, null != $cellTemplate_column_name$$97_row$$ && ($value$$168$$.renderer = $_getDataGridCellRenderer$$($bindingContext$$29$$, $cellTemplate_column_name$$97_row$$)), {cell:$value$$168$$};
    }
  }, update:function($cellTemplate$$1_column$$1_name$$98_row$$1$$, $value$$169$$, $columnTemplate$$1_element$$54_rowTemplate$$1$$, $widgetConstructor$$7$$, $valueAccessor$$11$$, $allBindingsAccessor$$10$$, $bindingContext$$30$$) {
    return "header" === $cellTemplate$$1_column$$1_name$$98_row$$1$$ ? ($cellTemplate$$1_column$$1_name$$98_row$$1$$ = $value$$169$$.row, null != $cellTemplate$$1_column$$1_name$$98_row$$1$$ && ($columnTemplate$$1_element$$54_rowTemplate$$1$$ = $cellTemplate$$1_column$$1_name$$98_row$$1$$.template, null != $columnTemplate$$1_element$$54_rowTemplate$$1$$ && ($cellTemplate$$1_column$$1_name$$98_row$$1$$.renderer = $_getDataGridHeaderRenderer$$($bindingContext$$30$$, $columnTemplate$$1_element$$54_rowTemplate$$1$$))), 
    $cellTemplate$$1_column$$1_name$$98_row$$1$$ = $value$$169$$.column, null != $cellTemplate$$1_column$$1_name$$98_row$$1$$ && ($columnTemplate$$1_element$$54_rowTemplate$$1$$ = $cellTemplate$$1_column$$1_name$$98_row$$1$$.template, null != $columnTemplate$$1_element$$54_rowTemplate$$1$$ && ($cellTemplate$$1_column$$1_name$$98_row$$1$$.renderer = $_getDataGridHeaderRenderer$$($bindingContext$$30$$, $columnTemplate$$1_element$$54_rowTemplate$$1$$))), {header:$value$$169$$}) : "cell" === $cellTemplate$$1_column$$1_name$$98_row$$1$$ ? 
    ($cellTemplate$$1_column$$1_name$$98_row$$1$$ = $value$$169$$.template, null != $cellTemplate$$1_column$$1_name$$98_row$$1$$ && ($value$$169$$.renderer = $_getDataGridCellRenderer$$($bindingContext$$30$$, $cellTemplate$$1_column$$1_name$$98_row$$1$$)), {cell:$value$$169$$}) : null;
  }, "for":"ojDataGrid"});
  ...
  $oj$$7$$.$ComponentBinding$.$getDefaultInstance$().$setupManagedAttributes$({attributes:["item"], init:function($name$$101_result$$17$$, $value$$172$$, $element$$57$$, $widgetConstructor$$10$$, $valueAccessor$$14$$, $allBindingsAccessor$$13$$, $bindingContext$$33$$) {
    $name$$101_result$$17$$ = $_handleListViewManagedAttributes$$($name$$101_result$$17$$, $value$$172$$, $bindingContext$$33$$);
    if (null != $name$$101_result$$17$$) {
      return $name$$101_result$$17$$;
    }
    ...
    return $_handleListViewManagedAttributes$$($name$$102$$, $value$$173$$, $bindingContext$$34$$);
