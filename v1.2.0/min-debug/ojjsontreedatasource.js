...
define(["ojs/ojcore", "jquery", "ojs/ojdatasource-common"], function($oj$$75$$) {
  ...
  $oj$$75$$.$_JsonTreeNodeDataSource$.prototype.$_ascending$ = function $$oj$$75$$$$_JsonTreeNodeDataSource$$$$_ascending$$($key$$183$$) {
    return function($a$$125$$, $b$$79$$) {
      return $a$$125$$.attr && $b$$79$$.attr && $a$$125$$.attr[$key$$183$$] && $b$$79$$.attr[$key$$183$$] ? $a$$125$$.attr[$key$$183$$] < $b$$79$$.attr[$key$$183$$] ? -1 : $a$$125$$.attr[$key$$183$$] === $b$$79$$.attr[$key$$183$$] ? 0 : 1 : $a$$125$$[$key$$183$$] < $b$$79$$[$key$$183$$] ? -1 : $a$$125$$[$key$$183$$] === $b$$79$$[$key$$183$$] ? 0 : 1;
    };
  };
  $oj$$75$$.$_JsonTreeNodeDataSource$.prototype.$_descending$ = function $$oj$$75$$$$_JsonTreeNodeDataSource$$$$_descending$$($key$$184$$) {
    return function($a$$126$$, $b$$80$$) {
      return $a$$126$$.attr && $b$$80$$.attr && $a$$126$$.attr[$key$$184$$] && $b$$80$$.attr[$key$$184$$] ? $a$$126$$.attr[$key$$184$$] < $b$$80$$.attr[$key$$184$$] ? 1 : $a$$126$$.attr[$key$$184$$] === $b$$80$$.attr[$key$$184$$] ? 0 : -1 : $a$$126$$[$key$$184$$] < $b$$80$$[$key$$184$$] ? 1 : $a$$126$$[$key$$184$$] === $b$$80$$[$key$$184$$] ? 0 : -1;
    };
  };
  $oj$$75$$.$_JsonTreeNodeDataSource$.prototype.$_sortRecursive$ = function $$oj$$75$$$$_JsonTreeNodeDataSource$$$$_sortRecursive$$($criteria$$10$$) {
    var $i$$464_key$$185$$ = $criteria$$10$$.key;
    "ascending" === $criteria$$10$$.direction ? this.children.sort(this.$_ascending$($i$$464_key$$185$$)) : "descending" === $criteria$$10$$.direction && this.children.sort(this.$_descending$($i$$464_key$$185$$));
    for (var $i$$464_key$$185$$ = 0, $l$$17$$ = this.children.length;$i$$464_key$$185$$ < $l$$17$$;$i$$464_key$$185$$++) {
      this.children[$i$$464_key$$185$$].$_sortRecursive$($criteria$$10$$);
    }
  };
  ...
  $oj$$75$$.$JsonTreeDataSource$.prototype.$_createTreeDataSource$ = function $$oj$$75$$$$JsonTreeDataSource$$$$_createTreeDataSource$$($c$$56$$, $target$$98$$, $source$$12$$, $depth$$26$$) {
    var $children$$29$$, $node$$165$$, $child$$22$$, $prop$$76$$, $propr$$, $prp$$, $j$$47$$;
    $depth$$26$$ || ($depth$$26$$ = 0);
    for ($prop$$76$$ in $source$$12$$) {
      if ("children" == $prop$$76$$ || 0 == $depth$$26$$ && $source$$12$$ instanceof Array) {
        for ($children$$29$$ = 0 == $depth$$26$$ && $source$$12$$ instanceof Array ? $source$$12$$ : $source$$12$$[$prop$$76$$], $depth$$26$$++, $j$$47$$ = 0;$j$$47$$ < $children$$29$$.length;$j$$47$$++) {
          ...
          $node$$165$$ = new $oj$$75$$.$_JsonTreeNodeDataSource$;
          $child$$22$$.id || ($c$$56$$.count++, $child$$22$$.attr ? $child$$22$$.attr.id || ($child$$22$$.attr.id = "rid_" + $c$$56$$.count) : $node$$165$$.id = "rid_" + $c$$56$$.count);
          for ($propr$$ in $child$$22$$) {
            for ($prp$$ in $node$$165$$) {
              $propr$$ == $prp$$ && "children" != $propr$$ && ($node$$165$$[$prp$$] = $child$$22$$[$propr$$]), "depth" == $prp$$ && ($node$$165$$[$prp$$] = $depth$$26$$);
            }
          }
          $target$$98$$.children.push($node$$165$$);
          for ($prp$$ in $child$$22$$) {
  ...
  $oj$$75$$.$JsonTreeDataSource$.prototype.$getChildCount$ = function $$oj$$75$$$$JsonTreeDataSource$$$$getChildCount$$($parent$$50_parentKey$$10$$) {
    $parent$$50_parentKey$$10$$ || ($parent$$50_parentKey$$10$$ = this.data.id);
    $parent$$50_parentKey$$10$$ = this.$_searchTreeById$(this.data, $parent$$50_parentKey$$10$$);
    return $parent$$50_parentKey$$10$$.children ? $parent$$50_parentKey$$10$$.children.length : 0;
  };
  ...
  $oj$$75$$.$JsonTreeDataSource$.prototype.$fetchChildren$ = function $$oj$$75$$$$JsonTreeDataSource$$$$fetchChildren$$($nodeSet$$33_parentKey$$11$$, $i$$465_range$$21$$, $callbacks$$56$$) {
    var $childStart$$, $childEnd$$, $results$$12$$, $parent$$51$$, $node$$166$$;
    $results$$12$$ = [];
    $nodeSet$$33_parentKey$$11$$ || ($nodeSet$$33_parentKey$$11$$ = this.data.id);
    $parent$$51$$ = this.$_searchTreeById$(this.data, $nodeSet$$33_parentKey$$11$$);
    $i$$465_range$$21$$ || ($i$$465_range$$21$$ = [], $i$$465_range$$21$$.start = 0, $i$$465_range$$21$$.count = $parent$$51$$.children.length);
    $i$$465_range$$21$$.count || ($i$$465_range$$21$$.count = $parent$$51$$.children.length);
    $i$$465_range$$21$$.start || ($i$$465_range$$21$$.start = 0);
    $childStart$$ = $i$$465_range$$21$$.start;
    $childEnd$$ = Math.min($parent$$51$$.children.length, $childStart$$ + $i$$465_range$$21$$.count);
    for ($i$$465_range$$21$$ = $childStart$$;$i$$465_range$$21$$ < $childEnd$$;$i$$465_range$$21$$ += 1) {
      $node$$166$$ = new $oj$$75$$.$_JsonTreeNodeDataSource$, $parent$$51$$.children[$i$$465_range$$21$$].attr && ($node$$166$$.attr = $parent$$51$$.children[$i$$465_range$$21$$].attr), $parent$$51$$.children[$i$$465_range$$21$$].id && ($node$$166$$.id = $parent$$51$$.children[$i$$465_range$$21$$].id), $parent$$51$$.children[$i$$465_range$$21$$].depth && ($node$$166$$.depth = $parent$$51$$.children[$i$$465_range$$21$$].depth), $parent$$51$$.children[$i$$465_range$$21$$].title && ($node$$166$$.title = 
      $parent$$51$$.children[$i$$465_range$$21$$].title), $parent$$51$$.children[$i$$465_range$$21$$].parent && ($node$$166$$.parent = $parent$$51$$.children[$i$$465_range$$21$$].parent), $node$$166$$.$leaf$ = 0 < $parent$$51$$.children[$i$$465_range$$21$$].children.length ? !1 : !0, $results$$12$$.push($node$$166$$);
    }
  ...
  $oj$$75$$.$JsonTreeDataSource$.prototype.$fetchDescendants$ = function $$oj$$75$$$$JsonTreeDataSource$$$$fetchDescendants$$($parentKey$$12$$, $callbacks$$57$$) {
    var $childEnd$$1_range$$22$$, $childStart$$1_i$$466$$, $nodeSet$$34_results$$13$$, $parent$$52$$;
    $nodeSet$$34_results$$13$$ = [];
    $parentKey$$12$$ || ($parentKey$$12$$ = this.data.id);
    $parent$$52$$ = this.$_searchTreeById$(this.data, $parentKey$$12$$);
    $childEnd$$1_range$$22$$ = [];
    $childEnd$$1_range$$22$$.start = 0;
    $childEnd$$1_range$$22$$.count = $parent$$52$$.children.length;
    $childStart$$1_i$$466$$ = $childEnd$$1_range$$22$$.start;
    for ($childEnd$$1_range$$22$$ = Math.min($parent$$52$$.children.length, $childStart$$1_i$$466$$ + $childEnd$$1_range$$22$$.count);$childStart$$1_i$$466$$ < $childEnd$$1_range$$22$$;$childStart$$1_i$$466$$ += 1) {
      $parent$$52$$.children[$childStart$$1_i$$466$$].$leaf$ = 0 < $parent$$52$$.children[$childStart$$1_i$$466$$].children.length ? !1 : !0, $nodeSet$$34_results$$13$$.push($parent$$52$$.children[$childStart$$1_i$$466$$]);
    }
  ...
  $oj$$75$$.$JsonTreeDataSource$.prototype.move = function $$oj$$75$$$$JsonTreeDataSource$$$move$($moveNode_nodeToMove$$, $refNode$$8_referenceNode$$1$$, $index$$289_position$$44$$, $callbacks$$58$$) {
    var $parent$$53_refNodeKey$$;
    $parent$$53_refNodeKey$$ = $refNode$$8_referenceNode$$1$$;
    if (!$parent$$53_refNodeKey$$ || $parent$$53_refNodeKey$$ == this.data.id) {
      ...
      $parent$$53_refNodeKey$$ || ($parent$$53_refNodeKey$$ = this.data.id);
    }
    $moveNode_nodeToMove$$ = this.$_searchTreeById$(null, $moveNode_nodeToMove$$);
    this.$_searchTreeById$($moveNode_nodeToMove$$, $parent$$53_refNodeKey$$) ? $oj$$75$$.$Logger$.log("Error: the node to move contains the reference node as its sub-tree.") : ($refNode$$8_referenceNode$$1$$ = this.$_searchTreeById$(null, $parent$$53_refNodeKey$$), $parent$$53_refNodeKey$$ = this.$_getParentById$($parent$$53_refNodeKey$$), this.$_removeFromTree$($moveNode_nodeToMove$$), "inside" == $index$$289_position$$44$$ ? (this.$_updateDepth$($moveNode_nodeToMove$$, $moveNode_nodeToMove$$.depth - 
    ($refNode$$8_referenceNode$$1$$.depth + 1)), $refNode$$8_referenceNode$$1$$.children.push($moveNode_nodeToMove$$)) : "before" == $index$$289_position$$44$$ ? (this.$_updateDepth$($moveNode_nodeToMove$$, $moveNode_nodeToMove$$.depth - $refNode$$8_referenceNode$$1$$.depth), $index$$289_position$$44$$ = $parent$$53_refNodeKey$$.children.indexOf($refNode$$8_referenceNode$$1$$), -1 < $index$$289_position$$44$$ && (0 != $index$$289_position$$44$$ ? $parent$$53_refNodeKey$$.children.splice($index$$289_position$$44$$ - 
    1, 0, $moveNode_nodeToMove$$) : $parent$$53_refNodeKey$$.children.unshift($moveNode_nodeToMove$$))) : "after" == $index$$289_position$$44$$ ? (this.$_updateDepth$($moveNode_nodeToMove$$, $moveNode_nodeToMove$$.depth - $refNode$$8_referenceNode$$1$$.depth), $index$$289_position$$44$$ = $parent$$53_refNodeKey$$.children.indexOf($refNode$$8_referenceNode$$1$$), -1 < $index$$289_position$$44$$ && $parent$$53_refNodeKey$$.children.splice($index$$289_position$$44$$, 0, $moveNode_nodeToMove$$)) : "first" == 
    $index$$289_position$$44$$ ? (this.$_updateDepth$($moveNode_nodeToMove$$, $moveNode_nodeToMove$$.depth - $refNode$$8_referenceNode$$1$$.depth), $parent$$53_refNodeKey$$.children.unshift($moveNode_nodeToMove$$)) : "last" == $index$$289_position$$44$$ && (this.$_updateDepth$($moveNode_nodeToMove$$, $moveNode_nodeToMove$$.depth - $refNode$$8_referenceNode$$1$$.depth), $parent$$53_refNodeKey$$.children.push($moveNode_nodeToMove$$)), null != $callbacks$$58$$ && null != $callbacks$$58$$.success && 
  ...
  $oj$$75$$.$JsonTreeDataSource$.prototype.sort = function $$oj$$75$$$$JsonTreeDataSource$$$sort$($criteria$$11$$, $callbacks$$59$$) {
    var $parent$$54$$;
    $parent$$54$$ = this.$_searchTreeById$(this.data, this.data.id);
    $parent$$54$$.$_sortRecursive$($criteria$$11$$);
    null != $callbacks$$59$$ && null != $callbacks$$59$$.success && $callbacks$$59$$.success.call(null, $parent$$54$$);
  };
  ...
  $oj$$75$$.$JsonTreeDataSource$.prototype.$_getParentById$ = function $$oj$$75$$$$JsonTreeDataSource$$$$_getParentById$$($refNodeKey$$1$$, $currNode$$4$$) {
    ...
    if ($currNode$$4$$.children && 0 < $currNode$$4$$.children.length) {
      ...
      for ($i$$467$$ = 0;$i$$467$$ < $currNode$$4$$.children.length && !($parent$$55$$ = this.$_getParentById$($refNodeKey$$1$$, $currNode$$4$$.children[$i$$467$$]));$i$$467$$++) {
      }
    }
    return $parent$$55$$;
  };
  $oj$$75$$.$JsonTreeDataSource$.prototype.$_searchTreeById$ = function $$oj$$75$$$$JsonTreeDataSource$$$$_searchTreeById$$($currChild$$2$$, $parentKey$$14$$) {
    ...
    if (null != $currChild$$2$$.children) {
      for ($i$$468$$ = 0;$i$$468$$ < $currChild$$2$$.children.length && !$result$$78$$;$i$$468$$++) {
        $result$$78$$ = $currChild$$2$$.children[$i$$468$$].id && $currChild$$2$$.children[$i$$468$$].id == $parentKey$$14$$ || $currChild$$2$$.children[$i$$468$$].attr && $currChild$$2$$.children[$i$$468$$].attr.id == $parentKey$$14$$ ? $currChild$$2$$.children[$i$$468$$] : this.$_searchTreeById$($currChild$$2$$.children[$i$$468$$], $parentKey$$14$$);
      }
    }
    return $result$$78$$;
  };
  ...
  $oj$$75$$.$JsonTreeDataSource$.prototype.$_removeFromTree$ = function $$oj$$75$$$$JsonTreeDataSource$$$$_removeFromTree$$($currChild$$4_index$$290$$) {
    var $key$$186_parent$$56$$;
    $currChild$$4_index$$290$$.id ? $key$$186_parent$$56$$ = $currChild$$4_index$$290$$.id : $currChild$$4_index$$290$$.attr && ($key$$186_parent$$56$$ = $currChild$$4_index$$290$$.attr.id);
    ($key$$186_parent$$56$$ = this.$_getParentById$($key$$186_parent$$56$$)) || ($key$$186_parent$$56$$ = this.data);
    $currChild$$4_index$$290$$ = $key$$186_parent$$56$$.children.indexOf($currChild$$4_index$$290$$);
    -1 < $currChild$$4_index$$290$$ && $key$$186_parent$$56$$.children.splice($currChild$$4_index$$290$$, 1);
  };
  ...
  $oj$$75$$.$JsonNodeSet$.prototype.getMetadata = function $$oj$$75$$$$JsonNodeSet$$$getMetadata$($index$$292$$) {
    ...
    $metadata$$17$$.key = this.$m_nodes$[$index$$292$$].id ? this.$m_nodes$[$index$$292$$].id : this.$m_nodes$[$index$$292$$].attr.id;
    $metadata$$17$$.leaf = this.$m_nodes$[$index$$292$$].$leaf$;
    $metadata$$17$$.depth = this.$m_nodes$[$index$$292$$].depth;
    null == $metadata$$17$$.leaf && ($metadata$$17$$.leaf = this.$m_nodes$[$index$$292$$].children && 0 < this.$m_nodes$[$index$$292$$].children.length ? !1 : !0);
    return $metadata$$17$$;
  };
  ...
  $oj$$75$$.$JsonNodeSet$.prototype.$getChildNodeSet$ = function $$oj$$75$$$$JsonNodeSet$$$$getChildNodeSet$$($index$$293_key$$187$$) {
    var $results$$14$$, $depth$$28$$, $i$$471$$;
    $oj$$75$$.$Assert$.assert($index$$293_key$$187$$ <= this.$m_endNode$ && $index$$293_key$$187$$ >= this.$m_startNode$);
    $index$$293_key$$187$$ -= this.$m_startNode$;
    $depth$$28$$ = this.$m_nodes$[$index$$293_key$$187$$].depth;
    $results$$14$$ = this.$m_nodes$[$index$$293_key$$187$$].children;
    if (0 == $results$$14$$.length) {
      return null;
    }
    $index$$293_key$$187$$ = this.$m_nodes$[$index$$293_key$$187$$].id ? this.$m_nodes$[$index$$293_key$$187$$].id : this.$m_nodes$[$index$$293_key$$187$$].attr.id;
    for ($i$$471$$ = 0;$i$$471$$ < $results$$14$$.length;$i$$471$$++) {
      this.$_updateDepth$($results$$14$$[$i$$471$$], $depth$$28$$);
    }
    return new $oj$$75$$.$JsonNodeSet$(0, $results$$14$$.length, $results$$14$$, $index$$293_key$$187$$);
  };
