...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "hammerjs", "ojs/ojpagingtabledatasource", "ojs/ojinputtext", "ojs/ojjquery-hammer"], function($oj$$10$$, $$$$10$$, $compCore$$, $Hammer$$2$$) {
  (function() {
    ...
    $_DATA_ATTR_PAGE_NUM$:"data-oj-pagenum", $_OPTION_ENABLED$:"enabled", $_OPTION_DISABLED$:"disabled", $_TAB_INDEX$:"tabindex", $_MODE$:{$_LOAD_MORE$:"loadMore", $_PAGE$:"page"}, $_PAGE_OPTION_LAYOUT$:{$_AUTO$:"auto", $_ALL$:"all", $_INPUT$:"input", $_RANGE_TEXT$:"rangeText", $_PAGES$:"pages", $_NAV$:"nav"}, $_PAGE_OPTION_DEFAULT_MAX_PAGE_LINKS$:6, $_TYPE$:{$_NUMBERS$:"numbers", $_DOTS$:"dots"}, firstPage:function() {
      ...
      return $$$$10$$($node$$30$$).hasClass(this.$_CSS_CLASSES$.$_PAGING_CONTROL_NAV_INPUT_CLASS$) ? {subId:"oj-pagingcontrol-nav-input"} : $$$$10$$($node$$30$$).hasClass(this.$_CSS_CLASSES$.$_PAGING_CONTROL_NAV_INPUT_MAX_CLASS$) ? {subId:"oj-pagingcontrol-nav-input-max"} : $$$$10$$($node$$30$$).hasClass(this.$_CSS_CLASSES$.$_PAGING_CONTROL_NAV_INPUT_SUMMARY_CLASS$) ? {subId:"oj-pagingcontrol-nav-input-summary"} : $$$$10$$($node$$30$$).hasClass(this.$_CSS_CLASSES$.$_PAGING_CONTROL_NAV_INPUT_SUMMARY_CURRENT_CLASS$) ? 
      {subId:"oj-pagingcontrol-nav-input-summary-current"} : $$$$10$$($node$$30$$).hasClass(this.$_CSS_CLASSES$.$_PAGING_CONTROL_NAV_INPUT_SUMMARY_MAX_CLASS$) ? {subId:"oj-pagingcontrol-nav-input-summary-max"} : $$$$10$$($node$$30$$).hasClass(this.$_CSS_CLASSES$.$_PAGING_CONTROL_NAV_FIRST_CLASS$) ? {subId:"oj-pagingcontrol-nav-first"} : $$$$10$$($node$$30$$).hasClass(this.$_CSS_CLASSES$.$_PAGING_CONTROL_NAV_NEXT_CLASS$) ? {subId:"oj-pagingcontrol-nav-next"} : $$$$10$$($node$$30$$).hasClass(this.$_CSS_CLASSES$.$_PAGING_CONTROL_NAV_PREVIOUS_CLASS$) ? 
      {subId:"oj-pagingcontrol-nav-previous"} : $$$$10$$($node$$30$$).hasClass(this.$_CSS_CLASSES$.$_PAGING_CONTROL_NAV_LAST_CLASS$) ? {subId:"oj-pagingcontrol-nav-last"} : $$$$10$$($node$$30$$).hasClass(this.$_CSS_CLASSES$.$_PAGING_CONTROL_NAV_PAGE_CLASS$) ? {subId:"oj-pagingcontrol-nav-page", index:$$$$10$$($node$$30$$).attr(this.$_DATA_ATTR_PAGE_NUM$)} : $$$$10$$($node$$30$$).hasClass(this.$_CSS_CLASSES$.$_PAGING_CONTROL_LOAD_MORE_LINK_CLASS$) ? {subId:"oj-pagingcontrol-load-more-link"} : $$$$10$$($node$$30$$).hasClass(this.$_CSS_CLASSES$.$_PAGING_CONTROL_LOAD_MORE_RANGE_CLASS$) ? 
      {subId:"oj-pagingcontrol-load-more-range"} : $$$$10$$($node$$30$$).hasClass(this.$_CSS_CLASSES$.$_PAGING_CONTROL_LOAD_MORE_RANGE_CURRENT_CLASS$) ? {subId:"oj-pagingcontrol-load-more-range-current"} : $$$$10$$($node$$30$$).hasClass(this.$_CSS_CLASSES$.$_PAGING_CONTROL_LOAD_MORE_RANGE_MAX_CLASS$) ? {subId:"oj-pagingcontrol-load-more-range-max"} : $$$$10$$($node$$30$$).hasClass(this.$_CSS_CLASSES$.$_PAGING_CONTROL_LOAD_MORE_MAX_ROWS_CLASS$) ? {subId:"oj-pagingcontrol-load-more-max-rows"} : null;
    ...
    }, $_events$:{"mouseup .oj-pagingcontrol-loadmore-link":function($event$$69$$) {
      this.loadNext();
      $$$$10$$($event$$69$$.target).data("_mouseup", !0);
      $event$$69$$.preventDefault();
    }, "click .oj-pagingcontrol-loadmore-link":function($event$$70$$) {
      $$$$10$$($event$$70$$.target).data("_mouseup") ? $$$$10$$($event$$70$$.target).data("_mouseup", !1) : this.loadNext();
      $event$$70$$.preventDefault();
    }, "click .oj-pagingcontrol-nav-dot":function($event$$71$$) {
      var $pageNum$$ = $$$$10$$($event$$71$$.currentTarget).attr("data-oj-pagenum"), $self$$53$$ = this;
    ...
    }, "click .oj-pagingcontrol-nav-page":function($event$$72$$) {
      var $pageNum$$1$$ = $$$$10$$($event$$72$$.currentTarget).attr("data-oj-pagenum"), $self$$54$$ = this;
    ...
    }, "click .oj-pagingcontrol-nav-first":function($event$$73$$) {
    ...
    }, "click .oj-pagingcontrol-nav-previous":function($event$$74$$) {
    ...
    }, "click .oj-pagingcontrol-nav-next":function($event$$75$$) {
    ...
    }, "click .oj-pagingcontrol-nav-last":function($event$$76$$) {
    ...
    }, "keypress .oj-pagingcontrol-nav-input":function($event$$77$$) {
      13 == $event$$77$$.which && $event$$77$$.preventDefault();
    }, "mousedown .oj-pagingcontrol-nav-first":function($event$$78$$) {
      $$$$10$$($event$$78$$.currentTarget).hasClass(this.$_MARKER_STYLE_CLASSES$.$_DISABLED$) || $$$$10$$($event$$78$$.target).addClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$78$$.preventDefault();
    }, "mousedown .oj-pagingcontrol-nav-previous":function($event$$79$$) {
      $$$$10$$($event$$79$$.currentTarget).hasClass(this.$_MARKER_STYLE_CLASSES$.$_DISABLED$) || $$$$10$$($event$$79$$.target).addClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$79$$.preventDefault();
    }, "mousedown .oj-pagingcontrol-nav-next":function($event$$80$$) {
    ...
    }, "mousedown .oj-pagingcontrol-nav-last":function($event$$81$$) {
    ...
    }, "mouseup .oj-pagingcontrol-nav-first":function($event$$82$$) {
      $$$$10$$($event$$82$$.target).removeClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$82$$.preventDefault();
    }, "mouseup .oj-pagingcontrol-nav-previous":function($event$$83$$) {
      $$$$10$$($event$$83$$.target).removeClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$83$$.preventDefault();
    }, "mouseup .oj-pagingcontrol-nav-next":function($event$$84$$) {
      $$$$10$$($event$$84$$.target).removeClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$84$$.preventDefault();
    }, "mouseup .oj-pagingcontrol-nav-last":function($event$$85$$) {
      $$$$10$$($event$$85$$.target).removeClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$85$$.preventDefault();
    }, "mouseleave .oj-pagingcontrol-nav-first":function($event$$86$$) {
      $$$$10$$($event$$86$$.target).removeClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$86$$.preventDefault();
    }, "mouseleave .oj-pagingcontrol-nav-previous":function($event$$87$$) {
      $$$$10$$($event$$87$$.target).removeClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$87$$.preventDefault();
    }, "mouseleave .oj-pagingcontrol-nav-next":function($event$$88$$) {
      $$$$10$$($event$$88$$.target).removeClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$88$$.preventDefault();
    }, "mouseleave .oj-pagingcontrol-nav-last":function($event$$89$$) {
      ...
      if (this.$_mode$ != this.options.mode) {
        ...
        if (this.options.mode == this.$_MODE$.$_LOAD_MORE$) {
          ...
          null != $data$$63$$ && ($startIndex$$2$$ + $size$$11$$ == $data$$63$$.totalSize() && this.$_isTotalSizeConfidenceActual$() || 0 == $data$$63$$.totalSize()) ? $pagingControlLoadMore$$.css("display", "none") : this.$_refreshPagingControlLoadMore$($size$$11$$, $startIndex$$2$$);
        } else {
          this.$_refreshPagingControlNav$($size$$11$$, $startIndex$$2$$);
        }
      }
    }, _setOption:function($key$$46$$, $value$$178$$) {
      this._superApply(arguments);
      this.$_invokeDataPage$(0, !0);
      if (this.options.mode != this.$_MODE$.$_LOAD_MORE$ && "pageOptions" == $key$$46$$) {
      ...
      var $data$$64$$ = this.$_getData$(), $page$$3$$ = 0;
      null != $data$$64$$ && ($page$$3$$ = $data$$64$$.getPage());
      return $page$$3$$;
    }, $_getData$:function() {
      ...
      var $data$$65_itemRangeItemsText$$ = this.$_getData$();
      if (null != $data$$65_itemRangeItemsText$$ && null != $data$$65_itemRangeItemsText$$.totalSize() && null != $size$$12$$) {
        ...
        if (-1 != $data$$65_itemRangeItemsText$$.totalSize()) {
          var $itemRangeCurrentText_pageTo$$ = $itemRangeCurrentText_pageTo$$ > $data$$65_itemRangeItemsText$$.totalSize() ? $data$$65_itemRangeItemsText$$.totalSize() : $itemRangeCurrentText_pageTo$$, $itemRangeCurrentText_pageTo$$ = $itemRangeItemsSpan_itemRangeMaxSpan_itemRangeOfText_pageFrom$$ == $itemRangeCurrentText_pageTo$$ ? this.$getTranslatedString$(this.$_BUNDLE_KEY$.$_MSG_ITEM_RANGE_CURRENT_SINGLE$, {pageFrom:$itemRangeItemsSpan_itemRangeMaxSpan_itemRangeOfText_pageFrom$$}) : this.$getTranslatedString$(this.$_BUNDLE_KEY$.$_MSG_ITEM_RANGE_CURRENT$, 
          ...
          "atLeast" == $data$$65_itemRangeItemsText$$.totalSizeConfidence() ? $itemRangeConf$$ = this.$getTranslatedString$(this.$_BUNDLE_KEY$.$_MSG_ITEM_RANGE_ATLEAST$) : "estimate" == $data$$65_itemRangeItemsText$$.totalSizeConfidence() && ($itemRangeConf$$ = this.$getTranslatedString$(this.$_BUNDLE_KEY$.$_MSG_ITEM_RANGE_APPROX$));
          ...
          $itemRangeItemsSpan_itemRangeMaxSpan_itemRangeOfText_pageFrom$$.text($data$$65_itemRangeItemsText$$.totalSize());
        ...
        $data$$65_itemRangeItemsText$$ = this.$getTranslatedString$(this.$_BUNDLE_KEY$.$_MSG_ITEM_RANGE_ITEMS$);
        $itemRangeItemsSpan_itemRangeMaxSpan_itemRangeOfText_pageFrom$$ = $$$$10$$(document.createElement("span"));
        $itemRangeItemsSpan_itemRangeMaxSpan_itemRangeOfText_pageFrom$$.text(" " + $data$$65_itemRangeItemsText$$);
        $itemRangeSpan$$.append($itemRangeItemsSpan_itemRangeMaxSpan_itemRangeOfText_pageFrom$$);
      ...
      return $maxPageLinks$$;
    }, $_getMaxPageVal$:function($data$$66_size$$13$$) {
      var $maxPageVal$$ = 0;
      0 < this.$_getTotalPages$() && this.$_isTotalSizeConfidenceActual$() ? $maxPageVal$$ = this.$_getTotalPages$() : 0 < $data$$66_size$$13$$ ? ($data$$66_size$$13$$ = this.$_getData$(), $maxPageVal$$ = null == $data$$66_size$$13$$ || "atLeast" != $data$$66_size$$13$$.totalSizeConfidence() && "estimate" != $data$$66_size$$13$$.totalSizeConfidence() ? this.$_getCurrentPage$() + 2 : this.$_getTotalPages$() + 1) : $maxPageVal$$ = this.$_getCurrentPage$() + 1;
      return $maxPageVal$$;
    }, $_getRejectPromise$:function() {
      return Promise.reject();
    }, $_getTotalPages$:function() {
      var $data$$67$$ = this.$_getData$(), $pageCount$$ = 0;
      null != $data$$67$$ && ($pageCount$$ = $data$$67$$.getPageCount());
      ...
      this.$_queueRefresh$();
    }, $_handleDataPage$:function($event$$91$$) {
      $event$$91$$.page != $event$$91$$.previousPage && this.$_queueRefresh$();
    }, $_handleDataReset$:function() {
      this.$_invokeDataPage$(0, !1);
    }, $_handleDataRefresh$:function() {
      this.$_queueRefresh$();
    }, $_handleDataSort$:function($event$$94$$) {
      this.options.mode == this.$_MODE$.$_LOAD_MORE$ && this.$_handleDataReset$($event$$94$$);
    }, $_handleDataRowAdd$:function($event$$95$$) {
      this.options.mode == this.$_MODE$.$_PAGE$ && this.$_isOperationOnCurrentPage$($event$$95$$) ? this.$_invokeDataPage$(this.$_getCurrentPage$(), !0) : this.$_queueRefresh$();
    }, $_handleDataRowRemove$:function($event$$96$$) {
      0 < this.$_getTotalPages$() && this.$_getCurrentPage$() > this.$_getTotalPages$() - 1 ? this.$_invokeDataPage$(this.$_getTotalPages$() - 1, !0) : this.$_isOperationOnCurrentPage$($event$$96$$) ? this.$_invokeDataPage$(this.$_getCurrentPage$(), !0) : this.$_queueRefresh$();
    }, $_handlePageChange$:function($event$$97$$, $data$$68$$) {
      var $page$$5$$ = $data$$68$$.value;
      ...
      var $data$$69$$ = this.$_getData$(), $self$$61$$ = this;
      return new Promise(function($resolve$$24$$, $reject$$24$$) {
        null != $data$$69$$ ? $data$$69$$.setPage($page$$6$$, {pageSize:$self$$61$$.options.pageSize}).then(function() {
          $resolve$$24$$(null);
        }, function($error$$24$$) {
          $reject$$24$$($error$$24$$);
        }) : $resolve$$24$$(null);
      ...
      var $data$$70$$ = this.$_getData$(), $pageSize$$ = this.options.pageSize;
      this.$_currentStartIndex$ = this.$_currentStartIndex$ ? this.$_currentStartIndex$ + $pageSize$$ : $pageSize$$;
      if (!this.$_isTotalSizeConfidenceActual$() || $data$$70$$.totalSize() > this.$_currentStartIndex$ && this.$_isTotalSizeConfidenceActual$()) {
        var $self$$62$$ = this;
        return new Promise(function($resolve$$25$$, $reject$$25$$) {
          $data$$70$$.fetch({startIndex:$self$$62$$.$_currentStartIndex$, pageSize:$pageSize$$}).then(function($result$$28$$) {
    ...
    }, $_isOperationOnCurrentPage$:function($event$$98$$) {
      var $data$$71$$ = this.$_getData$(), $pageSize$$1$$ = this.options.pageSize, $i$$134$$;
      for ($i$$134$$ = 0;$i$$134$$ < $event$$98$$.indexes.length;$i$$134$$++) {
        var $rowIdx$$ = $event$$98$$.indexes[$i$$134$$], $startIndex$$4$$ = $data$$71$$.getStartItemIndex(), $endIndex$$ = $startIndex$$4$$ + $pageSize$$1$$;
        this.options.mode == this.$_MODE$.$_LOAD_MORE$ && ($startIndex$$4$$ = 0);
        if ($rowIdx$$ >= $startIndex$$4$$ && $rowIdx$$ < $endIndex$$) {
          return!0;
        }
      }
      return!1;
    }, $_isTotalSizeConfidenceActual$:function() {
      var $data$$72$$ = this.$_getData$();
      return null != $data$$72$$ && "actual" == $data$$72$$.totalSizeConfidence() ? !0 : !1;
      ...
      this.$_pendingPageFetch$ = this.$_pendingPageFetch$.then(function() {
        ...
        if (0 == $self$$63$$.$_pageFetchCount$) {
          ...
          var $data$$73$$ = $self$$63$$.$_getData$();
          null != $data$$73$$ && $data$$73$$.setPage($self$$63$$.$_pageFetchLatestPage$, {pageSize:$self$$63$$.options.pageSize}).then(function() {
          }, function($error$$26$$) {
            $self$$63$$.$_pageFetchCount$--;
      ...
      var $pagingControlNavArrowSection$$1_pagingControlNavNext$$ = this.$_getPagingControlNavArrowSection$(), $navNextPageTip_pagingControlNavFirst_pagingControlNavLast_pagingControlNavPrevious$$ = $pagingControlNavArrowSection$$1_pagingControlNavNext$$.children("." + this.$_CSS_CLASSES$.$_PAGING_CONTROL_NAV_FIRST_CLASS$);
      ...
      $pagingControlNavArrowSection$$1_pagingControlNavNext$$.attr("title", $navNextPageTip_pagingControlNavFirst_pagingControlNavLast_pagingControlNavPrevious$$), this.$_getCurrentPage$() == this.$_getTotalPages$() - 1 && this.$_isTotalSizeConfidenceActual$() || 0 === this.$_getTotalPages$() || 0 > this.$_getTotalPages$() && 0 === $size$$16$$ ? ($pagingControlNavArrowSection$$1_pagingControlNavNext$$.addClass(this.$_MARKER_STYLE_CLASSES$.$_DISABLED$), $pagingControlNavArrowSection$$1_pagingControlNavNext$$.removeClass(this.$_MARKER_STYLE_CLASSES$.$_ENABLED$), 
      $pagingControlNavArrowSection$$1_pagingControlNavNext$$.attr(this.$_TAB_INDEX$, "-1")) : ($pagingControlNavArrowSection$$1_pagingControlNavNext$$.addClass(this.$_MARKER_STYLE_CLASSES$.$_ENABLED$), $pagingControlNavArrowSection$$1_pagingControlNavNext$$.removeClass(this.$_MARKER_STYLE_CLASSES$.$_DISABLED$), $pagingControlNavArrowSection$$1_pagingControlNavNext$$.attr(this.$_TAB_INDEX$, "0")));
      ...
      if (0 < this.$_getTotalPages$() && this.$_isTotalSizeConfidenceActual$()) {
        ...
        if (null != $pagingControlNavInput$$1_pagingControlNavMaxLabel$$ && 0 < $pagingControlNavInput$$1_pagingControlNavMaxLabel$$.length) {
          var $pagingControlNavInput$$1_pagingControlNavMaxLabel$$ = $$$$10$$($pagingControlNavInput$$1_pagingControlNavMaxLabel$$.get(0)), $navInputPageMaxLabel_pagingControlNavInputSection$$2$$ = this.$getTranslatedString$(this.$_BUNDLE_KEY$.$_LABEL_NAV_INPUT_PAGE_MAX$, {pageMax:$maxPageVal$$1_size$$19$$});
          $pagingControlNavInput$$1_pagingControlNavMaxLabel$$.text($navInputPageMaxLabel_pagingControlNavInputSection$$2$$);
        } else {
          $navInputPageMaxLabel_pagingControlNavInputSection$$2$$ = this.$_getPagingControlNavInputSection$(), null != $navInputPageMaxLabel_pagingControlNavInputSection$$2$$ && ($pagingControlNavInput$$1_pagingControlNavMaxLabel$$ = $$$$10$$(document.createElement("span")), $pagingControlNavInput$$1_pagingControlNavMaxLabel$$.addClass(this.$_CSS_CLASSES$.$_PAGING_CONTROL_NAV_INPUT_MAX_CLASS$), $navInputPageMaxLabel_pagingControlNavInputSection$$2$$.append($pagingControlNavInput$$1_pagingControlNavMaxLabel$$), 
      ...
      if (null != $data$$74$$) {
        ...
        var $i$$135$$, $ev$$;
        for ($i$$135$$ = 0;$i$$135$$ < this.$_dataSourceEventHandlers$.length;$i$$135$$++) {
          ($ev$$ = $data$$74$$.on(this.$_dataSourceEventHandlers$[$i$$135$$].eventType, this.$_dataSourceEventHandlers$[$i$$135$$].eventHandler)) && (this.$_dataSourceEventHandlers$[$i$$135$$].eventHandler = $ev$$);
        }
      }
    }, $_registerResizeListener$:function($element$$63$$) {
      if (!this.$_isResizeListenerAdded$) {
        var $self$$65$$ = this;
        $oj$$10$$.$DomUtils$.$addResizeListener$($element$$63$$[0], function() {
      ...
      if ($oj$$10$$.$DomUtils$.$isTouchSupported$() && this.options.mode == this.$_MODE$.$_PAGE$) {
        ...
        if (null != $pagingControlNavArrowSection$$2$$) {
          ...
          if ("vertical" == this.options.pageOptions.orientation) {
            ...
            this.$_hammerSwipeUp$ = $pagingControlNavArrowSection$$2$$.$ojHammer$($options$$218$$).on("swipeup", function($event$$99$$) {
              $event$$99$$.preventDefault();
              $self$$66$$.nextPage();
            });
            this.$_hammerSwipeDown$ = $pagingControlNavArrowSection$$2$$.$ojHammer$($options$$218$$).on("swipedown", function($event$$100$$) {
              $event$$100$$.preventDefault();
              $self$$66$$.previousPage();
            });
          } else {
            $options$$218$$ = {recognizers:[[$Hammer$$2$$.Swipe, {direction:$Hammer$$2$$.DIRECTION_HORIZONTAL}]]}, this.$_hammerSwipeLeft$ = $pagingControlNavArrowSection$$2$$.$ojHammer$($options$$218$$).on("swipeleft", function($event$$101$$) {
              $event$$101$$.preventDefault();
              $self$$66$$.nextPage();
            }), this.$_hammerSwipeRight$ = $pagingControlNavArrowSection$$2$$.$ojHammer$($options$$218$$).on("swiperight", function($event$$102$$) {
      ...
      if (null != this.$_dataSourceEventHandlers$ && null != $data$$75$$) {
        var $i$$136$$;
        for ($i$$136$$ = 0;$i$$136$$ < this.$_dataSourceEventHandlers$.length;$i$$136$$++) {
          $data$$75$$.off(this.$_dataSourceEventHandlers$[$i$$136$$].eventType, this.$_dataSourceEventHandlers$[$i$$136$$].eventHandler);
        }
      }
    ...
    }, $_createPagingControlNavPages$:function($pageNum$$3_parentDiv_totalPages$$, $numLinks_pageList$$, $errDetail$$1_i$$137_size$$22$$) {
      if (5 > $numLinks_pageList$$) {
        var $errSummary$$8_pagingControlNavPagesLinks$$ = this.$getTranslatedString$(this.$_BUNDLE_KEY$.$_ERR_MAXPAGELINKS_INVALID_SUMMARY$);
        $errDetail$$1_i$$137_size$$22$$ = this.$getTranslatedString$(this.$_BUNDLE_KEY$.$_ERR_MAXPAGELINKS_INVALID_DETAIL$);
        throw Error($errSummary$$8_pagingControlNavPagesLinks$$ + "\n" + $errDetail$$1_i$$137_size$$22$$);
      }
      $errSummary$$8_pagingControlNavPagesLinks$$ = $$$$10$$(document.createElement("div"));
      $errSummary$$8_pagingControlNavPagesLinks$$.addClass(this.$_CSS_CLASSES$.$_PAGING_CONTROL_NAV_PAGES_LINKS_CLASS$);
      $pageNum$$3_parentDiv_totalPages$$.append($errSummary$$8_pagingControlNavPagesLinks$$);
      $pageNum$$3_parentDiv_totalPages$$ = this.$_getTotalPages$();
      var $currentPage_pageAfterCurrent$$ = this.$_getCurrentPage$(), $numPagesToAdd$$ = $numLinks_pageList$$;
      $numLinks_pageList$$ = [];
      if (0 <= $currentPage_pageAfterCurrent$$) {
        if (this.$_isTotalSizeConfidenceActual$() && $pageNum$$3_parentDiv_totalPages$$ <= $numPagesToAdd$$) {
          for ($numLinks_pageList$$[0] = 0, $errDetail$$1_i$$137_size$$22$$ = 1;$errDetail$$1_i$$137_size$$22$$ < $pageNum$$3_parentDiv_totalPages$$;$errDetail$$1_i$$137_size$$22$$++) {
            $numLinks_pageList$$[$errDetail$$1_i$$137_size$$22$$] = $errDetail$$1_i$$137_size$$22$$;
          }
        } else {
          $numLinks_pageList$$.push(0);
          0 != $currentPage_pageAfterCurrent$$ && $numLinks_pageList$$.push($currentPage_pageAfterCurrent$$);
          $currentPage_pageAfterCurrent$$ != $pageNum$$3_parentDiv_totalPages$$ - 1 && this.$_isTotalSizeConfidenceActual$() && $numLinks_pageList$$.push($pageNum$$3_parentDiv_totalPages$$ - 1);
          var $numPagesToAdd$$ = $numPagesToAdd$$ - $numLinks_pageList$$.length, $pageBeforeCurrent$$ = $currentPage_pageAfterCurrent$$ - 1, $numPagesAfterCurrent$$ = 1;
          for (!this.$_isTotalSizeConfidenceActual$() || $currentPage_pageAfterCurrent$$ != $pageNum$$3_parentDiv_totalPages$$ - 1 && $currentPage_pageAfterCurrent$$ != $pageNum$$3_parentDiv_totalPages$$ - 2 || ($numPagesAfterCurrent$$ = 0);$numPagesToAdd$$ > $numPagesAfterCurrent$$ && 1 <= $pageBeforeCurrent$$;) {
            $numLinks_pageList$$.push($pageBeforeCurrent$$), $pageBeforeCurrent$$--, $numPagesToAdd$$--;
          }
          $currentPage_pageAfterCurrent$$ += 1;
          for (-1 == $pageNum$$3_parentDiv_totalPages$$ && ($numPagesToAdd$$ = 0 < $errDetail$$1_i$$137_size$$22$$ ? 1 : 0);0 < $numPagesToAdd$$ && ($currentPage_pageAfterCurrent$$ <= $pageNum$$3_parentDiv_totalPages$$ || -1 == $pageNum$$3_parentDiv_totalPages$$);) {
            $numLinks_pageList$$.push($currentPage_pageAfterCurrent$$), $currentPage_pageAfterCurrent$$++, $numPagesToAdd$$--;
          }
        }
        $numLinks_pageList$$.sort(function($a$$97$$, $b$$61$$) {
          return $a$$97$$ - $b$$61$$;
        });
        for ($errDetail$$1_i$$137_size$$22$$ = 0;$errDetail$$1_i$$137_size$$22$$ < $numLinks_pageList$$.length;$errDetail$$1_i$$137_size$$22$$++) {
          $pageNum$$3_parentDiv_totalPages$$ = $numLinks_pageList$$[$errDetail$$1_i$$137_size$$22$$], this.$_createPagingControlNavPage$($errSummary$$8_pagingControlNavPagesLinks$$, $pageNum$$3_parentDiv_totalPages$$), $errDetail$$1_i$$137_size$$22$$ != $numLinks_pageList$$.length - 1 && $pageNum$$3_parentDiv_totalPages$$ != $numLinks_pageList$$[$errDetail$$1_i$$137_size$$22$$ + 1] - 1 && this.$_createPagingControlNavPage$($errSummary$$8_pagingControlNavPagesLinks$$, -1);
        }
        this.$_isTotalSizeConfidenceActual$() || this.$_createPagingControlNavPage$($errSummary$$8_pagingControlNavPagesLinks$$, -1);
      }
      return $errSummary$$8_pagingControlNavPagesLinks$$;
