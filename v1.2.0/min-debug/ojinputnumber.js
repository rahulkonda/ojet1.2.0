...
define(["ojs/ojcore", "jquery", "ojs/ojeditablevalue", "ojs/ojbutton"], function($oj$$49$$, $$$$44$$) {
  $oj$$49$$.$__registerWidget$("oj.ojInputNumber", $$$$44$$.oj.editableValue, {version:"1.0.0", defaultElement:"\x3cinput\x3e", widgetEventPrefix:"oj", options:{converter:$oj$$49$$.$Validation$.$converterFactory$($oj$$49$$.$ConverterFactory$.CONVERTER_TYPE_NUMBER).createConverter(), max:null, min:null, placeholder:void 0, rawValue:void 0, readOnly:!1, step:1, value:null}, getNodeBySubId:function($locator$$49$$) {
    var $node$$99$$ = this._superApply(arguments), $subId$$52$$;
    $node$$99$$ || ($subId$$52$$ = $locator$$49$$.subId, "oj-inputnumber-up" === $subId$$52$$ && ($node$$99$$ = this.widget().find(".oj-inputnumber-up")[0]), "oj-inputnumber-down" === $subId$$52$$ && ($node$$99$$ = this.widget().find(".oj-inputnumber-down")[0]), "oj-inputnumber-input" === $subId$$52$$ && ($node$$99$$ = this.widget().find(".oj-inputnumber-input")[0]));
    return $node$$99$$ || null;
  }, getSubIdByNode:function($node$$100$$) {
    var $subId$$53$$ = null;
    null != $node$$100$$ && ($node$$100$$ === this.widget().find(".oj-inputnumber-up")[0] ? $subId$$53$$ = {subId:"oj-inputnumber-up"} : $node$$100$$ === this.widget().find(".oj-inputnumber-down")[0] ? $subId$$53$$ = {subId:"oj-inputnumber-down"} : $node$$100$$ === this.widget().find(".oj-inputnumber-input")[0] && ($subId$$53$$ = {subId:"oj-inputnumber-input"}));
    ...
    var $opts$$31$$ = this.options, $self$$154$$ = this;
    ...
    $oj$$49$$.$EditableValueUtils$.$initializeOptionsFromDom$([{$attribute$:"disabled", $validateOption$:!0}, {$attribute$:"placeholder"}, {$attribute$:"value"}, {$attribute$:"readonly", option:"readOnly", $validateOption$:!0}, {$attribute$:"required", $coerceDomValue$:!0, $validateOption$:!0}, {$attribute$:"title"}, {$attribute$:"min"}, {$attribute$:"max"}, {$attribute$:"step"}], $constructorOptions$$17$$, this, function($initializedOptions$$2$$) {
      for (var $toParse$$1$$ = ["value", "step", "min", "max"], $i$$365$$ = 0;$i$$365$$ < $toParse$$1$$.length;$i$$365$$++) {
        var $opt$$21$$ = $toParse$$1$$[$i$$365$$], $value$$270$$ = $opt$$21$$ in $initializedOptions$$2$$ ? $initializedOptions$$2$$[$opt$$21$$] : $opts$$31$$[$opt$$21$$];
        null != $value$$270$$ && ($initializedOptions$$2$$[$opt$$21$$] = "step" === $opt$$21$$ ? $self$$154$$.$_parseStep$($value$$270$$) : $self$$154$$.$_parse$($opt$$21$$, $value$$270$$));
      }
    });
    ...
    var $node$$101$$ = this.element;
    this._super();
    this.$_draw$();
    $node$$101$$.removeAttr("pattern");
  ...
  }, _setOption:function($key$$151$$, $value$$271$$, $flags$$42$$) {
    var $coercedValue$$2$$;
    $coercedValue$$2$$ = "value" === $key$$151$$ || "max" === $key$$151$$ || "min" === $key$$151$$ ? this.$_parse$($key$$151$$, $value$$271$$) : "step" === $key$$151$$ ? this.$_parseStep$($value$$271$$) : $value$$271$$;
    this._super($key$$151$$, $coercedValue$$2$$, $flags$$42$$);
    if ("max" === $key$$151$$ || "min" === $key$$151$$) {
      this.$_createRangeValidator$(), this.$_AfterSetOptionValidators$();
    }
    "disabled" === $key$$151$$ && this.element.prop("disabled", !!$value$$271$$);
    "readOnly" === $key$$151$$ && (this.element.prop("readonly", !!$value$$271$$), this.$_refreshStateTheming$("readOnly", this.options.readOnly), this.$_refreshRoleSpinbutton$("readOnly", this.options.readOnly));
  }, _destroy:function() {
    ...
    return $ret$$45$$;
  }, $_Refresh$:function($name$$117$$, $value$$272$$, $forceDisplayValueRefresh$$1$$) {
    this._superApply(arguments);
  ...
  }, $_events$:{input:function($event$$498$$) {
    this.$_SetRawValue$(this.element.val(), $event$$498$$);
  }, keydown:function($event$$499$$) {
    $event$$499$$.keyCode === $$$$44$$.ui.keyCode.ENTER ? (this.$_blurEnterSetValue$($event$$499$$), $event$$499$$.preventDefault()) : this.$_start$() && this.$_keydown$($event$$499$$) && $event$$499$$.preventDefault();
  }, keyup:function($event$$500$$) {
    this.$_stop$($event$$500$$);
  }, focus:function() {
    this.$previous$ = this.element.val();
  }, blur:function($event$$501$$) {
    this.$cancelBlur$ ? delete this.$cancelBlur$ : this.$_blurEnterSetValue$($event$$501$$);
  }, "mousedown .oj-inputnumber-button":function($event$$502$$) {
    ...
    this.$_start$();
    this.$_repeat$(null, $$$$44$$($event$$502$$.currentTarget).hasClass("oj-inputnumber-up") ? 1 : -1, $event$$502$$);
  }, "mouseup .oj-inputnumber-button":function($event$$503$$) {
    this.$_stop$($event$$503$$);
  }, "mouseenter .oj-inputnumber-button":function($event$$504$$) {
    $$$$44$$($event$$504$$.currentTarget).hasClass("oj-active") && (this.$_start$(), this.$_repeat$(null, $$$$44$$($event$$504$$.currentTarget).hasClass("oj-inputnumber-up") ? 1 : -1, $event$$504$$));
  }, "mouseleave .oj-inputnumber-button":function($event$$505$$) {
    this.$_stop$($event$$505$$);
    ...
    var $element$$134$$ = this.element, $uiInputNumber$$ = this.$uiInputNumber$ = $element$$134$$.addClass("oj-inputnumber-input").wrap("\x3cspan class\x3d'oj-inputnumber-wrapper'\x3e\x3c/span\x3e").parent().append("\x3cbutton type\x3d'button' class\x3d'oj-inputnumber-button oj-inputnumber-down'\x3e\x3c/button\x3e\x3cbutton type\x3d'button' class\x3d'oj-inputnumber-button oj-inputnumber-up'\x3e\x3c/button\x3e").wrap("\x3cdiv class\x3d'oj-inputnumber oj-component'\x3e\x3c/div\x3e").parent();
    this.saveType = $element$$134$$.prop("type");
    $element$$134$$.attr("type", "text");
    $uiInputNumber$$.find(".oj-inputnumber-button").attr("tabIndex", "-1").attr("aria-hidden", !0);
    this.$_createOjButton$();
  }, $_keydown$:function($event$$506$$) {
    var $keyCode$$19$$ = $$$$44$$.ui.keyCode;
    switch($event$$506$$.keyCode) {
      case $keyCode$$19$$.UP:
        return this.$_repeat$(null, 1, $event$$506$$), !0;
  ...
  }, $_repeat$:function($i$$366$$, $steps$$3$$, $event$$507$$) {
    $i$$366$$ = $i$$366$$ || 500;
    clearTimeout(this.$timer$);
    this.$timer$ = this._delay(function() {
      this.$_repeat$(40, $steps$$3$$, $event$$507$$);
    }, $i$$366$$);
    this.$_spin$($steps$$3$$ * this.options.step, $event$$507$$);
  }, $_spin$:function($step$$3$$, $event$$508$$) {
    var $value$$273$$ = this.$_getConvertedDisplayValue$(), $value$$273$$ = this.$_adjustValue$($value$$273$$, $step$$3$$);
    this.$_SetValue$($value$$273$$, $event$$508$$, this.$_VALIDATION_MODE$.$VALIDATORS_ONLY$);
  }, $_precision$:function() {
  ...
  }, $_adjustValue$:function($value$$274$$, $step$$4$$) {
    ...
    $aboveMin_newValue$$23$$ = $value$$274$$ - $stepBase$$;
    ...
    $rounded$$1$$ !== $aboveMin_newValue$$23$$ ? ($aboveMin_newValue$$23$$ = 0 > $step$$4$$ ? Math.ceil($aboveMin_newValue$$23$$ / $stepOpt$$) * $stepOpt$$ : Math.floor($aboveMin_newValue$$23$$ / $stepOpt$$) * $stepOpt$$, $aboveMin_newValue$$23$$ = $stepBase$$ + $aboveMin_newValue$$23$$ + $step$$4$$) : $aboveMin_newValue$$23$$ = $value$$274$$ + $step$$4$$;
    ...
    var $value$$275$$, $displayValue$$12$$;
    try {
      $displayValue$$12$$ = this.$_GetDisplayValue$() || 0, $value$$275$$ = this.$_parseValue$($displayValue$$12$$);
    } catch ($e$$96$$) {
      $value$$275$$ = void 0;
    }
    return $value$$275$$;
  }, $_blurEnterSetValue$:function($event$$510$$) {
    ...
    this.$_SetValue$($val$$61$$, $event$$510$$);
  ...
  }, $_refreshStateTheming$:function($option$$36$$, $value$$276$$) {
    -1 != Object.keys(this.$_OPTION_TO_CSS_MAPPING$).indexOf($option$$36$$) && this.widget().toggleClass(this.$_OPTION_TO_CSS_MAPPING$[$option$$36$$], !!$value$$276$$);
    ...
    var $element$$136$$ = this.element, $valuetext$$ = $element$$136$$.val();
    this.$_CompareOptionValues$("value", "" + $valuenow$$5$$, $valuetext$$) || $element$$136$$.attr({"aria-valuetext":$valuetext$$});
