...
define(["ojs/ojcore", "jquery", "ojs/ojeditablevalue", "jqueryui-amd/draggable", "ojs/ojtouchproxy"], function($oj$$45$$, $$$$41$$) {
  (function() {
    $oj$$45$$.$__registerWidget$("oj.ojSlider", $$$$41$$.oj.editableValue, {defaultElement:"\x3cinput\x3e", version:"1.0.1", widgetEventPrefix:"oj", options:{distance:0, max:100, min:0, orientation:"horizontal", readOnly:!1, disabled:!1, step:1, type:"fromMin", value:0, rawValue:void 0}, $_numPages$:5, $_sliderDisplayValue$:null, $_isRTL$:function() {
      ...
      var $id$$44_spanQuery$$ = this.element.prop("id");
      if (void 0 !== $id$$44_spanQuery$$) {
        var $jqLabelQuery$$ = $$$$41$$("label[for\x3d'" + $id$$44_spanQuery$$ + "']");
        if (0 < $jqLabelQuery$$.length) {
          return $jqLabelQuery$$;
        }
        $id$$44_spanQuery$$ = "span[for\x3d'" + $id$$44_spanQuery$$ + "']";
        if (0 !== $$$$41$$($id$$44_spanQuery$$).length) {
          return $$$$41$$($id$$44_spanQuery$$);
        }
      }
      return null;
      ...
      var $i$$354$$, $thumbCount$$, $thumb$$1$$ = "", $thumbClasses$$ = "class\x3d'oj-slider-thumb ui-state-default' tabindex\x3d'0' role\x3d'slider'" + ("aria-valuemin \x3d '" + this.$_valueMin$() + "' ") + ("aria-valuemax \x3d '" + this.$_valueMax$() + "' ") + "\x3e\x3c/span\x3e", $thumbs$$ = [];
      $thumbCount$$ = this.$_multipleThumbs$ ? this.options.value.length : 1;
      for ($i$$354$$ = 0;$i$$354$$ < $thumbCount$$;$i$$354$$++) {
        $thumb$$1$$ = "\x3cspan " + ("id\x3d'" + this.$_getThumbId$($i$$354$$) + "' ") + $thumbClasses$$, $thumbs$$.push($thumb$$1$$);
      }
      this.$_thumbs$ = $$$$41$$($thumbs$$.join("")).appendTo(this.$_sliderContainer$);
      this.$_thumb$ = this.$_thumbs$.eq(0);
      var $that$$11$$ = this;
      this.$_thumbs$.each(function($i$$355$$) {
        $$$$41$$(this).data("oj-slider-thumb-index", $i$$355$$);
      ...
      var $that$$12$$ = this;
      this.$_barback$.on("mousedown" + $that$$12$$.eventNamespace, function($event$$473$$) {
        $that$$12$$.$_repositionThumb$($event$$473$$);
        $that$$12$$.$_mouseStop$($event$$473$$);
      ...
      if ($options$$316$$.type) {
        ...
        this.$_range$.on("mousedown" + $that$$13$$.eventNamespace, function($event$$474$$) {
          $that$$13$$.$_repositionThumb$($event$$474$$);
          $that$$13$$.$_mouseStop$($event$$474$$);
    ...
    }, $_setupTouch$:function($e$$94$$) {
      this.$_touchProxy$ = $oj$$45$$.$_TouchProxy$.$addTouchListeners$($e$$94$$);
    }, $_tearDownTouch$:function($e$$95$$) {
      $oj$$45$$.$_TouchProxy$.$removeTouchListeners$($e$$95$$);
      ...
      this.$_unwrapSlider$();
      return this._super();
    }, $_repositionThumb$:function($event$$475$$) {
      ...
      $normValue$$ = this.$_getNormValueFromMouse$({x:$event$$475$$.pageX, y:$event$$475$$.pageY});
      $distance$$1$$ = this.$_valueMax$() - this.$_valueMin$() + 1;
      this.$_multipleThumbs$ && this.$_thumbs$.each(function($i$$358$$) {
        var $thisDistance$$ = Math.abs($normValue$$ - $that$$14$$.$_getMultiValues$($i$$358$$));
        if ($distance$$1$$ > $thisDistance$$ || $distance$$1$$ === $thisDistance$$ && ($i$$358$$ === $that$$14$$.$_lastChangedValueIndex$ || $that$$14$$.$_getMultiValues$($i$$358$$) === $o$$11$$.min)) {
          $distance$$1$$ = $thisDistance$$, this.$_closestThumb$ = $$$$41$$(this), $index$$210$$ = $i$$358$$;
        }
      });
      this.$_thumbIndex$ = $index$$210$$;
      if (this.$_closestThumb$) {
        return this.$_thumbs$.hasClass("ui-state-hover") || this.$_slide$($event$$475$$, $index$$210$$, $normValue$$), this.$_getActiveThumb$().addClass("oj-active").focus(), this.$_range$.addClass("oj-active"), !0;
      }
    }, $_initDragging$:function($event$$476$$, $thumb$$7$$) {
      ...
      return!0;
    }, $_mouseDragInternal$:function($event$$477$$, $thumb$$8$$) {
      var $normValue$$1_pct$$ = this.$_getNormValueFromThumb$($thumb$$8$$);
      this.$_slide$($event$$477$$, this.$_thumbIndex$, $normValue$$1_pct$$, !0);
      ...
      return!1;
    }, $_mouseStop$:function($event$$478$$, $thumb$$9$$) {
      this.$_thumbs$.removeClass("oj-active");
      this.$_range$.removeClass("oj-active");
      var $normValue$$2$$ = this.$_getNormValueFromThumb$($thumb$$9$$);
      this.$_slide$($event$$478$$, this.$_thumbIndex$, $normValue$$2$$);
      this.$_change$($event$$478$$, this.$_thumbIndex$, !1);
      this.$_thumbIndex$ = null;
      return!1;
    ...
    }, $_slide$:function($event$$479$$, $index$$213$$, $newVal$$1$$, $rawOnly$$) {
      var $otherVal$$1$$;
      this.$_multipleThumbs$ ? ($otherVal$$1$$ = this.$_getOtherThumbValue$($index$$213$$), $newVal$$1$$ = this.$_getNewThumbValueLimited$($index$$213$$, $newVal$$1$$, $otherVal$$1$$), $newVal$$1$$ !== this.$_getMultiValues$($index$$213$$) && this.$_setMultiValue$($event$$479$$, $index$$213$$, $newVal$$1$$, $rawOnly$$)) : $newVal$$1$$ !== this.$_getSingleValue$() && (this.$_setSingleValue$($event$$479$$, $newVal$$1$$, $rawOnly$$), $rawOnly$$ || this.$_inputtag$ && this.element.val($newVal$$1$$));
    }, $_setSingleValue$:function($event$$480$$, $newValue$$20$$, $rawOnly$$1$$) {
      this.$_newValue$ = this.$_trimAlignValue$($newValue$$20$$);
      $rawOnly$$1$$ || (this.$_SetValue$(this.$_newValue$, $event$$480$$), this.$_updateUI$());
      this.$_SetRawValue$(this.$_newValue$, $event$$480$$);
    }, $_change$:function($event$$481$$, $index$$214$$, $rawOnly$$2$$) {
      this.$_multipleThumbs$ ? (this.$_lastChangedValues$ = this.$_getNewValues$($index$$214$$, this.$_newMultiValue$[$index$$214$$]), this.$_SetRawValue$(this.$_lastChangedValues$, $event$$481$$), $rawOnly$$2$$ || this.$_SetValue$(this.$_lastChangedValues$, $event$$481$$)) : (this.$_SetRawValue$(this.$_newValue$, $event$$481$$), $rawOnly$$2$$ || this.$_SetValue$(this.$_newValue$, $event$$481$$));
      this.$_lastChangedValueIndex$ = $index$$214$$;
    }, $_getNewValues$:function($index$$215$$, $newValue$$21$$) {
      var $vals$$, $i$$359$$;
      $vals$$ = this.options.value.slice();
      for ($i$$359$$ = 0;$i$$359$$ < $vals$$.length;$i$$359$$ += 1) {
        $vals$$[$i$$359$$] = this.$_trimAlignValue$($vals$$[$i$$359$$]);
      }
    ...
    }, $_setMultiValue$:function($event$$482$$, $index$$217$$, $newValue$$22$$, $rawOnly$$3$$) {
      this.$_newMultiValue$[$index$$217$$] = this.$_trimAlignValue$($newValue$$22$$);
      this.$_change$($event$$482$$, $index$$217$$, $rawOnly$$3$$);
      $rawOnly$$3$$ || this.$_updateUI$();
    }, _setOption:function($key$$149$$, $coercedValue_value$$266$$, $flags$$39$$) {
      "value" === $key$$149$$ && (Array.isArray($coercedValue_value$$266$$) ? isNaN($coercedValue_value$$266$$[0]) ? (this.$_multipleThumbs$ = !1, this.$_parse$($key$$149$$, $coercedValue_value$$266$$[0])) : this.$_multipleThumbs$ = !0 : (this.$_multipleThumbs$ = !1, this.$_parse$($key$$149$$, $coercedValue_value$$266$$)));
      $coercedValue_value$$266$$ = "max" === $key$$149$$ || "min" === $key$$149$$ ? this.$_parse$($key$$149$$, $coercedValue_value$$266$$) : "step" === $key$$149$$ ? this.$_parseStep$($coercedValue_value$$266$$) : $coercedValue_value$$266$$;
      "disabled" != $key$$149$$ && this._super($key$$149$$, $coercedValue_value$$266$$, $flags$$39$$);
      "readOnly" === $key$$149$$ && (this.options.$readonly$ = $coercedValue_value$$266$$);
      "disabled" === $key$$149$$ && (this.options.disabled = $coercedValue_value$$266$$);
      switch($key$$149$$) {
        case "value":
          this.$_updateUI$();
          this.$_makeDraggable$();
      ...
      var $valPercent$$, $value$$267$$, $valueMin$$, $valueMax$$;
      this.$_multipleThumbs$ ? this.$_thumbs$.toArray().forEach(function($current$$22$$, $i$$361$$) {
        var $thumb$$12$$ = $$$$41$$($current$$22$$);
        $valPercent$$ = 100 * this.$_getThumbsValueFrac$($i$$361$$);
        ...
        $$$$41$$($thumb$$12$$).attr("aria-valuenow", this.$_getMultiValues$($i$$361$$));
        this.$_setRangeMultiThumb$($valPercent$$, $i$$361$$);
      }, this) : ($value$$267$$ = this.$_getValueAligned$(), $valueMin$$ = this.$_valueMin$(), $valueMax$$ = this.$_valueMax$(), $valPercent$$ = $valueMax$$ !== $valueMin$$ ? ($value$$267$$ - $valueMin$$) / ($valueMax$$ - $valueMin$$) * 100 : 0, this.$_isRTL$() && !this.$_isVertical$() && ($valPercent$$ = 100 - $valPercent$$), this.$_isVertical$() ? this.$_thumb$.css({top:100 - $valPercent$$ + "%"}) : this.$_thumb$.css({left:$valPercent$$ + "%"}), $$$$41$$(this.$_thumb$).attr("aria-valuenow", $value$$267$$), 
      ...
      var $id$$45_thumb1Pct$$ = this.$_range$.attr("id");
      if (0 == $index$$220$$) {
        switch($id$$45_thumb1Pct$$ = 100 * this.$_getThumbsValueFrac$(1), this.options.type) {
          case "fromMin":
            this.$_isVertical$() ? this.$_range$.css({height:$val$$57$$ + "%"}) : this.$_range$.css({width:$val$$57$$ + "%"});
            break;
          case "range":
            this.$_isVertical$() ? (this.$_range$.css({top:100 - $id$$45_thumb1Pct$$ + "%"}), this.$_range$.css({height:$id$$45_thumb1Pct$$ - $val$$57$$ + "%"})) : this.$_isRTL$() ? (this.$_range$.css({left:100 - $id$$45_thumb1Pct$$ + "%"}), this.$_range$.css({width:$id$$45_thumb1Pct$$ - (100 - $val$$57$$) + "%"})) : (this.$_range$.css({left:$val$$57$$ + "%"}), this.$_range$.css({width:$id$$45_thumb1Pct$$ - $val$$57$$ + "%"}));
        }
      } else {
        ...
        switch(this.options.type) {
          case "fromMax":
            ...
            break;
          case "range":
            this.$_isVertical$() ? document.getElementById($id$$45_thumb1Pct$$) && (this.$_range$.css({top:100 - $val$$57$$ + "%"}), this.$_range$.css({height:$val$$57$$ - $thumb0Pct$$ + "%"})) : this.$_isRTL$() ? document.getElementById($id$$45_thumb1Pct$$) && (this.$_range$.css({left:$val$$57$$ + "%"}), this.$_range$.css({width:-$val$$57$$ + 100 - $thumb0Pct$$ + "%"})) : document.getElementById($id$$45_thumb1Pct$$) && this.$_range$.css({width:$val$$57$$ - parseInt(document.getElementById($id$$45_thumb1Pct$$).style.left, 
            10) + "%"});
        }
      }
    }, $_thumbEvents$:{keydown:function($event$$483$$) {
      var $curVal_tempVal$$, $newVal$$2$$, $step$$2$$, $index$$221$$ = $$$$41$$($event$$483$$.target).data("oj-slider-thumb-index");
      this.$_thumbIndex$ = $index$$221$$;
      switch($event$$483$$.keyCode) {
        ...
        case $$$$41$$.ui.keyCode.LEFT:
          $event$$483$$.preventDefault(), $$$$41$$($event$$483$$.target).addClass("oj-active");
      }
      ...
      this.$_slide$($event$$483$$, $index$$221$$, $newVal$$2$$);
    }, keyup:function($event$$484$$) {
      var $index$$222$$ = $$$$41$$($event$$484$$.target).data("oj-slider-thumb-index");
      this.$_thumbIndex$ = $index$$222$$;
      this.$_change$($event$$484$$, $index$$222$$, !1);
      $$$$41$$($event$$484$$.target).removeClass("oj-active");
      this.$_thumbIndex$ = null;
    }}, $_InitOptions$:function($originalDefaults$$13$$, $constructorOptions$$15$$) {
      var $opts$$30$$ = this.options, $self$$153$$ = this;
      ...
      $oj$$45$$.$EditableValueUtils$.$initializeOptionsFromDom$([{$attribute$:"disabled", $validateOption$:!0}, {$attribute$:"value"}, {$attribute$:"title"}, {$attribute$:"min"}, {$attribute$:"max"}, {$attribute$:"step"}], $constructorOptions$$15$$, this, function($initializedOptions$$1$$) {
        for (var $toParse$$ = ["value", "step", "min", "max"], $i$$362$$ = 0;$i$$362$$ < $toParse$$.length;$i$$362$$++) {
          var $opt$$20$$ = $toParse$$[$i$$362$$], $value$$268$$ = $opt$$20$$ in $initializedOptions$$1$$ ? $initializedOptions$$1$$[$opt$$20$$] : $opts$$30$$[$opt$$20$$];
          null != $value$$268$$ && ("step" === $opt$$20$$ ? $initializedOptions$$1$$[$opt$$20$$] = $self$$153$$.$_parseStep$($value$$268$$) : "min" === $opt$$20$$ || "max" === $opt$$20$$ ? $initializedOptions$$1$$[$opt$$20$$] = $self$$153$$.$_parse$($opt$$20$$, $value$$268$$) : "value" === $opt$$20$$ && (Array.isArray($value$$268$$) ? $initializedOptions$$1$$[$opt$$20$$] = $value$$268$$ : $initializedOptions$$1$$[$opt$$20$$] = $self$$153$$.$_parse$($opt$$20$$, $value$$268$$)));
        }
      });
    ...
    }, getSubIdByNode:function($node$$96$$) {
      if (null != $node$$96$$) {
        if ($node$$96$$.id === this.$_getThumbId$(0) && $$$$41$$($node$$96$$).hasClass("oj-slider-thumb")) {
          return{subId:"oj-slider-thumb-0"};
        }
        if ($node$$96$$.id === this.$_getThumbId$(1) && $$$$41$$($node$$96$$).hasClass("oj-slider-thumb")) {
          return{subId:"oj-slider-thumb-1"};
        }
        if ($$$$41$$($node$$96$$).hasClass("oj-slider-bar")) {
          return{subId:"oj-slider-bar"};
        }
        if ($$$$41$$($node$$96$$).hasClass("oj-slider-bar-value")) {
      ...
      $thumbParam$$.draggable({axis:this.$_isVertical$() ? "y" : "x", grid:$g$$1$$, disabled:!1, start:function($event$$485$$) {
        $thumbParam$$[0] == $$$$41$$($that$$15$$.$_thumbs$)[0] ? $that$$15$$.$_thumbIndex$ = 0 : $thumbParam$$[0] == $$$$41$$($that$$15$$.$_thumbs$)[1] && ($that$$15$$.$_thumbIndex$ = 1);
        $that$$15$$.$_initDragging$($event$$485$$, $thumbParam$$);
      }, drag:function($event$$486$$, $ui$$34$$) {
        var $pos$$11$$ = $ui$$34$$.position;
        $that$$15$$.$_isVertical$() ? ($cachedStyle$$.left = "", $pos$$11$$.left = "") : ($cachedStyle$$.top = "", $pos$$11$$.top = "");
        $that$$15$$.$_mouseDragInternal$($event$$486$$, $thumbParam$$);
      ...
      }, stop:function($event$$487$$) {
        this.style.width = "";
        this.style.height = "";
        $that$$15$$.$_mouseStop$($event$$487$$, $thumbParam$$);
      }});
