 ...
 */
"use strict";
define(["ojs/ojcore", "jquery", "ojs/internal-deps/datagrid/DvtDataGrid", "ojs/ojcomponentcore", "ojs/ojdatasource-common", "ojs/ojarraydatagriddatasource", "ojs/ojflattenedtreedatagriddatasource", "ojs/ojpagingdatagriddatasource", "ojs/ojinputnumber", "ojs/ojmenu", "ojs/ojdialog", "ojs/ojpagingcontrol"], function($oj$$11$$, $$$$11$$, $DvtDataGrid$$1$$) {
  ...
  height:"disable"}, sortable:"auto", style:null}}, cell:{className:null, renderer:null, style:null}, resize:null, sort:null, optionChange:null, ready:null, scroll:null}, _ComponentCreate:function() {
    this._super();
    ...
    this.grid.addListener("ready", function() {
      $self$$68$$._trigger("ready", null, {});
    });
    this.grid.addListener("scroll", function($details$$6$$) {
      $self$$68$$._trigger("scroll", $details$$6$$.event, $details$$6$$.ui);
    });
    ...
    var $i$$138$$, $key$$51$$, $isRefresh$$1$$, $elm$$, $itm$$, $opt$$19$$;
    $isRefresh$$1$$ = !1;
    for ($key$$51$$ in $options$$221$$) {
      if ($key$$51$$ in this.$redrawSet$) {
        if ("data" === $key$$51$$) {
          $isRefresh$$1$$ = !0;
          break;
        } else {
          if ("header" == $key$$51$$) {
            for ($elm$$ in $options$$221$$.header) {
              if ("column" == $elm$$ || "row" == $elm$$ || "cell" == $elm$$) {
                for ($itm$$ in $options$$221$$.header[$elm$$]) {
                  for ($i$$138$$ = 0;$i$$138$$ < this.$redrawSet$.header.length;$i$$138$$++) {
                    if ($itm$$ == this.$redrawSet$.header[$i$$138$$]) {
            ...
            for ($opt$$19$$ in this.options) {
              if ($opt$$19$$ == $key$$51$$ && !$oj$$11$$.$Object$.$compareValues$($options$$221$$[$key$$51$$], this.options[$opt$$19$$])) {
                $isRefresh$$1$$ = !0;
                break;
              }
            }
    ...
    var $key$$52$$ = "label" + $command$$3$$.charAt(0).toUpperCase() + $command$$3$$.slice(1);
    "discontiguousSelection" === $command$$3$$ && ($key$$52$$ = "labelEnableNonContiguous");
    return $$$$11$$('\x3ca href\x3d"#"\x3e\x3c/a\x3e').text(this.$_getTranslation$($key$$52$$));
  }, $_getDataGridContextMenu$:function() {
    return $$$$11$$(this.options.contextMenu).get(0);
  }, $_getTranslation$:function($key$$53$$, $args$$18$$) {
    return this.$getTranslatedString$($key$$53$$, $args$$18$$);
  }, $_handleResizeDialog$:function() {
    var $value$$179$$ = $$$$11$$("#" + this.$rootId$ + "spinner").ojInputNumber("option", "value");
    $$$$11$$("#" + this.$rootId$ + "dialog").ojDialog("close");
    this.grid.handleContextMenuReturn(this.$contextMenuEvent$, this.$menuItemFunction$, $value$$179$$);
  ...
  }, $_handleContextMenuSelect$:function($event$$104$$, $ui$$3$$) {
    var $initialSize$$1_key$$54_parent$$9$$;
    ...
    ($initialSize$$1_key$$54_parent$$9$$ = $$$$11$$(this.$contextMenuEvent$.target).closest("." + this.$_getMappedStyle$("cell")), 0 == $initialSize$$1_key$$54_parent$$9$$.length && ($initialSize$$1_key$$54_parent$$9$$ = $$$$11$$(this.$contextMenuEvent$.target).closest("." + this.$_getMappedStyle$("headercell"))), 0 < $initialSize$$1_key$$54_parent$$9$$.length && ($initialSize$$1_key$$54_parent$$9$$ = this.$menuItemFunction$ === this.$_getMappedCommand$("resizeWidth") ? $initialSize$$1_key$$54_parent$$9$$.outerWidth() : 
    $initialSize$$1_key$$54_parent$$9$$.outerHeight(), this.$_buildResizeDialog$($ui$$3$$.item.text(), $initialSize$$1_key$$54_parent$$9$$))) : this.$menuItemFunction$ === this.$_getMappedCommand$("discontiguousSelection") && (this.$_discontiguousSelection$ = !this.$_discontiguousSelection$, this.grid.handleContextMenuReturn(this.$contextMenuEvent$, this.$menuItemFunction$, this.$_discontiguousSelection$), $initialSize$$1_key$$54_parent$$9$$ = this.$_discontiguousSelection$ ? "labelDisableNonContiguous" : 
    "labelEnableNonContiguous", $ui$$3$$.item.children().first().text(this.$_getTranslation$($initialSize$$1_key$$54_parent$$9$$)));
  }, $_NotifyContextMenuGesture$:function($menu$$4$$, $event$$105$$, $eventType$$31$$) {
    this.grid.handleContextMenuGesture($event$$105$$, $eventType$$31$$, this.$_contextMenuGestureCallback$.bind(this));
  }, $_contextMenuGestureCallback$:function($capabilities_returnVal$$1$$, $event$$106$$, $eventType$$32$$) {
    var $launcher$$7_openOptions$$2$$;
    null != $capabilities_returnVal$$1$$ && (this.$contextMenuEvent$ = $event$$106$$.originalEvent, $launcher$$7_openOptions$$2$$ = $capabilities_returnVal$$1$$.launcher, $capabilities_returnVal$$1$$ = $capabilities_returnVal$$1$$.capabilities, this.$_manageContextMenu$($capabilities_returnVal$$1$$), $launcher$$7_openOptions$$2$$ = "keyboard" === $eventType$$32$$ ? {position:{of:$launcher$$7_openOptions$$2$$}, launcher:$$$$11$$($launcher$$7_openOptions$$2$$)} : {launcher:$$$$11$$($launcher$$7_openOptions$$2$$)}, 
    this.$_OpenContextMenu$($event$$106$$, $eventType$$32$$, $launcher$$7_openOptions$$2$$));
  ...
  }, $_findCellIndex$:function($columnIndex_element$$64$$) {
    var $row$$2$$;
    $row$$2$$ = $columnIndex_element$$64$$.parent();
    $columnIndex_element$$64$$ = $columnIndex_element$$64$$.index();
    return{rowIndex:$row$$2$$.index(), columnIndex:$columnIndex_element$$64$$};
  ...
  }, $_modifyContext$:function($context$$49$$) {
    $context$$49$$.component = $oj$$11$$.Components.$getWidgetConstructor$(this.element, "ojDataGrid");
  }, $_setAccessibleContext$:function($context$$50$$) {
    this.grid.SetAccessibleContext($context$$50$$);
  }, $_unregisterResizeListener$:function($element$$65$$) {
    $element$$65$$ && this.$_resizeHandler$ && $oj$$11$$.$DomUtils$.$removeResizeListener$($element$$65$$, this.$_resizeHandler$);
  }, $_registerResizeListener$:function($element$$66$$) {
    $element$$66$$ && (null == this.$_resizeHandler$ && (this.$_resizeHandler$ = this.$_handleResize$.bind(this)), $oj$$11$$.$DomUtils$.$addResizeListener$($element$$66$$, this.$_resizeHandler$));
  ...
  }, getSubIdByNode:function($indexes_node$$31_subId$$7$$) {
    var $cell_index$$99$$, $header$$5_level$$10$$, $axis$$3$$;
    $cell_index$$99$$ = $$$$11$$($indexes_node$$31_subId$$7$$).closest("." + this.$_getMappedStyle$("cell"));
    if (0 < $cell_index$$99$$.length) {
      return $indexes_node$$31_subId$$7$$ = this.$_findCellIndex$($cell_index$$99$$), {subId:"oj-datagrid-cell", rowIndex:$indexes_node$$31_subId$$7$$.rowIndex + this.grid.getStartRow(), columnIndex:$indexes_node$$31_subId$$7$$.columnIndex + this.grid.getStartColumn()};
    }
    $header$$5_level$$10$$ = $$$$11$$($indexes_node$$31_subId$$7$$).closest("." + this.$_getMappedStyle$("headercell"));
    return 0 < $header$$5_level$$10$$.length ? ($axis$$3$$ = $header$$5_level$$10$$.hasClass(this.$_getMappedStyle$("colheadercell")) ? "column" : "row", $cell_index$$99$$ = this.$_getHeaderIndex$($header$$5_level$$10$$), $header$$5_level$$10$$ = this.$_getHeaderLevel$($header$$5_level$$10$$), $indexes_node$$31_subId$$7$$ = $$$$11$$($indexes_node$$31_subId$$7$$).hasClass(this.$_getMappedStyle$("sortascending")) ? "oj-datagrid-sort-ascending" : $$$$11$$($indexes_node$$31_subId$$7$$).hasClass(this.$_getMappedStyle$("sortdescending")) ? 
    "oj-datagrid-sort-descending" : "oj-datagrid-header", {subId:$indexes_node$$31_subId$$7$$, index:$cell_index$$99$$, axis:$axis$$3$$, level:$header$$5_level$$10$$}) : null;
  }, $_getMappedStyle$:function($key$$55$$) {
    return this.$resources$.$getMappedStyle$($key$$55$$);
  }, $_getMappedAttribute$:function($key$$56$$) {
    return this.$resources$.$getMappedAttribute$($key$$56$$);
  }, $_getMappedCommand$:function($key$$57$$) {
    return this.$resources$.$getMappedCommand$($key$$57$$);
  ...
  }, $_getHeaderByIndex$:function($index$$100_relativeIndex$$, $level$$11$$, $grouping_headerContainer$$, $start$$27$$) {
    if (0 > $level$$11$$) {
      return null;
    }
    ...
    $grouping_headerContainer$$ = this.$_getGroupingContainer$($index$$100_relativeIndex$$, $level$$11$$, 0, $grouping_headerContainer$$.children().first().children());
    if (null == $grouping_headerContainer$$) {
      return null;
    }
    if ($level$$11$$ <= parseInt($grouping_headerContainer$$.attr(this.$_getMappedAttribute$("level")), 10) + parseInt($grouping_headerContainer$$.children().eq(0).attr(this.$_getMappedAttribute$("depth")), 10) - 1) {
  ...
  }, $_getGroupingContainer$:function($index$$101$$, $level$$12$$, $currentLevel$$1$$, $headers$$2$$) {
    var $headerIndex_headerRoot$$, $headerExtent$$, $i$$139$$, $headerDepth$$;
    ...
    for ($i$$139$$ = $headerIndex_headerRoot$$.hasClass(this.$_getMappedStyle$("colheader")) || $headerIndex_headerRoot$$.hasClass(this.$_getMappedStyle$("rowheader")) ? 0 : 1;$i$$139$$ < $headers$$2$$.length;$i$$139$$++) {
      if ($headerIndex_headerRoot$$ = parseInt($headers$$2$$.eq($i$$139$$).attr(this.$_getMappedAttribute$("start")), 10), $headerExtent$$ = parseInt($headers$$2$$.eq($i$$139$$).attr(this.$_getMappedAttribute$("extent")), 10), $headerDepth$$ = parseInt($headers$$2$$.eq($i$$139$$).children().eq(0).attr(this.$_getMappedAttribute$("depth")), 10), $index$$101$$ >= $headerIndex_headerRoot$$ && $index$$101$$ < $headerIndex_headerRoot$$ + $headerExtent$$) {
        return $level$$12$$ < $currentLevel$$1$$ + $headerDepth$$ ? $headers$$2$$.eq($i$$139$$) : this.$_getGroupingContainer$($index$$101$$, $level$$12$$, $currentLevel$$1$$ + $headerDepth$$, $headers$$2$$.eq($i$$139$$).children());
      }
    }
    return null;
    ...
    if ($header$$6$$.parent().hasClass(this.$_getMappedStyle$("groupingcontainer"))) {
      $index$$102$$ = parseInt($header$$6$$.parent().attr(this.$_getMappedAttribute$("start")), 10);
      if ($header$$6$$.get(0) === $header$$6$$.parent().children(":first").get(0)) {
        return $index$$102$$;
      }
      $index$$102$$--;
    } else {
      $index$$102$$ = $header$$6$$.hasClass(this.$_getMappedStyle$("rowheadercell")) ? this.grid.getStartRowHeader() : this.grid.getStartColumnHeader();
    }
    return $index$$102$$ += $header$$6$$.index();
  ...
  }, $_remove$:function($element$$67$$) {
    $$$$11$$($element$$67$$).remove();
