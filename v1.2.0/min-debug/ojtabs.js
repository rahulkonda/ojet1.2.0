...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojconveyorbelt", "ojs/ojmenu", "jqueryui-amd/sortable", "ojs/ojtouchproxy"], function($oj$$53$$, $$$$48$$) {
  (function() {
    ...
    $oj$$53$$.$__registerWidget$("oj.ojTabs", $$$$48$$.oj.baseComponent, {widgetEventPrefix:"oj", delay:300, options:{selected:0, disabledTabs:null, truncation:"auto", selectOn:"click", orientation:"horizontal", edge:"top", removable:!1, reorderable:!1, beforeSelect:null, select:null, beforeDeselect:null, deselect:null, beforeRemove:null, remove:null, beforeReorder:null, reorder:null, optionChange:null}, _ComponentCreate:function() {
    ...
    }, $_NotifyContextMenuGesture$:function($menu$$15_openOptions$$5$$, $event$$513$$, $eventType$$45$$) {
      if (this.$_isInATab$($event$$513$$.target) && (!this.$_touchProxy$ || !this.$_touchProxy$.$_touchMoved$)) {
        var $disabledState_keyboard$$ = "keyboard" === $eventType$$45$$;
        if ("contextmenu" == $event$$513$$.type || $disabledState_keyboard$$ || "touch" == $eventType$$45$$) {
          var $tab$$ = $$$$48$$($event$$513$$.target).closest("li");
          ...
          if (this.$_menu$.tab) {
            ...
            this.$_OpenContextMenu$($event$$513$$, $eventType$$45$$, $menu$$15_openOptions$$5$$);
          } else {
            $event$$513$$.preventDefault();
          }
        }
      }
    }, $_tabKeydown$:function($event$$514$$) {
      if (!this.$_handlePageNav$($event$$514$$)) {
        ...
        switch($event$$514$$.keyCode) {
          ...
          case $$$$48$$.ui.keyCode.HOME:
            ...
            break;
          case 46:
            this.options.removable && ($anchor$$2_focusedTab$$ = this.$_getCloseIcons$(this.$active$)) && ($event$$514$$.preventDefault(), this.$_removeTabHandler$({target:$anchor$$2_focusedTab$$, currentTarget:$anchor$$2_focusedTab$$, preventDefault:$$$$48$$.noop}, $event$$514$$));
            return;
          default:
            return;
        }
        $event$$514$$.preventDefault();
        clearTimeout(this.$activating$);
        var $selTab$$ = $$$$48$$($enabledTabs$$[$selectedIndex$$4$$]);
        $selTab$$.focus();
        if (!$event$$514$$.ctrlKey) {
          $anchor$$2_focusedTab$$.attr("aria-selected", "false");
          $selTab$$.attr("aria-selected", "true");
          this.$_getTabIdOrIndex$($selTab$$);
          var $self$$158$$ = this;
          this.$activating$ = this._delay(function() {
            $self$$158$$ && $self$$158$$.$tabs$ && $self$$158$$.$_activate$($selTab$$, $event$$514$$);
          }, this.delay);
        }
      }
    }, $_panelKeydown$:function($event$$515$$) {
      $$$$48$$($event$$515$$.target).closest(".oj-tabs-selected").attr("id") === this.element.children(".oj-tabs-selected").attr("id") && !this.$_handlePageNav$($event$$515$$) && $event$$515$$.ctrlKey && $event$$515$$.keyCode === $$$$48$$.ui.keyCode.UP && ($event$$515$$.preventDefault(), this.$active$.focus());
    }, $_handlePageNav$:function($event$$516$$) {
      var $selectedIndex$$5$$ = this.$_getSelectedIndex$();
      if ($event$$516$$.ctrlKey && $event$$516$$.keyCode === $$$$48$$.ui.keyCode.PAGE_UP) {
        return this.$_activate$(this.$_focusNextTab$($selectedIndex$$5$$, !1)), !0;
      }
      if ($event$$516$$.ctrlKey && $event$$516$$.keyCode === $$$$48$$.ui.keyCode.PAGE_DOWN) {
    ...
    }, _setOption:function($edge$$13_key$$153_selectedIndex$$6$$, $value$$278$$, $flags$$44$$) {
      "selected" === $edge$$13_key$$153_selectedIndex$$6$$ ? ($value$$278$$ = this.$_getTab$($value$$278$$), void 0 !== $value$$278$$ && this.$_activate$($value$$278$$)) : "disabledTabs" === $edge$$13_key$$153_selectedIndex$$6$$ ? Array.isArray($value$$278$$) && (this.$_setOjDisabledOnTab$($value$$278$$), $edge$$13_key$$153_selectedIndex$$6$$ = this.$_getSelectedIndex$(), this.$_isTabDisabled$($edge$$13_key$$153_selectedIndex$$6$$) && this.$_fireSelectEvents$($edge$$13_key$$153_selectedIndex$$6$$), 
      this.refresh()) : "removable" === $edge$$13_key$$153_selectedIndex$$6$$ || "truncation" === $edge$$13_key$$153_selectedIndex$$6$$ ? $value$$278$$ != this.options[$edge$$13_key$$153_selectedIndex$$6$$] && (this._super($edge$$13_key$$153_selectedIndex$$6$$, $value$$278$$, $flags$$44$$), this.refresh()) : "reorderable" === $edge$$13_key$$153_selectedIndex$$6$$ ? $value$$278$$ !== this.options.reorderable && (this._super($edge$$13_key$$153_selectedIndex$$6$$, $value$$278$$, $flags$$44$$), this.refresh()) : 
      "orientation" === $edge$$13_key$$153_selectedIndex$$6$$ ? this.$_edgeSpecified$ || ($edge$$13_key$$153_selectedIndex$$6$$ = this.$_orientationToEdge$($value$$278$$)) && this.$_setupEdge$($edge$$13_key$$153_selectedIndex$$6$$) && this.refresh() : "edge" === $edge$$13_key$$153_selectedIndex$$6$$ ? this.$_setupEdge$($value$$278$$) && (this.$_edgeSpecified$ = !0, this._super($edge$$13_key$$153_selectedIndex$$6$$, $value$$278$$, $flags$$44$$), this.refresh()) : "selectOn" === $edge$$13_key$$153_selectedIndex$$6$$ ? 
      (this.$_tearDownEvents$(!0), this._super($edge$$13_key$$153_selectedIndex$$6$$, $value$$278$$, $flags$$44$$), this.$_setupEvents$()) : ("contextMenu" === $edge$$13_key$$153_selectedIndex$$6$$ && (this.$_clearMenu$(), $value$$278$$ && this.$_initMenu$($value$$278$$)), this._super($edge$$13_key$$153_selectedIndex$$6$$, $value$$278$$, $flags$$44$$), "translations" === $edge$$13_key$$153_selectedIndex$$6$$ && $flags$$44$$ && "removeCueText" === $flags$$44$$.subkey && this.$tablist$ && this.$_getCloseIcons$(this.$tablist$).attr("aria-label", 
      $value$$278$$ ? $value$$278$$.removeCueText : ""));
    }, refresh:function() {
      this._super();
      this.$_processTabs$();
      this.$_refresh$();
      ...
      var $self$$159$$ = this, $edge$$14$$ = this.options.edge;
      this.$_destroyTabBar$();
      this.$_createTabbar$();
      ...
      this.$tablist$.children("li").each(function() {
        ...
        $self$$159$$.$tabs$ = $self$$159$$.$tabs$.add($tab$$1$$);
        var $anchor$$3_anchorId_div$$3$$ = $anchor$$3_anchorId_div$$3$$.uniqueId().attr("id"), $panelId$$ = $tab$$1$$.attr("data-content"), $panel$$2$$ = $self$$159$$.element.find($self$$159$$.$_sanitizeSelector$("#" + $panelId$$));
        $tab$$1$$.attr({"aria-controls":$panelId$$, "aria-labelledby":$anchor$$3_anchorId_div$$3$$});
        $self$$159$$.$panels$ = $self$$159$$.$panels$.add($panel$$2$$);
        $panel$$2$$.attr("aria-labelledby", $anchor$$3_anchorId_div$$3$$).attr("role", "tabpanel");
      });
      "start" != $edge$$14$$ && "end" != $edge$$14$$ || $self$$159$$.$tablist$.addClass("oj-tabs-nav-root");
      this.$_initialRender$ && this.$_setOjDisabledOnTab$(this.options.disabledTabs);
    }, $_setupEvents$:function() {
      var $events$$13$$ = {keydown:this.$_tabKeydown$}, $enabledTabs$$2_event$$517$$ = this.options.selectOn, $selectOnClick$$ = !1;
      if ($enabledTabs$$2_event$$517$$) {
        var $self$$160$$ = this;
        $$$$48$$.each($enabledTabs$$2_event$$517$$.split(" "), function($index$$228$$, $eventName$$2$$) {
          "click" == $eventName$$2$$ && ($selectOnClick$$ = !0);
          $oj$$53$$.$DomUtils$.$isValidIdentifier$($eventName$$2$$) && ($events$$13$$[$eventName$$2$$] = $self$$160$$.$_eventHandler$);
        });
      }
      $enabledTabs$$2_event$$517$$ = this.$_getEnabledTabs$();
      this._on($enabledTabs$$2_event$$517$$, $events$$13$$);
      $selectOnClick$$ || this._on($enabledTabs$$2_event$$517$$, {click:function($e$$97$$) {
        $e$$97$$.preventDefault();
      }});
      this.$panels$.on("keydown" + this.eventNamespace, this.$_panelKeydown$.bind(this));
      if (this.options.removable) {
        var $revents$$ = {click:this.$_removeTabHandler$};
        this._on(this.$_getCloseIcons$($enabledTabs$$2_event$$517$$), $revents$$);
      }
      this._focusable($enabledTabs$$2_event$$517$$);
      this._hoverable($enabledTabs$$2_event$$517$$);
      this.$_activeable$($enabledTabs$$2_event$$517$$);
    ...
    }, $_toggle$:function($event$$519$$, $eventData$$12$$) {
      ...
      this.$running$ = !1;
      this.$_initialRender$ || (this._trigger("deselect", $event$$519$$, $eventData$$12$$), this._trigger("select", $event$$519$$, $eventData$$12$$));
    ...
    }, $_getCloseIcons$:function($elem$$74$$) {
      return $elem$$74$$.find(".oj-tabs-close-icon");
      ...
      var $self$$162$$ = this, $tab$$3$$, $div$$5$$, $anchor$$5$$, $header$$12$$;
      this.$tabs$.each(function($index$$230$$) {
        ...
        $header$$12$$ = $anchor$$5$$.children();
        $header$$12$$.removeClass("oj-tabs-title").removeAttr("aria-hidden");
        $self$$162$$.$_isOldMarkup$ ? $header$$12$$.prependTo($self$$162$$.$panels$.get($index$$230$$)) : $div$$5$$.hasClass("oj-tabs-gen-div") && $anchor$$5$$.hasClass("oj-tabs-gen-a") ? ($header$$12$$.prependTo($tab$$3$$), $div$$5$$.remove()) : $anchor$$5$$.hasClass("oj-tabs-gen-a") ? ($header$$12$$.prependTo($div$$5$$), $anchor$$5$$.remove()) : $div$$5$$.hasClass("oj-tabs-gen-div") && ($anchor$$5$$.prependTo($tab$$3$$), $div$$5$$.remove());
      });
    ...
    }, $_removeTabHandler$:function($event$$520$$, $flags$$47$$) {
      var $tab$$4$$ = $$$$48$$($event$$520$$.currentTarget).closest("li"), $panel$$4$$ = this.$_getPanelForTab$($tab$$4$$), $eventData$$13$$ = {tab:$tab$$4$$, content:$panel$$4$$}, $oEvent$$1$$ = $flags$$47$$ ? $flags$$47$$ : $event$$520$$;
      if ($tab$$4$$ && !1 !== this._trigger("beforeRemove", $oEvent$$1$$, $eventData$$13$$)) {
        $event$$520$$.preventDefault();
      ...
      if ("li" == $header$$13$$.prop("tagName").toLowerCase()) {
        ...
        $tab$$5$$ = $header$$13$$.wrap("\x3cli\x3e\x3cdiv\x3e\x3ca href\x3d'#'\x3e\x3c/a\x3e\x3c/div\x3e\x3c/li\x3e").parent().parent().parent(), $tab$$5$$.addClass("oj-tabs-gen-li"), $tab$$5$$.children().addClass("oj-tabs-gen-div oj-tabs-tab-content");
      }
      ...
      window.setTimeout(function() {
        $self$$163$$.$tabs$ && $tab$$6$$[0].scrollIntoView(!1);
      }, 0);
      ...
      if (this.options.reorderable) {
        ...
        this.$tablist$.sortable({axis:$self$$164$$.$_isHorizontal$() ? "x" : "y", stop:function($event$$521$$, $ui$$39$$) {
          var $mvTab$$ = $ui$$39$$.item;
          $self$$164$$.$_doReorder$($event$$521$$, $mvTab$$, $mvTab$$.prev()) || $self$$164$$.$tablist$.sortable("cancel");
        }});
        this.$_sortable$ = !0;
      } else {
    ...
    }, $_orientationToEdge$:function($value$$279$$) {
      return "horizontal" == $value$$279$$ ? "top" : "vertical" == $value$$279$$ ? "start" : null;
      ...
      return $ulParent$$;
    }, $_addPrefixId$:function($elem$$75$$) {
      0 > $elem$$75$$.id.indexOf("ojtabs-id_") && $$$$48$$($elem$$75$$).attr("id", "ojtabs-id_" + $elem$$75$$.id);
      ...
      for (var $panels_title$$11$$ = [], $i$$368_tabIndex$$5$$ = 0;$i$$368_tabIndex$$5$$ < this.$tabs$.length;$i$$368_tabIndex$$5$$++) {
        $panels_title$$11$$.push(this.$_getPanelForTab$(this.$tabs$[$i$$368_tabIndex$$5$$])[0]);
      }
      for (var $closeIcon_panelIndex$$ = $i$$368_tabIndex$$5$$ = -1, $currentNode$$2$$ = $node$$105$$;$currentNode$$2$$;) {
        if (this.$conveyor$ && $currentNode$$2$$ === this.$conveyor$[0]) {
          return{subId:"oj-conveyorbelt"};
        }
        $i$$368_tabIndex$$5$$ = Array.prototype.indexOf.call(this.$tabs$, $currentNode$$2$$);
        if (-1 != $i$$368_tabIndex$$5$$) {
          break;
        }
      ...
      if (-1 != $i$$368_tabIndex$$5$$) {
        for ($panels_title$$11$$ = this.getNodeBySubId({subId:"oj-tabs-title", index:$i$$368_tabIndex$$5$$}), $closeIcon_panelIndex$$ = this.getNodeBySubId({subId:"oj-tabs-close", index:$i$$368_tabIndex$$5$$}), $currentNode$$2$$ = $node$$105$$;$currentNode$$2$$;) {
          if ($currentNode$$2$$ === $panels_title$$11$$) {
            return{subId:"oj-tabs-title", index:$i$$368_tabIndex$$5$$};
          }
          if ($currentNode$$2$$ === $closeIcon_panelIndex$$) {
            return{subId:"oj-tabs-close", index:$i$$368_tabIndex$$5$$};
          }
          if ($currentNode$$2$$ === this.$tabs$[$i$$368_tabIndex$$5$$]) {
            return{subId:"oj-tabs-tab", index:$i$$368_tabIndex$$5$$};
          }
          $currentNode$$2$$ = $currentNode$$2$$.parentElement;
        }
      }
    ...
    }, $_menu_paste$:function($event$$522$$, $obj$$56$$, $pasteBefore$$) {
      if (!$obj$$56$$ || !$obj$$56$$.length || !this.$_menu$.$cutTab$) {
        return!1;
      }
      var $mvTab$$1$$ = this.$_menu$.$cutTab$;
      this.$_menu$.$cutTab$ = !1;
      this.$_doReorder$($event$$522$$, $mvTab$$1$$, $obj$$56$$, $pasteBefore$$);
    }, $_menu_remove$:function($event$$523$$, $obj$$57$$) {
      if (!$obj$$57$$ || !$obj$$57$$.length) {
        return!1;
      }
      var $anchor$$7$$ = this.$_getCloseIcons$($obj$$57$$);
      this.$_removeTabHandler$({target:$anchor$$7$$, currentTarget:$anchor$$7$$, preventDefault:$$$$48$$.noop}, $event$$523$$);
    }, $_handleContextMenuSelect$:function($ev$$3$$, $ui$$40$$) {
      var $id$$48$$ = $ui$$40$$ ? $ui$$40$$.item.attr("id") : void 0;
      "ojtabscut" === $id$$48$$ ? this.$_menu_cut$(this.$_menu$.tab) : "ojtabspastebefore" === $id$$48$$ ? this.$_menu_paste$($ev$$3$$, this.$_menu$.tab, !0) : "ojtabspasteafter" === $id$$48$$ ? this.$_menu_paste$($ev$$3$$, this.$_menu$.tab, !1) : "ojtabsremove" === $id$$48$$ && this.$_menu_remove$($ev$$3$$, this.$_menu$.tab);
      ...
      if ($$menuContainer$$ || this.options.reorderable || this.options.removable) {
        ...
        if (0 == $$menuContainer$$.length) {
          var $key$$154$$ = this.options.reorderable ? "labelReorder" : $_arMenuKeyMap$$.remove, $menuId$$ = this.element.uniqueId().attr("id") + "contextmenu", $$menuContainer$$ = $$$$48$$("\x3cul\x3e");
          $$menuContainer$$.css("display", "none").attr("id", $menuId$$).attr("aria-label", this.$getTranslatedString$($key$$154$$));
        ...
        $$menuContainer$$.find("[data-oj-command]").each(function() {
          if (0 === $$$$48$$(this).children("a").length) {
            ...
            $$$$48$$(this).replaceWith($self$$165$$.$_buildContextMenuItem$($command$$13$$));
    ...
    }, $_doReorder$:function($event$$524$$, $mvTab$$2$$, $prevTab$$, $pasteBefore$$1$$) {
      var $mvContent$$ = this.$_getPanelForTab$($mvTab$$2$$), $eventData$$14$$ = {tab:$mvTab$$2$$, content:$mvContent$$};
      if (!1 === this._trigger("beforeReorder", $event$$524$$, $eventData$$14$$)) {
        return!1;
      }
      ...
      this.refresh();
      $mvTab$$2$$.focus();
      this._trigger("reorder", $event$$524$$, $eventData$$14$$);
      return!0;
      ...
      var $id$$49$$ = $panel$$5$$.attr("id");
      $id$$49$$ || ($id$$49$$ = $panel$$5$$.uniqueId().attr("id"), $panel$$5$$.addClass("oj-tabs-gen-id"));
      return $id$$49$$;
      ...
      if ($tab$$8$$) {
        var $id$$50$$ = $tab$$8$$.attr("id");
        return $id$$50$$ ? $id$$50$$ : this.$tabs$.index($tab$$8$$);
      }
      ...
      if ($disTabs$$ && 0 < $disTabs$$.length) {
        for (var $id$$51$$, $tab$$9$$, $i$$369$$ = 0;$i$$369$$ < $disTabs$$.length;$i$$369$$++) {
          if ($tab$$9$$ = this.$_getTab$($disTabs$$[$i$$369$$])) {
            $tab$$9$$.addClass("oj-disabled"), $tab$$9$$.attr("aria-disabled", "true"), $tab$$9$$.find(".oj-tabs-anchor").removeAttr("href"), $id$$51$$ = $tab$$9$$.attr("id"), $arr$$23$$.push($id$$51$$ ? $id$$51$$ : $children$$12$$.index($tab$$9$$));
          }
        }
      }
      ...
      if (!$arr$$24$$) {
        ...
        this.$tablist$.children().each(function() {
          var $tab$$10$$ = $$$$48$$(this);
          $tab$$10$$.hasClass("oj-disabled") && $arr$$24$$.push($self$$166$$.$_getTabIdOrIndex$($tab$$10$$));
        });
      }
    ...
    }, $_isInATab$:function($element$$138$$) {
      var $found$$8$$ = !1;
      this.$tabs$.each(function() {
        if (this === $element$$138$$ || $$$$48$$.contains(this, $element$$138$$)) {
          return $found$$8$$ = !0, !1;
        }
      });
      return $found$$8$$;
    }, $_createTabbar$:function() {
      var $contentIds$$ = this.$_getContentIds$(), $self$$167$$ = this, $tabbar$$5$$ = this.element.children("ul");
      0 < $tabbar$$5$$.length && $tabbar$$5$$.children("li").each(function($index$$239$$) {
        $self$$167$$.$_wrapLi$($$$$48$$(this), $contentIds$$[$index$$239$$]);
      });
    }, $_createTabbarFromOldMarkup$:function() {
      var $tabbar$$6$$ = this.element.children("ul");
      if (0 == $tabbar$$6$$.length) {
        var $self$$168$$ = this, $contentIds$$1$$ = this.$_getContentIds$(), $tabbar$$6$$ = $$$$48$$("\x3cul\x3e");
        this.element.children().each(function($index$$240$$) {
          $self$$168$$.$_wrapLi$($$$$48$$(this).find("\x3e :first-child"), $contentIds$$1$$[$index$$240$$]).appendTo($tabbar$$6$$);
        });
        $tabbar$$6$$.prependTo(this.element);
      }
    }, $_addFacets$:function() {
      var $navRoot$$3$$ = this.element.children(".oj-tabs-nav-root"), $self$$169$$ = this, $tabbarWrapper$$ = $navRoot$$3$$.children(".oj-tabs-conveyorbelt-wrapper");
      $navRoot$$3$$.index();
      this.element.children(".oj-tabs-facet").each(function() {
        var $facet$$1$$ = $$$$48$$(this), $facetId$$ = $self$$169$$.$_getUniqueId$($facet$$1$$);
