...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore"], function($oj$$24$$, $$$$22$$) {
  (function() {
    function $_getChromingDefault$$($componentName$$8$$, $element$$118_element$$inline_817$$, $actualContainers$$1_containerConstructor$$) {
      a: {
        for (var $interestingContainers$$inline_819$$ = $_interestingContainers$$[$componentName$$8$$], $i$$inline_820$$ = 0;$i$$inline_820$$ < $interestingContainers$$inline_819$$.length;++$i$$inline_820$$) {
          var $containerName$$inline_821$$ = $interestingContainers$$inline_819$$[$i$$inline_820$$];
          if (0 <= $actualContainers$$1_containerConstructor$$.indexOf($containerName$$inline_821$$)) {
            for (;;$element$$118_element$$inline_817$$ = $element$$118_element$$inline_817$$.parentNode) {
              var $func$$inline_822$$ = $oj$$24$$.Components.$getWidgetConstructor$($element$$118_element$$inline_817$$, $containerName$$inline_821$$);
              if ($func$$inline_822$$) {
                $actualContainers$$1_containerConstructor$$ = $func$$inline_822$$;
                break a;
              }
            }
          }
    ...
    function $_radioGroup$$($radio$$, $$elems$$) {
      var $name$$113_selector$$30$$ = $radio$$.name, $$radios_form$$1$$ = $radio$$.form;
      $name$$113_selector$$30$$ ? ($name$$113_selector$$30$$ = $name$$113_selector$$30$$.replace(/'/g, "\\'"), $name$$113_selector$$30$$ = ":radio[name\x3d'" + $name$$113_selector$$30$$ + "']:oj-button", $$radios_form$$1$$ = $$elems$$ ? $$elems$$.filter($name$$113_selector$$30$$) : $$radios_form$$1$$ ? $$$$22$$($$radios_form$$1$$).find($name$$113_selector$$30$$) : $$$$22$$($name$$113_selector$$30$$, $radio$$.ownerDocument).filter(function() {
        return!this.form;
    ...
    $oj$$24$$.$__registerWidget$("oj.ojButton", $$$$22$$.oj.baseComponent, {defaultElement:"\x3cbutton\x3e", widgetEventPrefix:"oj", options:{chroming:"full", disabled:!1, display:"all", label:null, icons:{start:null, end:null}, menu:null}, $_InitOptions$:function($originalDefaults$$10$$, $constructorOptions$$12$$) {
      ...
      function $endHandler$$() {
        $self$$130$$.$_lastTouch$ = Date.now();
        $self$$130$$.$rootElement$.removeClass($activeClass$$);
        $self$$130$$.$rootElement$.removeClass("oj-hover");
        $self$$130$$.$_toggleDefaultClasses$();
      }
      this._super();
      ...
      var $self$$130$$ = this, $tabIndex$$4_toggleButton$$ = this.$_isToggle$, $activeClass$$ = $tabIndex$$4_toggleButton$$ ? "" : "oj-active";
      ...
      this.$buttonElement$.bind("touchstart" + this.eventNamespace, function() {
        $self$$130$$.$_IsEffectivelyDisabled$() || ($$$$22$$(this).addClass($activeClass$$), $self$$130$$.$_toggleDefaultClasses$());
        ...
        $self$$130$$.$_IsEffectivelyDisabled$() || $self$$130$$.$_recentTouch$() || (this === $_lastActive$$ && $self$$130$$.$rootElement$.addClass("oj-active"), $self$$130$$.$rootElement$.addClass("oj-hover").removeClass("oj-default oj-focus-only"));
      }).bind("mouseleave" + this.eventNamespace, function() {
        $self$$130$$.$rootElement$.removeClass("oj-hover");
        $self$$130$$.$_IsEffectivelyDisabled$() || ($self$$130$$.$rootElement$.removeClass($activeClass$$), $self$$130$$.$_toggleDefaultClasses$());
      }).bind("click" + this.eventNamespace, function($event$$345$$) {
        $self$$130$$.$_IsEffectivelyDisabled$() && ($event$$345$$.preventDefault(), $event$$345$$.stopImmediatePropagation());
      });
      this.element.bind("focus" + this.eventNamespace, function() {
        $self$$130$$.$rootElement$.addClass("oj-focus");
        $self$$130$$.$_toggleDefaultClasses$();
      }).bind("blur" + this.eventNamespace, function() {
        $self$$130$$.$rootElement$.removeClass("oj-focus");
        $self$$130$$.$_toggleDefaultClasses$();
      });
      $tabIndex$$4_toggleButton$$ && (this.element.bind("change" + this.eventNamespace, function($event$$346$$) {
        $self$$130$$.$_applyCheckedStateFromDom$(!0);
        ...
        $buttonset$$ && void 0 !== $checkedState$$ && $buttonset$$.option("checked", $checkedState$$, {_context:{$writeback$:!0, originalEvent:$event$$346$$, $internalSet$:!0}});
      }), this.$buttonElement$.bind("mousedown" + this.eventNamespace, function() {
        $self$$130$$.$_IsEffectivelyDisabled$() || ($_lastToggleActive$$ = this, $self$$130$$.document.one("mouseup", function() {
          $_lastToggleActive$$ = null;
        }));
      }).bind("mouseup" + this.eventNamespace, function() {
        $self$$130$$.$_IsEffectivelyDisabled$() || this !== $_lastToggleActive$$ || $self$$130$$.element.focus();
      }));
      "checkbox" === this.type ? (this.$buttonElement$.bind("click" + this.eventNamespace, function() {
        if ($self$$130$$.$_IsEffectivelyDisabled$()) {
          return!1;
        }
      }), this.element.bind("keyup" + this.eventNamespace, function($event$$350$$) {
        $event$$350$$.keyCode === $$$$22$$.ui.keyCode.ENTER && ($self$$130$$.$_IsEffectivelyDisabled$() || $self$$130$$.element.click());
      })) : "radio" === this.type ? (this.$buttonElement$.bind("click" + this.eventNamespace, function() {
        if ($self$$130$$.$_IsEffectivelyDisabled$()) {
          return!1;
        }
      }), this.element.bind("keyup" + this.eventNamespace, function($event$$351$$) {
        $event$$351$$.keyCode !== $$$$22$$.ui.keyCode.ENTER || $self$$130$$.element[0].checked || $self$$130$$.$_IsEffectivelyDisabled$() || ($self$$130$$.element[0].checked = !0, $self$$130$$.element.change(), $self$$130$$.element.click());
      })) : (this.$buttonElement$.bind("mousedown" + this.eventNamespace, function($event$$352$$) {
        if ($self$$130$$.$_IsEffectivelyDisabled$()) {
          return!1;
        }
        1 !== $event$$352$$.which || $self$$130$$.$_recentTouch$() || ($$$$22$$(this).addClass("oj-active").removeClass("oj-default oj-focus-only"), $_lastActive$$ = this, $self$$130$$.document.one("mouseup", function() {
          $_lastActive$$ = null;
        }));
      }).bind("mouseup" + this.eventNamespace, function() {
        if ($self$$130$$.$_IsEffectivelyDisabled$()) {
        ...
        $self$$130$$.$_toggleDefaultClasses$();
      }).bind("keydown" + this.eventNamespace, function($event$$353$$) {
        if ($self$$130$$.$_IsEffectivelyDisabled$()) {
          return!1;
        }
        var $isSpace$$ = $event$$353$$.keyCode === $$$$22$$.ui.keyCode.SPACE, $isAnchor$$ = "anchor" === $self$$130$$.type;
        $isAnchor$$ && $isSpace$$ && $event$$353$$.preventDefault();
        ($isSpace$$ && !$isAnchor$$ || $event$$353$$.keyCode === $$$$22$$.ui.keyCode.ENTER) && $$$$22$$(this).addClass("oj-active").removeClass("oj-default oj-focus-only");
    ...
    }, $_NotifyContextMenuGesture$:function($menu$$9$$, $event$$354$$, $eventType$$39$$) {
      this.$_OpenContextMenu$($event$$354$$, $eventType$$39$$, {position:{of:"keyboard" === $eventType$$39$$ ? this.$rootElement$ : $event$$354$$}});
    ...
    }, _setOption:function($key$$129$$, $value$$250$$, $flags$$33$$) {
      this._super($key$$129$$, $value$$250$$, $flags$$33$$);
      switch($key$$129$$) {
        case "chroming":
          $_setChromingClass$$(this.$rootElement$, $value$$250$$);
          break;
        case "disabled":
          this.$_updateEffectivelyDisabled$();
          break;
      ...
      if (this.options.menu) {
        var $self$$131$$ = this;
        this.element.attr("aria-haspopup", !0).on("keydown" + this.$menuEventNamespace$, function($event$$355$$) {
          if ($event$$355$$.which === $$$$22$$.ui.keyCode.DOWN) {
            $self$$131$$.$_showMenu$($event$$355$$, "firstItem"), $event$$355$$.preventDefault();
          } else {
            if ($event$$355$$.which === $$$$22$$.ui.keyCode.ESCAPE) {
              var $bubbleEscUp$$ = $self$$131$$.$_checkMenuParent$($self$$131$$.$rootElement$);
              $self$$131$$.$_dismissMenu$($event$$355$$);
              return $bubbleEscUp$$;
            }
          }
          return!0;
        }).on("click" + this.$menuEventNamespace$, function($event$$356$$) {
          var $menu$$10$$ = $self$$131$$.$_getMenu$();
          $menu$$10$$.$__spaceEnterDownInMenu$ || $self$$131$$.$_showMenu$($event$$356$$, "firstItem");
          $menu$$10$$.$__spaceEnterDownInMenu$ = !1;
          $event$$356$$.preventDefault();
          return!0;
        });
      }
    }, $_checkMenuParent$:function($element$$116$$) {
      return!$element$$116$$.hasClass("oj-selected");
      ...
      if (!this.$_menu$) {
        ...
        var $self$$132$$ = this;
        this.$_menu$.widget().on("oj__dismiss" + this.$menuEventNamespace$, function($event$$357$$) {
          $self$$132$$.$_menuDismissHandler$($event$$357$$);
        }).on("ojbeforeopen" + this.$menuEventNamespace$, function($event$$358$$) {
          $self$$132$$.$_launchingMenu$ || $self$$132$$.$_menuDismissHandler$($event$$358$$);
          $self$$132$$.$_launchingMenu$ = !1;
        });
      }
      return this.$_menu$;
    }, $_showMenu$:function($event$$359$$, $focus$$) {
      if (!this.$_IsEffectivelyDisabled$()) {
        this.$_launchingMenu$ = !0;
        var $menu$$11$$ = this.$_getMenu$(), $menuElem$$ = $menu$$11$$.widget();
        $menu$$11$$.open($event$$359$$, {launcher:this.element, initialFocus:$focus$$});
        this.$_menuVisible$ = !0;
    ...
    }, $_dismissMenu$:function($event$$360$$) {
      this.$_menuVisible$ && (this.$_menu$.$__collapseAll$($event$$360$$, !0), this.$_menu$.$__dismiss$($event$$360$$));
    ...
    $oj$$24$$.$__registerWidget$("oj.ojButtonset", $$$$22$$.oj.baseComponent, {$_items$:"button, input[type\x3dbutton], input[type\x3dsubmit], input[type\x3dreset], input[type\x3dcheckbox], input[type\x3dradio], a", widgetEventPrefix:"oj", options:{checked:null, chroming:"full", focusManagement:"oneTabstop"}, $_setCheckedOnDom$:function($checked$$1$$, $$buttons$$1$$) {
      var $name$$111_type$$86_valid$$10_validRadios$$ = $$$$22$$.type($checked$$1$$), $allCheckboxes$$;
      if ("null" === $name$$111_type$$86_valid$$10_validRadios$$ || "array" === $name$$111_type$$86_valid$$10_validRadios$$) {
        $allCheckboxes$$ = $$buttons$$1$$.filter("input[type\x3dcheckbox]").length === $$buttons$$1$$.length;
      }
      if ($allCheckboxes$$ && "null" === $name$$111_type$$86_valid$$10_validRadios$$) {
        throw Error("Invalid 'checked' value set on JET Buttonset: " + $checked$$1$$);
      }
      if ("string" === $name$$111_type$$86_valid$$10_validRadios$$ || "null" === $name$$111_type$$86_valid$$10_validRadios$$) {
        ($name$$111_type$$86_valid$$10_validRadios$$ = (($name$$111_type$$86_valid$$10_validRadios$$ = $$buttons$$1$$[0].name) || 1 >= $$buttons$$1$$.length) && $$buttons$$1$$.filter("input[type\x3dradio][name\x3d" + $name$$111_type$$86_valid$$10_validRadios$$ + "]").length === $$buttons$$1$$.length && (null === $checked$$1$$ || $$buttons$$1$$.filter("[value\x3d" + $checked$$1$$ + "]").length)) && $$buttons$$1$$.each(function() {
          this.checked = this.value === $checked$$1$$;
        }), $name$$111_type$$86_valid$$10_validRadios$$ = $name$$111_type$$86_valid$$10_validRadios$$ || null === $checked$$1$$;
      } else {
        if ("array" === $name$$111_type$$86_valid$$10_validRadios$$) {
          var $last$$2$$;
          ($name$$111_type$$86_valid$$10_validRadios$$ = $allCheckboxes$$ && $checked$$1$$.concat().sort().every(function($elem$$68$$) {
            var $retVal$$15$$ = $elem$$68$$ !== $last$$2$$ && $$buttons$$1$$.filter("[value\x3d" + $elem$$68$$ + "]").length;
            $last$$2$$ = $elem$$68$$;
            return $retVal$$15$$;
          ...
          $name$$111_type$$86_valid$$10_validRadios$$ = !1;
        }
      }
      if (!$name$$111_type$$86_valid$$10_validRadios$$) {
        throw Error("Invalid 'checked' value set on JET Buttonset: " + $checked$$1$$);
      }
    }, $_getCheckedFromDom$:function($$buttons$$2$$) {
      var $checked$$2$$ = void 0, $isRadio$$ = null, $name$$112$$ = null;
      $$buttons$$2$$.each(function() {
        ...
        if (void 0 !== $checked$$2$$ && ($currentIsRadio_currentType$$ !== $isRadio$$ || $currentName$$ !== $name$$112$$ || $isRadio$$ && !$name$$112$$)) {
          return $checked$$2$$ = void 0, !1;
        }
        void 0 === $checked$$2$$ ? ($checked$$2$$ = $currentIsRadio_currentType$$ ? this.checked ? this.value : null : this.checked ? [this.value] : [], $isRadio$$ = $currentIsRadio_currentType$$, $name$$112$$ = $currentName$$) : this.checked && ($isRadio$$ ? $checked$$2$$ = this.value : $checked$$2$$.push(this.value));
      });
      return $checked$$2$$;
      ...
      this.$_setup$(!0);
    }, $_NotifyContextMenuGesture$:function($currentButton_menu$$12$$, $event$$362$$, $eventType$$40$$) {
      $currentButton_menu$$12$$ = this.element.find(":oj-button[tabindex\x3d0]");
      this.$_OpenContextMenu$($event$$362$$, $eventType$$40$$, {launcher:$currentButton_menu$$12$$, position:{of:"keyboard" === $eventType$$40$$ ? $currentButton_menu$$12$$.ojButton("widget") : $event$$362$$}});
    ...
    }, _setOption:function($key$$130$$, $value$$251$$, $flags$$34$$) {
      this._superApply(arguments);
      "disabled" === $key$$130$$ ? this.$_propagateDisabled$($value$$251$$) : "checked" === $key$$130$$ ? (this.$_setCheckedOnDom$($value$$251$$, this.$$buttons$), this.$$buttons$.each(function() {
        $$$$22$$(this).data("oj-ojButton").$_applyCheckedStateFromDom$(!1);
      })) : "focusManagement" === $key$$130$$ ? this.$_setRole$($value$$251$$) : "chroming" === $key$$130$$ && ($_setChromingClass$$(this.element, $value$$251$$), this.$$buttons$.ojButton("refresh"));
    }, refresh:function() {
      this._super();
      this.$_setup$(!1);
      ...
      "oneTabstop" === this.options.focusManagement && (this.$$buttons$.unbind("keydown" + this.eventNamespace).bind("keydown" + this.eventNamespace, function($event$$363$$) {
        $self$$133$$.$_handleKeyDown$($event$$363$$, $$$$22$$(this));
      }).unbind("click" + this.eventNamespace).bind("click" + this.eventNamespace, function() {
        $$$$22$$(this).data("oj-ojButton").$_IsEffectivelyDisabled$() || $self$$133$$.$_setTabStop$($$$$22$$(this));
      }).unbind("focus" + this.eventNamespace).bind("focus" + this.eventNamespace, function() {
        $self$$133$$.$_setTabStop$($$$$22$$(this));
      ...
      return $$button$$.map(function($index$$179$$, $elem$$69$$) {
        if ("radio" != $elem$$69$$.type || $elem$$69$$.checked || "" == $elem$$69$$.name) {
          return $elem$$69$$;
        }
        var $$checkedRadio$$ = $_radioGroup$$($elem$$69$$, $$enabledButtons$$).filter(":checked");
        return $$checkedRadio$$.length ? $$checkedRadio$$[0] : $elem$$69$$;
      });
    ...
    }, $_handleKeyDown$:function($event$$366$$, $$button$$2$$) {
      switch($event$$366$$.which) {
        case $$$$22$$.ui.keyCode.LEFT:
        ;
        case $$$$22$$.ui.keyCode.RIGHT:
          $event$$366$$.preventDefault();
          var $$enabledButtons$$1$$ = this.$$enabledButtons$, $length$$17$$ = $$enabledButtons$$1$$.length;
          if (2 > $length$$17$$) {
            break;
          }
          var $oldIndex$$1$$ = $$enabledButtons$$1$$.index($$button$$2$$);
          $$enabledButtons$$1$$.eq(($oldIndex$$1$$ + ($event$$366$$.which == $$$$22$$.ui.keyCode.RIGHT ^ this.$isRtl$ ? 1 : -1) + $length$$17$$) % $length$$17$$).focus();
          break;
        case $$$$22$$.ui.keyCode.UP:
        ;
        case $$$$22$$.ui.keyCode.DOWN:
          "radio" == $$button$$2$$.attr("type") && $event$$366$$.preventDefault();
      }
    }, _destroy:function() {
    ...
    $oj$$24$$.Components.$setDefaultOptions$({ojButton:{chroming:$oj$$24$$.Components.$createDynamicPropertyGetter$(function($context$$103$$) {
      return $_getChromingDefault$$("button", $context$$103$$.element, $context$$103$$.containers);
    })}, ojButtonset:{chroming:$oj$$24$$.Components.$createDynamicPropertyGetter$(function($context$$104$$) {
      return $_getChromingDefault$$("buttonset", $context$$104$$.element, $context$$104$$.containers);
    })}});
  })();
});
