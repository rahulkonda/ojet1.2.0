...
define(["ojs/ojcore", "jquery", "knockout", "ojs/ojdatasource-common"], function($oj$$71$$, $$$$66$$, $ko$$7$$) {
  ...
  $oj$$71$$.$ArrayPagingDataSource$.prototype.handleEvent = function $$oj$$71$$$$ArrayPagingDataSource$$$handleEvent$($eventType$$54$$, $event$$608$$) {
    return $oj$$71$$.$ArrayPagingDataSource$.$superclass$.handleEvent.call(this, $eventType$$54$$, $event$$608$$);
  };
  ...
  $oj$$71$$.$ArrayPagingDataSource$.prototype.setPage = function $$oj$$71$$$$ArrayPagingDataSource$$$setPage$($value$$293$$, $options$$370$$) {
    ...
    var $self$$203$$ = this;
    return new Promise(function($resolve$$59$$, $reject$$57$$) {
      $self$$203$$.$_fetchInternal$($options$$370$$).then(function() {
        $oj$$71$$.$ArrayPagingDataSource$.$superclass$.handleEvent.call($self$$203$$, $oj$$71$$.$PagingModel$.$EventType$.PAGE, {page:$self$$203$$.$_page$, previousPage:$previousPage$$4$$});
        $resolve$$59$$(null);
      }, function() {
        $self$$203$$.$_page$ = $previousPage$$4$$;
        $self$$203$$.$_startIndex$ = $self$$203$$.$_page$ * $self$$203$$.pageSize;
        $reject$$57$$(null);
      });
    });
  };
  ...
  $oj$$71$$.$ArrayPagingDataSource$.prototype.fetch = function $$oj$$71$$$$ArrayPagingDataSource$$$fetch$($options$$371_opts$$42$$) {
    $options$$371_opts$$42$$ = $options$$371_opts$$42$$ || {};
    if (void 0 !== $options$$371_opts$$42$$.pageSize && void 0 !== $options$$371_opts$$42$$.startIndex) {
      if (!this.$_hasMore$()) {
        return Promise.resolve();
      }
      this.$currentPageSize$ = $options$$371_opts$$42$$.startIndex + $options$$371_opts$$42$$.pageSize;
    }
  ...
  $oj$$71$$.$ArrayPagingDataSource$.prototype.$_fetchInternal$ = function $$oj$$71$$$$ArrayPagingDataSource$$$$_fetchInternal$$($options$$372$$) {
    var $opts$$43$$ = $options$$372$$ || {};
    void 0 !== $opts$$43$$.startIndex && (this.current = $opts$$43$$.startIndex);
    void 0 !== $opts$$43$$.pageSize && (this.$currentPageSize$ = this.pageSize = $opts$$43$$.pageSize);
