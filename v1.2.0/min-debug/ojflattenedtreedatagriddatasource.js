...
define(["ojs/ojcore", "jquery", "ojs/ojdatasource-common", "ojs/ojrowexpander"], function($oj$$68$$) {
  ...
  $oj$$68$$.$FlattenedTreeHeaderSet$.prototype.getData = function $$oj$$68$$$$FlattenedTreeHeaderSet$$$getData$($index$$277$$, $level$$40$$) {
    var $rowData$$5$$;
  ...
  $oj$$68$$.$FlattenedTreeHeaderSet$.prototype.getMetadata = function $$oj$$68$$$$FlattenedTreeHeaderSet$$$getMetadata$($index$$278$$, $level$$41$$) {
  ...
  $oj$$68$$.$FlattenedTreeHeaderSet$.prototype.$getExtent$ = function $$oj$$68$$$$FlattenedTreeHeaderSet$$$$getExtent$$($index$$279$$, $level$$42$$) {
  ...
  $oj$$68$$.$FlattenedTreeHeaderSet$.prototype.$getDepth$ = function $$oj$$68$$$$FlattenedTreeHeaderSet$$$$getDepth$$($index$$280$$, $level$$43$$) {
    $oj$$68$$.$Assert$.assert($index$$280$$ <= this.$m_end$ && $index$$280$$ >= this.$m_start$, "index out of bounds");
    $oj$$68$$.$Assert$.assert(null == $level$$43$$ || 0 == $level$$43$$, "level out of bounds");
    return 1;
  };
  ...
  $oj$$68$$.$FlattenedTreeCellSet$.prototype.getMetadata = function $$oj$$68$$$$FlattenedTreeCellSet$$$getMetadata$($indexes$$17_metadata$$15_row$$49$$) {
    var $column$$27_columnKey$$7_relIndex$$3$$;
    $column$$27_columnKey$$7_relIndex$$3$$ = this.$_getRelIndexes$($indexes$$17_metadata$$15_row$$49$$);
    if (null == $column$$27_columnKey$$7_relIndex$$3$$) {
      return null;
    }
    $indexes$$17_metadata$$15_row$$49$$ = $column$$27_columnKey$$7_relIndex$$3$$[0];
    $column$$27_columnKey$$7_relIndex$$3$$ = $column$$27_columnKey$$7_relIndex$$3$$[1];
    $oj$$68$$.$Assert$.assert($indexes$$17_metadata$$15_row$$49$$ < this.$m_nodeSet$.$getStart$() + this.$m_nodeSet$.$getCount$() && $column$$27_columnKey$$7_relIndex$$3$$ < this.$m_columns$.length);
    $column$$27_columnKey$$7_relIndex$$3$$ = this.$m_columns$[$column$$27_columnKey$$7_relIndex$$3$$];
    $indexes$$17_metadata$$15_row$$49$$ = this.$m_nodeSet$.getMetadata($indexes$$17_metadata$$15_row$$49$$);
    $indexes$$17_metadata$$15_row$$49$$.keys = {row:$indexes$$17_metadata$$15_row$$49$$.key, column:$column$$27_columnKey$$7_relIndex$$3$$};
    return $indexes$$17_metadata$$15_row$$49$$;
  };
  ...
  $oj$$68$$.$FlattenedTreeCellSet$.prototype.$getStart$ = function $$oj$$68$$$$FlattenedTreeCellSet$$$$getStart$$($axis$$47$$) {
    return "row" === $axis$$47$$ ? this.$m_startRow$ : "column" === $axis$$47$$ ? this.$m_startColumn$ : 0;
  };
  ...
  $oj$$68$$.$FlattenedTreeCellSet$.prototype.$getCount$ = function $$oj$$68$$$$FlattenedTreeCellSet$$$$getCount$$($axis$$48$$) {
    return "row" === $axis$$48$$ ? Math.min(this.$m_endRow$ - this.$m_startRow$, this.$m_nodeSet$.$getCount$()) : "column" === $axis$$48$$ ? this.$m_endColumn$ - this.$m_startColumn$ : 0;
  };
  ...
  $oj$$68$$.$FlattenedTreeDataGridDataSource$.prototype.$getCountPrecision$ = function $$oj$$68$$$$FlattenedTreeDataGridDataSource$$$$getCountPrecision$$($axis$$49$$) {
    return "row" === $axis$$49$$ ? "estimate" : "actual";
  };
  ...
  $oj$$68$$.$FlattenedTreeDataGridDataSource$.prototype.$getCount$ = function $$oj$$68$$$$FlattenedTreeDataGridDataSource$$$$getCount$$($axis$$50$$) {
    return "row" === $axis$$50$$ ? -1 : "column" === $axis$$50$$ ? this.$m_columns$.length : 0;
  };
  ...
  $oj$$68$$.$FlattenedTreeDataGridDataSource$.prototype.$fetchHeaders$ = function $$oj$$68$$$$FlattenedTreeDataGridDataSource$$$$fetchHeaders$$($headerRange$$6$$, $callbacks$$43$$, $callbackObjects$$21$$) {
    var $axis$$51_columnCount$$3$$, $headerSet$$2$$;
    $axis$$51_columnCount$$3$$ = $headerRange$$6$$.axis;
    if ("column" === $axis$$51_columnCount$$3$$) {
      $axis$$51_columnCount$$3$$ = $headerRange$$6$$.start + $headerRange$$6$$.count, $axis$$51_columnCount$$3$$ > this.$getCount$("column") && ($axis$$51_columnCount$$3$$ = this.$getCount$("column") - $headerRange$$6$$.start), $headerSet$$2$$ = new $oj$$68$$.$FlattenedTreeHeaderSet$($headerRange$$6$$.start, $axis$$51_columnCount$$3$$, this.$m_columns$);
    } else {
      if ("row" === $axis$$51_columnCount$$3$$) {
        ...
        $headerSet$$2$$ = new $oj$$68$$.$ArrayHeaderSet$($headerRange$$6$$.start, $headerRange$$6$$.start, $axis$$51_columnCount$$3$$, null);
      }
    }
  ...
  $oj$$68$$.$FlattenedTreeDataGridDataSource$.prototype.keys = function $$oj$$68$$$$FlattenedTreeDataGridDataSource$$$keys$($indexes$$19$$) {
    ...
    return new Promise(function($resolve$$55$$) {
      $rowIndex$$12$$ > $oj$$68$$.$FlattenedTreeDataGridDataSource$.$superclass$.$getFetchedRange$.call(this).end || $colIndex$$ > this.$m_columns$.length ? $resolve$$55$$(null) : $resolve$$55$$({row:$oj$$68$$.$FlattenedTreeDataGridDataSource$.$superclass$.getKey.call(this, $rowIndex$$12$$), column:this.$m_columns$[$colIndex$$]});
    }.bind(this));
  };
  ...
  $oj$$68$$.$FlattenedTreeDataGridDataSource$.prototype.$indexes$ = function $$oj$$68$$$$FlattenedTreeDataGridDataSource$$$$indexes$$($keys$$41$$) {
    ...
    return new Promise(function($resolve$$56$$) {
      ...
      0 <= $rowIndex$$13$$ || 0 <= $colIndex$$1$$ ? $resolve$$56$$({row:$rowIndex$$13$$, column:$colIndex$$1$$}) : $resolve$$56$$(null);
    }.bind(this));
  };
  ...
  $oj$$68$$.$FlattenedTreeDataGridDataSource$.prototype.$insertMetadata$ = function $$oj$$68$$$$FlattenedTreeDataGridDataSource$$$$insertMetadata$$($key$$180$$, $metadata$$16$$) {
    $oj$$68$$.$FlattenedTreeDataGridDataSource$.$superclass$.$insertMetadata$.call(this, $key$$180$$, $metadata$$16$$);
  };
  ...
  $oj$$68$$.$FlattenedTreeDataGridDataSource$.prototype.$insertRows$ = function $$oj$$68$$$$FlattenedTreeDataGridDataSource$$$$insertRows$$($event$$603_insertAtIndex$$1$$, $cellSet$$3_insertAtRowKey$$, $nodeSet$$32$$) {
    var $headerSet$$4$$, $i$$450$$, $keys$$42$$, $indexes$$20$$;
    $headerSet$$4$$ = null;
    this.$m_rowHeader$ && ($headerSet$$4$$ = new $oj$$68$$.$FlattenedTreeHeaderSet$($event$$603_insertAtIndex$$1$$, $event$$603_insertAtIndex$$1$$ + $nodeSet$$32$$.$getCount$(), this.$m_columns$, $nodeSet$$32$$, this.$m_rowHeader$));
    $cellSet$$3_insertAtRowKey$$ = new $oj$$68$$.$FlattenedTreeCellSet$($event$$603_insertAtIndex$$1$$, $event$$603_insertAtIndex$$1$$ + $nodeSet$$32$$.$getCount$(), 0, this.$m_columns$.length, $nodeSet$$32$$, this.$m_columns$);
    $keys$$42$$ = [];
    $indexes$$20$$ = [];
    for ($i$$450$$ = 0;$i$$450$$ < $nodeSet$$32$$.$getCount$();$i$$450$$++) {
      $keys$$42$$.push({row:this.$_getEntry$($event$$603_insertAtIndex$$1$$ + $i$$450$$).key}), $indexes$$20$$.push({row:$event$$603_insertAtIndex$$1$$ + $i$$450$$, column:-1});
    }
    $event$$603_insertAtIndex$$1$$ = {source:this, operation:"insert"};
    $event$$603_insertAtIndex$$1$$.result = $cellSet$$3_insertAtRowKey$$;
    $headerSet$$4$$ && ($event$$603_insertAtIndex$$1$$.header = $headerSet$$4$$);
    $event$$603_insertAtIndex$$1$$.keys = $keys$$42$$;
    $event$$603_insertAtIndex$$1$$.indexes = $indexes$$20$$;
    $oj$$68$$.$FlattenedTreeDataGridDataSource$.$superclass$.handleEvent.call(this, "change", $event$$603_insertAtIndex$$1$$);
  };
  $oj$$68$$.$FlattenedTreeDataGridDataSource$.prototype.$removeRows$ = function $$oj$$68$$$$FlattenedTreeDataGridDataSource$$$$removeRows$$($event$$604_rowKeys$$1$$) {
    var $keys$$43$$, $i$$451$$, $indexes$$21$$;
    $keys$$43$$ = [];
    $indexes$$21$$ = [];
    for ($i$$451$$ = 0;$i$$451$$ < $event$$604_rowKeys$$1$$.length;$i$$451$$++) {
      $keys$$43$$.push({row:$event$$604_rowKeys$$1$$[$i$$451$$].key}), $indexes$$21$$.push({row:$event$$604_rowKeys$$1$$[$i$$451$$].index, column:-1});
    }
    $event$$604_rowKeys$$1$$ = {source:this, operation:"delete"};
    $event$$604_rowKeys$$1$$.keys = $keys$$43$$;
    $event$$604_rowKeys$$1$$.indexes = $indexes$$21$$;
    $oj$$68$$.$FlattenedTreeDataGridDataSource$.$superclass$.handleEvent.call(this, "change", $event$$604_rowKeys$$1$$);
  };
