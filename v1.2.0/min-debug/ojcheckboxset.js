...
define(["ojs/ojcore", "jquery", "ojs/ojeditablevalue", "ojs/ojradiocheckbox"], function($oj$$44$$, $$$$40$$) {
  (function() {
    $oj$$44$$.$__registerWidget$("oj.ojCheckboxset", $$$$40$$.oj.editableValue, {version:"1.0.0", defaultElement:"\x3cdiv\x3e", widgetEventPrefix:"oj", options:{disabled:!1, value:void 0}, refresh:function() {
      ...
      var $allcheckboxes_first$$9_name$$116$$ = this.element.find("input[type\x3dcheckbox]:first");
      0 === $allcheckboxes_first$$9_name$$116$$.length && $oj$$44$$.$Logger$.warn("Could not find any input type\x3dcheckbox within this element");
      $allcheckboxes_first$$9_name$$116$$ = $allcheckboxes_first$$9_name$$116$$.attr("name");
      return void 0 === $allcheckboxes_first$$9_name$$116$$ ? ($allcheckboxes_first$$9_name$$116$$ = this.element.find("input[type\x3dcheckbox]"), $allcheckboxes_first$$9_name$$116$$.not("[name]")) : this.element.find("input[type\x3dcheckbox][name\x3d" + $allcheckboxes_first$$9_name$$116$$ + "]");
    }, $_NotifyContextMenuGesture$:function($launcher$$12_menu$$14$$, $event$$470$$, $eventType$$44$$) {
      $launcher$$12_menu$$14$$ = this.element.find("input[type\x3dcheckbox]:tabbable").first();
      this.$_OpenContextMenu$($event$$470$$, $eventType$$44$$, {launcher:$launcher$$12_menu$$14$$});
    ...
    }, $_events$:{change:function($event$$471$$) {
      this.$_HandleChangeEvent$($event$$471$$);
    }}, $_HandleChangeEvent$:function($event$$472$$) {
      var $submittedValue$$4$$ = this.$_GetDisplayValue$();
      this.$_SetValue$($submittedValue$$4$$, $event$$472$$, $_sValueChangeCheckFalse$$);
    ...
    }, _setOption:function($key$$148$$, $value$$265$$, $flags$$38$$) {
      this._super($key$$148$$, $value$$265$$, $flags$$38$$);
      "disabled" === $key$$148$$ && this.$_propagateDisabled$($value$$265$$);
    }, getNodeBySubId:function($locator$$46_subId$$49$$) {
      var $node$$94$$ = this._super($locator$$46_subId$$49$$);
      return $node$$94$$ || ($locator$$46_subId$$49$$ = $locator$$46_subId$$49$$.subId, "oj-checkboxset-inputs" !== $locator$$46_subId$$49$$) ? $node$$94$$ || null : this.$$checkboxes$.get();
    }, _destroy:function() {
