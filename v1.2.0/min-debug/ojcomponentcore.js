...
define(["ojs/ojcore", "jquery", "jqueryui-amd/core", "jqueryui-amd/widget", "ojs/ojmessaging"], function($oj$$3$$, $$$$3$$) {
  ...
  $$$$3$$.widget("oj.baseComponent", {options:{contextMenu:null, rootAttributes:null, optionChange:void 0, destroy:void 0}, refresh:function() {
    ...
    var $element$$inline_451$$ = this.element, $widgetName$$inline_452$$ = this.widgetName, $data$$inline_453$$ = $element$$inline_451$$.data($_OJ_WIDGET_NAMES_DATA$$);
    $data$$inline_453$$ || ($data$$inline_453$$ = [], $element$$inline_451$$.data($_OJ_WIDGET_NAMES_DATA$$, $data$$inline_453$$));
    0 > $data$$inline_453$$.indexOf($widgetName$$inline_452$$) && $data$$inline_453$$.push($widgetName$$inline_452$$);
    ...
    return null == $pattern$$2$$ ? $key$$27$$ : $oj$$3$$.$Translations$.$applyParameters$($pattern$$2$$.toString(), $params$$4$$);
    ...
    var $element$$inline_455$$ = this.element, $index$$inline_458_widgetName$$inline_456$$ = this.widgetName, $data$$inline_457$$ = $element$$inline_455$$.data($_OJ_WIDGET_NAMES_DATA$$);
    $data$$inline_457$$ && ($index$$inline_458_widgetName$$inline_456$$ = $data$$inline_457$$.indexOf($index$$inline_458_widgetName$$inline_456$$), 0 <= $index$$inline_458_widgetName$$inline_456$$ && ($data$$inline_457$$.splice($index$$inline_458_widgetName$$inline_456$$, 1), 0 === $data$$inline_457$$.length && $element$$inline_455$$.removeData($_OJ_WIDGET_NAMES_DATA$$)));
    ...
    var $callback$$79$$ = this.options[$type$$63$$];
    $data$$49$$ = $data$$49$$ || {};
    ...
    return!($$$$3$$.isFunction($callback$$79$$) && !1 === $callback$$79$$.apply(this.element[0], [$event$$15$$].concat($data$$49$$)) || $event$$15$$.isDefaultPrevented());
    ...
    if (this.options.contextMenu) {
      ...
      this.$_preventKeyUpEventIfMenuOpen$ = function $this$$_preventKeyUpEventIfMenuOpen$$($event$$16$$) {
        121 == $event$$16$$.which && $event$$16$$.shiftKey && $self$$41$$.$_getContextMenuNode$().is(":visible") && $event$$16$$.preventDefault();
      };
      var $isPressHold$$ = !1, $touchInProgress$$ = !1, $touchPageX$$, $touchPageY$$, $doubleOpenTimer$$, $doubleOpenType$$ = null, $launch$$ = function $$launch$$$($event$$17$$, $eventType$$25$$, $pressHold$$) {
        ...
        "touchstart" === $doubleOpenType$$ && "contextmenu" === $event$$17$$.type || "contextmenu" === $doubleOpenType$$ && "touchstart" === $event$$17$$.type ? ($doubleOpenType$$ = null, clearTimeout($doubleOpenTimer$$)) : $event$$17$$.isDefaultPrevented() || $event$$17$$.originalEvent && $event$$17$$.originalEvent.defaultPrevented || $self$$41$$.$_IsEffectivelyDisabled$() || ($self$$41$$.$_NotifyContextMenuGesture$($menu$$, $event$$17$$, $eventType$$25$$), !$self$$41$$.$_getContextMenuNode$().is(":visible") || 
        ($event$$17$$.preventDefault(), document.addEventListener("keyup", $self$$41$$.$_preventKeyUpEventIfMenuOpen$), "touchstart" !== $event$$17$$.type && "contextmenu" !== $event$$17$$.type)) || ($doubleOpenType$$ = $event$$17$$.type, $doubleOpenTimer$$ = setTimeout(function() {
          $doubleOpenType$$ = null;
        }, 300));
      };
      ...
      $rootNode$$.on("touchstart" + this.$contextMenuEventNamespace$ + " mousedown" + this.$contextMenuEventNamespace$ + " keydown" + this.$contextMenuEventNamespace$ + " ", function($event$$20$$) {
        if ("mousedown" !== $event$$20$$.type || !$self$$41$$.$_getContextMenu$().$__contextMenuPressHoldJustEnded$()) {
          $isPressHold$$ = !1;
          if ("touchstart" === $event$$20$$.type && 1 === $event$$20$$.originalEvent.touches.length) {
            var $firstTouch$$ = $event$$20$$.originalEvent.touches[0];
            $touchPageX$$ = $firstTouch$$.pageX;
            $touchPageY$$ = $firstTouch$$.pageY;
            $touchInProgress$$ = !0;
            this.$_contextMenuPressHoldTimer$ = setTimeout($launch$$.bind(void 0, $event$$20$$, "touch", !0), 750);
          }
          return!0;
        }
      }).on("touchmove" + this.$contextMenuEventNamespace$, function($event$$21_firstTouch$$1$$) {
        $event$$21_firstTouch$$1$$ = $event$$21_firstTouch$$1$$.originalEvent.touches[0];
        if (5 < Math.abs($touchPageX$$ - $event$$21_firstTouch$$1$$.pageX) || 5 < Math.abs($touchPageY$$ - $event$$21_firstTouch$$1$$.pageY)) {
        ...
        return!0;
      }).on("keydown" + this.$contextMenuEventNamespace$ + " contextmenu" + this.$contextMenuEventNamespace$, function($event$$23$$) {
        ("contextmenu" === $event$$23$$.type || 121 == $event$$23$$.which && $event$$23$$.shiftKey) && $launch$$($event$$23$$, $touchInProgress$$ ? "touch" : "keydown" === $event$$23$$.type ? "keyboard" : "mouse", !1);
        return!0;
  ...
  }, $_NotifyContextMenuGesture$:function($menu$$1$$, $event$$25$$, $eventType$$27$$) {
    this.$_OpenContextMenu$($event$$25$$, $eventType$$27$$);
  }, $_OpenContextMenu$:function($event$$26$$, $defaults_eventType$$28$$, $openOptions$$, $submenuOpenOptions$$, $menu$$2_shallow$$) {
    $defaults_eventType$$28$$ = {launcher:this.element, position:{mouse:{my:"start top", at:"start bottom", of:$event$$26$$, collision:"flipfit"}, touch:{my:"start\x3e40 center", at:"start bottom", of:$event$$26$$, collision:"flipfit"}, keyboard:{my:"start top", at:"start bottom", of:"launcher", collision:"flipfit"}}[$defaults_eventType$$28$$]};
    ...
    $menu$$2_shallow$$.open($event$$26$$, $openOptions$$, $submenuOpenOptions$$);
    ...
    this._on($element$$19$$, {mouseenter:function($event$$27$$) {
      $$$$3$$($event$$27$$.currentTarget).hasClass("oj-disabled") || $$$$3$$($event$$27$$.currentTarget).addClass("oj-hover");
    }, mouseleave:function($event$$28$$) {
      $$$$3$$($event$$28$$.currentTarget).removeClass("oj-hover");
    }});
  }, _focusable:function($element$$20$$) {
    this._on($element$$20$$, {focusin:function($event$$29$$) {
      $$$$3$$($event$$29$$.currentTarget).addClass("oj-focus");
    }, focusout:function($event$$30$$) {
      $$$$3$$($event$$30$$.currentTarget).removeClass("oj-focus");
    }});
  }, $_activeable$:function($element$$21$$) {
    this._on($element$$21$$, {mousedown:function($event$$31$$) {
      $$$$3$$($event$$31$$.currentTarget).addClass("oj-active");
    }, mouseup:function($event$$32$$) {
      $$$$3$$($event$$32$$.currentTarget).removeClass("oj-active");
    }});
    ...
    if (!this.$_propertyContext$) {
      ...
      for (var $element$$23$$ = this.element[0], $elem$$inline_460$$ = $element$$23$$, $containers$$inline_461$$ = [];$elem$$inline_460$$;) {
        var $ga$$inline_462_name$$inline_463$$ = $elem$$inline_460$$.getAttribute, $ga$$inline_462_name$$inline_463$$ = $ga$$inline_462_name$$inline_463$$ ? $ga$$inline_462_name$$inline_463$$.call($elem$$inline_460$$, $oj$$3$$.Components.$_OJ_CONTAINER_ATTR$) : null;
        null != $ga$$inline_462_name$$inline_463$$ && $containers$$inline_461$$.push($ga$$inline_462_name$$inline_463$$);
        $elem$$inline_460$$ = $elem$$inline_460$$.parentNode;
      }
      $c$$31$$.containers = $containers$$inline_461$$;
  ...
  $oj$$3$$.$DomUtils$.$isChromeEvent$ = function $$oj$$3$$$$DomUtils$$$isChromeEvent$$($JSCompiler_temp$$9_event$$33$$) {
    function $_isChromeEventWebkit$$($event$$36$$) {
      var $domTarget$$ = $event$$36$$.target, $target$$73$$ = $$$$3$$($domTarget$$), $pos$$ = $domTarget$$.getBoundingClientRect(), $sbw$$ = $oj$$3$$.$DomUtils$.$getScrollBarWidth$(), $isLTR$$ = "ltr" === $oj$$3$$.$DomUtils$.$getReadingDirection$();
      return $isLTR$$ && ("HTML" === $domTarget$$.nodeName || "visible" !== $target$$73$$.css("overflow-x")) && $event$$36$$.clientX > $pos$$.right - $sbw$$ ? !0 : !$isLTR$$ && "HTML" === $domTarget$$.nodeName && $event$$36$$.clientX > $pos$$.left - $sbw$$ ? !0 : !$isLTR$$ && "visible" !== $target$$73$$.css("overflow-x") && $event$$36$$.clientX < $pos$$.left + $sbw$$ ? !0 : ("HTML" === $domTarget$$.nodeName || "visible" !== $target$$73$$.css("overflow-y")) && $event$$36$$.clientY > $pos$$.bottom - 
      $sbw$$ ? !0 : !1;
    }
    if (!("clientX" in $JSCompiler_temp$$9_event$$33$$ && "clientY" in $JSCompiler_temp$$9_event$$33$$)) {
      return!1;
    }
    ...
    if ($oj$$3$$.$AgentUtils$.$OS$.$ANDROID$ === $agentInfo$$1$$.os || $oj$$3$$.$AgentUtils$.$OS$.$IOS$ === $agentInfo$$1$$.os) {
      $JSCompiler_temp$$9_event$$33$$ = !1;
    } else {
      var $JSCompiler_temp$$10$$;
      if ($oj$$3$$.$AgentUtils$.$ENGINE$.$GECKO$ === $agentInfo$$1$$.engine) {
        try {
          $JSCompiler_temp$$10$$ = $JSCompiler_temp$$9_event$$33$$.originalTarget.localName ? !1 : !0;
        } catch ($e$$inline_470$$) {
          $JSCompiler_temp$$10$$ = !0;
        }
      } else {
        $JSCompiler_temp$$10$$ = $oj$$3$$.$AgentUtils$.$ENGINE$.$WEBKIT$ === $agentInfo$$1$$.engine ? $_isChromeEventWebkit$$($JSCompiler_temp$$9_event$$33$$) : $oj$$3$$.$AgentUtils$.$BROWSER$.$IE$ === $agentInfo$$1$$.browser ? $_isChromeEventWebkit$$($JSCompiler_temp$$9_event$$33$$) : !1;
      }
      $JSCompiler_temp$$9_event$$33$$ = $JSCompiler_temp$$10$$;
    }
    return $JSCompiler_temp$$9_event$$33$$;
  };
  ...
  $oj$$3$$.$DomUtils$.$isWithinViewport$ = function $$oj$$3$$$$DomUtils$$$isWithinViewport$$($element$$24_parent$$2$$) {
    function $isVisible$$($alignBox$$1$$, $containerBox$$) {
      ...
      var $scrollBarWidth$$1$$ = "auto" === $containerBox$$.overflowY || "scroll" === $containerBox$$.overflowY ? $oj$$3$$.$DomUtils$.$getScrollBarWidth$() : 0;
      if (1 > $containerBox$$.bottom - $scrollBarWidth$$1$$ - $alignBox$$1$$.top) {
        return!1;
      }
      $scrollBarWidth$$1$$ = "auto" !== $containerBox$$.overflowX && "scroll" !== $containerBox$$.overflowX || "rtl" !== $oj$$3$$.$DomUtils$.$getReadingDirection$() ? 0 : $oj$$3$$.$DomUtils$.$getScrollBarWidth$();
      ...
      return-1 < $alignBox$$1$$.left - ($containerBox$$.right - $scrollBarWidth$$1$$) ? !1 : !0;
    }
    ...
    function $getRect$$($element$$26$$) {
      ...
      return 1 === $domElement_rec$$.nodeType ? ($domElement_rec$$ = $domElement_rec$$.getBoundingClientRect(), $domElement_rec$$.overflowX = $element$$26$$.css("overflow-x"), $domElement_rec$$.overflowY = $element$$26$$.css("overflow-y"), $domElement_rec$$) : $$$$3$$.isWindow($domElement_rec$$) ? $domElement_rec$$ = {width:$domElement_rec$$.innerWidth, height:$domElement_rec$$.innerHeight, top:0, bottom:$domElement_rec$$.innerHeight, left:0, right:$domElement_rec$$.innerWidth} : {height:0, width:0};
    }
    if (!$element$$24_parent$$2$$) {
      return!1;
    }
    var $alignBox$$ = $getRect$$($element$$24_parent$$2$$), $isWithinViewPort$$ = !0;
    for ($element$$24_parent$$2$$ = $element$$24_parent$$2$$.parent();$isWithinViewPort$$ && $element$$24_parent$$2$$ && 0 < $element$$24_parent$$2$$.length && 1 === $element$$24_parent$$2$$[0].nodeType;) {
  ...
  $oj$$3$$.$DomUtils$.$getLogicalParent$ = function $$oj$$3$$$$DomUtils$$$getLogicalParent$$($element$$27$$) {
    if ($element$$27$$) {
      return $element$$27$$.data($oj$$3$$.$DomUtils$.$_LOGICAL_PARENT_DATA$);
    }
  };
  $oj$$3$$.$DomUtils$.$setLogicalParent$ = function $$oj$$3$$$$DomUtils$$$setLogicalParent$$($element$$28$$, $parent$$3$$) {
    $element$$28$$ && (null === $parent$$3$$ ? $element$$28$$.removeData($oj$$3$$.$DomUtils$.$_LOGICAL_PARENT_DATA$) : $element$$28$$.data($oj$$3$$.$DomUtils$.$_LOGICAL_PARENT_DATA$, $parent$$3$$));
  };
  ...
  $oj$$3$$.$DomUtils$.$_supressNativeContextMenu$ = function $$oj$$3$$$$DomUtils$$$_supressNativeContextMenu$$() {
    $$$$3$$(document.body).hasClass("oj-hybrid") && document.body.addEventListener("contextmenu", function($event$$37$$) {
      $event$$37$$.preventDefault();
    }, !0);
  };
  ...
  $oj$$3$$.$ComponentMessaging$.prototype.$_getResolvedMessagingDisplayOptions$ = function $$oj$$3$$$$ComponentMessaging$$$$_getResolvedMessagingDisplayOptions$$() {
    ...
    $$$$3$$.each($oj$$3$$.$ComponentMessaging$.$_DISPLAY_TYPE$, function($type$$66$$, $name$$70$$) {
  ...
  $oj$$3$$.$FocusUtils$.$containsFocus$ = function $$oj$$3$$$$FocusUtils$$$containsFocus$$($element$$29$$) {
    var $activeElem$$ = document.activeElement;
    return $element$$29$$ && $activeElem$$ ? $oj$$3$$.$DomUtils$.$isAncestorOrSelf$($element$$29$$, $activeElem$$) : !1;
  };
  $oj$$3$$.$FocusUtils$.$focusElement$ = function $$oj$$3$$$$FocusUtils$$$focusElement$$($element$$30$$) {
    $element$$30$$.focus();
  };
  $oj$$3$$.$FocusUtils$.$focusFirstTabStop$ = function $$oj$$3$$$$FocusUtils$$$focusFirstTabStop$$($element$$31_focusElement$$) {
    ($element$$31_focusElement$$ = $oj$$3$$.$FocusUtils$.$getFirstTabStop$($element$$31_focusElement$$)) && $oj$$3$$.$FocusUtils$.$focusElement$($element$$31_focusElement$$);
  };
  $oj$$3$$.$FocusUtils$.$getFirstTabStop$ = function $$oj$$3$$$$FocusUtils$$$getFirstTabStop$$($element$$32_jqFocusables$$) {
    var $jqElem$$ = $$$$3$$($element$$32_jqFocusables$$);
    return $jqElem$$.is($oj$$3$$.$FocusUtils$.$_TABBABLE$) ? $element$$32_jqFocusables$$ : ($element$$32_jqFocusables$$ = $jqElem$$.find($oj$$3$$.$FocusUtils$.$_TABBABLE$)) && 0 < $element$$32_jqFocusables$$.length ? $element$$32_jqFocusables$$[0] : null;
  };
  $oj$$3$$.$Test$ = {};
  $goog$exportPath_$$("Test", $oj$$3$$.$Test$, $oj$$3$$);
  $oj$$3$$.$Test$.ready = !1;
  $goog$exportPath_$$("Test.ready", $oj$$3$$.$Test$.ready, $oj$$3$$);
  $oj$$3$$.$Test$.$domNodeForLocator$ = function $$oj$$3$$$$Test$$$domNodeForLocator$$($element$$33_locator$$3_widgetConst$$) {
    var $locObj$$ = $element$$33_locator$$3_widgetConst$$;
    if ($oj$$3$$.$StringUtils$.$isString$($element$$33_locator$$3_widgetConst$$)) {
      try {
        $locObj$$ = $$$$3$$.parseJSON($element$$33_locator$$3_widgetConst$$);
      } catch ($e$$30$$) {
        return null;
      }
    }
    return $locObj$$ && $locObj$$.element && ($element$$33_locator$$3_widgetConst$$ = $$$$3$$($locObj$$.element)) ? ($element$$33_locator$$3_widgetConst$$ = $oj$$3$$.Components.$getWidgetConstructor$($element$$33_locator$$3_widgetConst$$[0], $locObj$$.component), delete $locObj$$.element, $element$$33_locator$$3_widgetConst$$("getNodeBySubId", $locObj$$)) : null;
  };
