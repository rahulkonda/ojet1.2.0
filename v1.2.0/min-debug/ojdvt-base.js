...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojvalidation", "ojs/internal-deps/dvt/DvtToolkit", "promise"], function($oj$$15$$, $$$$15$$, $comp$$5$$, $val$$39$$, $dvt$$1$$) {
  ...
  var $DvtStyleProcessor$$ = {CSS_TEXT_PROPERTIES:function($cssDiv$$) {
    ...
    for (var $i$$241$$ = 0;$i$$241$$ < $componentClasses_innerDummyDiv$$.length;$i$$241$$++) {
      $definitions_element$$103_styleClasses$$ = $definitions_element$$103_styleClasses$$ + $componentClasses_innerDummyDiv$$[$i$$241$$] + " ";
    }
    ...
    for (var $cssDiv$$7$$ = null, $i$$242$$ = 0;$i$$242$$ < $definitions$$1$$.length;$i$$242$$++) {
      var $definition_path$$10$$ = $definitions$$1$$[$i$$242$$], $property$$24_strValue$$ = $definition_path$$10$$.property;
  ...
  $oj$$15$$.$__registerWidget$("oj.dvtBaseComponent", $$$$15$$.oj.baseComponent, {_ComponentCreate:function() {
    ...
    if ($automation$$) {
      return $automation$$.getDomElementForSubId(this.$_ConvertLocatorToSubId$($locator$$19$$));
    }
    ...
    for (var $componentStyles$$ = this.$_GetComponentStyleClasses$(), $i$$243$$ = 0;$i$$243$$ < $componentStyles$$.length;$i$$243$$++) {
      this.element.addClass($componentStyles$$[$i$$243$$]);
    }
    ...
    return{"oj-dvt-status-message":{path:"_statusMessageStyle", property:"CSS_TEXT_PROPERTIES"}};
    ...
    for (var $componentStyles$$1$$ = this.$_GetComponentStyleClasses$(), $i$$244$$ = 0;$i$$244$$ < $componentStyles$$1$$.length;$i$$244$$++) {
      this.element.removeClass($componentStyles$$1$$[$i$$244$$]);
    }
    this._super();
    ...
    return null;
  }, $_HandleEvent$:function($event$$245$$) {
    var $type$$80$$ = $event$$245$$ && $event$$245$$.getType ? $event$$245$$.getType() : null;
    $type$$80$$ === $dvt$$1$$.DvtCategoryHideShowEvent.TYPE_HIDE || $type$$80$$ === $dvt$$1$$.DvtCategoryHideShowEvent.TYPE_SHOW ? this.$_UserOptionChange$("hiddenCategories", $event$$245$$.hiddenCategories) : $type$$80$$ === $dvt$$1$$.DvtCategoryRolloverEvent.TYPE_OVER || $type$$80$$ === $dvt$$1$$.DvtCategoryRolloverEvent.TYPE_OUT ? this.$_UserOptionChange$("highlightedCategories", $event$$245$$.categories) : $type$$80$$ === $dvt$$1$$.DvtOptionChangeEvent.TYPE ? this.$_UserOptionChange$($event$$245$$.key, 
    $event$$245$$.value, $event$$245$$.optionMetadata) : this.options.contextMenu && $type$$80$$ === $dvt$$1$$.DvtComponentTouchEvent.TOUCH_HOVER_END_TYPE && this.$_OpenContextMenu$($$$$15$$.Event($event$$245$$.getNativeEvent()), "touch");
  ...
  }, $_NotifyContextMenuGesture$:function($menu$$5$$, $event$$246$$, $eventType$$34$$) {
    "touch" !== $eventType$$34$$ && ("keyboard" === $eventType$$34$$ ? this.$_OpenContextMenu$($event$$246$$, $eventType$$34$$, {position:{of:this.$_component$.getKeyboardFocus()}}) : this._super($menu$$5$$, $event$$246$$, $eventType$$34$$));
    ...
    for (var $ret$$31$$ = "", $i$$245$$ = 0;$i$$245$$ < $indexPath$$.length;$i$$245$$++) {
      $ret$$31$$ += "[" + $indexPath$$[$i$$245$$] + "]";
    }
    return $ret$$31$$;
    ...
    for ($path$$11$$ in $paths$$) {
      for (var $subpaths$$ = $paths$$[$path$$11$$], $i$$246$$ = 0;$i$$246$$ < $subpaths$$.length;$i$$246$$++) {
        if ("root" === $path$$11$$) {
          if (this.$_copyOptions$(this.options, $subpaths$$[$i$$246$$])) {
            break;
          }
        } else {
          var $suboptions$$ = this.options[$path$$11$$];
          if ($suboptions$$) {
            for (var $j$$35$$ = 0;$j$$35$$ < $suboptions$$.length && !this.$_copyOptions$($suboptions$$[$j$$35$$], $subpaths$$[$i$$246$$]);$j$$35$$++) {
            }
          }
        }
      }
    ...
    if (this.$_optionsCopy$) {
      ...
      for ($path$$11$$ in $paths$$) {
        $subpaths$$ = $paths$$[$path$$11$$], $subpaths$$.forEach(function($subpath$$) {
          var $promise$$;
          if ("root" === $path$$11$$) {
            ($promise$$ = $self$$110$$.$_getPromise$($self$$110$$.$_optionsCopy$, $subpath$$)) && $deferredData$$1$$.push($promise$$);
          } else {
            var $suboptions$$1$$ = $self$$110$$.$_optionsCopy$[$path$$11$$];
            if ($suboptions$$1$$) {
              for (var $j$$36$$ = 0;$j$$36$$ < $suboptions$$1$$.length;$j$$36$$++) {
                ($promise$$ = $self$$110$$.$_getPromise$($suboptions$$1$$[$j$$36$$], $subpath$$)) && $deferredData$$1$$.push($promise$$);
              }
            }
          }
        });
    ...
    if ($optionValue$$3$$ && $optionValue$$3$$ instanceof Promise) {
      ...
      var $renderCount$$ = this.$_renderCount$, $self$$111$$ = this;
      $optionValue$$3$$.then(function($value$$218$$) {
        $self$$111$$.$_renderDeferredData$($renderCount$$, $optionPath$$, $value$$218$$);
      }, function() {
        $self$$111$$.$_renderDeferredData$($renderCount$$, $optionPath$$, []);
      });
    ...
    $bRemoveResizeListener$$ && $oj$$15$$.$DomUtils$.$removeResizeListener$(this.element[0], this.$_resizeListener$);
    this.$_component$.render($options$$254$$, this.$_width$, this.$_height$);
    $bRemoveResizeListener$$ && $oj$$15$$.$DomUtils$.$addResizeListener$(this.element[0], this.$_resizeListener$, 250);
  ...
  $oj$$15$$.$ColorAttributeGroupHandler$ = function $$oj$$15$$$$ColorAttributeGroupHandler$$($matchRules$$3$$) {
    ...
    if ($$$$15$$(document.body).hasClass("oj-hicontrast")) {
      ...
      if (!$oj$$15$$.$ColorAttributeGroupHandler$.$_colors$) {
        ...
        for (var $i$$247$$ = 0;$i$$247$$ < $oj$$15$$.$ColorAttributeGroupHandler$.$_STYLE_CLASSES$.length;$i$$247$$++) {
          var $childDiv_color$$2$$ = $$$$15$$(document.createElement("div"));
          $childDiv_color$$2$$.addClass($oj$$15$$.$ColorAttributeGroupHandler$.$_STYLE_CLASSES$[$i$$247$$]);
