...
define(["ojs/ojcore", "jquery", "promise"], function($oj$$1$$, $$$$1$$) {
  $oj$$1$$.$Events$ = window.oj.Events = {on:function $window$oj$Events$on$($eventType$$11$$, $callback$$57$$, $context$$5$$) {
    ...
    for ($prop$$9$$ in $eventMap$$) {
      if ($eventMap$$.hasOwnProperty($prop$$9$$)) {
        for ($eventArray_eventType$$15$$ = $oj$$1$$.$Events$.$_getEvents$($prop$$9$$), $callback$$60_e$$14$$ = 0;$callback$$60_e$$14$$ < $eventArray_eventType$$15$$.length;$callback$$60_e$$14$$ += 1) {
          $event$$3_eventString$$ = $eventArray_eventType$$15$$[$callback$$60_e$$14$$].event, $attr$$ = $eventArray_eventType$$15$$[$callback$$60_e$$14$$].$attribute$, $listenerObj$$ = {event:$event$$3_eventString$$, $attribute$:$attr$$, object:$otherObj$$, $callback$:$eventMap$$[$prop$$9$$]}, this.$_checkForHandler$(this._listeningTo, $listenerObj$$, $oj$$1$$.$Events$.$_listenersIdentical$), $event$$3_eventString$$ = $attr$$ ? $event$$3_eventString$$ + ":" + $attr$$ : $event$$3_eventString$$, void 0 === 
    ...
    var $actualType_eventArray$$2$$, $eventMap$$2$$ = {}, $e$$16$$, $oneEvent$$, $oneAttr$$, $attrEqual_event$$5$$, $cb_objEqual$$, $eventEqual_len$$, $callbackEqual$$, $i$$17$$, $prop$$11$$;
      ...
      if ($eventMap$$2$$.hasOwnProperty($prop$$11$$)) {
        for ($actualType_eventArray$$2$$ = $oj$$1$$.$Events$.$_getEvents$($prop$$11$$), $e$$16$$ = 0;$e$$16$$ < $actualType_eventArray$$2$$.length;$e$$16$$ += 1) {
          for ($oneEvent$$ = $actualType_eventArray$$2$$[$e$$16$$].event, $oneAttr$$ = $actualType_eventArray$$2$$[$e$$16$$].$attribute$, $eventEqual_len$$ = this._listeningTo ? this._listeningTo.length : 0, $i$$17$$ = $eventEqual_len$$ - 1;0 <= $i$$17$$;$i$$17$$ -= 1) {
            $attrEqual_event$$5$$ = this._listeningTo[$i$$17$$], $cb_objEqual$$ = $otherObj$$2$$ ? $otherObj$$2$$ === $attrEqual_event$$5$$.object : !0, $eventEqual_len$$ = $oneEvent$$ ? $oneEvent$$ === $attrEqual_event$$5$$.event : !0, $callbackEqual$$ = $callback$$62$$ ? $eventMap$$2$$[$prop$$11$$] === $attrEqual_event$$5$$.$callback$ : !0, $attrEqual_event$$5$$ = $oneAttr$$ ? $oneAttr$$ === $attrEqual_event$$5$$.$attribute$ : !0, $cb_objEqual$$ && $eventEqual_len$$ && $callbackEqual$$ && $attrEqual_event$$5$$ && 
    ...
    for ($prop$$12$$ in $eventMap$$3$$) {
      if ($eventMap$$3$$.hasOwnProperty($prop$$12$$)) {
        for ($eventArray$$3_eventType$$18$$ = this.$_getEvents$($prop$$12$$), $callback$$63_e$$17$$ = 0;$callback$$63_e$$17$$ < $eventArray$$3_eventType$$18$$.length;$callback$$63_e$$17$$ += 1) {
          $event$$6$$ = $eventArray$$3_eventType$$18$$[$callback$$63_e$$17$$].event, $attr$$2$$ = $eventArray$$3_eventType$$18$$[$callback$$63_e$$17$$].$attribute$, void 0 === this.$eventHandlers$ && (this.$eventHandlers$ = []), void 0 === this.$eventHandlers$[$event$$6$$] && (this.$eventHandlers$[$event$$6$$] = []), this.$eventHandlers$[$event$$6$$].push({$callback$:$eventMap$$3$$[$prop$$12$$], context:$context$$8$$, $attribute$:$attr$$2$$, $once$:!0, fired:!1, $listen$:$listenTo$$, $otherObj$:$otherObj$$3$$})
          ;
        }
      }
    }
  ...
  $oj$$1$$.$Events$.$TriggerInternal$ = function $$oj$$1$$$$Events$$$TriggerInternal$$($silent$$, $eventType$$19$$) {
    var $eventArray$$4_handlers$$1$$ = this.$_getEvents$($eventType$$19$$), $e$$18$$, $event$$7_i$$18$$, $args$$13_attr$$3$$, $eventsToFire$$, $allHandlers$$, $callback$$64$$;
    $eventsToFire$$ = [];
    for ($e$$18$$ = 0;$e$$18$$ < $eventArray$$4_handlers$$1$$.length;$e$$18$$ += 1) {
      $event$$7_i$$18$$ = $eventArray$$4_handlers$$1$$[$e$$18$$].event, $args$$13_attr$$3$$ = $eventArray$$4_handlers$$1$$[$e$$18$$].$attribute$, $eventsToFire$$.push({event:$event$$7_i$$18$$, $attribute$:$args$$13_attr$$3$$});
    }
    for ($e$$18$$ = 0;$e$$18$$ < $eventsToFire$$.length;$e$$18$$ += 1) {
      ...
      for ($event$$7_i$$18$$ = 0;$event$$7_i$$18$$ < ($eventArray$$4_handlers$$1$$ ? $eventArray$$4_handlers$$1$$.length : 0);$event$$7_i$$18$$ += 1) {
        $eventArray$$4_handlers$$1$$[$event$$7_i$$18$$].$attribute$ === $eventsToFire$$[$e$$18$$].$attribute$ && $eventArray$$4_handlers$$1$$[$event$$7_i$$18$$].$callback$ && ($args$$13_attr$$3$$ = Array.prototype.slice.call(arguments), $eventArray$$4_handlers$$1$$ && $eventArray$$4_handlers$$1$$[$event$$7_i$$18$$] && $eventArray$$4_handlers$$1$$[$event$$7_i$$18$$].$once$ && (this.$_removeHandler$($oj$$1$$.$Events$.$_getHandlers$(this.$eventHandlers$, $eventsToFire$$[$e$$18$$].event, !0), $eventArray$$4_handlers$$1$$[$event$$7_i$$18$$]), 
        $eventArray$$4_handlers$$1$$[$event$$7_i$$18$$].$otherObj$ && $eventArray$$4_handlers$$1$$[$event$$7_i$$18$$].$otherObj$.stopListening(this, $eventType$$19$$, $eventArray$$4_handlers$$1$$[$event$$7_i$$18$$].$callback$)), $eventArray$$4_handlers$$1$$ && $eventArray$$4_handlers$$1$$[$event$$7_i$$18$$] && this.$_shouldFire$($eventArray$$4_handlers$$1$$[$event$$7_i$$18$$]) && ($callback$$64$$ = $eventArray$$4_handlers$$1$$[$event$$7_i$$18$$].$callback$, $silent$$ && !$eventArray$$4_handlers$$1$$[$event$$7_i$$18$$].$ignoreSilent$ || 
        $callback$$64$$.apply($oj$$1$$.$Events$.$_getContext$(this, $eventArray$$4_handlers$$1$$[$event$$7_i$$18$$]), $args$$13_attr$$3$$.slice(2))));
      }
      for ($event$$7_i$$18$$ = 0;$event$$7_i$$18$$ < ($allHandlers$$ ? $allHandlers$$.length : 0);$event$$7_i$$18$$ += 1) {
        $args$$13_attr$$3$$ = Array.prototype.slice.call(arguments), 0 < $args$$13_attr$$3$$.length && ($args$$13_attr$$3$$[1] = $eventsToFire$$[$e$$18$$].$attribute$ ? $eventsToFire$$[$e$$18$$].event + ":" + $eventsToFire$$[$e$$18$$].$attribute$ : $eventsToFire$$[$e$$18$$].event), $allHandlers$$ && $allHandlers$$[$event$$7_i$$18$$] && $allHandlers$$[$event$$7_i$$18$$].$callback$ && this.$_shouldFire$($allHandlers$$[$event$$7_i$$18$$]) && ($callback$$64$$ = $allHandlers$$[$event$$7_i$$18$$].$callback$, 
        $silent$$ && !$allHandlers$$[$event$$7_i$$18$$].$ignoreSilent$ || $callback$$64$$.apply($oj$$1$$.$Events$.$_getContext$(this, $allHandlers$$[$event$$7_i$$18$$]), $args$$13_attr$$3$$.slice(1))), $allHandlers$$ && $allHandlers$$[$event$$7_i$$18$$] && $allHandlers$$[$event$$7_i$$18$$].$once$ && (this.$_removeHandler$(this.$_getHandlers$(this.$eventHandlers$, $oj$$1$$.$Events$.$EventType$.ALL, !0), $allHandlers$$[$event$$7_i$$18$$]), $allHandlers$$[$event$$7_i$$18$$].$otherObj$ && $allHandlers$$[$event$$7_i$$18$$].$otherObj$.stopListening(this, 
    ...
    for ($prop$$13$$ in $eventMap$$4_eventType$$20$$) {
      if ($eventMap$$4_eventType$$20$$.hasOwnProperty($prop$$13$$)) {
        for ($callback$$65_eventArray$$5$$ = this.$_getEvents$($prop$$13$$), $i$$19$$ = 0;$i$$19$$ < $callback$$65_eventArray$$5$$.length;$i$$19$$ += 1) {
          $event$$8$$ = $callback$$65_eventArray$$5$$[$i$$19$$].event, $attr$$4_eventObj$$ = $callback$$65_eventArray$$5$$[$i$$19$$].$attribute$, void 0 === this.$eventHandlers$ && (this.$eventHandlers$ = []), void 0 === this.$eventHandlers$[$event$$8$$] && (this.$eventHandlers$[$event$$8$$] = []), $attr$$4_eventObj$$ = {$callback$:$eventMap$$4_eventType$$20$$[$prop$$13$$], context:$context$$9$$, $attribute$:$attr$$4_eventObj$$, $listen$:$listenTo$$1$$, $ignoreSilent$:$ignoreSilent$$}, -1 === this.$_checkForHandler$(this.$eventHandlers$[$event$$8$$], 
  ...
  $oj$$1$$.$Events$.$_removeEvent$ = function $$oj$$1$$$$Events$$$_removeEvent$$($e$$19_eventType$$23$$, $callback$$68$$, $context$$12$$, $listen$$1$$) {
    ...
    for ($e$$19_eventType$$23$$ = 0;$e$$19_eventType$$23$$ < $eventArray$$6$$.length;$e$$19_eventType$$23$$ += 1) {
      if ($event$$9$$ = $eventArray$$6$$[$e$$19_eventType$$23$$].event, $attr$$5$$ = $eventArray$$6$$[$e$$19_eventType$$23$$].$attribute$, void 0 !== this.$eventHandlers$ && this.$eventHandlers$[$event$$9$$] instanceof Array) {
  ...
  $oj$$1$$.$Model$.prototype.matches = function $$oj$$1$$$$Model$$$matches$($JSCompiler_inline_result$$4_attrs$$8$$) {
    a: {
      for (var $prop$$inline_343$$ in $JSCompiler_inline_result$$4_attrs$$8$$) {
        if (this.get($prop$$inline_343$$) !== $JSCompiler_inline_result$$4_attrs$$8$$[$prop$$inline_343$$]) {
  ...
  $oj$$1$$.$Collection$.prototype.$_setChangeAt$ = function $$oj$$1$$$$Collection$$$$_setChangeAt$$($start$$6$$, $count$$8$$) {
    for (var $at$$ = $start$$6$$;$at$$ < $start$$6$$ + $count$$8$$;$at$$++) {
      -1 === this.changes.indexOf($at$$) && (this.changes.push($at$$), this.changes.sort(function($a$$88$$, $b$$49$$) {
        return $a$$88$$ - $b$$49$$;
      }));
    }
  };
  ...
  $oj$$1$$.$Collection$.prototype.$_cloneInternal$ = function $$oj$$1$$$$Collection$$$$_cloneInternal$$($i$$41_withProperties$$) {
    ...
    if ($i$$41_withProperties$$) {
      ...
      $indices$$.sort(function($a$$89$$, $b$$50$$) {
        return $a$$89$$ - $b$$50$$;
      });
      var $index$$56$$;
  ...
  $oj$$1$$.$Collection$.prototype.$_addInternal$ = function $$oj$$1$$$$Collection$$$$_addInternal$$($m$$2$$, $options$$67$$, $fillIn$$, $deferred$$2$$) {
    function $mergeAttrs$$($collection$$10$$, $modelToTryAndMerge_sortOpt$$inline_377$$, $modelFoundInCollection$$1$$, $newModel$$3$$, $deferred$$4$$) {
      ...
      $needSort$$1$$ && void 0 === $existingModel$$1$$ && !$sort$$ && void 0 === $at$$1$$ && 1 < $collection$$10$$.$_getLength$() && (-1 < $index$$57$$ && ($cid$$1$$ = $collection$$10$$.$_getModel$($index$$57$$).cid), $modelToTryAndMerge_sortOpt$$inline_377$$ = {}, $oj$$1$$.$CollectionUtils$.$copyInto$($modelToTryAndMerge_sortOpt$$inline_377$$, $options$$67$$), $modelToTryAndMerge_sortOpt$$inline_377$$.add = !0, $collection$$10$$.sort($modelToTryAndMerge_sortOpt$$inline_377$$), -1 < $index$$57$$ && 
  ...
  $oj$$1$$.$Collection$.prototype.sort = function $$oj$$1$$$$Collection$$$sort$($options$$68$$) {
    ...
    $self$$7$$ = this;
    this.$_getModels$().sort(function($a$$90$$, $b$$51$$) {
      return $oj$$1$$.$Collection$.$SortFunc$($a$$90$$, $b$$51$$, $comparator$$2$$, $self$$7$$, $self$$7$$);
    });
  ...
  $oj$$1$$.$Collection$.$SortFunc$ = function $$oj$$1$$$$Collection$$$SortFunc$$($a$$91$$, $b$$52$$, $attrs$$12_comparator$$3$$, $collection$$13$$, $self$$8$$) {
    var $attrs1_keyA$$, $keyB_retVal$$2$$, $i$$45$$;
    if ($$$$1$$.isFunction($attrs$$12_comparator$$3$$)) {
      if (1 === $attrs$$12_comparator$$3$$.length) {
        $attrs1_keyA$$ = $attrs$$12_comparator$$3$$.call($self$$8$$, $a$$91$$);
      ...
      return $attrs$$12_comparator$$3$$.call($self$$8$$, $a$$91$$, $b$$52$$);
    }
    if ($oj$$1$$.$StringUtils$.$isString$($attrs$$12_comparator$$3$$)) {
      for ($attrs$$12_comparator$$3$$ = $attrs$$12_comparator$$3$$.split(","), $i$$45$$ = 0;$i$$45$$ < $attrs$$12_comparator$$3$$.length;$i$$45$$++) {
        if ($attrs1_keyA$$ = $oj$$1$$.$Collection$.$_getKey$($a$$91$$, $attrs$$12_comparator$$3$$[$i$$45$$]), $keyB_retVal$$2$$ = $oj$$1$$.$Collection$.$_getKey$($b$$52$$, $attrs$$12_comparator$$3$$[$i$$45$$]), $keyB_retVal$$2$$ = $oj$$1$$.$Collection$.$_compareKeys$($attrs1_keyA$$, $keyB_retVal$$2$$, $collection$$13$$.sortDirection), 0 !== $keyB_retVal$$2$$) {
          return $keyB_retVal$$2$$;
        }
      }
    }
  ...
  $oj$$1$$.$Collection$.prototype.$sortedIndex$ = function $$oj$$1$$$$Collection$$$$sortedIndex$$($model$$23$$, $comparator$$4$$) {
    ...
    $self$$9$$ = this;
    return $oj$$1$$.$Collection$.$_find$(this.$_getModels$(), $model$$23$$, function($a$$92$$, $b$$53$$) {
      var $attrs1$$1_keyA$$1$$, $attrs2$$1_keyB$$1$$;
      if ($$$$1$$.isFunction($comp$$)) {
        if (1 === $comp$$.length) {
          $attrs1$$1_keyA$$1$$ = $comp$$.call($self$$9$$, $a$$92$$);
        ...
        return $comp$$.call($self$$9$$, $a$$92$$, $b$$53$$);
      }
      return $oj$$1$$.$StringUtils$.$isString$($comp$$) ? ($attrs1$$1_keyA$$1$$ = $a$$92$$.get($comp$$), $attrs2$$1_keyB$$1$$ = $b$$53$$.get($comp$$), $oj$$1$$.$Collection$.$_compareKeys$($attrs1$$1_keyA$$1$$, $attrs2$$1_keyB$$1$$, $self$$9$$.sortDirection)) : 0;
    });
  };
  ...
  $oj$$1$$.$Collection$.prototype.$_modelEvent$ = function $$oj$$1$$$$Collection$$$$_modelEvent$$($event$$14$$, $model$$29$$, $collection$$14$$, $options$$78$$) {
    $event$$14$$ === $oj$$1$$.$Events$.$EventType$.DESTROY && this.remove($model$$29$$);
    void 0 !== $collection$$14$$ && $collection$$14$$ instanceof $oj$$1$$.$Collection$ && $collection$$14$$ !== this || (Array.prototype.slice.call(arguments), this.$TriggerInternal$($options$$78$$ && $options$$78$$.silent, $event$$14$$, $model$$29$$, $collection$$14$$, $options$$78$$));
  };
    ...
    if (this.$IsVirtual$()) {
      ...
      return new Promise(function($resolve$$10$$, $reject$$10$$) {
        ...
        $opts$$7$$.success = function $$opts$$7$$$success$($collection$$17$$, $response$$3$$) {
          if (null != $response$$3$$) {
            var $index$$inline_380$$ = $self$$20$$.$_getOffset$(), $model$$inline_381$$ = $self$$20$$.$_getModel$($index$$inline_380$$);
            void 0 !== $model$$inline_381$$ && $model$$inline_381$$.$Match$($id$$9$$, $cid$$4$$) ? $resolve$$10$$($oj$$1$$.$Collection$.$_getModinfo$($index$$inline_380$$, $model$$inline_381$$)) : $resolve$$10$$($oj$$1$$.$Collection$.$_getModinfo$(-1, void 0));
          } else {
  ...
  $oj$$1$$.$Collection$.prototype.$_setRangeLocalFetch$ = function $$oj$$1$$$$Collection$$$$_setRangeLocalFetch$$($start$$19$$, $count$$15$$, $actual$$3_placement$$, $original$$2$$, $resolve$$14$$, $reject$$14$$, $fill$$) {
    ...
    $newStart_opts$$8$$.success = function $$newStart_opts$$8$$$success$() {
      var $actual$$inline_383$$ = $self$$23$$.$_getLocalRange$($original$$2$$.start, $original$$2$$.count);
      if ($fill$$ && $self$$23$$.$_hasTotalResults$() && $actual$$inline_383$$.count < $original$$2$$.count) {
        var $newPlacement$$inline_384$$ = $actual$$inline_383$$.start + $actual$$inline_383$$.count, $newStart$$inline_385$$ = $start$$19$$ + $count$$15$$;
        $newStart$$inline_385$$ < $self$$23$$.totalResults ? $self$$23$$.$_setRangeLocalFetch$($newStart$$inline_385$$, $count$$15$$, $newPlacement$$inline_384$$, $original$$2$$, $resolve$$14$$, $reject$$14$$, $fill$$) : $resolve$$14$$($actual$$inline_383$$);
      } else {
        $resolve$$14$$($actual$$inline_383$$);
      }
    };
    try {
  ...
  $oj$$1$$.$Collection$.prototype.$sortBy$ = function $$oj$$1$$$$Collection$$$$sortBy$$($iterator$$2$$, $context$$25$$) {
    ...
    $self$$29$$ = this;
    $retArr$$2$$.sort(function($a$$93$$, $b$$54$$) {
      var $keyA$$3$$, $keyB$$3$$;
      if ($$$$1$$.isFunction($iterator$$2$$)) {
        return $keyA$$3$$ = $iterator$$2$$.call($context$$25$$ || $self$$29$$, $a$$93$$), $keyB$$3$$ = $iterator$$2$$.call($context$$25$$ || $self$$29$$, $b$$54$$), $oj$$1$$.$Collection$.$_compareKeys$($keyA$$3$$, $keyB$$3$$, $self$$29$$.sortDirection);
      }
      $keyA$$3$$ = $a$$93$$.get($iterator$$2$$);
