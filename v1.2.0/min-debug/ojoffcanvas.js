...
define(["ojs/ojcore", "jquery", "hammerjs", "promise", "ojs/ojjquery-hammer", "ojs/ojcomponentcore"], function($oj$$35$$, $$$$32$$, $Hammer$$5$$) {
  ...
  $oj$$35$$.$OffcanvasUtils$.$_registerCloseHandler$ = function $$oj$$35$$$$OffcanvasUtils$$$_registerCloseHandler$$($offcanvas$$7$$) {
    ...
    if ($oj$$35$$.$OffcanvasUtils$.$_isAutoDismiss$($offcanvas$$7$$)) {
      var $drawer$$5$$ = $oj$$35$$.$OffcanvasUtils$.$_getDrawer$($offcanvas$$7$$), $dismisHandler$$ = $offcanvas$$7$$[$oj$$35$$.$OffcanvasUtils$.$DISMISS_HANDLER_KEY$] = function $$offcanvas$$7$$$$oj$$35$$$$OffcanvasUtils$$$DISMISS_HANDLER_KEY$$($event$$413$$) {
        var $target$$92$$ = $event$$413$$.target;
        $oj$$35$$.$DomUtils$.$isChromeEvent$($event$$413$$) || "focus" === $event$$413$$.type && !$$$$32$$($target$$92$$).is(":focusable") || $oj$$35$$.$DomUtils$.$isLogicalAncestorOrSelf$($drawer$$5$$[0], $target$$92$$) || $oj$$35$$.$OffcanvasUtils$.close($offcanvas$$7$$);
  ...
  $oj$$35$$.$OffcanvasUtils$.$_registerSwipeHandler$ = function $$oj$$35$$$$OffcanvasUtils$$$_registerSwipeHandler$$($offcanvas$$9$$) {
    if ($oj$$35$$.$DomUtils$.$isTouchSupported$()) {
      ...
      $drawer$$6_drawerHammer$$ = $drawer$$6_drawerHammer$$.$ojHammer$($options$$307$$).on($swipeEvent$$, function($event$$414$$) {
        $event$$414$$.preventDefault();
  ...
  $oj$$35$$.$OffcanvasUtils$.$_unregisterSwipeHandler$ = function $$oj$$35$$$$OffcanvasUtils$$$_unregisterSwipeHandler$$($dHammer_drawer$$7_offcanvas$$10$$) {
    ...
    ($dHammer_drawer$$7_offcanvas$$10$$ = $$$$32$$.data($dHammer_drawer$$7_offcanvas$$10$$[0], $oj$$35$$.$OffcanvasUtils$.$_DATA_HAMMER_KEY$)) && $dHammer_drawer$$7_offcanvas$$10$$.hammer.off($dHammer_drawer$$7_offcanvas$$10$$.event);
  };
  ...
  $oj$$35$$.$OffcanvasUtils$.$setupResponsive$ = function $$oj$$35$$$$OffcanvasUtils$$$setupResponsive$$($mqListener_offcanvas$$12$$) {
    ...
    if (null !== $mqs_query$$11$$) {
      ...
      $mqListener_offcanvas$$12$$ = function $$mqListener_offcanvas$$12$$$($event$$415$$) {
        $oj$$35$$.$OffcanvasUtils$.$_setVisible$($selector$$34$$, $event$$415$$.matches, $edge$$9$$);
      };
  ...
  $oj$$35$$.$OffcanvasUtils$.open = function $$oj$$35$$$$OffcanvasUtils$$open$($offcanvas$$14$$) {
    ...
    var $oldOffcanvas_promise$$7$$ = new Promise(function($resolve$$35$$, $reject$$33$$) {
      $oj$$35$$.$Assert$.$assertPrototype$($drawer$$11$$, jQuery);
      var $edge$$10$$ = $oj$$35$$.$OffcanvasUtils$.$_saveEdge$($offcanvas$$14$$), $displayMode$$2_event$$416$$ = $$$$32$$.Event("ojbeforeopen");
      $drawer$$11$$.trigger($displayMode$$2_event$$416$$, $offcanvas$$14$$);
      if (!1 === $displayMode$$2_event$$416$$.result) {
        $reject$$33$$("ojbeforeopen veto");
      } else {
        var $size$$24$$, $displayMode$$2_event$$416$$ = $oj$$35$$.$OffcanvasUtils$.$_getDisplayMode$($offcanvas$$14$$), $myOffcanvas$$ = $$$$32$$.extend({}, $offcanvas$$14$$);
        $myOffcanvas$$[$oj$$35$$.$OffcanvasUtils$.$DISPLAY_MODE_KEY$] = $displayMode$$2_event$$416$$;
        ...
        $edge$$10$$ === $oj$$35$$.$OffcanvasUtils$.$EDGE_START$ || $edge$$10$$ === $oj$$35$$.$OffcanvasUtils$.$EDGE_END$ ? ($size$$24$$ = void 0 === $size$$24$$ ? $drawer$$11$$.outerWidth(!0) + "px" : $size$$24$$, $displayMode$$2_event$$416$$ === $oj$$35$$.$OffcanvasUtils$.$DISPLAY_MODE_PUSH$ && $oj$$35$$.$OffcanvasUtils$.$_setTranslationX$($wrapper$$8$$, $edge$$10$$, $size$$24$$)) : ($size$$24$$ = void 0 === $size$$24$$ ? $drawer$$11$$.outerHeight(!0) + "px" : $size$$24$$, $displayMode$$2_event$$416$$ === 
  ...
  $oj$$35$$.$OffcanvasUtils$.$_close$ = function $$oj$$35$$$$OffcanvasUtils$$$_close$$($selector$$35$$, $animation$$2$$) {
    ...
    var $promise$$8$$ = new Promise(function($resolve$$36$$, $reject$$34$$) {
      if ($oj$$35$$.$OffcanvasUtils$.$_isOpen$($drawer$$12$$)) {
        $selector$$35$$ != $offcanvas$$16$$[$oj$$35$$.$OffcanvasUtils$.$SELECTOR_KEY$] && $resolve$$36$$(!0);
        ...
        $outerWrapper$$1$$.hasClass($edge$$11_shiftSelector$$) || $resolve$$36$$(!0);
        var $event$$417_wrapper$$9$$ = $$$$32$$.Event("ojbeforeclose");
        $drawer$$12$$.trigger($event$$417_wrapper$$9$$, $offcanvas$$16$$);
        if (!1 === $event$$417_wrapper$$9$$.result) {
          $reject$$34$$("beforeClose veto");
        } else {
          $event$$417_wrapper$$9$$ = $oj$$35$$.$OffcanvasUtils$.$_getAnimateWrapper$($offcanvas$$16$$);
          if ($animation$$2$$) {
            ...
            $oj$$35$$.$OffcanvasUtils$.$_onTransitionEnd$($event$$417_wrapper$$9$$, $endHandler$$1$$);
            $rafId$$ = window.requestAnimationFrame($checkDetachedHandler$$);
          }
          $displayMode$$3$$ === $oj$$35$$.$OffcanvasUtils$.$DISPLAY_MODE_PUSH$ && $oj$$35$$.$OffcanvasUtils$.$_setTransform$($event$$417_wrapper$$9$$, "");
          ...
          $animation$$2$$ ? $event$$417_wrapper$$9$$.addClass($oj$$35$$.$OffcanvasUtils$.$TRANSITION_SELECTOR$) : ($oj$$35$$.$OffcanvasUtils$.$_afterCloseHandler$($offcanvas$$16$$), $resolve$$36$$(!0));
        }
      } else {
        $resolve$$36$$(!0);
      }
  ...
  $oj$$35$$.$OffcanvasUtils$.$_addGlassPane$ = function $$oj$$35$$$$OffcanvasUtils$$$_addGlassPane$$($drawer$$14$$) {
    ...
    $overlay$$2$$.on("keydown keyup keypress mousedown mouseup mouseover mouseout click focusin focus", function($event$$418$$) {
      $event$$418$$.stopPropagation();
  ...
  $oj$$35$$.$OffcanvasUtils$.$setupPanToReveal$ = function $$oj$$35$$$$OffcanvasUtils$$$setupPanToReveal$$($offcanvas$$22$$) {
    var $drawer$$19$$, $size$$25$$, $outerWrapper$$2$$, $wrapper$$10$$, $mOptions$$, $proceed$$, $direction$$7$$, $ui$$22$$, $evt$$26$$, $delta$$6$$, $edge$$12$$, $listener$$39$$;
    ...
    $mOptions$$ = {recognizers:[[$Hammer$$5$$.Pan, {direction:$Hammer$$5$$.DIRECTION_HORIZONTAL}]]}, $proceed$$ = !1, $$$$32$$($outerWrapper$$2$$).$ojHammer$($mOptions$$).on("panstart", function($event$$419$$) {
      switch($event$$419$$.gesture.direction) {
        case $Hammer$$5$$.DIRECTION_LEFT:
          $direction$$7$$ = $oj$$35$$.$OffcanvasUtils$.$_isRTL$() ? "end" : "start";
          break;
        case $Hammer$$5$$.DIRECTION_RIGHT:
          $direction$$7$$ = $oj$$35$$.$OffcanvasUtils$.$_isRTL$() ? "start" : "end";
      }
      $ui$$22$$ = {direction:$direction$$7$$, distance:Math.abs($event$$419$$.gesture.deltaX)};
      $evt$$26$$ = $$$$32$$.Event("ojpanstart");
      $drawer$$19$$.trigger($evt$$26$$, $ui$$22$$);
      $evt$$26$$.isDefaultPrevented() || ($offcanvas$$22$$._closePromise = null, $oj$$35$$.$OffcanvasUtils$.$_toggleClass$($offcanvas$$22$$, $wrapper$$10$$, !0), $proceed$$ = !0);
    }).on("panmove", function($event$$420$$) {
      $proceed$$ && ($delta$$6$$ = Math.abs($event$$420$$.gesture.deltaX), $drawer$$19$$.css("width", $delta$$6$$), $wrapper$$10$$.removeClass($oj$$35$$.$OffcanvasUtils$.$TRANSITION_SELECTOR$), $oj$$35$$.$OffcanvasUtils$.$_setTranslationX$($wrapper$$10$$, "start", $event$$420$$.gesture.deltaX + "px"), $ui$$22$$ = {direction:$direction$$7$$, distance:$delta$$6$$}, $evt$$26$$ = $$$$32$$.Event("ojpanmove"), $drawer$$19$$.trigger($evt$$26$$, $ui$$22$$));
    }).on("panend", function($event$$421$$) {
      $proceed$$ && ($proceed$$ = !1, $delta$$6$$ = Math.abs($event$$421$$.gesture.deltaX), $ui$$22$$ = {distance:$delta$$6$$}, $evt$$26$$ = $$$$32$$.Event("ojpanend"), $drawer$$19$$.trigger($evt$$26$$, $ui$$22$$), $evt$$26$$.isDefaultPrevented() ? ($listener$$39$$ = function $$listener$$39$$$() {
