 ...
 */
"use strict";
define(["ojs/ojcore", "jquery", "ojs/ojeditablevalue", "ojs/ojradiocheckbox"], function($oj$$69$$, $$$$64$$) {
  (function() {
    $oj$$69$$.$__registerWidget$("oj.ojRadioset", $$$$64$$.oj.editableValue, {version:"1.0.0", defaultElement:"\x3cdiv\x3e", widgetEventPrefix:"oj", options:{disabled:!1, value:void 0}, refresh:function() {
      this._super();
      this.$_setup$();
    }, widget:function() {
      ...
      $oj$$69$$.$EditableValueUtils$.$initializeOptionsFromDom$([{$attribute$:"disabled", $validateOption$:!0}, {$attribute$:"placeholder"}, {$attribute$:"required", $coerceDomValue$:!0, $validateOption$:!0}, {$attribute$:"title"}], $constructorOptions$$22$$, this);
      ...
      var $element$$140$$ = this.element;
      this._super();
      if ($element$$140$$.is("fieldset")) {
        throw Error("ojRadioset cannot be bound to a fieldset. Use a div instead.");
      }
      this.$$radios$._ojRadioCheckbox();
      this.$uiRadioset$ = $element$$140$$.addClass("oj-radioset oj-component").attr("role", "radiogroup").wrapInner("\x3cdiv class\x3d'oj-radioset-wrapper'\x3e\x3c/div\x3e");
      ...
      var $allradios_element$$141$$ = this.element, $first$$10_name$$119$$ = $allradios_element$$141$$.find("input[type\x3dradio]:first");
      0 === $first$$10_name$$119$$.length && $oj$$69$$.$Logger$.warn("Could not find any input type\x3dradio within this element");
      $first$$10_name$$119$$ = $first$$10_name$$119$$.attr("name");
      return void 0 === $first$$10_name$$119$$ ? ($allradios_element$$141$$ = $allradios_element$$141$$.find("input[type\x3dradio]"), $allradios_element$$141$$.not("[name]")) : $allradios_element$$141$$.find("input[type\x3dradio][name\x3d" + $first$$10_name$$119$$ + "]");
    }, $_NotifyContextMenuGesture$:function($launcher$$13_menu$$25_radios$$, $event$$605$$, $eventType$$53$$) {
      ...
      this.$_OpenContextMenu$($event$$605$$, $eventType$$53$$, {launcher:$launcher$$13_menu$$25_radios$$});
    }, _GetMessagingLauncherElement:function() {
      var $inputElem$$1$$ = this.$_GetContentElement$(), $renderInputAs$$1$$ = $oj$$69$$.$ThemeUtils$.$getOptionDefaultMap$("radioset").renderInputAs;
      return $renderInputAs$$1$$ && "html" !== $renderInputAs$$1$$ ? this.widget() : $inputElem$$1$$;
    }, $_setup$:function() {
      this.$_propagateDisabled$(this.options.disabled);
    }, $_events$:{change:function($event$$606$$) {
      this.$_HandleChangeEvent$($event$$606$$);
    }}, $_HandleChangeEvent$:function($event$$607$$) {
      var $submittedValue$$5$$ = this.$_GetDisplayValue$();
      this.$_SetValue$($submittedValue$$5$$, $event$$607$$, $_sValueChangeCheckFalse$$1$$);
    ...
    }, _setOption:function($key$$181$$, $value$$291$$) {
      this._superApply(arguments);
      "disabled" === $key$$181$$ && this.$_propagateDisabled$($value$$291$$);
    }, getNodeBySubId:function($locator$$64_subId$$67$$) {
      var $node$$163$$ = this._super($locator$$64_subId$$67$$);
      $node$$163$$ || ($locator$$64_subId$$67$$ = $locator$$64_subId$$67$$.subId, "oj-radioset-inputs" === $locator$$64_subId$$67$$ && ($node$$163$$ = this.$$radios$.get()));
      return $node$$163$$ || null;
    }, _destroy:function() {
      var $ret$$80$$ = this._super(), $wrapperDom$$1$$ = this.element[0].firstChild;
