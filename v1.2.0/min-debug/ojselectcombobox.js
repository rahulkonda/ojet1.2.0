...
define(["ojs/ojcore", "jquery", "ojs/ojeditablevalue"], function($oj$$12$$, $$$$12$$) {
  var $_ComboUtils$$ = {$GENERATED_OPTIONS_SELECTOR$:"oj-select-options-generated", $KEY$:{TAB:9, ENTER:13, $ESC$:27, SPACE:32, LEFT:37, UP:38, RIGHT:39, DOWN:40, $SHIFT$:16, $CTRL$:17, $ALT$:18, PAGE_UP:33, PAGE_DOWN:34, HOME:36, END:35, $BACKSPACE$:8, $DELETE$:46, $isControl$:function($e$$51$$) {
    ...
    for (var $j$$19$$ = $$$$12$$.isFunction($list$$1$$[0]) ? $$$$12$$($list$$1$$[0]()) : $$$$12$$($list$$1$$[0]), $i$$140$$ = -1, $l$$3$$ = $list$$1$$.length;++$i$$140$$ < $l$$3$$ && ($j$$19$$.context = $j$$19$$[0] = $$$$12$$.isFunction($list$$1$$[0]) ? $list$$1$$[$i$$140$$]() : $list$$1$$[$i$$140$$]) && !1 !== $c$$37$$.call($j$$19$$[0], $i$$140$$, $j$$19$$);) {
    }
    return $list$$1$$;
    ...
    var $val$$27$$, $i$$141$$, $l$$4$$;
    if (null === $string$$3$$ || 1 > $string$$3$$.length) {
      return[];
    }
    $val$$27$$ = $string$$3$$.split($separator$$);
    $i$$141$$ = 0;
    for ($l$$4$$ = $val$$27$$.length;$i$$141$$ < $l$$4$$;$i$$141$$ += 1) {
      $val$$27$$[$i$$141$$] = $$$$12$$.trim($val$$27$$[$i$$141$$]);
    }
    return $val$$27$$;
  }, $getSideBorderPadding$:function($element$$68$$) {
    return $element$$68$$.outerWidth(!1) - $element$$68$$.width();
  }, $installKeyUpChangeEvent$:function($element$$69$$) {
    $element$$69$$.on("keydown", function() {
      void 0 === $$$$12$$.data($element$$69$$, "keyup-change-value") && $$$$12$$.data($element$$69$$, "keyup-change-value", $element$$69$$.val());
    });
    $element$$69$$.on("keyup", function($e$$52_val$$28$$) {
      $e$$52_val$$28$$.which === $_ComboUtils$$.$KEY$.ENTER ? $e$$52_val$$28$$.stopPropagation() : ($e$$52_val$$28$$ = $$$$12$$.data($element$$69$$, "keyup-change-value"), void 0 !== $e$$52_val$$28$$ && $element$$69$$.val() !== $e$$52_val$$28$$ && ($$$$12$$.removeData($element$$69$$, "keyup-change-value"), $element$$69$$.trigger("keyup-change")));
    });
  }, $installFilteredMouseMove$:function($element$$70$$) {
    $element$$70$$.on("mousemove", function($e$$53$$) {
    ...
    var $evaluated$$ = !1, $value$$180$$;
    return function() {
      !1 === $evaluated$$ && ($value$$180$$ = $formula$$(), $evaluated$$ = !0);
      return $value$$180$$;
    };
  }, $_focus$:function($$el$$) {
  ...
  }, $killEvent$:function($event$$107$$) {
    $event$$107$$.preventDefault();
    $event$$107$$.stopPropagation();
  }, $killEventImmediately$:function($event$$108$$) {
    $event$$108$$.preventDefault();
    $event$$108$$.stopImmediatePropagation();
    ...
    var $data$$76$$ = $options$$223$$, $dataText$$, $tmp$$1$$;
    $$$$12$$.isArray($data$$76$$) && ($tmp$$1$$ = $data$$76$$, $data$$76$$ = {$results$:$tmp$$1$$});
    !1 === $$$$12$$.isFunction($data$$76$$) && ($tmp$$1$$ = $data$$76$$, $data$$76$$ = function $$data$$76$$$() {
      return $tmp$$1$$;
    });
    var $dataItem$$ = $data$$76$$();
    ...
    return function($query$$6$$) {
      ...
      "" !== $query$$6$$.$term$ || $optKeys$$ ? ($data$$76$$() && $_ComboUtils$$.$each2$($$$$12$$($data$$76$$().$results$), function($i$$142$$, $datum$$) {
        $_ComboUtils$$.$_processData$($query$$6$$, $datum$$, $filtered$$.$results$, $optKeys$$, !0, $text$$9$$);
      }), $query$$6$$.$callback$($filtered$$)) : $query$$6$$.$callback$($data$$76$$());
    };
  }, $createOptionTag$:function($depth$$4$$, $value$$181$$, $label$$4$$, $formatFunc$$) {
  ...
  }, $lookupOptionKeys$:function($result$$29$$, $optionsKeys$$, $key$$59$$) {
    $key$$59$$ = $optionsKeys$$[$key$$59$$] || $key$$59$$;
    return $result$$29$$[$key$$59$$];
    ...
    function $populate$$1$$($container$$6$$, $arrlist$$1$$, $depth$$6$$, $optionsKeys$$2$$) {
      for (var $item$$8$$, $label$$7_node$$35$$, $children$$1_value$$182$$, $i$$143$$ = 0, $l$$5$$ = $arrlist$$1$$.length;$i$$143$$ < $l$$5$$;$i$$143$$++) {
        $item$$8$$ = $arrlist$$1$$[$i$$143$$], $children$$1_value$$182$$ = $_ComboUtils$$.$lookupOptionKeys$($item$$8$$, $optionsKeys$$2$$, "children"), $label$$7_node$$35$$ = $_ComboUtils$$.$lookupOptionKeys$($item$$8$$, $optionsKeys$$2$$, "label"), $children$$1_value$$182$$ && 0 < $children$$1_value$$182$$.length ? ($label$$7_node$$35$$ = $_ComboUtils$$.$createOptgroupTag$($container$$6$$, $label$$7_node$$35$$, $formatFunc$$3$$), $populate$$1$$($label$$7_node$$35$$, $children$$1_value$$182$$, $depth$$6$$ + 
        1, $optionsKeys$$2$$.childKeys || {})) : ($children$$1_value$$182$$ = $_ComboUtils$$.$lookupOptionKeys$($item$$8$$, $optionsKeys$$2$$, "value"), $label$$7_node$$35$$ = $_ComboUtils$$.$createOptionTag$($depth$$6$$, $children$$1_value$$182$$, $label$$7_node$$35$$, $formatFunc$$3$$)), $label$$7_node$$35$$.appendTo($container$$6$$);
      }
    }
    ...
    return function($query$$7$$) {
      var $context$$51$$ = {component:this.$ojContext$};
      $query$$7$$.value ? $context$$51$$.value = $query$$7$$.value : $context$$51$$.term = $query$$7$$.$term$ || "";
      $options$$224$$($context$$51$$).then(function($data$$77$$) {
        var $filtered$$1$$ = {$results$:[]};
        $data$$77$$ && $_ComboUtils$$.$each2$($$$$12$$($data$$77$$), function($i$$144$$, $datum$$1$$) {
          $_ComboUtils$$.$_processData$($query$$7$$, $datum$$1$$, $filtered$$1$$.$results$, $optKeys$$1$$, !1);
        });
        $query$$7$$.$callback$($filtered$$1$$);
      });
    };
  }, $_processData$:function($query$$8$$, $datum$$2$$, $collection$$29$$, $keys$$10$$, $isLocal$$, $text$$10$$) {
    var $group$$, $attr$$14$$;
    $datum$$2$$ = $datum$$2$$[0];
    !$datum$$2$$.label && $keys$$10$$ && $keys$$10$$.label && ($datum$$2$$.label = $datum$$2$$[$keys$$10$$.label]);
    !$datum$$2$$.value && $keys$$10$$ && $keys$$10$$.value && ($datum$$2$$.value = $datum$$2$$[$keys$$10$$.value]);
    !$datum$$2$$.children && $keys$$10$$ && $keys$$10$$.children && ($datum$$2$$.children = $datum$$2$$[$keys$$10$$.children], delete $datum$$2$$[$keys$$10$$.children]);
    if ($datum$$2$$.children) {
      $group$$ = {};
      ...
      $group$$.children = [];
      $_ComboUtils$$.$each2$($$$$12$$($datum$$2$$.children), function($i$$145$$, $childDatum$$) {
        $_ComboUtils$$.$_processData$($query$$8$$, $childDatum$$, $group$$.children, $keys$$10$$ && $keys$$10$$.childKeys ? $keys$$10$$.childKeys : null, $isLocal$$, $text$$10$$);
      });
  ...
  }, $LAST_QUERY_RESULT$:"last-query-result", $getLastQueryResult$:function($context$$52$$) {
    return $$$$12$$.data($context$$52$$.$container$, $context$$52$$.$_classNm$ + "-" + $_ComboUtils$$.$LAST_QUERY_RESULT$);
  }, $saveLastQueryResult$:function($context$$53$$, $queryResult$$2$$) {
    $$$$12$$.data($context$$53$$.$container$, $context$$53$$.$_classNm$ + "-" + $_ComboUtils$$.$LAST_QUERY_RESULT$, $queryResult$$2$$);
  }}, $_AbstractOjChoice$$ = $_ComboUtils$$.$clazz$(Object, {$_bind$:function($func$$8$$) {
    var $self$$70$$ = this;
    return function() {
      $func$$8$$.apply($self$$70$$, arguments);
    };
    ...
    $search$$1$$.on("focus", function() {
      ...
      "oj-select" !== $className$$6$$ && $self$$71$$.$container$.addClass("oj-focus");
    });
    $search$$1$$.on("blur", function() {
      $search$$1$$.removeClass($className$$6$$ + "-focused");
      "oj-select" !== $className$$6$$ && $self$$71$$.$container$.removeClass("oj-focus");
    });
  ...
  }, $_clickAwayHandler$:function($event$$109$$) {
    var $dropdown_self$$72$$ = this.$dropdown$;
    !$$$$12$$($event$$109$$.target).closest($dropdown_self$$72$$).length && !$$$$12$$($event$$109$$.target).closest("#" + $dropdown_self$$72$$.attr("data-oj-containerid")).length && 0 < $dropdown_self$$72$$.length && ($dropdown_self$$72$$ = $dropdown_self$$72$$.data("ojlistbox"), $dropdown_self$$72$$.close($event$$109$$));
  }, $_surrogateRemoveHandler$:function() {
    this.$dropdown$ && this.$dropdown$.remove();
  }, _destroy:function() {
    var $closeDelayTimer_element$$71$$ = this.$_closeDelayTimer$;
    isNaN($closeDelayTimer_element$$71$$) || (delete this.$_closeDelayTimer$, window.clearTimeout($closeDelayTimer_element$$71$$));
    var $closeDelayTimer_element$$71$$ = this.$opts$.element, $ojcomp$$ = $closeDelayTimer_element$$71$$.data(this.$_elemNm$);
    this.close();
    ...
    void 0 !== $ojcomp$$ && ($ojcomp$$.$container$.remove(), $ojcomp$$.$dropdown$.remove(), $closeDelayTimer_element$$71$$.removeAttr("aria-hidden").removeData(this.$_elemNm$).off("." + this.$_classNm$).prop("autofocus", this.autofocus || !1), this.$elementTabIndex$ ? $closeDelayTimer_element$$71$$.attr({$tabindex$:this.$elementTabIndex$}) : $closeDelayTimer_element$$71$$.removeAttr("tabindex"), $closeDelayTimer_element$$71$$.show());
    ...
    if ($list$$4$$ && $list$$4$$.is("ul")) {
      ...
      for (var $i$$146_wrappingDiv$$ = $list$$4$$.children().length - 1;0 <= $i$$146_wrappingDiv$$;$i$$146_wrappingDiv$$--) {
        this.$_cleanupList$($$$$12$$($list$$4$$.children()[$i$$146_wrappingDiv$$]));
      }
    } else {
      $list$$4$$.is("li") && (($list$$4$$.hasClass("oj-listbox-placeholder") || $list$$4$$.hasClass("oj-listbox-no-results")) && $list$$4$$.remove(), $list$$4$$.attr("class") && $list$$4$$.attr("class", $list$$4$$.attr("class").replace(/\oj-listbox-\S+/g, "")), ($i$$146_wrappingDiv$$ = $list$$4$$.children(".oj-listbox-result-label")) && $i$$146_wrappingDiv$$.contents().unwrap(), "none" == $list$$4$$.css("display") && $list$$4$$.css("display", ""), this.$_cleanupList$($list$$4$$.children("ul")));
    }
  }, $_optionToData$:function($element$$72$$) {
    if ($element$$72$$.is("option")) {
      return{value:$element$$72$$.prop("value"), label:$element$$72$$.text(), element:$element$$72$$.get(), css:$element$$72$$.attr("class"), disabled:$element$$72$$.prop("disabled"), locked:"locked" === $element$$72$$.attr("locked") || !0 === $element$$72$$.data("locked")};
    }
    if ($element$$72$$.is("optgroup")) {
      return{label:$element$$72$$.attr("label"), children:[], element:$element$$72$$.get(), css:$element$$72$$.attr("class")};
    }
    if ($element$$72$$.is("li")) {
      var $elemChildren_itemLabel$$, $groupData$$ = null;
      ($elemChildren_itemLabel$$ = $element$$72$$.children()) && 0 < $elemChildren_itemLabel$$.length && $elemChildren_itemLabel$$.is("ul") ? ($elemChildren_itemLabel$$ = $element$$72$$.attr("oj-data-label") ? $element$$72$$.attr("oj-data-label") : $element$$72$$.clone().children().remove().end().text().trim(), $groupData$$ = []) : $elemChildren_itemLabel$$ = $element$$72$$.attr("oj-data-label") ? $element$$72$$.attr("oj-data-label") : $element$$72$$.text().trim();
      return{value:$element$$72$$.attr("oj-data-value"), label:$elemChildren_itemLabel$$, element:$element$$72$$.get(), css:$element$$72$$.attr("class"), children:$groupData$$};
    }
  }, $_prepareOpts$:function($opts$$12$$) {
    var $element$$73$$, $datalist$$, $self$$73$$ = this;
    $opts$$12$$.options && Array.isArray($opts$$12$$.options) && $opts$$12$$.optionsKeys && ($opts$$12$$.options = $$$$12$$.extend(!0, [], $opts$$12$$.options));
    $element$$73$$ = $opts$$12$$.element;
    var $tagName$$2$$ = $element$$73$$.get(0).tagName.toLowerCase();
    "input" === $tagName$$2$$ && $element$$73$$.attr("list") ? this.$datalist$ = $datalist$$ = $$$$12$$("#" + $element$$73$$.attr("list")) : "select" === $tagName$$2$$ && 0 < $element$$73$$.children().length ? this.$datalist$ = $datalist$$ = $element$$73$$ : $opts$$12$$.list && (this.$datalist$ = $datalist$$ = $$$$12$$("#" + $opts$$12$$.list));
    $opts$$12$$ = $$$$12$$.extend({}, {$populateResults$:function($container$$8$$, $results$$1$$, $query$$9$$, $showPlaceholder$$) {
      ...
      $populate$$2$$ = function $$populate$$2$$$($resultsParent$$, $results$$2$$, $container$$9$$, $depth$$7$$, $l$$6_showPlaceholder$$1$$) {
        function $createLabelContent$$($labelNode$$, $result$$32$$) {
          if ($optionRenderer$$1$$) {
            var $content$$15_context$$54_highlighterSection$$1$$ = {index:$i$$147$$, depth:$depth$$7$$, leaf:!$result$$32$$.children, parent:$resultsParent$$, data:$result$$32$$, component:$opts$$12$$.$ojContext$, parentElement:$labelNode$$.get(0)}, $content$$15_context$$54_highlighterSection$$1$$ = $optionRenderer$$1$$.call($opts$$12$$.$ojContext$, $content$$15_context$$54_highlighterSection$$1$$);
            null !== $content$$15_context$$54_highlighterSection$$1$$ && (null === $content$$15_context$$54_highlighterSection$$1$$.parentNode || $content$$15_context$$54_highlighterSection$$1$$.parentNode instanceof DocumentFragment) && $labelNode$$.appendChild($content$$15_context$$54_highlighterSection$$1$$);
          } else {
            $formatted$$ = $opts$$12$$.$formatResult$($result$$32$$), void 0 !== $formatted$$ && $labelNode$$.text($formatted$$);
          }
          !0 !== $query$$9$$.$initial$ && ($content$$15_context$$54_highlighterSection$$1$$ = $labelNode$$.find(".oj-listbox-highlighter-section"), $content$$15_context$$54_highlighterSection$$1$$.length || ($content$$15_context$$54_highlighterSection$$1$$ = $labelNode$$), $termHighlight$$($content$$15_context$$54_highlighterSection$$1$$, $query$$9$$.$term$));
        }
        function $termHighlight$$($highlighterSection$$, $pattern$$13$$) {
          function $innerHighlight$$($node$$38$$, $pat$$1$$) {
            ...
            if (3 === $node$$38$$.nodeType) {
              var $i$$148_middlebit_pos$$6$$ = $node$$38$$.data.toUpperCase().indexOf($pat$$1$$);
              if (0 <= $i$$148_middlebit_pos$$6$$) {
                $skip$$1_spannode$$ = document.createElement("span");
                $skip$$1_spannode$$.className = "oj-listbox-highlighter";
                $i$$148_middlebit_pos$$6$$ = $node$$38$$.splitText($i$$148_middlebit_pos$$6$$);
                $i$$148_middlebit_pos$$6$$.splitText($pat$$1$$.length);
                var $middleclone$$ = $i$$148_middlebit_pos$$6$$.cloneNode(!0);
                $skip$$1_spannode$$.appendChild($middleclone$$);
                $i$$148_middlebit_pos$$6$$.parentNode.replaceChild($skip$$1_spannode$$, $i$$148_middlebit_pos$$6$$);
                $skip$$1_spannode$$ = 1;
              }
            } else {
              if (1 === $node$$38$$.nodeType && $node$$38$$.childNodes && !/(script|style)/i.test($node$$38$$.tagName)) {
                for ($i$$148_middlebit_pos$$6$$ = 0;$i$$148_middlebit_pos$$6$$ < $node$$38$$.childNodes.length;++$i$$148_middlebit_pos$$6$$) {
                  $i$$148_middlebit_pos$$6$$ += $innerHighlight$$($node$$38$$.childNodes[$i$$148_middlebit_pos$$6$$], $pat$$1$$);
                }
              }
            }
        ...
        var $i$$147$$, $placeholder_result$$30$$, $label$$8_selectable$$, $disabled$$3$$, $node$$36$$, $formatted$$;
        $placeholder_result$$30$$ = $self$$73$$.$_getPlaceholder$();
        ...
        $label$$8_selectable$$.addClass("oj-listbox-result-label"), $label$$8_selectable$$.attr("id", "oj-listbox-result-label-" + $_ComboUtils$$.$nextUid$()), $label$$8_selectable$$.attr("role", "option"), $formatted$$ = $opts$$12$$.$formatResult$($placeholder_result$$30$$), void 0 !== $formatted$$ && $label$$8_selectable$$.text($formatted$$), $node$$36$$.append($label$$8_selectable$$), $node$$36$$.data($self$$73$$.$_elemNm$, $placeholder_result$$30$$), $container$$9$$.prepend($node$$36$$));
        $i$$147$$ = 0;
        for ($l$$6_showPlaceholder$$1$$ = $results$$2$$.length;$i$$147$$ < $l$$6_showPlaceholder$$1$$;$i$$147$$ += 1) {
          $placeholder_result$$30$$ = $results$$2$$[$i$$147$$];
          ...
          "true"), $isList$$ || ($createLabelContent$$($label$$8_selectable$$, $placeholder_result$$30$$), $node$$36$$.append($label$$8_selectable$$)), $placeholder_result$$30$$.children && 0 < $placeholder_result$$30$$.children.length && $processChildren$$($node$$36$$, $placeholder_result$$30$$), $node$$36$$.data($self$$73$$.$_elemNm$, $placeholder_result$$30$$), $isList$$ ? ($$$$12$$($placeholder_result$$30$$.element[0]).contents().filter(function() {
    ...
    $opts$$12$$.$formatSelection$ = function $$opts$$12$$$$formatSelection$$($data$$78$$) {
      return $data$$78$$ && $data$$78$$.label ? isNaN($data$$78$$.label) ? $data$$78$$.label : this.$ojContext$.$_formatValue$($data$$78$$.label) : void 0;
    };
    ...
    $datalist$$ ? $opts$$12$$.$query$ = this.$_bind$(function($query$$10$$) {
      var $data$$79$$ = {$results$:[], $more$:!1}, $term$$1$$ = $query$$10$$.$term$, $children$$2$$, $process$$;
      $process$$ = function $$process$$$($element$$74$$, $collection$$30$$) {
        var $group$$1$$, $nestedLi$$ = $element$$74$$.children() && 0 < $element$$74$$.children().length && $element$$74$$.children().is("ul");
        if ($element$$74$$.is("option") || $element$$74$$.is("li") && !$nestedLi$$) {
          $query$$10$$.$matcher$($term$$1$$, $element$$74$$.text(), $element$$74$$) && $collection$$30$$.push($self$$73$$.$_optionToData$($element$$74$$));
        } else {
          if ($element$$74$$.is("optgroup") || $element$$74$$.is("li") && $nestedLi$$) {
            $group$$1$$ = $self$$73$$.$_optionToData$($element$$74$$), $_ComboUtils$$.$each2$($element$$74$$.is("optgroup") ? $element$$74$$.children() : $element$$74$$.children("ul").children(), function($i$$149$$, $elm$$1$$) {
      ...
      $_ComboUtils$$.$each2$($children$$2$$, function($i$$150$$, $elm$$2$$) {
        $process$$($elm$$2$$, $data$$79$$.$results$);
      });
      $query$$10$$.$callback$($data$$79$$);
  ...
  }, $_triggerSelect$:function($data$$80_evt$$20$$) {
    $data$$80_evt$$20$$ = $$$$12$$.Event(this.$_elemNm$ + "-selecting", {val:this.id($data$$80_evt$$20$$), object:$data$$80_evt$$20$$});
    this.$opts$.element.trigger($data$$80_evt$$20$$);
    return!$data$$80_evt$$20$$.isDefaultPrevented();
  ...
  }, $_highlightUnderEvent$:function($el$$5_event$$111$$) {
    $el$$5_event$$111$$ = $$$$12$$($el$$5_event$$111$$.target).closest(".oj-listbox-result-selectable");
    if (0 < $el$$5_event$$111$$.length && !$el$$5_event$$111$$.is(".oj-hover")) {
      var $choices$$2$$ = this.$_findHighlightableChoices$();
      this.$_highlight$($choices$$2$$.index($el$$5_event$$111$$));
    } else {
      0 == $el$$5_event$$111$$.length && this.$_removeHighlight$();
    }
  }, $_updateResults$:function($initial$$) {
    var $self$$74$$ = this, $term$$2$$ = this.search.val(), $lastTerm$$ = $$$$12$$.data(this.$container$, this.$_classNm$ + "-last-term");
    if (!0 === $initial$$ || !$lastTerm$$ || $term$$2$$ !== $lastTerm$$) {
      if ($lastTerm$$ || $term$$2$$ || !$initial$$ || "input" !== $initial$$.type) {
        $$$$12$$.data(this.$container$, this.$_classNm$ + "-last-term", $term$$2$$), $term$$2$$.length >= (this.$opts$.minLength || 0) ? (clearTimeout(this.$queryTimer$), $initial$$ && !0 !== $initial$$ ? this.$queryTimer$ = setTimeout(function() {
          $self$$74$$.$_queryResults$($initial$$);
        }, $_ComboUtils$$.$DEFAULT_QUERY_DELAY$) : this.$_queryResults$($initial$$)) : this.close();
      }
    }
  }, $_queryResults$:function($initial$$1$$) {
    function $postRender$$() {
      $self$$75$$.$_positionDropdown$();
      if ($self$$75$$.header && $self$$75$$.$headerItems$.length) {
        var $highlightableChoices_highlightableOptions$$ = $self$$75$$.$_findHighlightableChoices$(), $totalOptions$$ = $self$$75$$.$headerItems$.length + $highlightableChoices_highlightableOptions$$.length;
        $self$$75$$.$headerItems$.attr("aria-setsize", $totalOptions$$);
        $highlightableChoices_highlightableOptions$$.length && ($highlightableChoices_highlightableOptions$$ = $highlightableChoices_highlightableOptions$$.children("[role\x3d'option']"), $highlightableChoices_highlightableOptions$$.attr("aria-setsize", $totalOptions$$), $highlightableChoices_highlightableOptions$$.first().attr("aria-posinset", $self$$75$$.$headerItems$.length + 1));
      }
    }
    var $search$$3$$ = this.search, $results$$4$$ = this.$results$, $opts$$13$$ = this.$opts$, $self$$75$$ = this, $input$$2_term$$3$$;
    ...
    page:this.$resultsPage$, context:null, $matcher$:$opts$$13$$.$matcher$, $callback$:this.$_bind$(function($data$$82_li$$1$$) {
      $queryNumber$$ === this.$queryCount$ && this.$_opened$() && (this.context = $data$$82_li$$1$$ && void 0 !== $data$$82_li$$1$$.context ? $data$$82_li$$1$$.context : null, $data$$82_li$$1$$ && 0 !== $data$$82_li$$1$$.$results$.length || !$_ComboUtils$$.$checkFormatter$($self$$75$$.$ojContext$, $opts$$13$$.$formatNoMatches$, "formatNoMatches") ? ($_ComboUtils$$.$saveLastQueryResult$(this, $data$$82_li$$1$$.$results$), this.$_showDropDown$(), this.$_preprocessResults$($results$$4$$), $self$$75$$.$opts$.$populateResults$.call(this, 
      $results$$4$$, $data$$82_li$$1$$.$results$, {$term$:$search$$3$$.val(), page:this.$resultsPage$, context:null, $initial$:$initial$$1$$}, this.$_showPlaceholder$()), this.$_postprocessResults$($data$$82_li$$1$$, $initial$$1$$), $postRender$$()) : "oj-select" === this.$_classNm$ && !0 !== this.$opts$.multiple || this.header ? ($data$$82_li$$1$$ = $$$$12$$("\x3cli\x3e"), $data$$82_li$$1$$.addClass("oj-listbox-no-results"), $data$$82_li$$1$$.text($opts$$13$$.$formatNoMatches$($self$$75$$.$ojContext$, 
      $search$$3$$.val())), this.$_showDropDown$(), this.$_preprocessResults$($results$$4$$), $results$$4$$.append($data$$82_li$$1$$), $postRender$$()) : this.close());
    })}));
    ...
    for (var $i$$151$$ = 0;$i$$151$$ < $resultList$$1$$.length;$i$$151$$++) {
      $$$$12$$($resultList$$1$$[$i$$151$$]).is("LI") && (($$$$12$$($resultList$$1$$[$i$$151$$]).hasClass("oj-listbox-no-results") || $$$$12$$($resultList$$1$$[$i$$151$$]).hasClass("oj-listbox-placeholder")) && $$$$12$$($resultList$$1$$[$i$$151$$]).remove(), $$$$12$$($resultList$$1$$[$i$$151$$]).css("display", "none"), $$$$12$$($resultList$$1$$[$i$$151$$]).hasClass("oj-selected") && $$$$12$$($resultList$$1$$[$i$$151$$]).removeClass("oj-selected"));
      var $nested$$ = $$$$12$$($resultList$$1$$[$i$$151$$]).children("ul");
      $nested$$ && $nested$$.children() && this.$_hideResultList$($nested$$.children());
    }
  }, $_cancel$:function($event$$112$$) {
    this.close($event$$112$$);
  }, $_focusSearch$:function() {
    $_ComboUtils$$.$_focus$(this.search);
  }, $_selectHighlighted$:function($options$$225$$, $event$$113$$) {
    if (this.header) {
      ...
      if (this.$_isHeaderItem$($activeDescendant$$1_activeItem_index$$107$$)) {
        var $activeDescendant$$1_activeItem_index$$107$$ = $$$$12$$("#" + $activeDescendant$$1_activeItem_index$$107$$), $clickable_data$$83$$ = $activeDescendant$$1_activeItem_index$$107$$.find("a, input, select, textarea, button, object").first();
        0 === $clickable_data$$83$$.length && ($clickable_data$$83$$ = $activeDescendant$$1_activeItem_index$$107$$.children());
        $clickable_data$$83$$.length && $clickable_data$$83$$[0].click();
        this.close($event$$113$$);
        return;
      }
    }
    $activeDescendant$$1_activeItem_index$$107$$ = this.$_highlight$();
    ($clickable_data$$83$$ = this.$results$.find(".oj-hover").closest(".oj-listbox-result").data(this.$_elemNm$)) ? (this.$_highlight$($activeDescendant$$1_activeItem_index$$107$$), $options$$225$$ = $options$$225$$ || {}, $options$$225$$.trigger = $_ComboUtils$$.$ValueChangeTriggerTypes$.$OPTION_SELECTED$, this.$_onSelect$($clickable_data$$83$$, $options$$225$$, $event$$113$$)) : $options$$225$$ && $options$$225$$.$noFocus$ && this.close($event$$113$$);
    ...
    var $attrs$$inline_673_style$$inline_672_width$$15$$;
    a: {
      var $attr$$inline_677_matches$$inline_674$$, $i$$inline_675$$, $l$$inline_676$$;
      $attrs$$inline_673_style$$inline_672_width$$15$$ = this.$opts$.element.attr("style");
      if (void 0 !== $attrs$$inline_673_style$$inline_672_width$$15$$) {
        for ($attrs$$inline_673_style$$inline_672_width$$15$$ = $attrs$$inline_673_style$$inline_672_width$$15$$.split(";"), $i$$inline_675$$ = 0, $l$$inline_676$$ = $attrs$$inline_673_style$$inline_672_width$$15$$.length;$i$$inline_675$$ < $l$$inline_676$$;$i$$inline_675$$ += 1) {
          if ($attr$$inline_677_matches$$inline_674$$ = $attrs$$inline_673_style$$inline_672_width$$15$$[$i$$inline_675$$].replace(/\s/g, ""), $attr$$inline_677_matches$$inline_674$$ = $attr$$inline_677_matches$$inline_674$$.match(/^width:(([-+]?([0-9]*\.)?[0-9]+)(px|em|ex|%|in|cm|mm|pt|pc))/i), null !== $attr$$inline_677_matches$$inline_674$$ && 1 <= $attr$$inline_677_matches$$inline_674$$.length) {
            $attrs$$inline_673_style$$inline_672_width$$15$$ = $attr$$inline_677_matches$$inline_674$$[1];
            break a;
          }
        }
      }
      $attrs$$inline_673_style$$inline_672_width$$15$$ = void 0;
    }
    null !== $attrs$$inline_673_style$$inline_672_width$$15$$ && this.$container$.css("width", $attrs$$inline_673_style$$inline_672_width$$15$$);
  }, $getVal$:function() {
    return this.$ojContext$.option("value");
  }, $setVal$:function($val$$29$$, $event$$114$$, $context$$55$$) {
    var $options$$226$$ = {$doValueChangeCheck$:!1};
    $context$$55$$ && ($options$$226$$._context = $context$$55$$);
    "string" === typeof $val$$29$$ ? this.$ojContext$.$_SetValue$([$val$$29$$], $event$$114$$, $options$$226$$) : this.$ojContext$.$_SetValue$($val$$29$$, $event$$114$$, $options$$226$$);
  ...
  }, $_findItem$:function($list$$5$$, $value$$183$$) {
    for (var $i$$153$$ = 0;$i$$153$$ < $list$$5$$.length;$i$$153$$++) {
      if ($$$$12$$($list$$5$$[$i$$153$$]).data(this.$_elemNm$).value === $value$$183$$) {
        return $list$$5$$[$i$$153$$];
      }
    }
    return null;
  ...
  }, $_clear$:function($event$$115$$) {
    this.selection.data(this.$_elemNm$) && ($event$$115$$ || $oj$$12$$.$Logger$.warn("Event should not be null when user modified the value in UI"), "oj-select" === this.$_classNm$ && this.$ojContext$.$_IsRequired$() || this.$setVal$([], $event$$115$$), this.search.val(""), this.selection.removeData(this.$_elemNm$));
    ...
    $container$$12_selection$$1$$.on("mousedown", this.$_bind$(function($e$$65$$) {
      this.$opts$.element.prop("disabled") && $_ComboUtils$$.$killEvent$($e$$65$$);
      this.$_opened$() ? this.close($e$$65$$) : this.$_isInterfaceEnabled$() && this.open($e$$65$$);
    ...
    this.search.on("blur keyup", this.$_bind$(function($e$$68_formatted$$1$$) {
      if ("keyup" !== $e$$68_formatted$$1$$.type || 10 === $e$$68_formatted$$1$$.keyCode || 13 === $e$$68_formatted$$1$$.keyCode) {
        if (void 0 !== this.search.val() && 0 >= this.$results$.find(".oj-hover").length) {
          if (this.$opts$.manageNewEntry) {
            var $data$$85_selectionData$$ = this.selection.data(this.$_elemNm$);
            if (!$data$$85_selectionData$$ && "" !== this.search.val() || $data$$85_selectionData$$ && ($data$$85_selectionData$$.label !== this.search.val() || !this.$ojContext$.isValid())) {
              $data$$85_selectionData$$ = this.$opts$.manageNewEntry(this.search.val()), this.$_onSelect$($data$$85_selectionData$$, {trigger:"blur" === $e$$68_formatted$$1$$.type ? $_ComboUtils$$.$ValueChangeTriggerTypes$.$BLUR$ : $_ComboUtils$$.$ValueChangeTriggerTypes$.$ENTER_PRESSED$}, $e$$68_formatted$$1$$);
            }
          } else {
            null == this.$opts$.manageNewEntry && (($data$$85_selectionData$$ = this.selection.data(this.$_elemNm$), "" == this.search.val()) ? this.$_clear$($e$$68_formatted$$1$$) : $data$$85_selectionData$$ || "" === this.search.val() ? "oj-select" !== this.$_classNm$ && ($e$$68_formatted$$1$$ = this.$opts$.$formatSelection$($data$$85_selectionData$$), void 0 !== $e$$68_formatted$$1$$ && this.search.val($e$$68_formatted$$1$$)) : this.$_clearSearch$());
          }
        }
    ...
    var $opts$$14$$ = $_AbstractSingleChoice$$.$superclass$.$_prepareOpts$.apply(this, arguments), $self$$77$$ = this, $tagName$$3$$ = $opts$$14$$.element.get(0).tagName.toLowerCase();
    if ("input" === $tagName$$3$$ && $opts$$14$$.element.attr("list") || "select" === $tagName$$3$$ && 0 < $opts$$14$$.element.children().length || $opts$$14$$.list) {
      ...
      $opts$$14$$.$initSelection$ = function $$opts$$14$$$$initSelection$$($element$$76$$, $callback$$85$$) {
        var $selected$$1$$, $value$$184$$ = $self$$77$$.$getVal$();
        Array.isArray($value$$184$$) && ($value$$184$$ = $value$$184$$[0]);
        $selected$$1$$ = void 0 !== $value$$184$$ && null !== $value$$184$$ ? $self$$77$$.$_optionToData$($element$$76$$.find($eleName$$).filter(function() {
          if ("li" == $eleName$$) {
            return this.getAttribute("oj-data-value") === $value$$184$$;
          }
          if ("option" == $eleName$$) {
            return this.value === $value$$184$$;
          }
        })) : $self$$77$$.$_optionToData$($element$$76$$.find($eleName$$).filter(function() {
          if ("li" == $eleName$$) {
      ...
      $opts$$14$$.validate = function $$opts$$14$$$validate$($element$$77$$, $value$$185$$) {
        var $selected$$2$$;
        void 0 !== $value$$185$$ && null !== $value$$185$$ && ($selected$$2$$ = $self$$77$$.$_optionToData$($element$$77$$.find($eleName$$).filter(function() {
          if ("li" == $eleName$$) {
            return this.getAttribute("oj-data-value") === $value$$185$$;
          }
          if ("option" == $eleName$$) {
            return this.value === $value$$185$$;
          }
        })));
        return!!$selected$$2$$;
      };
      ...
      if ("options" in $opts$$14$$ || this.$getVal$() && 0 < this.$getVal$().length) {
        $$$$12$$.isFunction($opts$$14$$.options) ? $opts$$14$$.$initSelection$ = function $$opts$$14$$$$initSelection$$($element$$78$$, $callback$$86$$) {
          function $findOption$$($results$$6$$, $optionValue$$1$$) {
            for (var $i$$154$$ = 0, $l$$8$$ = $results$$6$$.length;$i$$154$$ < $l$$8$$;$i$$154$$++) {
              var $found$$4_result$$34$$ = $results$$6$$[$i$$154$$];
          ...
          var $id$$17$$ = "";
          $self$$77$$.$getVal$() && $self$$77$$.$getVal$().length && ($id$$17$$ = $self$$77$$.$getVal$()[0]);
          var $match$$17$$ = null;
          if ($id$$17$$) {
            var $currentItem$$2_queryResult$$3$$ = $_ComboUtils$$.$getLastQueryResult$($self$$77$$);
            $currentItem$$2_queryResult$$3$$ && ($match$$17$$ = $findOption$$($currentItem$$2_queryResult$$3$$, $id$$17$$));
            $match$$17$$ || ($currentItem$$2_queryResult$$3$$ = $self$$77$$.currentItem) && $currentItem$$2_queryResult$$3$$.length && $id$$17$$ === $opts$$14$$.id($currentItem$$2_queryResult$$3$$[0]) && ($match$$17$$ = $currentItem$$2_queryResult$$3$$[0]);
            $match$$17$$ || $self$$77$$.$valueChangeTrigger$ ? $callback$$86$$($match$$17$$) : $opts$$14$$.$query$({value:[$id$$17$$], $callback$:$$$$12$$.isFunction($callback$$86$$) ? function($queryResult$$4$$) {
        ...
        } : ($opts$$14$$.$initSelection$ = function $$opts$$14$$$$initSelection$$($element$$79$$, $callback$$87$$) {
          var $id$$18$$ = "";
          $self$$77$$.$getVal$() && $self$$77$$.$getVal$().length && ($id$$18$$ = $self$$77$$.$getVal$()[0]);
          var $first$$4$$ = "select" == $tagName$$3$$ && $self$$77$$.$ojContext$.$_HasPlaceholderSet$() && !$self$$77$$.$ojContext$.$_IsRequired$() ? $self$$77$$.$_getPlaceholder$() : null, $match$$18$$ = null;
        ...
        }, $opts$$14$$.validate = function $$opts$$14$$$validate$($element$$80$$, $value$$186$$) {
          var $match$$19$$ = null;
          $opts$$14$$.$query$({$matcher$:function($is_match$$1_term$$6$$, $text$$13$$, $el$$7$$) {
            ($is_match$$1_term$$6$$ = $value$$186$$ === $opts$$14$$.id($el$$7$$)) && ($match$$19$$ = $el$$7$$);
    ...
    return $opts$$14$$;
  }, $_postprocessResults$:function($data$$86_highlightableChoices$$1$$, $initial$$2$$, $noHighlightUpdate$$) {
    var $selected$$3$$ = -1, $self$$78$$ = this;
    $data$$86_highlightableChoices$$1$$ = this.$_findHighlightableChoices$();
    $_ComboUtils$$.$each2$($data$$86_highlightableChoices$$1$$, function($i$$155$$, $elm$$3$$) {
      if ($self$$78$$.$getVal$() && $self$$78$$.$getVal$()[0] === $self$$78$$.id($elm$$3$$.data($self$$78$$.$_elemNm$))) {
        return $selected$$3$$ = $i$$155$$, !1;
      }
    });
    !1 !== $noHighlightUpdate$$ && !0 === $initial$$2$$ && 0 <= $selected$$3$$ && this.$_highlight$($selected$$3$$);
  }, $_onSelect$:function($data$$87$$, $options$$228$$, $event$$116$$) {
    if (this.$_triggerSelect$($data$$87$$)) {
      var $context$$56$$;
      $options$$228$$ && $options$$228$$.trigger && ($context$$56$$ = {$optionMetadata$:{trigger:$options$$228$$.trigger}});
      this.close($event$$116$$);
      this.$setVal$(0 === this.id($data$$87$$).length ? [] : this.id($data$$87$$), $event$$116$$, $context$$56$$);
      this.$_focusSearch$();
    }
  }, $_clearSearch$:function() {
    this.search.val("");
  ...
  }, close:function($event$$117$$) {
    this.$_opened$() && $_OjSingleCombobox$$.$superclass$.close.apply(this, arguments);
  }, $_opening$:function($event$$118$$, $dontUpdateResults$$1$$) {
    $_OjSingleCombobox$$.$superclass$.$_opening$.apply(this, arguments);
    $dontUpdateResults$$1$$ || this.$_updateResults$(!0);
  }, $_containerKeydownHandler$:function($e$$69$$) {
    $_ComboUtils$$.$KEY$.$isControl$($e$$69$$) || $_ComboUtils$$.$KEY$.$isFunctionKey$($e$$69$$) || $_OjSingleCombobox$$.$superclass$.$_containerKeydownHandler$.apply(this, arguments);
  }, $_updateSelection$:function($data$$88$$) {
    var $formatted$$2$$, $item$$11$$ = [];
    this.selection.data(this.$_elemNm$, $data$$88$$);
    null !== $data$$88$$ && 0 != $data$$88$$.length ? ($formatted$$2$$ = this.$opts$.$formatSelection$($data$$88$$), void 0 !== $formatted$$2$$ && this.search.val() !== $formatted$$2$$ && this.search.val($formatted$$2$$), this.search.removeClass(this.$_classNm$ + "-default"), $item$$11$$.push($data$$88$$)) : (this.search.val(""), this.$_setPlaceholder$());
    this.currentItem = $item$$11$$;
    this.$opts$.$allowClear$ && this.$container$.addClass(this.$_classNm$ + "-allowclear");
  }, $_updateSelectedOption$:function($data$$89_selected$$4_value$$187$$) {
    if (void 0 === $data$$89_selected$$4_value$$187$$ || null === $data$$89_selected$$4_value$$187$$) {
      $data$$89_selected$$4_value$$187$$ = ($data$$89_selected$$4_value$$187$$ = this.$getVal$()) ? Array.isArray($data$$89_selected$$4_value$$187$$) ? Array.isArray($data$$89_selected$$4_value$$187$$) && $data$$89_selected$$4_value$$187$$.length ? {label:$data$$89_selected$$4_value$$187$$[0]} : null : {label:$data$$89_selected$$4_value$$187$$} : null;
    }
    this.$_updateSelection$($data$$89_selected$$4_value$$187$$);
    ...
    this.$_opened$() && ($_OjSingleSelect$$.$superclass$.close.apply(this, arguments), this.$container$.find(".oj-select-choice").attr("aria-expanded", !1), this.$_testClear$($event$$119$$) || this.$_clearSearch$(), $event$$119$$ instanceof MouseEvent && $event$$119$$.target != this.selection && $event$$119$$.target != this.search || $_ComboUtils$$.$_focus$(this.selection), this.$container$.find(".oj-listbox-spyglass-box").off("mouseup click"));
  }, $_opening$:function($event$$120$$, $dontUpdateResults$$2$$) {
    $_OjSingleSelect$$.$superclass$.$_opening$.apply(this, arguments);
    var $searchText$$;
    $event$$120$$ && "keydown" == $event$$120$$.type && $event$$120$$.which != $_ComboUtils$$.$KEY$.UP && $event$$120$$.which != $_ComboUtils$$.$KEY$.DOWN && $event$$120$$.which != $_ComboUtils$$.$KEY$.LEFT && $event$$120$$.which != $_ComboUtils$$.$KEY$.RIGHT && ($searchText$$ = String.fromCharCode($event$$120$$.which), $_ComboUtils$$.$killEvent$($event$$120$$));
    ...
    var $self$$79$$ = this;
    this.selection.on("blur", function($e$$70$$) {
      $self$$79$$.$_testClear$($e$$70$$);
    });
  }, $_initSelection$:function() {
    ...
    if (void 0 !== $selected$$5$$ && null !== $selected$$5$$) {
      var $selectedVal$$, $value$$188$$ = this.$getVal$(), $value$$188$$ = Array.isArray($value$$188$$) ? $value$$188$$[0] : $value$$188$$;
      $selectedVal$$ = this.$opts$.id($selected$$5$$);
      $value$$188$$ !== $selectedVal$$ && (void 0 === $value$$188$$ || null === $value$$188$$ ? this.$ojContext$.options.value = Array.isArray($selectedVal$$) ? $selectedVal$$ : [$selectedVal$$] : this.$setVal$(Array.isArray($selectedVal$$) ? $selectedVal$$ : [$selectedVal$$]));
      this.$_updateSelection$($selected$$5$$);
      this.close();
    }
  }, $_updateSelection$:function($data$$90$$) {
    this.selection.data(this.$_elemNm$, $data$$90$$);
    null !== $data$$90$$ && this.text.text($data$$90$$.label);
    $data$$90$$ && "" != $data$$90$$.id && this.text.removeClass(this.$_classNm$ + "-default");
    this.$opts$.$allowClear$ && this.$container$.addClass(this.$_classNm$ + "-allowclear");
  }, $_getActiveContainer$:function() {
  ...
  }, $setVal$:function($val$$31$$, $event$$121$$, $context$$57$$) {
    $_OjSingleSelect$$.$superclass$.$setVal$.call(this, $val$$31$$, $event$$121$$, $context$$57$$);
    this.selection.data("selectVal", $val$$31$$);
  }, $_containerKeydownHandler$:function($e$$71$$) {
    if (!($_ComboUtils$$.$KEY$.$isControl$($e$$71$$) && $e$$71$$.which != $_ComboUtils$$.$KEY$.$SHIFT$ || $_ComboUtils$$.$KEY$.$isFunctionKey$($e$$71$$))) {
      switch($e$$71$$.which) {
        case $_ComboUtils$$.$KEY$.TAB:
          this.close($e$$71$$);
          this.selection.focus();
          this.$_testClear$($e$$71$$);
          return;
        case $_ComboUtils$$.$KEY$.ENTER:
          if ($e$$71$$.target === this.selection[0] && !this.$_opened$()) {
            this.open($e$$71$$);
      ...
      this.$_userTyping$ && !this.$_opened$() && this.open($e$$71$$);
      if (!$hasSearchBoxAlready$$ && this.$_userTyping$) {
        var $c$$38$$;
        $e$$71$$.which != $_ComboUtils$$.$KEY$.LEFT && $e$$71$$.which != $_ComboUtils$$.$KEY$.RIGHT && ($c$$38$$ = String.fromCharCode($e$$71$$.which));
        this.$_showSearchBox$($c$$38$$);
        this.$_updateResults$();
        $_ComboUtils$$.$killEvent$($e$$71$$);
      }
    }
  }, $_testClear$:function($event$$122$$) {
    return "" == this.text.text() ? (this.$_clear$($event$$122$$), !0) : !1;
    ...
    if ($focusOnSearchBox$$) {
      var $self$$80$$ = this;
      $searchBox$$.find(".oj-listbox-spyglass-box").on("mouseup click", function($e$$72$$) {
    ...
    var $opts$$15$$ = $_AbstractMultiChoice$$.$superclass$.$_prepareOpts$.apply(this, arguments), $self$$81$$ = this, $tagName$$4$$ = $opts$$15$$.element.get(0).tagName.toLowerCase();
    if ("input" === $tagName$$4$$ && $opts$$15$$.element.attr("list") || "select" === $tagName$$4$$ && 0 < $opts$$15$$.element.children().length || $opts$$15$$.list) {
      ...
      $opts$$15$$.$initSelection$ = function $$opts$$15$$$$initSelection$$($element$$81$$, $callback$$88$$) {
        var $data$$91$$ = [];
        if ($self$$81$$.$getVal$()) {
          for (var $selected$$6$$, $ids$$ = $self$$81$$.$getVal$(), $i$$156$$ = 0;$i$$156$$ < $ids$$.length;$i$$156$$++) {
            var $id$$20$$ = $ids$$[$i$$156$$];
            ($selected$$6$$ = $element$$81$$.find($eleName$$1$$).filter(function() {
              if ("option" === $eleName$$1$$) {
            ...
            })) && $selected$$6$$.length ? $data$$91$$.push($self$$81$$.$_optionToData$($selected$$6$$)) : $data$$91$$.push({value:$id$$20$$, label:$id$$20$$});
          }
        } else {
          "select" !== $tagName$$4$$ && ($selected$$6$$ = $element$$81$$.find($eleName$$1$$).filter(function() {
            if ("option" === $eleName$$1$$) {
              return this.selected;
            }
            if ("li" === $eleName$$1$$) {
          ...
          }), $_ComboUtils$$.$each2$($selected$$6$$, function($i$$157$$, $elm$$4$$) {
            $data$$91$$.push($self$$81$$.$_optionToData$($elm$$4$$));
          }));
        }
        $callback$$88$$($data$$91$$);
      };
    } else {
      "options" in $opts$$15$$ && ($opts$$15$$.$initSelection$ = $$$$12$$.isFunction($opts$$15$$.options) ? function($element$$82$$, $callback$$89$$) {
        function $reorderOptions$$() {
          for (var $ordered$$ = [], $i$$159$$ = 0;$i$$159$$ < $ids$$1$$.length;$i$$159$$++) {
            for (var $id$$21$$ = $ids$$1$$[$i$$159$$], $found$$5$$ = !1, $currentItem$$3_j$$20$$ = 0;$currentItem$$3_j$$20$$ < $matches$$3$$.length;$currentItem$$3_j$$20$$++) {
            ...
            if (!$found$$5$$) {
              if (($currentItem$$3_j$$20$$ = $self$$81$$.currentItem) && $currentItem$$3_j$$20$$.length) {
        ...
        function $findOptions$$($results$$7$$, $optionValues$$) {
          for (var $foundOptions$$ = [], $i$$158$$ = 0, $l$$9$$ = $results$$7$$.length;$i$$158$$ < $l$$9$$;$i$$158$$++) {
            var $childOptions_result$$35$$ = $results$$7$$[$i$$158$$];
        ...
        var $ids$$1$$ = $self$$81$$.$getVal$(), $matches$$3$$ = [], $queryResult$$5$$ = $_ComboUtils$$.$getLastQueryResult$($self$$81$$);
        $queryResult$$5$$ && ($matches$$3$$ = $findOptions$$($queryResult$$5$$, $ids$$1$$));
        $self$$81$$.$valueChangeTrigger$ ? $reorderOptions$$() : $opts$$15$$.$query$({value:$ids$$1$$, $callback$:function($queryResult$$6_results$$8$$) {
      ...
      } : $opts$$15$$.$initSelection$ || function($element$$83$$, $callback$$90$$) {
        var $ids$$2$$ = $self$$81$$.$getVal$(), $matches$$4$$ = [];
        $opts$$15$$.$query$({$matcher$:function($is_match$$2_term$$7$$, $text$$14$$, $el$$9$$) {
          ...
          for (var $ordered$$1$$ = [], $i$$160$$ = 0;$i$$160$$ < $ids$$2$$.length;$i$$160$$++) {
            for (var $id$$23$$ = $ids$$2$$[$i$$160$$], $found$$6$$ = !1, $j$$21$$ = 0;$j$$21$$ < $matches$$4$$.length;$j$$21$$++) {
    ...
    this.$keydowns$ = 0;
    this.search.on("keydown", this.$_bind$(function($e$$74$$) {
      if (this.$_isInterfaceEnabled$()) {
        ++this.$keydowns$;
        ...
        if (!$selected$$8$$.length || $e$$74$$.which != $_ComboUtils$$.$KEY$.LEFT && $e$$74$$.which != $_ComboUtils$$.$KEY$.RIGHT && $e$$74$$.which != $_ComboUtils$$.$KEY$.$BACKSPACE$ && $e$$74$$.which != $_ComboUtils$$.$KEY$.$DELETE$ && $e$$74$$.which != $_ComboUtils$$.$KEY$.ENTER) {
          if (($e$$74$$.which !== $_ComboUtils$$.$KEY$.$BACKSPACE$ || 1 != this.$keydowns$) && $e$$74$$.which != $_ComboUtils$$.$KEY$.LEFT || 0 != $pos$$8_selectedChoice$$.offset || $pos$$8_selectedChoice$$.length) {
            ...
            if (this.$_opened$()) {
              switch($e$$74$$.which) {
                ...
                ;
                case $_ComboUtils$$.$KEY$.DOWN:
                  this.$_moveHighlight$($e$$74$$.which === $_ComboUtils$$.$KEY$.UP ? -1 : 1);
                  $_ComboUtils$$.$killEvent$($e$$74$$);
                  return;
                case $_ComboUtils$$.$KEY$.ENTER:
                  this.$_selectHighlighted$(null, $e$$74$$);
                  $_ComboUtils$$.$killEvent$($e$$74$$);
                  return;
                case $_ComboUtils$$.$KEY$.TAB:
                  this.close($e$$74$$);
            ...
            if (!($e$$74$$.which === $_ComboUtils$$.$KEY$.TAB || $_ComboUtils$$.$KEY$.$isControl$($e$$74$$) || $_ComboUtils$$.$KEY$.$isFunctionKey$($e$$74$$) || $e$$74$$.which === $_ComboUtils$$.$KEY$.$ESC$ || $e$$74$$.which === $_ComboUtils$$.$KEY$.ENTER && this.search.val() && "ojcombobox" === this.$_elemNm$)) {
              switch($e$$74$$.which) {
                case $_ComboUtils$$.$KEY$.UP:
                ;
                case $_ComboUtils$$.$KEY$.DOWN:
            ...
            this.$_selectChoice$($selection$$2$$.find("." + this.$_classNm$ + "-selected-choice:not(." + this.$_classNm$ + "-locked)").last()), $_ComboUtils$$.$killEvent$($e$$74$$);
          }
        } else {
          $pos$$8_selectedChoice$$ = $selected$$8$$, $e$$74$$.which == $_ComboUtils$$.$KEY$.LEFT && $prev$$.length ? $pos$$8_selectedChoice$$ = $prev$$ : $e$$74$$.which == $_ComboUtils$$.$KEY$.RIGHT ? $pos$$8_selectedChoice$$ = $next$$.length ? $next$$ : null : $e$$74$$.which === $_ComboUtils$$.$KEY$.$BACKSPACE$ ? (this.$_unselect$($selected$$8$$.first(), $e$$74$$), this.search.width(10), $pos$$8_selectedChoice$$ = $prev$$.length ? $prev$$ : $next$$) : $e$$74$$.which == $_ComboUtils$$.$KEY$.$DELETE$ ? 
          (this.$_unselect$($selected$$8$$.first(), $e$$74$$), this.search.width(10), $pos$$8_selectedChoice$$ = $next$$.length ? $next$$ : null) : $e$$74$$.which == $_ComboUtils$$.$KEY$.ENTER && ($pos$$8_selectedChoice$$ = null), this.$_selectChoice$($pos$$8_selectedChoice$$), $_ComboUtils$$.$killEvent$($e$$74$$), $pos$$8_selectedChoice$$ && $pos$$8_selectedChoice$$.length || this.open();
        }
      }
    }));
    ...
    this.search.on("blur keyup", this.$_bind$(function($e$$76$$) {
      if ("keyup" !== $e$$76$$.type || 10 === $e$$76$$.keyCode || 13 === $e$$76$$.keyCode) {
        if (this.$opts$.manageNewEntry && this.search.val() && 0 >= this.$results$.find(".oj-hover").length) {
          var $data$$92$$ = this.$opts$.manageNewEntry(this.search.val());
          this.$_onSelect$($data$$92$$, {trigger:"blur" === $e$$76$$.type ? $_ComboUtils$$.$ValueChangeTriggerTypes$.$BLUR$ : $_ComboUtils$$.$ValueChangeTriggerTypes$.$ENTER_PRESSED$}, $e$$76$$);
        }
        this.search.removeClass(this.$_classNm$ + "-focused");
        this.$container$.removeClass("oj-focus");
        this.$_selectChoice$(null);
        this.$_opened$() || this.$_clearSearch$();
        $e$$76$$.stopImmediatePropagation();
      }
    }));
    this.$container$.on("click touchstart", $selector$$23$$, this.$_bind$(function($e$$77$$) {
      !this.$_isInterfaceEnabled$() || 0 < $$$$12$$($e$$77$$.target).closest("." + this.$_classNm$ + "-selected-choice").length || (this.$_selectChoice$(null), this.$_opened$() ? this.close($e$$77$$) : (this.open(), this.$_focusSearch$()), $e$$77$$.preventDefault());
    }));
    ...
    if (this.$datalist$ || null !== this.$getVal$() && this.$getVal$().length) {
      var $self$$82$$ = this;
      this.$opts$.$initSelection$.call(null, this.$datalist$ ? this.$datalist$ : this.$opts$.element, function($data$$94$$) {
        void 0 !== $data$$94$$ && null !== $data$$94$$ && 0 !== $data$$94$$.length && ($self$$82$$.$_updateSelection$($data$$94$$), $self$$82$$.close(), $self$$82$$.$_clearSearch$());
      });
    }
  }, $_clearSearch$:function() {
  ...
  }, $_opening$:function($event$$123$$, $dontUpdateResults$$3$$) {
    this.$_resizeSearch$();
    $_AbstractMultiChoice$$.$superclass$.$_opening$.apply(this, arguments);
    this.$_focusSearch$();
    $dontUpdateResults$$3$$ || this.$_updateResults$(!0);
    this.search.focus();
  }, close:function($event$$124$$) {
    this.$_opened$() && $_AbstractMultiChoice$$.$superclass$.close.apply(this, arguments);
  }, $_focus$:function() {
    this.close();
    this.search.focus();
  }, $_updateSelection$:function($data$$95$$) {
    var $ids$$3$$ = [], $filtered$$2$$ = [], $self$$83$$ = this;
    $$$$12$$($data$$95$$).each(function() {
      0 > $ids$$3$$.indexOf($self$$83$$.id(this)) && ($ids$$3$$.push($self$$83$$.id(this)), $filtered$$2$$.push(this));
    });
    $data$$95$$ = $filtered$$2$$;
    ...
    this.currentItem = $data$$95$$;
    this.$opts$.element.val(0 === $ids$$3$$.length ? "" : $ids$$3$$.join(this.$opts$.separator));
    $self$$83$$.$_postprocessResults$();
  }, $_onSelect$:function($data$$96$$, $options$$230$$, $event$$125$$) {
    if (this.$_triggerSelect$($data$$96$$)) {
      var $context$$58$$;
      $options$$230$$ && $options$$230$$.trigger && ($context$$58$$ = {$optionMetadata$:{trigger:$options$$230$$.trigger}});
      var $id$$24$$ = this.id($data$$96$$), $val$$32$$ = this.$getVal$() ? this.$getVal$().slice(0) : [];
      ...
      this.$setVal$($val$$32$$, $event$$125$$, $context$$58$$);
      !this.select && this.$opts$.$closeOnSelect$ || this.$_postprocessResults$($data$$96$$, !1, !0 === this.$opts$.$closeOnSelect$);
      this.$opts$.$closeOnSelect$ && (this.close($event$$125$$), this.search.width(10));
      $options$$230$$ && $options$$230$$.$noFocus$ || this.$_focusSearch$();
    }
  }, $_cancel$:function($event$$126$$) {
    this.close($event$$126$$);
    this.$_focusSearch$();
  }, $_addSelectedChoice$:function($data$$97$$) {
    var $enableChoice$$ = !$data$$97$$.locked, $choice$$3_enabledItem$$ = $$$$12$$("\x3cli class\x3d'" + this.$_classNm$ + "-selected-choice'\x3e    \x3cdiv\x3e\x3c/div\x3e    \x3ca href\x3d'#' onclick\x3d'return false;' role\x3d'button' aria-label\x3d'remove' class\x3d'" + this.$_classNm$ + "-clear-entry       oj-component-icon oj-clickable-icon-nocontext " + this.$_classNm$ + "-clear-entry-icon' tabindex\x3d'-1'\x3e    \x3c/a\x3e\x3c/li\x3e"), $disabledItem_formatted$$3$$ = $$$$12$$("\x3cli class\x3d'" + 
    ...
    this.id($data$$97$$);
    $disabledItem_formatted$$3$$ = this.$opts$.$formatSelection$($data$$97$$);
    ...
    if ($enableChoice$$) {
      $choice$$3_enabledItem$$.find("." + this.$_classNm$ + "-clear-entry").on("mousedown", $_ComboUtils$$.$killEvent$).on("click dblclick", this.$_bind$(function($e$$78$$) {
        this.$_isInterfaceEnabled$() && ($$$$12$$($e$$78$$.target).closest("." + this.$_classNm$ + "-selected-choice").fadeOut("fast", this.$_bind$(function() {
          this.$_unselect$($$$$12$$($e$$78$$.target), $e$$78$$);
          this.selection.find("." + this.$_classNm$ + "-selected-choice.oj-focus").removeClass("oj-focus");
          this.close($e$$78$$);
          this.$_focusSearch$();
        })).dequeue(), $_ComboUtils$$.$killEvent$($e$$78$$));
      }));
    }
    $choice$$3_enabledItem$$.data(this.$_elemNm$, $data$$97$$);
    $choice$$3_enabledItem$$.insertBefore(this.$searchContainer$);
  }, $_unselect$:function($selected$$9$$, $event$$127$$) {
    var $val$$33$$ = this.$getVal$() ? this.$getVal$().slice(0) : [], $data$$98$$, $index$$108$$;
    ...
    if ($data$$98$$ = $selected$$9$$.data(this.$_elemNm$)) {
      for (this.$ojContext$.isValid() || ($val$$33$$ = $_ComboUtils$$.$splitVal$(this.$opts$.element.val(), this.$opts$.separator));0 <= ($index$$108$$ = $val$$33$$.indexOf(this.id($data$$98$$)));) {
        $val$$33$$.splice($index$$108$$, 1), this.$setVal$($val$$33$$, $event$$127$$), this.select && this.$_postprocessResults$();
      }
      $selected$$9$$.remove();
    }
  }, $_postprocessResults$:function() {
    var $val$$34$$ = this.$getVal$() && (this.$opts$.element.val() || this.$ojContext$.isValid()) ? this.$getVal$() : [], $choices$$3$$ = this.$results$.find(".oj-listbox-result"), $compound$$ = this.$results$.find(".oj-listbox-result-with-children"), $self$$84$$ = this;
    $_ComboUtils$$.$each2$($choices$$3$$, function($i$$161$$, $choice$$4$$) {
      var $id$$26$$ = $self$$84$$.id($choice$$4$$.data($self$$84$$.$_elemNm$));
    ...
    $_ComboUtils$$.$each2$($compound$$, function($i$$162$$, $choice$$5$$) {
  ...
  }, $setVal$:function($options$$231_val$$35$$, $event$$128$$, $context$$59$$) {
    var $unique$$;
    $unique$$ = [];
    "string" === typeof $options$$231_val$$35$$ && ($options$$231_val$$35$$ = $_ComboUtils$$.$splitVal$($options$$231_val$$35$$, this.$opts$.separator));
    for (var $i$$163$$ = 0;$i$$163$$ < $options$$231_val$$35$$.length;$i$$163$$++) {
      0 > $unique$$.indexOf($options$$231_val$$35$$[$i$$163$$]) && $unique$$.push($options$$231_val$$35$$[$i$$163$$]);
    }
    $options$$231_val$$35$$ = {$doValueChangeCheck$:!1};
    $context$$59$$ && ($options$$231_val$$35$$._context = $context$$59$$);
    this.$ojContext$.$_SetValue$($unique$$, $event$$128$$, $options$$231_val$$35$$);
  ...
  $oj$$12$$.$__registerWidget$("oj.ojCombobox", $$$$12$$.oj.editableValue, {defaultElement:"\x3cinput\x3e", widgetEventPrefix:"oj", options:{converter:void 0, placeholder:"", list:void 0, multiple:!1, options:null, optionsKeys:null, optionRenderer:null, minLength:0, beforeExpand:null}, widget:function() {
    ...
    if (void 0 === this.options.value) {
      ...
      var $value$$189$$ = this.options.value;
      Array.isArray($value$$189$$) ? $value$$189$$ = $value$$189$$.slice(0) : "string" === typeof $value$$189$$ && ($value$$189$$ = !0 === this.options.multiple ? $_ComboUtils$$.$splitVal$($value$$189$$, ",") : [$value$$189$$]);
      this.options.value = $value$$189$$;
    }
  }, $_setup$:function() {
  ...
  }, _setOption:function($key$$60$$, $value$$190$$, $flags$$17$$) {
    "value" === $key$$60$$ && (Array.isArray($value$$190$$) ? $value$$190$$ = $value$$190$$.slice(0) : "string" === typeof $value$$190$$ && ($value$$190$$ = !0 === this.options.multiple ? $_ComboUtils$$.$splitVal$($value$$190$$, ",") : [$value$$190$$]), this.$combobox$.$valueChangeTrigger$ = $flags$$17$$ && $flags$$17$$._context && $flags$$17$$._context.$optionMetadata$ ? $flags$$17$$._context.$optionMetadata$.trigger : null);
    this._super($key$$60$$, $value$$190$$, $flags$$17$$);
    "options" === $key$$60$$ && (this.$combobox$.$opts$.options = $value$$190$$, this.$combobox$.$opts$ = this.$combobox$.$_prepareOpts$(this.$combobox$.$opts$));
    "disabled" === $key$$60$$ && ($value$$190$$ ? this.$combobox$.$_disable$() : this.$combobox$.$_enable$());
  ...
  }, $_SetPlaceholder$:function($value$$191$$) {
    this.$combobox$ && (this.$combobox$.$opts$.placeholder = $value$$191$$, this.$combobox$.$_setPlaceholder$ && this.$combobox$.$_setPlaceholder$());
  }, validate:function() {
    ...
    if (Array.isArray($submittedValue$$2$$)) {
      for (var $i$$164$$ = 0;$i$$164$$ < $submittedValue$$2$$.length;$i$$164$$++) {
        var $parsed$$2$$ = this._super($submittedValue$$2$$[$i$$164$$]);
    ...
    if (this.$combobox$ && this.$combobox$.$_opened$()) {
      for (var $dropdown$$4$$ = $$$$12$$(".oj-listbox-drop"), $i$$165$$ = 0;$i$$165$$ < $dropdown$$4$$.length;$i$$165$$++) {
        if ("oj-listbox-drop" == $$$$12$$($dropdown$$4$$[$i$$165$$]).attr("id") && $$$$12$$($dropdown$$4$$[$i$$165$$]).attr("data-oj-containerid") == this.$combobox$.$containerId$) {
          return $$$$12$$($dropdown$$4$$[$i$$165$$]);
        }
      }
    }
    return null;
  }, $_findItem$:function($list$$6$$, $value$$192$$) {
    for (var $i$$166$$ = 0;$i$$166$$ < $list$$6$$.length;$i$$166$$++) {
      if ($$$$12$$($list$$6$$[$i$$166$$]).data("ojcombobox").value === $value$$192$$) {
        return $list$$6$$[$i$$166$$];
      }
    }
    return null;
  ...
  $oj$$12$$.$__registerWidget$("oj.ojSelect", $$$$12$$.oj.editableValue, {defaultElement:"\x3cselect\x3e", widgetEventPrefix:"oj", options:{minimumResultsForSearch:10, placeholder:null, list:void 0, multiple:!1, options:null, optionsKeys:null, beforeExpand:null, renderMode:"jet"}, widget:function() {
  ...
  }, $_nativeChangeHandler$:function($event$$129$$) {
    var $arr$$21$$ = [], $emptyValueAllowed$$ = !this.$_IsRequired$() && this.$_HasPlaceholderSet$();
    $$$$12$$($event$$129$$.target).find("option").each(function() {
      this.selected && (this.value || $emptyValueAllowed$$ && "" === this.value) && $arr$$21$$.push(this.value);
    });
    this.$_SetValue$($arr$$21$$, $event$$129$$, {$doValueChangeCheck$:!1});
  }, $_nativeSetup$:function() {
    var $element$$85$$ = this.element;
    $element$$85$$.wrap("\x3cdiv\x3e").parent().addClass("oj-select-native oj-component oj-select oj-form-control");
    $element$$85$$.addClass("oj-select-select oj-component-initnode");
    this.options.multiple ? ($element$$85$$.attr("multiple", ""), $element$$85$$.parent().prepend("\x3ca class\x3d'oj-select-arrow oj-component-icon oj-clickable-icon-nocontext oj-select-multiple-open-icon' role\x3d'presentation'\x3e\x3c/a\x3e")) : $element$$85$$.parent().prepend("\x3ca class\x3d'oj-select-arrow oj-component-icon oj-clickable-icon-nocontext oj-select-open-icon' role\x3d'presentation'\x3e\x3c/a\x3e");
    this.$_nativeSetDisabled$(this.options.disabled);
    this.options.list ? ($_ComboUtils$$.$listPopulateResults$($element$$85$$, $$$$12$$("#" + this.options.list).children(), this.$_formatValue$.bind(this)), $element$$85$$.addClass($_ComboUtils$$.$GENERATED_OPTIONS_SELECTOR$)) : this.options.options && ($_ComboUtils$$.$arrayPopulateResults$($element$$85$$, this.options.options, this.$_formatValue$.bind(this), this.options.optionsKeys), $element$$85$$.addClass($_ComboUtils$$.$GENERATED_OPTIONS_SELECTOR$));
    $element$$85$$.change(this.$_nativeChangeHandler$.bind(this));
  }, $_jetSetup$:function() {
    ...
    this.select && this.select.close();
  }, $_SetPlaceholder$:function($value$$193$$) {
    if (this.$_isNative$() && null != $value$$193$$) {
      var $placeholder$$4$$ = $$$$12$$(this.element.children("option:first-child"));
      $placeholder$$4$$ && "" === $placeholder$$4$$.attr("value") ? ($placeholder$$4$$.text(this.options.placeholder), $placeholder$$4$$.attr("value", "")) : ($placeholder$$4$$ = $_ComboUtils$$.$createOptionTag$(0, "", $value$$193$$, this.$_formatValue$.bind(this)), $placeholder$$4$$.addClass("oj-listbox-placeholder"), $placeholder$$4$$.prependTo(this.element));
    }
    ...
    if (void 0 === this.options.value) {
      ...
      var $value$$194$$ = this.options.value;
      Array.isArray($value$$194$$) && ($value$$194$$ = $value$$194$$.slice(0));
      this.options.value = $value$$194$$;
    }
  }, validate:function() {
  ...
  }, $_nativeSetOptions$:function($defVal_value$$195$$) {
    var $oSelected$$ = this.options.value, $element$$86$$ = this.element;
    if ($element$$86$$.hasClass($_ComboUtils$$.$GENERATED_OPTIONS_SELECTOR$)) {
      $_ComboUtils$$.$cleanupResults$($element$$86$$);
    } else {
      var $children$$5$$ = $element$$86$$.children();
      0 < $children$$5$$.length && $children$$5$$.remove();
    }
    $_ComboUtils$$.$arrayPopulateResults$($element$$86$$, $defVal_value$$195$$, this.$_formatValue$.bind(this), this.options.optionsKeys);
    $element$$86$$.addClass($_ComboUtils$$.$GENERATED_OPTIONS_SELECTOR$);
    $defVal_value$$195$$ = null;
    this.$_HasPlaceholderSet$() && (this.options.required && ($defVal_value$$195$$ = this.$_nativeFindFirstEnabledOptionValue$()), this.$_SetPlaceholder$());
    null === $defVal_value$$195$$ && ($defVal_value$$195$$ = this.$_nativeFindFirstEnabledOptionValue$());
    this.options.value = $defVal_value$$195$$;
    this._setOption("value", $oSelected$$);
  }, $_removePlaceholderInMultiValues$:function($valArr$$) {
    for (var $val$$36$$, $narr$$ = [], $i$$167$$ = 0;$i$$167$$ < $valArr$$.length;$i$$167$$++) {
      $val$$36$$ = $valArr$$[$i$$167$$], null != $val$$36$$ && (0 < $val$$36$$.length ? (1 == $narr$$.length && "" === $narr$$[0] && $narr$$.pop(), $narr$$.push($val$$36$$)) : 0 == $narr$$.length && $narr$$.push($val$$36$$));
    }
    return $narr$$;
  }, _setOption:function($key$$61$$, $value$$196$$, $flags$$18$$) {
    if ("value" === $key$$61$$) {
      if (this.$_HasPlaceholderSet$() && $value$$196$$ && 0 == $value$$196$$.length) {
        this._super($key$$61$$, $value$$196$$, $flags$$18$$);
      } else {
        var $element$$87_selected$$10$$;
        this.select && ($element$$87_selected$$10$$ = this.select.$datalist$, $element$$87_selected$$10$$ || ($element$$87_selected$$10$$ = this.select.$opts$.element));
        Array.isArray($value$$196$$) || ($value$$196$$ = [$value$$196$$]);
        this.$_isNative$() && ($value$$196$$ = this.$_removePlaceholderInMultiValues$($value$$196$$), 1 == $value$$196$$.length && "" == $value$$196$$[0] ? this.element.addClass("oj-select-default") : this.element.removeClass("oj-select-default"));
        for (var $newArr$$ = [], $i$$168$$ = 0;$i$$168$$ < $value$$196$$.length;$i$$168$$++) {
          this.select ? (this.options.multiple || this.select.$opts$.validate($element$$87_selected$$10$$, $value$$196$$[$i$$168$$])) && $newArr$$.push($value$$196$$[$i$$168$$]) : 0 < this.element.find("option[value\x3d'" + $value$$196$$[$i$$168$$] + "']").length && $newArr$$.push($value$$196$$[$i$$168$$]);
        }
        (0 < $newArr$$.length || this.options.multiple) && this._super($key$$61$$, $newArr$$, $flags$$18$$);
      }
    } else {
      "placeholder" === $key$$61$$ ? this.select ? (this.select.$opts$.placeholder = $value$$196$$, this.select.$_setPlaceholder$()) : ($element$$87_selected$$10$$ = this.options.value, $element$$87_selected$$10$$ && 0 !== $element$$87_selected$$10$$.length && $element$$87_selected$$10$$[0] || (this.element[0].selectedIndex = 0)) : "minimumResultsForSearch" === $key$$61$$ ? this.select && (this.select.$opts$.minimumResultsForSearch = $value$$196$$) : "renderMode" === $key$$61$$ && (this.$_cleanup$(), 
      this.options.renderMode = $value$$196$$, this.refresh()), this._super($key$$61$$, $value$$196$$, $flags$$18$$), "disabled" === $key$$61$$ ? this.select ? $value$$196$$ ? this.select.$_disable$() : this.select.$_enable$() : this.$_nativeSetDisabled$($value$$196$$) : "options" === $key$$61$$ && (this.select ? (this.select.$opts$.options = $value$$196$$, this.select.$opts$ = this.select.$_prepareOpts$(this.select.$opts$), this._super("value", this.select.$getVal$())) : this.$_nativeSetOptions$($value$$196$$))
      ;
    }
  }, $_getDropdown$:function() {
  ...
  var $_OjInputSeachContainer$$ = $_ComboUtils$$.$clazz$($_OjSingleCombobox$$, {$_elemNm$:"ojinputsearch", $_classNm$:"oj-inputsearch", $_createContainer$:function() {
    ...
    var $self$$85$$ = this;
    $trigger$$3$$.on("click", function($event$$130$$) {
      if ($self$$85$$.$_isInterfaceEnabled$()) {
        if ($self$$85$$.$opts$.manageNewEntry) {
          var $data$$100$$ = $self$$85$$.$opts$.manageNewEntry($self$$85$$.search.val());
          $self$$85$$.$_onSelect$($data$$100$$, {trigger:$_ComboUtils$$.$ValueChangeTriggerTypes$.$SEARCH_ICON_CLICKED$}, $event$$130$$);
        }
        return!1;
      }
    }).on("mousedown", function($event$$131$$) {
  ...
  $oj$$12$$.$__registerWidget$("oj.ojInputSearch", $$$$12$$.oj.editableValue, {defaultElement:"\x3cinput\x3e", widgetEventPrefix:"oj", options:{placeholder:void 0, options:null, optionsKeys:null, optionRenderer:null, minLength:0, beforeExpand:null, optionChange:null}, widget:function() {
    ...
    if (void 0 === this.options.value) {
      ...
      Array.isArray($value$$197$$) ? $value$$197$$ = $value$$197$$.slice(0) : "string" === typeof $value$$197$$ && ($value$$197$$ = [$value$$197$$]);
    ...
    this.$_SetRootAttributes$();
    this.$_Refresh$("required", this.options.required);
  }, _setOption:function($key$$62$$, $value$$198$$, $flags$$19$$) {
    "value" === $key$$62$$ && (Array.isArray($value$$198$$) ? $value$$198$$ = $value$$198$$.slice(0) : "string" === typeof $value$$198$$ && ($value$$198$$ = [$value$$198$$]), this.$inputSearch$.$valueChangeTrigger$ = $flags$$19$$ && $flags$$19$$._context && $flags$$19$$._context.$optionMetadata$ ? $flags$$19$$._context.$optionMetadata$.trigger : null);
    this._super($key$$62$$, $value$$198$$, $flags$$19$$);
    "options" === $key$$62$$ && (this.$inputSearch$.$opts$.options = $value$$198$$, this.$inputSearch$.$opts$ = this.$inputSearch$.$_prepareOpts$(this.$inputSearch$.$opts$));
    "disabled" === $key$$62$$ && ($value$$198$$ ? this.$inputSearch$.$_disable$() : this.$inputSearch$.$_enable$());
  }, $_NotifyDetached$:function() {
    ...
    this.$inputSearch$ && (this.$inputSearch$.$opts$.placeholder = $value$$199$$, this.$inputSearch$.$_setPlaceholder$ && this.$inputSearch$.$_setPlaceholder$());
  }, validate:function() {
    ...
    if (Array.isArray($submittedValue$$3$$)) {
      for (var $i$$169$$ = 0;$i$$169$$ < $submittedValue$$3$$.length;$i$$169$$++) {
        var $parsed$$3$$ = this._super($submittedValue$$3$$[$i$$169$$]);
    ...
    if (this.$inputSearch$ && this.$inputSearch$.$_opened$()) {
      for (var $dropdown$$8$$ = $$$$12$$(".oj-listbox-drop"), $i$$170$$ = 0;$i$$170$$ < $dropdown$$8$$.length;$i$$170$$++) {
        if ("oj-listbox-drop" == $$$$12$$($dropdown$$8$$[$i$$170$$]).attr("id") && $$$$12$$($dropdown$$8$$[$i$$170$$]).attr("data-oj-containerid") == this.$inputSearch$.$containerId$) {
          return $$$$12$$($dropdown$$8$$[$i$$170$$]);
        }
      }
    }
    return null;
