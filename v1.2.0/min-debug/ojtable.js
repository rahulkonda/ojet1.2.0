...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "promise", "ojdnd", "ojs/ojdomscroller", "ojs/ojeditablevalue", "ojs/ojmenu", "ojs/ojdatasource-common", "ojs/ojpagingtabledatasource", "ojs/ojflattenedtreetabledatasource"], function($oj$$14$$, $$$$14$$) {
  (function() {
    ...
    $_KEYBOARD_CODE_ENTER$:13, $_KEYBOARD_CODE_UP$:38, $_KEYBOARD_CODE_DOWN$:40, $_KEYBOARD_CODE_LEFT$:37, $_KEYBOARD_CODE_RIGHT$:39, $_KEYBOARD_CODE_HOME$:36, $_KEYBOARD_CODE_END$:35, $_KEYBOARD_CODE_TAB$:9, $_KEYBOARD_CODE_ESC$:27, $_KEYBOARD_MODIFIER_SHIFT$:"shiftKey"}, getContextByNode:function($node$$54$$) {
    ...
    }, getDataForVisibleRow:function($rowIndex$$2_tableBodyRow$$) {
      $rowIndex$$2_tableBodyRow$$ = this.$_getTableDomUtils$().$getTableBodyRow$($rowIndex$$2_tableBodyRow$$);
      return null != $rowIndex$$2_tableBodyRow$$ ? $rowIndex$$2_tableBodyRow$$.data("rowData") : null;
      ...
      if ("oj-table-cell" === $offset$$20_rowIdx$$1_subId$$19$$) {
        var $offset$$20_rowIdx$$1_subId$$19$$ = 0, $data$$101$$ = this.$_getData$();
        $data$$101$$ instanceof $oj$$14$$.$PagingTableDataSource$ && ($offset$$20_rowIdx$$1_subId$$19$$ = $data$$101$$.getStartItemIndex());
      ...
      var $cell$$1_footer_header$$8_headerSortAsc_headerSortDsc$$ = $$$$14$$($node$$55$$).closest("." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_DATA_CELL_CLASS$);
      if (0 < $cell$$1_footer_header$$8_headerSortAsc_headerSortDsc$$.length) {
        var $offset$$21$$ = 0, $data$$102$$ = this.$_getData$();
        $data$$102$$ instanceof $oj$$14$$.$PagingTableDataSource$ && ($offset$$21$$ = $data$$102$$.getStartItemIndex());
        return{subId:"oj-table-cell", rowIndex:$offset$$21$$ + this.$_getTableDomUtils$().$getElementRowIdx$($cell$$1_footer_header$$8_headerSortAsc_headerSortDsc$$), columnIndex:this.$_getTableDomUtils$().$getElementColumnIdx$($cell$$1_footer_header$$8_headerSortAsc_headerSortDsc$$)};
      }
      $cell$$1_footer_header$$8_headerSortAsc_headerSortDsc$$ = $$$$14$$($node$$55$$).closest("." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_COLUMN_HEADER_ASC_LINK_CLASS$);
      if (0 < $cell$$1_footer_header$$8_headerSortAsc_headerSortDsc$$.length) {
        return{subId:$ignoreSortIcons$$ ? "oj-table-header" : "oj-table-sort-ascending", index:this.$_getTableDomUtils$().$getElementColumnIdx$($cell$$1_footer_header$$8_headerSortAsc_headerSortDsc$$)};
      }
      $cell$$1_footer_header$$8_headerSortAsc_headerSortDsc$$ = $$$$14$$($node$$55$$).closest("." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_COLUMN_HEADER_DSC_LINK_CLASS$);
      if (0 < $cell$$1_footer_header$$8_headerSortAsc_headerSortDsc$$.length) {
        return{subId:$ignoreSortIcons$$ ? "oj-table-header" : "oj-table-sort-descending", index:this.$_getTableDomUtils$().$getElementColumnIdx$($cell$$1_footer_header$$8_headerSortAsc_headerSortDsc$$)};
      }
      $cell$$1_footer_header$$8_headerSortAsc_headerSortDsc$$ = $$$$14$$($node$$55$$).closest("." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_COLUMN_HEADER_CELL_CLASS$);
      if (0 < $cell$$1_footer_header$$8_headerSortAsc_headerSortDsc$$.length) {
        return{subId:"oj-table-header", index:this.$_getTableDomUtils$().$getElementColumnIdx$($cell$$1_footer_header$$8_headerSortAsc_headerSortDsc$$)};
      }
      $cell$$1_footer_header$$8_headerSortAsc_headerSortDsc$$ = $$$$14$$($node$$55$$).closest("." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_FOOTER_CELL_CLASS$);
      return 0 < $cell$$1_footer_header$$8_headerSortAsc_headerSortDsc$$.length ? {subId:"oj-table-footer", index:this.$_getTableDomUtils$().$getElementColumnIdx$($cell$$1_footer_header$$8_headerSortAsc_headerSortDsc$$)} : null;
    }, refresh:function() {
      this._super();
      this.$_refresh$();
    }, refreshRow:function($rowIdx$$2$$) {
      var $data$$103_errSummary$$9$$ = this.$_getData$();
      if (!$data$$103_errSummary$$9$$) {
        return!1;
      }
      ...
      if (isNaN($rowIdx$$2$$) || 0 > $rowIdx$$2$$ || null != $errDetail$$2_rowKey_tableBodyRows$$ && $rowIdx$$2$$ >= $errDetail$$2_rowKey_tableBodyRows$$.length) {
        throw $data$$103_errSummary$$9$$ = this.$_LOGGER_MSG$.$_ERR_REFRESHROW_INVALID_INDEX_SUMMARY$, $errDetail$$2_rowKey_tableBodyRows$$ = $oj$$14$$.$Translations$.$applyParameters$(this.$_LOGGER_MSG$.$_ERR_REFRESHROW_INVALID_INDEX_DETAIL$, {rowIdx:$rowIdx$$2$$.toString()}), new RangeError($data$$103_errSummary$$9$$ + "\n" + $errDetail$$2_rowKey_tableBodyRows$$);
      }
      var $errDetail$$2_rowKey_tableBodyRows$$ = this.$_getRowKeyForRowIdx$($rowIdx$$2$$), $row$$4$$ = $data$$103_errSummary$$9$$.get($errDetail$$2_rowKey_tableBodyRows$$);
      if (null == $row$$4$$) {
        return!1;
      }
      var $self$$92$$ = this;
      return this.$_queueTask$(function() {
        return $row$$4$$.then(function($row$$5$$) {
          $self$$92$$.$_refreshTableBodyRow$($rowIdx$$2$$, $row$$5$$);
        }).then(function() {
          return!0;
        });
      });
      ...
      this.$_initFetch$();
    }, $_NotifyContextMenuGesture$:function($contextMenu$$2$$, $event$$147$$, $eventType$$33$$) {
      var $openOptions$$3$$ = {};
      this.$_contextMenuEvent$ = $event$$147$$.originalEvent;
      if (!(this.$_isNodeEditable$($$$$14$$(this.$_contextMenuEvent$.target)) || this.$_isNodeClickable$($$$$14$$(this.$_contextMenuEvent$.target)) || "touch" == $eventType$$33$$ && this.$_isNodeDraggable$($$$$14$$(this.$_contextMenuEvent$.target)))) {
        ...
        this.$_OpenContextMenu$($event$$147$$, $eventType$$33$$, $openOptions$$3$$);
      }
    }, _destroy:function() {
      this.$_getData$();
    ...
    }, $_events$:{blur:function($event$$148$$) {
      var $table$$1$$ = this.$_getTableDomUtils$().$getTable$();
      0 < $table$$1$$.has($event$$148$$.relatedTarget).length || null != $event$$148$$.originalEvent && $event$$148$$.originalEvent.explicitOriginalTarget == $table$$1$$[0] || (this.$_clearKeyboardKeys$(), this.$_clearFocusedHeaderColumn$(), this.$_clearFocusedRow$(!1), this.$_setTableNavigationMode$(!1));
    }, focus:function($event$$149$$) {
      this.$_checkRowOrHeaderColumnFocus$($event$$149$$);
    }, "focus .oj-table-column-header-acc-asc-link":function($event$$150$$) {
      var $self$$93$$ = this;
      setTimeout(function() {
        $self$$93$$.$_checkRowOrHeaderColumnFocus$($event$$150$$);
      }, 0);
    }, "click .oj-table-checkbox-acc-select-column":function($event$$151$$) {
      var $columnIdx$$2$$ = this.$_getTableDomUtils$().$getElementColumnIdx$($$$$14$$($event$$151$$.currentTarget)), $selected$$15$$ = $$$$14$$($event$$151$$.currentTarget).is(":checked");
      $selected$$15$$ && this.$_setHeaderColumnFocus$($columnIdx$$2$$, !0, !0, null);
      this.$_setHeaderColumnSelection$($columnIdx$$2$$, $selected$$15$$, $event$$151$$.currentTarget, $event$$151$$, !0);
      $event$$151$$.stopPropagation();
    }, "click .oj-table-checkbox-acc-select-row":function($event$$152$$) {
      var $rowIdx$$3$$ = this.$_getTableDomUtils$().$getElementRowIdx$($$$$14$$($event$$152$$.currentTarget)), $selected$$16$$ = $$$$14$$($event$$152$$.currentTarget).is(":checked"), $focused$$ = !1;
      $selected$$16$$ && ($focused$$ = this.$_setRowFocus$($rowIdx$$3$$, !0, !0, null, $event$$152$$, !0));
      $focused$$ && this.$_setRowSelection$($rowIdx$$3$$, $selected$$16$$, $event$$152$$.currentTarget, $event$$152$$, !0);
      $event$$152$$.stopPropagation();
    }, keydown:function($event$$153$$) {
      if (!(this.$_isNodeEditable$($$$$14$$($event$$153$$.target)) || null != this.$_getTableDomUtils$().$getTableFooter$() && 0 < this.$_getTableDomUtils$().$getTableFooter$().has($event$$153$$.target).length) && (this.$_addKeyboardKey$($event$$153$$.keyCode), 1 == this.$_getKeyboardKeys$().length || 2 == this.$_getKeyboardKeys$().length && $event$$153$$[this.$_KEYBOARD_CODES$.$_KEYBOARD_MODIFIER_SHIFT$])) {
        if (this.$_isKeyboardKeyPressed$(this.$_KEYBOARD_CODES$.$_KEYBOARD_CODE_UP$) || this.$_isKeyboardKeyPressed$(this.$_KEYBOARD_CODES$.$_KEYBOARD_CODE_DOWN$) || this.$_isKeyboardKeyPressed$(this.$_KEYBOARD_CODES$.$_KEYBOARD_CODE_SPACEBAR$) || this.$_isKeyboardKeyPressed$(this.$_KEYBOARD_CODES$.$_KEYBOARD_CODE_HOME$) || this.$_isKeyboardKeyPressed$(this.$_KEYBOARD_CODES$.$_KEYBOARD_CODE_END$)) {
          $event$$153$$.preventDefault(), $event$$153$$.stopPropagation();
        }
        this.$_isKeyboardKeyPressed$(this.$_KEYBOARD_CODES$.$_KEYBOARD_CODE_UP$) || this.$_isKeyboardKeyPressed$(this.$_KEYBOARD_CODES$.$_KEYBOARD_CODE_DOWN$) ? this.$_handleKeydownUpDown$($event$$153$$) : this.$_isKeyboardKeyPressed$(this.$_KEYBOARD_CODES$.$_KEYBOARD_CODE_LEFT$) || this.$_isKeyboardKeyPressed$(this.$_KEYBOARD_CODES$.$_KEYBOARD_CODE_RIGHT$) ? this.$_handleKeydownLeftRight$($event$$153$$) : this.$_isKeyboardKeyPressed$(this.$_KEYBOARD_CODES$.$_KEYBOARD_CODE_TAB$) && this.$_handleKeydownTab$($event$$153$$);
      }
    }, keyup:function($event$$154$$) {
      if (!(this.$_isNodeEditable$($$$$14$$($event$$154$$.target)) || null != this.$_getTableDomUtils$().$getTableFooter$() && 0 < this.$_getTableDomUtils$().$getTableFooter$().has($event$$154$$.target).length)) {
        if (1 == this.$_getKeyboardKeys$().length) {
          var $keyboardCode1$$ = this.$_getKeyboardKeys$()[0];
          $keyboardCode1$$ == this.$_KEYBOARD_CODES$.$_KEYBOARD_CODE_SPACEBAR$ ? this.$_handleKeyupSpacebar$($event$$154$$) : $keyboardCode1$$ == this.$_KEYBOARD_CODES$.$_KEYBOARD_CODE_ENTER$ ? this.$_handleKeyupEnter$($event$$154$$) : $keyboardCode1$$ == this.$_KEYBOARD_CODES$.$_KEYBOARD_CODE_HOME$ ? this.$_handleKeyupHome$($event$$154$$) : $keyboardCode1$$ == this.$_KEYBOARD_CODES$.$_KEYBOARD_CODE_END$ ? this.$_handleKeyupEnd$($event$$154$$) : $keyboardCode1$$ == this.$_KEYBOARD_CODES$.$_KEYBOARD_CODE_ESC$ && 
          this.$_handleKeyupEsc$($event$$154$$);
          this.$_removeKeyboardKey$($keyboardCode1$$);
        }
        this.$_removeKeyboardKey$($event$$154$$.keyCode);
      }
    }, "mousedown .oj-table-body":function($event$$155_tableBodyRow$$2$$) {
      this.$_mouseDownRowIdx$ = this.$_getTableDomUtils$().$getElementRowIdx$($$$$14$$($event$$155_tableBodyRow$$2$$.target));
      null != this.$_mouseDownRowIdx$ && ($event$$155_tableBodyRow$$2$$ = this.$_getTableDomUtils$().$getTableBodyRow$(this.$_mouseDownRowIdx$), null != $event$$155_tableBodyRow$$2$$ && $event$$155_tableBodyRow$$2$$.prop("draggable") ? this.$_mouseDownRowIdx$ = null : null != this.$_mouseDownRowIdx$ && this.$_clearSelectedRows$());
    }, "mouseup .oj-table-body":function() {
      this.$_mouseDownRowIdx$ = null;
    }, "mouseenter .oj-table-body-row":function($event$$157$$) {
      $$$$14$$($event$$157$$.currentTarget).addClass($oj$$14$$.$TableDomUtils$.$MARKER_STYLE_CLASSES$.$_HOVER$);
      this.$_handleMouseEnterSelection$($event$$157$$.target);
    }, "mouseleave .oj-table-body-row":function($event$$158$$) {
      $$$$14$$($event$$158$$.currentTarget).removeClass($oj$$14$$.$TableDomUtils$.$MARKER_STYLE_CLASSES$.$_HOVER$);
    }, "mousedown .oj-table-column-header-cell":function($event$$159$$) {
      var $columnIdx$$3$$ = this.$_getTableDomUtils$().$getElementColumnIdx$($$$$14$$($event$$159$$.currentTarget));
      this.$_setHeaderColumnFocus$($columnIdx$$3$$, !0, !0, $event$$159$$);
      $$$$14$$($event$$159$$.target).data(this.$_FOCUS_CALLED$, !0);
    }, "mouseenter .oj-table-column-header-cell":function($columnIdx$$4_event$$160$$) {
      $$$$14$$($columnIdx$$4_event$$160$$.currentTarget).addClass($oj$$14$$.$TableDomUtils$.$MARKER_STYLE_CLASSES$.$_HOVER$);
      $columnIdx$$4_event$$160$$ = this.$_getTableDomUtils$().$getElementColumnIdx$($$$$14$$($columnIdx$$4_event$$160$$.currentTarget));
      this.$_showTableHeaderColumnSortLink$($columnIdx$$4_event$$160$$);
    }, "mouseleave .oj-table-column-header-cell":function($columnIdx$$5_event$$161$$) {
      $$$$14$$($columnIdx$$5_event$$161$$.currentTarget).removeClass($oj$$14$$.$TableDomUtils$.$MARKER_STYLE_CLASSES$.$_HOVER$);
      $columnIdx$$5_event$$161$$ = this.$_getTableDomUtils$().$getElementColumnIdx$($$$$14$$($columnIdx$$5_event$$161$$.currentTarget));
      this.$_hideTableHeaderColumnSortLink$($columnIdx$$5_event$$161$$, !0);
      this.$_hideTableHeaderColumnSortLink$($columnIdx$$5_event$$161$$, !1);
    }, "mousedown .oj-table-data-cell":function($event$$162$$) {
      var $rowIdx$$4$$ = this.$_getTableDomUtils$().$getElementRowIdx$($$$$14$$($event$$162$$.currentTarget));
      this.$_setRowFocus$($rowIdx$$4$$, !0, !0, $event$$162$$.currentTarget, $event$$162$$);
      $$$$14$$($event$$162$$.target).data(this.$_FOCUS_CALLED$, !0);
    }, "mouseenter .oj-table-data-cell":function($event$$163$$) {
      $$$$14$$($event$$163$$.currentTarget).addClass($oj$$14$$.$TableDomUtils$.$MARKER_STYLE_CLASSES$.$_HOVER$);
    }, "mouseleave .oj-table-data-cell":function($event$$164$$) {
      $$$$14$$($event$$164$$.currentTarget).removeClass($oj$$14$$.$TableDomUtils$.$MARKER_STYLE_CLASSES$.$_HOVER$);
    }, "click .oj-table-column-header-asc-link":function($event$$165$$) {
      var $columnIdx$$6$$ = this.$_getTableDomUtils$().$getElementColumnIdx$($$$$14$$($event$$165$$.target)), $tableHeaderColumn$$1$$ = this.$_getTableDomUtils$().$getTableHeaderColumn$($columnIdx$$6$$);
      $tableHeaderColumn$$1$$ && ($tableHeaderColumn$$1$$.data("sorted") == this.$_COLUMN_SORT_ORDER$.$_ASCENDING$ ? this.$_handleSortTableHeaderColumn$($columnIdx$$6$$, !1, $event$$165$$) : this.$_handleSortTableHeaderColumn$($columnIdx$$6$$, !0, $event$$165$$), $event$$165$$.preventDefault(), $event$$165$$.stopPropagation());
    }, "click .oj-table-column-header-acc-asc-link":function($event$$166$$) {
      var $columnIdx$$7$$ = this.$_getTableDomUtils$().$getElementColumnIdx$($$$$14$$($event$$166$$.target));
      this.$_handleSortTableHeaderColumn$($columnIdx$$7$$, !0, $event$$166$$);
      $event$$166$$.preventDefault();
      $event$$166$$.stopPropagation();
    }, "click .oj-table-column-header-dsc-link":function($event$$167$$) {
      var $columnIdx$$8$$ = this.$_getTableDomUtils$().$getElementColumnIdx$($$$$14$$($event$$167$$.target)), $tableHeaderColumn$$2$$ = this.$_getTableDomUtils$().$getTableHeaderColumn$($columnIdx$$8$$);
      $tableHeaderColumn$$2$$ && ($tableHeaderColumn$$2$$.data("sorted") == this.$_COLUMN_SORT_ORDER$.$_DESCENDING$ ? this.$_handleSortTableHeaderColumn$($columnIdx$$8$$, !0, $event$$167$$) : this.$_handleSortTableHeaderColumn$($columnIdx$$8$$, !1, $event$$167$$), $event$$167$$.preventDefault(), $event$$167$$.stopPropagation());
    }, "click .oj-table-column-header-acc-dsc-link":function($event$$168$$) {
      var $columnIdx$$9$$ = this.$_getTableDomUtils$().$getElementColumnIdx$($$$$14$$($event$$168$$.target));
      this.$_handleSortTableHeaderColumn$($columnIdx$$9$$, !1, $event$$168$$);
      $event$$168$$.preventDefault();
      $event$$168$$.stopPropagation();
    }, "click .oj-table-data-cell":function($event$$169$$) {
      var $rowIdx$$5$$ = this.$_getTableDomUtils$().$getElementRowIdx$($$$$14$$($event$$169$$.currentTarget));
      if (!$$$$14$$($event$$169$$.target).data(this.$_FOCUS_CALLED$)) {
        var $focused$$2_lastSelectedRowIdx$$ = this.$_setRowFocus$($rowIdx$$5$$, !0, !0, $event$$169$$.currentTarget, $event$$169$$);
        $$$$14$$($event$$169$$.target).data(this.$_FOCUS_CALLED$, !1);
        if (!$focused$$2_lastSelectedRowIdx$$) {
          return;
        }
      }
      if ($event$$169$$[this.$_KEYBOARD_CODES$.$_KEYBOARD_MODIFIER_SHIFT$]) {
        if ($focused$$2_lastSelectedRowIdx$$ = this.$_getLastRowSelection$(), null != $focused$$2_lastSelectedRowIdx$$) {
          if (window.getSelection().removeAllRanges(), $rowIdx$$5$$ < $focused$$2_lastSelectedRowIdx$$) {
            var $i$$176$$;
            for ($i$$176$$ = $rowIdx$$5$$;$i$$176$$ <= $focused$$2_lastSelectedRowIdx$$;$i$$176$$++) {
              this.$_setRowSelection$($i$$176$$, !0, $event$$169$$.currentTarget, $event$$169$$, !0);
            }
          } else {
            for ($i$$176$$ = $focused$$2_lastSelectedRowIdx$$;$i$$176$$ <= $rowIdx$$5$$;$i$$176$$++) {
              this.$_setRowSelection$($i$$176$$, !0, $event$$169$$.currentTarget, $event$$169$$, !0);
            }
          }
        }
      } else {
        $oj$$14$$.$DomUtils$.$isMetaKeyPressed$($event$$169$$) ? this.$_setRowSelection$($rowIdx$$5$$, !this.$_getRowSelection$($rowIdx$$5$$), $event$$169$$.currentTarget, $event$$169$$, !0) : 0 == this.$_getKeyboardKeys$().length && (this.$_clearSelectedRows$(), this.$_setRowSelection$($rowIdx$$5$$, !this.$_getRowSelection$($rowIdx$$5$$), $event$$169$$.currentTarget, $event$$169$$, !0), this.$_isTouchDevice$() && this.$_getRowSelectionMode$() == this.$_OPTION_SELECTION_MODES$.$_MULTIPLE$ && this.$_getTableDomUtils$().$createTableBodyRowTouchSelectionAffordance$($rowIdx$$5$$))
        ;
      }
    }, "contextmenu .oj-table-data-cell":function($event$$170$$) {
      var $rowIdx$$6_rowKey$$1$$ = this.$_getTableDomUtils$().$getElementRowIdx$($$$$14$$($event$$170$$.currentTarget)), $rowIdx$$6_rowKey$$1$$ = this.$_getRowKeyForRowIdx$($rowIdx$$6_rowKey$$1$$);
      this.$_setCurrentRow$({rowKey:$rowIdx$$6_rowKey$$1$$}, $event$$170$$);
    }, "click .oj-table-column-header-cell":function($event$$171$$) {
      var $columnIdx$$10$$ = this.$_getTableDomUtils$().$getElementColumnIdx$($$$$14$$($event$$171$$.currentTarget));
      $$$$14$$($event$$171$$.target).data(this.$_FOCUS_CALLED$) || (this.$_setHeaderColumnFocus$($columnIdx$$10$$, !0, !0, $event$$171$$), $$$$14$$($event$$171$$.target).data(this.$_FOCUS_CALLED$, !1));
      if ($event$$171$$[this.$_KEYBOARD_CODES$.$_KEYBOARD_MODIFIER_SHIFT$]) {
        ...
        if (null != $lastSelectedColumnIdx$$) {
          if ($columnIdx$$10$$ < $lastSelectedColumnIdx$$) {
            var $i$$177$$;
            for ($i$$177$$ = $columnIdx$$10$$;$i$$177$$ <= $lastSelectedColumnIdx$$;$i$$177$$++) {
              this.$_setHeaderColumnSelection$($i$$177$$, !0, $event$$171$$.currentTarget, $event$$171$$, !0);
            }
          } else {
            for ($i$$177$$ = $lastSelectedColumnIdx$$;$i$$177$$ <= $columnIdx$$10$$;$i$$177$$++) {
              this.$_setHeaderColumnSelection$($i$$177$$, !0, $event$$171$$.currentTarget, $event$$171$$, !0);
            }
          }
        }
      } else {
        $oj$$14$$.$DomUtils$.$isMetaKeyPressed$($event$$171$$) ? this.$_setHeaderColumnSelection$($columnIdx$$10$$, !this.$_getHeaderColumnSelection$($columnIdx$$10$$), $event$$171$$.currentTarget, $event$$171$$, !0) : 0 == this.$_getKeyboardKeys$().length && (this.$_clearSelectedHeaderColumns$(), this.$_setHeaderColumnSelection$($columnIdx$$10$$, !this.$_getHeaderColumnSelection$($columnIdx$$10$$), $event$$171$$.currentTarget, $event$$171$$, !0), this.$_getTableDndContext$().$setTableHeaderColumnDraggable$($columnIdx$$10$$, 
        !0));
      }
    }, "dragstart .oj-table-column-header-cell":function($event$$172$$) {
      return this.$_getTableDndContext$().$handleColumnDragStart$($event$$172$$);
    }, "dragenter .oj-table-column-header-cell":function($event$$173$$) {
      return this.$_getTableDndContext$().$handleColumnDragEnter$($event$$173$$);
    }, "dragover .oj-table-column-header-cell":function($event$$174$$) {
      return this.$_getTableDndContext$().$handleColumnDragOver$($event$$174$$);
    }, "dragleave .oj-table-column-header-cell":function($event$$175$$) {
      return this.$_getTableDndContext$().$handleColumnDragLeave$($event$$175$$);
    }, "drop .oj-table-column-header-cell":function($event$$176$$) {
      return this.$_getTableDndContext$().$handleColumnDrop$($event$$176$$);
    }, "dragend .oj-table-column-header-cell":function() {
      return this.$_getTableDndContext$().$handleColumnDragEnd$();
    }, "dragstart .oj-table-body-row":function($event$$178$$) {
      return this.$_getTableDndContext$().$handleRowDragStart$($event$$178$$);
    }, "drag .oj-table-body-row":function($event$$179$$) {
      return this.$_getTableDndContext$().$handleRowDrag$($event$$179$$);
    }, "dragend .oj-table-body-row":function($event$$180$$) {
      return this.$_getTableDndContext$().$handleRowDragEnd$($event$$180$$);
    }, "dragenter .oj-table-body":function($event$$181$$) {
      return this.$_getTableDndContext$().$handleRowDragEnter$($event$$181$$);
    }, "dragover .oj-table-body":function($event$$182$$) {
      return this.$_getTableDndContext$().$handleRowDragOver$($event$$182$$);
    }, "dragleave .oj-table-body":function($event$$183$$) {
      return this.$_getTableDndContext$().$handleRowDragLeave$($event$$183$$);
    }, "drop .oj-table-body":function($event$$184$$) {
      return this.$_getTableDndContext$().$handleRowDrop$($event$$184$$);
    }}, $_eventsContainer$:{touchstart:function($event$$185$$) {
      if (1 == $event$$185$$.originalEvent.touches.length && this.$_getRowSelectionMode$() == this.$_OPTION_SELECTION_MODES$.$_MULTIPLE$) {
        if ($$$$14$$($event$$185$$.target).hasClass($oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_DATA_ROW_TOUCH_SELECTIOM_AFFORDANCE_TOP_CLASS$) || $$$$14$$($event$$185$$.target).hasClass($oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_DATA_ROW_TOUCH_SELECTIOM_AFFORDANCE_TOP_ICON_CLASS$)) {
          $event$$185$$.preventDefault(), this.$_mouseDownRowIdx$ = this.$_getTableDomUtils$().$getTableBodyRowTouchSelectionAffordanceBottom$().data("rowIdx");
        } else {
          if ($$$$14$$($event$$185$$.target).hasClass($oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_DATA_ROW_TOUCH_SELECTIOM_AFFORDANCE_BOTTOM_CLASS$) || $$$$14$$($event$$185$$.target).hasClass($oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_DATA_ROW_TOUCH_SELECTIOM_AFFORDANCE_BOTTOM_ICON_CLASS$)) {
            $event$$185$$.preventDefault(), this.$_mouseDownRowIdx$ = this.$_getTableDomUtils$().$getTableBodyRowTouchSelectionAffordanceTop$().data("rowIdx");
          }
        }
      }
    }, touchmove:function($event$$186_eventTarget$$) {
      null != this.$_mouseDownRowIdx$ && ($event$$186_eventTarget$$.preventDefault(), $event$$186_eventTarget$$ = this.$_getTouchEventTargetElement$($event$$186_eventTarget$$), this.$_handleMouseEnterSelection$($event$$186_eventTarget$$));
    }, touchend:function($event$$187_eventTarget$$1$$) {
      null != this.$_mouseDownRowIdx$ && ($event$$187_eventTarget$$1$$ = this.$_getTouchEventTargetElement$($event$$187_eventTarget$$1$$), this.$_handleMouseEnterSelection$($event$$187_eventTarget$$1$$));
      this.$_mouseDownRowIdx$ = null;
      ...
      this.$_queueTask$(function() {
        return $self$$94$$.$_invokeDataFetchRows$($startIndex$$14$$);
      });
    }, _setOption:function($key$$67$$, $value$$208$$) {
      this._superApply(arguments);
      this.$_isTableRefreshNeeded$($key$$67$$, $value$$208$$) ? this.$_refresh$() : "selection" == $key$$67$$ ? (this.$_clearSelectedRows$(), this.$_clearSelectedHeaderColumns$(), this.$_setSelection$($value$$208$$)) : "currentRow" == $key$$67$$ && this.$_setCurrentRow$($value$$208$$, null, !0);
      ...
      if ($foundCode_keyboardKeys$$) {
        ...
        $found$$7_prop$$60$$ = !1;
        var $i$$178$$, $keyboardKeysCount$$ = $foundCode_keyboardKeys$$.length;
        for ($i$$178$$ = 0;$i$$178$$ < $keyboardKeysCount$$;$i$$178$$++) {
          if ($foundCode_keyboardKeys$$[$i$$178$$] == $keyCode$$1$$) {
            $found$$7_prop$$60$$ = !0;
            break;
          }
        }
    ...
    }, $_addSingleTableBodyRow$:function($rowIdx$$7$$, $row$$6$$, $docFrag$$, $docFragStartIdx$$) {
      var $tableBodyRow$$3$$ = this.$_getTableDomUtils$().$createTableBodyRow$($rowIdx$$7$$, $row$$6$$[this.$_CONST_KEY$]);
      this.$_getTableDomUtils$().$styleTableBodyRow$($tableBodyRow$$3$$, !0);
      this.$_getTableDomUtils$().$insertTableBodyRow$($rowIdx$$7$$, $tableBodyRow$$3$$, $row$$6$$, $docFrag$$);
      this.$_refreshTableBodyRow$($rowIdx$$7$$, $row$$6$$, $tableBodyRow$$3$$, $docFrag$$, $docFragStartIdx$$, !0);
    }, $_checkRowOrHeaderColumnFocus$:function($event$$189$$) {
      var $focusedRowIdx$$1$$ = this.$_getFocusedRowIdx$(), $focusedHeaderColumnIdx$$ = this.$_getFocusedHeaderColumnIdx$();
      null == $focusedRowIdx$$1$$ && null == $focusedHeaderColumnIdx$$ && (this.$_isTableHeaderless$() ? this.$_setRowFocus$(0, !0, !0, null, $event$$189$$) : this.$_setHeaderColumnFocus$(0, !0, !1, $event$$189$$));
      ...
      var $selectedHeaderColumnIdxs$$ = this.$_getSelectedHeaderColumnIdxs$(), $i$$179$$, $selectedHeaderColumnIdxsCount$$ = $selectedHeaderColumnIdxs$$.length;
      for ($i$$179$$ = 0;$i$$179$$ < $selectedHeaderColumnIdxsCount$$;$i$$179$$++) {
        this.$_setHeaderColumnSelection$($selectedHeaderColumnIdxs$$[$i$$179$$], !1, null, null, !1);
      }
    }, $_clearSelectedRows$:function() {
      var $selectedRowIdxs$$ = this.$_getSelectedRowIdxs$(), $i$$180$$, $selectedRowIdxsCount$$ = $selectedRowIdxs$$.length;
      for ($i$$180$$ = 0;$i$$180$$ < $selectedRowIdxsCount$$;$i$$180$$++) {
        this.$_setRowSelection$($selectedRowIdxs$$[$i$$180$$], !1, null, null, !1);
      }
      ...
      this.$_queueTask$(function() {
        ...
        if (1 < $rows$$.length) {
          var $i$$181_tableBodyRowBefore$$, $rowsCount$$ = $rows$$.length, $isContiguous_tableBodyDocFrag$$ = !0;
          for ($i$$181_tableBodyRowBefore$$ = 0;$i$$181_tableBodyRowBefore$$ < $rowsCount$$;$i$$181_tableBodyRowBefore$$++) {
            if (0 != $i$$181_tableBodyRowBefore$$ && $rows$$[$i$$181_tableBodyRowBefore$$ - 1].$rowIdx$ != $rows$$[$i$$181_tableBodyRowBefore$$].$rowIdx$ - 1) {
              $isContiguous_tableBodyDocFrag$$ = !1;
              break;
            }
          }
          if ($isContiguous_tableBodyDocFrag$$) {
            $batchAdd_tableBody$$ = $self$$95$$.$_getTableDomUtils$().$getTableBody$();
            $isContiguous_tableBodyDocFrag$$ = $$$$14$$(document.createDocumentFragment());
            $rowsCount$$ = $rows$$.length;
            for ($i$$181_tableBodyRowBefore$$ = 0;$i$$181_tableBodyRowBefore$$ < $rowsCount$$;$i$$181_tableBodyRowBefore$$++) {
              $self$$95$$.$_addSingleTableBodyRow$($rows$$[$i$$181_tableBodyRowBefore$$].$rowIdx$, $rows$$[$i$$181_tableBodyRowBefore$$].row, $isContiguous_tableBodyDocFrag$$, $rows$$[0].$rowIdx$);
            }
            0 == $rows$$[0].$rowIdx$ ? $batchAdd_tableBody$$.prepend($isContiguous_tableBodyDocFrag$$) : ($i$$181_tableBodyRowBefore$$ = $self$$95$$.$_getTableDomUtils$().$getTableBodyRow$($rows$$[0].$rowIdx$), null != $i$$181_tableBodyRowBefore$$ ? $batchAdd_tableBody$$[0].insertBefore($isContiguous_tableBodyDocFrag$$[0], $i$$181_tableBodyRowBefore$$[0]) : $batchAdd_tableBody$$[0].insertBefore($isContiguous_tableBodyDocFrag$$[0], null));
            $self$$95$$.$_getTableDomUtils$().$clearCachedDomRowData$();
            $oj$$14$$.Components.$subtreeAttached$($batchAdd_tableBody$$[0]);
            $batchAdd_tableBody$$ = !0;
          }
        }
        if (!$batchAdd_tableBody$$) {
          for ($rowsCount$$ = $rows$$.length, $i$$181_tableBodyRowBefore$$ = 0;$i$$181_tableBodyRowBefore$$ < $rowsCount$$;$i$$181_tableBodyRowBefore$$++) {
            $self$$95$$.$_addSingleTableBodyRow$($rows$$[$i$$181_tableBodyRowBefore$$].$rowIdx$, $rows$$[$i$$181_tableBodyRowBefore$$].row);
          }
        }
        $self$$95$$.$_getTableDomUtils$().$clearCachedDomRowData$();
      ...
      var $self$$96$$ = this;
      this.$_queueTask$(function() {
        var $i$$182$$, $rowsCount$$1$$ = $rows$$1$$.length;
        for ($i$$182$$ = 0;$i$$182$$ < $rowsCount$$1$$;$i$$182$$++) {
          $self$$96$$.$_refreshTableBodyRow$($rows$$1$$[$i$$182$$].$rowIdx$, $rows$$1$$[$i$$182$$].row);
        }
        $self$$96$$.$_refreshTableFooter$();
      });
    }, $_executeTableBodyRowsRemove$:function($rows$$2$$) {
      var $self$$97$$ = this, $currentRow$$ = this.$_getCurrentRow$(), $currentRowKey$$ = null != $currentRow$$ ? $currentRow$$.rowKey : null;
      this.$_queueTask$(function() {
        var $i$$183_tableBodyRows$$1$$, $rowKey$$2$$, $rowsCount$$2$$ = $rows$$2$$.length;
        for ($i$$183_tableBodyRows$$1$$ = 0;$i$$183_tableBodyRows$$1$$ < $rowsCount$$2$$;$i$$183_tableBodyRows$$1$$++) {
          $self$$97$$.$_getTableDomUtils$().$removeTableBodyRow$($rows$$2$$[$i$$183_tableBodyRows$$1$$].$rowIdx$), null != $currentRowKey$$ && ($rowKey$$2$$ = $rows$$2$$[$i$$183_tableBodyRows$$1$$].row[$self$$97$$.$_FIELD_ID$], $oj$$14$$.$Object$.$compareValues$($rowKey$$2$$, $currentRowKey$$) && ($self$$97$$.$_setCurrentRow$(null, null), $currentRowKey$$ = null));
        }
        $self$$97$$.$_refreshTableFooter$();
        $i$$183_tableBodyRows$$1$$ = $self$$97$$.$_getTableDomUtils$().$getTableBodyRows$();
        null != $i$$183_tableBodyRows$$1$$ && 0 != $i$$183_tableBodyRows$$1$$.length || this.$_showNoDataMessage$();
      });
      ...
      var $defaultedColumns_sortSupportedData$$ = [], $data$$105_i$$184$$, $columnsCount$$ = $columns_columnsSortedArray$$.length;
      for ($data$$105_i$$184$$ = 0;$data$$105_i$$184$$ < $columnsCount$$;$data$$105_i$$184$$++) {
        $defaultedColumns_sortSupportedData$$[$data$$105_i$$184$$] = $$$$14$$.extend({}, $columnsDefault_defaultedColumnsCount$$, $columns_columnsSortedArray$$[$data$$105_i$$184$$]);
      }
      $columns_columnsSortedArray$$ = [];
      $columnsDefault_defaultedColumnsCount$$ = $defaultedColumns_sortSupportedData$$.length;
      for ($data$$105_i$$184$$ = 0;$data$$105_i$$184$$ < $columnsDefault_defaultedColumnsCount$$;$data$$105_i$$184$$++) {
        $columns_columnsSortedArray$$.push($defaultedColumns_sortSupportedData$$[$data$$105_i$$184$$]);
      }
      $data$$105_i$$184$$ = this.$_getData$();
      $defaultedColumns_sortSupportedData$$ = !1;
      null != $data$$105_i$$184$$ && "full" == $data$$105_i$$184$$.getCapability("sort") && ($defaultedColumns_sortSupportedData$$ = !0);
      for ($data$$105_i$$184$$ = 0;$data$$105_i$$184$$ < $columnsDefault_defaultedColumnsCount$$;$data$$105_i$$184$$++) {
        null == $columns_columnsSortedArray$$[$data$$105_i$$184$$][this.$_FIELD_ID$] && ($columns_columnsSortedArray$$[$data$$105_i$$184$$][this.$_FIELD_ID$] = this.$_COLUMN_HEADER_ID_PREFIX$ + $data$$105_i$$184$$), null != $columns_columnsSortedArray$$[$data$$105_i$$184$$].sortable && $columns_columnsSortedArray$$[$data$$105_i$$184$$].sortable != this.$_OPTION_AUTO$ || !$defaultedColumns_sortSupportedData$$ || ($columns_columnsSortedArray$$[$data$$105_i$$184$$].sortable = this.$_OPTION_ENABLED$)
        ;
      }
      ...
      if (null != $columns$$1$$) {
        var $i$$185$$, $column$$4$$, $columnsCount$$1$$ = $columns$$1$$.length;
        for ($i$$185$$ = 0;$i$$185$$ < $columnsCount$$1$$;$i$$185$$++) {
          if ($column$$4$$ = $columns$$1$$[$i$$185$$], $oj$$14$$.$Object$.$compareValues$($column$$4$$.id, $columnKey$$)) {
            return $i$$185$$;
          }
        }
      }
      ...
      if ($elements$$1_styleClass$$ && 0 < $elements$$1_styleClass$$.length) {
        var $i$$186$$, $j$$27$$, $alreadyAdded$$, $columnIdx$$12$$, $columnIdxsCount$$, $elementsCount$$ = $elements$$1_styleClass$$.length;
        for ($i$$186$$ = 0;$i$$186$$ < $elementsCount$$;$i$$186$$++) {
          $columnIdx$$12$$ = this.$_getTableDomUtils$().$getElementColumnIdx$($$$$14$$($elements$$1_styleClass$$.get($i$$186$$)));
          $alreadyAdded$$ = !1;
    ...
    }, $_getColumnRenderer$:function($columnIdx$$14$$, $type$$78$$) {
      var $column$$5$$ = this.$_getColumnDefs$()[$columnIdx$$14$$];
      return "cell" == $type$$78$$ ? $column$$5$$.renderer : "footer" == $type$$78$$ ? $column$$5$$.footerRenderer : "header" == $type$$78$$ ? $column$$5$$.headerRenderer : null;
    }, $_getCurrentRow$:function() {
      return this.$_getData$() ? this.$_currentRow$ : null;
    }, $_getData$:function() {
      if (!this.$_data$ && null != this.options.data) {
        var $data$$107$$ = this.options.data;
        if ($data$$107$$ instanceof $oj$$14$$.$TableDataSource$ || $data$$107$$ instanceof $oj$$14$$.$PagingTableDataSource$) {
          this.$_data$ = $data$$107$$;
        } else {
      ...
      if (null != $resultObject$$) {
        var $i$$187$$, $indexesCount$$ = $resultObject$$[this.$_CONST_INDEXES$].length;
        for ($i$$187$$ = 0;$i$$187$$ < $indexesCount$$;$i$$187$$++) {
          $rowIdxRowArray$$.push({row:{data:$resultObject$$[this.$_CONST_DATA$][$i$$187$$], key:$resultObject$$[this.$_CONST_KEYS$][$i$$187$$], index:$resultObject$$[this.$_CONST_INDEXES$][$i$$187$$]}, $rowIdx$:$startIndex$$16$$ + $i$$187$$});
        }
      }
      ...
      if (null != $tableBodyRows$$2$$ && 0 < $tableBodyRows$$2$$.length) {
        var $i$$188$$, $tableBodyRowsCount$$ = $tableBodyRows$$2$$.length;
        for ($i$$188$$ = 0;$i$$188$$ < $tableBodyRowsCount$$;$i$$188$$++) {
          if ($oj$$14$$.$Object$.$compareValues$($$$$14$$($tableBodyRows$$2$$[$i$$188$$]).data("rowKey"), $rowKey$$3$$)) {
            return $i$$188$$;
          }
        }
      }
      return null;
    }, $_getDataSourceRowIndexForRowKey$:function($data$$108_rowKey$$4$$) {
      ...
      if (null != $startIndex$$17_tableBodyRows$$3$$ && 0 < $startIndex$$17_tableBodyRows$$3$$.length) {
        var $i$$189$$, $tableBodyRowsCount$$1$$ = $startIndex$$17_tableBodyRows$$3$$.length;
        for ($i$$189$$ = 0;$i$$189$$ < $tableBodyRowsCount$$1$$;$i$$189$$++) {
          if ($oj$$14$$.$Object$.$compareValues$($$$$14$$($startIndex$$17_tableBodyRows$$3$$[$i$$189$$]).data("rowKey"), $data$$108_rowKey$$4$$)) {
            return $data$$108_rowKey$$4$$ = this.$_getData$(), $startIndex$$17_tableBodyRows$$3$$ = 0, $data$$108_rowKey$$4$$ instanceof $oj$$14$$.$PagingTableDataSource$ && ($startIndex$$17_tableBodyRows$$3$$ = $data$$108_rowKey$$4$$.getStartItemIndex()), $i$$189$$ + $startIndex$$17_tableBodyRows$$3$$;
          }
        }
      }
      return null;
      ...
      if ($elements$$2_styleClass$$1$$ && 0 < $elements$$2_styleClass$$1$$.length) {
        var $i$$190$$, $j$$28$$, $rowIdx$$8$$, $rowIdxsCount$$, $alreadyAdded$$1$$, $elementsCount$$1$$ = $elements$$2_styleClass$$1$$.length;
        for ($i$$190$$ = 0;$i$$190$$ < $elementsCount$$1$$;$i$$190$$++) {
          $rowIdx$$8$$ = this.$_getTableDomUtils$().$getElementRowIdx$($$$$14$$($elements$$2_styleClass$$1$$.get($i$$190$$)));
          $alreadyAdded$$1$$ = !1;
      ...
      if (null != $tableBodyRows$$4$$ && 0 < $tableBodyRows$$4$$.length) {
        var $data$$109_i$$191$$ = this.$_getData$(), $startIndex$$18$$ = 0;
        $data$$109_i$$191$$ instanceof $oj$$14$$.$PagingTableDataSource$ && ($startIndex$$18$$ = $data$$109_i$$191$$.getStartItemIndex());
        for (var $tableBodyRowsCount$$2$$ = $tableBodyRows$$4$$.length, $data$$109_i$$191$$ = 0;$data$$109_i$$191$$ < $tableBodyRowsCount$$2$$;$data$$109_i$$191$$++) {
          if ($startIndex$$18$$ + $data$$109_i$$191$$ == $rowIndex$$3$$) {
            return $$$$14$$($tableBodyRows$$4$$[$data$$109_i$$191$$]).data("rowKey");
          }
        }
      }
      return null;
      ...
      var $rangeArray_selectedRowIdxs$$1$$ = [], $rangeCount_selectedColumnIdxs$$ = 0, $previousIdx$$ = null, $rangeObj$$, $selectionIndex$$, $selectionIdx$$, $selectionKey$$, $i$$192$$, $selectionIdxsCount$$ = $selectionIdxs$$.length;
      for ($i$$192$$ = 0;$i$$192$$ < $selectionIdxsCount$$;$i$$192$$++) {
        $selectionIdx$$ = $selectionIdxs$$[$i$$192$$], 0 == $i$$192$$ ? ($rangeObj$$ = {}, $rangeObj$$[this.$_CONST_STARTINDEX$] = {}, $rangeObj$$[this.$_CONST_ENDINDEX$] = {}, $rangeObj$$.startKey = {}, $rangeObj$$.endKey = {}, $rowSelection$$ ? ($selectionKey$$ = this.$_getRowKeyForRowIdx$($selectionIdx$$), $selectionIndex$$ = this.$_getDataSourceRowIndexForRowKey$($selectionKey$$), $rangeObj$$.startKey[this.$_CONST_ROW$] = $selectionKey$$, $rangeObj$$.endKey[this.$_CONST_ROW$] = $selectionKey$$, 
      ...
      var $tableHeaderColumns$$ = this.$_getTableDomUtils$().$getTableHeaderColumns$(), $i$$193$$, $sorted$$3$$, $tableHeaderColumnsCount$$ = $tableHeaderColumns$$.length;
      for ($i$$193$$ = 0;$i$$193$$ < $tableHeaderColumnsCount$$;$i$$193$$++) {
        if ($sorted$$3$$ = $$$$14$$($tableHeaderColumns$$[$i$$193$$]).data("sorted"), null != $sorted$$3$$) {
          return $i$$193$$;
        }
      }
      return null;
    }, $_getTabbableElements$:function($element$$88_tabbableElements$$) {
      $element$$88_tabbableElements$$ = $element$$88_tabbableElements$$.find(":tabbable");
      return null != $element$$88_tabbableElements$$ && 0 < $element$$88_tabbableElements$$.length ? $element$$88_tabbableElements$$ : null;
    ...
    }, $_getTouchEventTargetElement$:function($event$$190_eventLocation$$) {
      $event$$190_eventLocation$$ = $event$$190_eventLocation$$.originalEvent.changedTouches[0];
      return $$$$14$$(document.elementFromPoint($event$$190_eventLocation$$.clientX, $event$$190_eventLocation$$.clientY));
    }, $_handleContextMenuSelect$:function($event$$191$$, $ui$$5$$) {
      ...
      "oj-table-sortAsc" == $menuItemCommand$$ ? this.$_handleSortTableHeaderColumn$($columnIdx$$18$$, !0, $event$$191$$) : "oj-table-sortDsc" == $menuItemCommand$$ && this.$_handleSortTableHeaderColumn$($columnIdx$$18$$, !1, $event$$191$$);
    ...
    }, $_handleDataFetchEnd$:function($event$$193$$) {
      try {
        var $self$$98$$ = this;
        this.$_queueTask$(function() {
          var $offset$$22$$ = 0, $data$$110_indexArray$$ = $self$$98$$.$_getData$();
          $data$$110_indexArray$$ instanceof $oj$$14$$.$PagingTableDataSource$ && ($offset$$22$$ = $data$$110_indexArray$$.getStartItemIndex());
          var $data$$110_indexArray$$ = [], $i$$194$$, $eventDataCount$$ = $event$$193$$[$self$$98$$.$_CONST_DATA$].length;
          for ($i$$194$$ = 0;$i$$194$$ < $eventDataCount$$;$i$$194$$++) {
            $data$$110_indexArray$$[$i$$194$$] = $i$$194$$ + $offset$$22$$ + $event$$193$$[$self$$98$$.$_CONST_STARTINDEX$];
          }
          $self$$98$$.$_refreshAll$({data:$event$$193$$[$self$$98$$.$_CONST_DATA$], keys:$event$$193$$[$self$$98$$.$_CONST_KEYS$], indexes:$data$$110_indexArray$$}, $event$$193$$[$self$$98$$.$_CONST_STARTINDEX$]);
        });
      } catch ($e$$81$$) {
        $oj$$14$$.$Logger$.error($e$$81$$);
      } finally {
        this.$_clearDataWaitingState$();
      }
    }, $_handleDataRefresh$:function() {
      try {
        var $fetchPromise$$ = this.$_invokeDataFetchRows$(), $self$$99$$ = this;
        this.$_queueTask$(function() {
          $self$$99$$.$_setCurrentRow$(null, null);
          return $fetchPromise$$;
        });
      } catch ($e$$82$$) {
        $oj$$14$$.$Logger$.error($e$$82$$);
      } finally {
        this.$_clearDataWaitingState$();
      }
      ...
      try {
        ...
        var $self$$100$$ = this;
        this.$_queueTask$(function() {
          $self$$100$$.$_setCurrentRow$(null, null);
        });
      } catch ($e$$83$$) {
    ...
    }, $_handleDataRowAdd$:function($event$$196_startIndex$$19$$) {
      try {
        var $data$$111_rowArray$$ = this.$_getData$(), $eventData$$5$$ = $event$$196_startIndex$$19$$[this.$_CONST_DATA$], $eventIndexes$$ = $event$$196_startIndex$$19$$[this.$_CONST_INDEXES$], $eventKeys$$ = $event$$196_startIndex$$19$$[this.$_CONST_KEYS$];
        $eventData$$5$$ instanceof Array || ($eventData$$5$$ = [$eventData$$5$$]);
        $event$$196_startIndex$$19$$ = 0;
        $data$$111_rowArray$$ instanceof $oj$$14$$.$PagingTableDataSource$ && ($event$$196_startIndex$$19$$ = $data$$111_rowArray$$.getStartItemIndex());
        var $data$$111_rowArray$$ = [], $i$$195$$, $eventDataCount$$1$$ = $eventData$$5$$.length;
        for ($i$$195$$ = 0;$i$$195$$ < $eventDataCount$$1$$;$i$$195$$++) {
          var $rowIdx$$11$$ = $eventIndexes$$[$i$$195$$] - $event$$196_startIndex$$19$$;
          void 0 !== $rowIdx$$11$$ && $data$$111_rowArray$$.push({row:{data:$eventData$$5$$[$i$$195$$], key:$eventKeys$$[$i$$195$$], index:$eventIndexes$$[$i$$195$$]}, $rowIdx$:$rowIdx$$11$$});
        }
        0 < $data$$111_rowArray$$.length && this.$_executeTableBodyRowsAdd$($data$$111_rowArray$$);
      } catch ($e$$84$$) {
        $oj$$14$$.$Logger$.error($e$$84$$);
      } finally {
        this.$_clearDataWaitingState$();
      }
    }, $_handleDataRowChange$:function($event$$197_startIndex$$20$$) {
      try {
        var $data$$112_rowArray$$1$$ = this.$_getData$(), $eventData$$6$$ = $event$$197_startIndex$$20$$[this.$_CONST_DATA$], $eventIndexes$$1$$ = $event$$197_startIndex$$20$$[this.$_CONST_INDEXES$], $eventKeys$$1$$ = $event$$197_startIndex$$20$$[this.$_CONST_KEYS$];
        $eventData$$6$$ instanceof Array || ($eventData$$6$$ = [$eventData$$6$$]);
        $event$$197_startIndex$$20$$ = 0;
        $data$$112_rowArray$$1$$ instanceof $oj$$14$$.$PagingTableDataSource$ && ($event$$197_startIndex$$20$$ = $data$$112_rowArray$$1$$.getStartItemIndex());
        var $data$$112_rowArray$$1$$ = [], $i$$196$$, $eventDataCount$$2$$ = $eventData$$6$$.length;
        for ($i$$196$$ = 0;$i$$196$$ < $eventDataCount$$2$$;$i$$196$$++) {
          var $rowIdx$$12$$ = $eventIndexes$$1$$[$i$$196$$] - $event$$197_startIndex$$20$$;
          void 0 !== $rowIdx$$12$$ && $data$$112_rowArray$$1$$.push({row:{data:$eventData$$6$$[$i$$196$$], key:$eventKeys$$1$$[$i$$196$$], index:$eventIndexes$$1$$[$i$$196$$]}, $rowIdx$:$rowIdx$$12$$});
        }
        0 < $data$$112_rowArray$$1$$.length && this.$_executeTableBodyRowsChange$($data$$112_rowArray$$1$$);
      } catch ($e$$85$$) {
        $oj$$14$$.$Logger$.error($e$$85$$);
      } finally {
        this.$_clearDataWaitingState$();
      }
    }, $_handleDataRowRemove$:function($event$$198_startIndex$$21$$) {
      try {
        var $data$$113_rowArray$$2$$ = this.$_getData$(), $eventData$$7$$ = $event$$198_startIndex$$21$$[this.$_CONST_DATA$], $eventIndexes$$2$$ = $event$$198_startIndex$$21$$[this.$_CONST_INDEXES$], $eventKeys$$2$$ = $event$$198_startIndex$$21$$[this.$_CONST_KEYS$];
        $eventData$$7$$ instanceof Array || ($eventData$$7$$ = [$eventData$$7$$]);
        $event$$198_startIndex$$21$$ = 0;
        $data$$113_rowArray$$2$$ instanceof $oj$$14$$.$PagingTableDataSource$ && ($event$$198_startIndex$$21$$ = $data$$113_rowArray$$2$$.getStartItemIndex());
        var $data$$113_rowArray$$2$$ = [], $i$$197$$;
        for ($i$$197$$ = $eventData$$7$$.length - 1;0 <= $i$$197$$;$i$$197$$--) {
          var $rowIdx$$13$$ = $eventIndexes$$2$$[$i$$197$$] - $event$$198_startIndex$$21$$;
          void 0 !== $rowIdx$$13$$ && $data$$113_rowArray$$2$$.push({row:{data:$eventData$$7$$[$i$$197$$], key:$eventKeys$$2$$[$i$$197$$], index:$eventIndexes$$2$$[$i$$197$$]}, $rowIdx$:$rowIdx$$13$$});
        }
        0 < $data$$113_rowArray$$2$$.length && this.$_executeTableBodyRowsRemove$($data$$113_rowArray$$2$$);
      } catch ($e$$86$$) {
        $oj$$14$$.$Logger$.error($e$$86$$);
      } finally {
        this.$_clearDataWaitingState$();
      }
    }, $_handleDataSort$:function($clearSelection_event$$199$$) {
      try {
        var $columnIdx$$19$$;
        if (null != $clearSelection_event$$199$$) {
          var $columns$$4$$ = this.$_getColumnDefs$(), $i$$198$$, $column$$6$$, $sortField$$, $columnsCount$$2$$ = $columns$$4$$.length;
          for ($i$$198$$ = 0;$i$$198$$ < $columnsCount$$2$$;$i$$198$$++) {
            if ($column$$6$$ = $columns$$4$$[$i$$198$$], $sortField$$ = null == $column$$6$$.sortProperty ? $column$$6$$.field : $column$$6$$.sortProperty, $clearSelection_event$$199$$.header == $sortField$$) {
              $columnIdx$$19$$ = $i$$198$$;
              break;
            }
          }
          null != $columnIdx$$19$$ && this.$_refreshSortTableHeaderColumn$($columnIdx$$19$$, $clearSelection_event$$199$$.direction == this.$_COLUMN_SORT_ORDER$.$_ASCENDING$);
        }
        var $existingSelection$$ = this.options.selection;
        if (null != $existingSelection$$) {
          $clearSelection_event$$199$$ = !1;
          if (1 < $existingSelection$$.length) {
            $clearSelection_event$$199$$ = !0;
          } else {
            if (null != $existingSelection$$[0]) {
              var $endIndex$$1$$ = $existingSelection$$[0][this.$_CONST_ENDINDEX$];
              $oj$$14$$.$Object$.$compareValues$($existingSelection$$[0][this.$_CONST_STARTINDEX$], $endIndex$$1$$) || null == $endIndex$$1$$ || ($clearSelection_event$$199$$ = !0);
            }
          }
          $clearSelection_event$$199$$ && (this.$_setSelection$(null), this.option("selection", null, {_context:{$writeback$:!0, $internalSet$:!0}}));
        }
        this.$_setCurrentRow$(this.options.currentRow, null);
        var $self$$101$$ = this;
        this.$_queueTask$(function() {
          return $self$$101$$.$_invokeDataFetchRows$(null);
        }).then(function() {
          null != $columnIdx$$19$$ && setTimeout(function() {
            $self$$101$$.$_scrollColumnIntoViewport$($columnIdx$$19$$);
          }, 0);
        });
      } catch ($e$$87$$) {
    ...
    }, $_handleKeydownLeftRight$:function($event$$200$$) {
      ...
      if (null != $focusedHeaderColumnIdx$$2$$) {
        ...
        $newFocusedHeaderColumnIdx$$ != $focusedHeaderColumnIdx$$2$$ && (this.$_setHeaderColumnFocus$($newFocusedHeaderColumnIdx$$, !0, !1, null), $event$$200$$[this.$_KEYBOARD_CODES$.$_KEYBOARD_MODIFIER_SHIFT$] && ($columns$$5_newFocusedHeaderColumnSelection$$ = this.$_getHeaderColumnSelection$($newFocusedHeaderColumnIdx$$), this.$_setHeaderColumnSelection$($newFocusedHeaderColumnIdx$$, !$columns$$5_newFocusedHeaderColumnSelection$$, null, $event$$200$$, !0), $columns$$5_newFocusedHeaderColumnSelection$$ && 
        this.$_getHeaderColumnSelection$($focusedHeaderColumnIdx$$2$$) && this.$_setHeaderColumnSelection$($focusedHeaderColumnIdx$$2$$, !1, null, $event$$200$$, !0)));
      }
    }, $_handleKeydownTab$:function($event$$201$$) {
      ...
      if (!$tabHandled_tabbableElementsInDocument$$) {
        ...
        if ($event$$201$$[this.$_KEYBOARD_CODES$.$_KEYBOARD_MODIFIER_SHIFT$]) {
        ...
        $event$$201$$.preventDefault();
        $event$$201$$.stopPropagation();
      }
      this.$_removeKeyboardKey$($event$$201$$.keyCode);
    }, $_handleKeydownUpDown$:function($event$$202$$) {
      ...
      if (null != $focusedRowIdx$$4$$) {
        ...
        $focusedHeaderColumnIdx$$3_newFocusedRowIdx_tableBodyRows$$5$$ != $focusedRowIdx$$4$$ ? this.$_setRowFocus$($focusedHeaderColumnIdx$$3_newFocusedRowIdx_tableBodyRows$$5$$, !0, !0, null, $event$$202$$) && $event$$202$$[this.$_KEYBOARD_CODES$.$_KEYBOARD_MODIFIER_SHIFT$] && ($newFocusedRowSelection_rowCount$$2$$ = this.$_getRowSelection$($focusedHeaderColumnIdx$$3_newFocusedRowIdx_tableBodyRows$$5$$), this.$_setRowSelection$($focusedHeaderColumnIdx$$3_newFocusedRowIdx_tableBodyRows$$5$$, !$newFocusedRowSelection_rowCount$$2$$, 
        null, $event$$202$$, !0), $newFocusedRowSelection_rowCount$$2$$ && this.$_getRowSelection$($focusedRowIdx$$4$$) && this.$_setRowSelection$($focusedRowIdx$$4$$, !1, null, $event$$202$$, !0)) : $focusedHeaderColumnIdx$$3_newFocusedRowIdx_tableBodyRows$$5$$ == $focusedRowIdx$$4$$ && 0 == $focusedRowIdx$$4$$ && this.$_isKeyboardKeyPressed$(this.$_KEYBOARD_CODES$.$_KEYBOARD_CODE_UP$) && this.$_setHeaderColumnFocus$(0, !0, !1, null);
      } else {
        null != $focusedHeaderColumnIdx$$3_newFocusedRowIdx_tableBodyRows$$5$$ && this.$_isKeyboardKeyPressed$(this.$_KEYBOARD_CODES$.$_KEYBOARD_CODE_DOWN$) && this.$_setRowFocus$(0, !0, !0, null, $event$$202$$);
      }
    }, $_handleKeyupEnd$:function($event$$203$$) {
      ...
      if (null != $focusedColumnIdx_focusedRowIdx$$5$$ && $focusedColumnIdx_focusedRowIdx$$5$$ != this.$_getColumnDefs$().length - 1) {
        ...
        null != $focusedColumnIdx_focusedRowIdx$$5$$ && $focusedColumnIdx_focusedRowIdx$$5$$ != $rowCount$$3_tableBodyRows$$6$$ - 1 && 0 < $rowCount$$3_tableBodyRows$$6$$ && this.$_setRowFocus$($rowCount$$3_tableBodyRows$$6$$ - 1, !0, !0, null, $event$$203$$);
      }
    }, $_handleKeyupEnter$:function($event$$204$$) {
      ...
      if (null != $focusedColumnIdx$$1$$ && this.$_getColumnDefs$()[$focusedColumnIdx$$1$$].sortable == this.$_OPTION_ENABLED$) {
        ...
        null == $sorted$$4$$ || $sorted$$4$$ == this.$_COLUMN_SORT_ORDER$.$_DESCENDING$ ? this.$_handleSortTableHeaderColumn$($focusedColumnIdx$$1$$, !0, $event$$204$$) : this.$_handleSortTableHeaderColumn$($focusedColumnIdx$$1$$, !1, $event$$204$$);
      }
    }, $_handleKeyupEsc$:function($event$$205$$) {
      $event$$205$$.preventDefault();
      $event$$205$$.stopPropagation();
      this.$_getTableDomUtils$().$getTable$().focus();
      this.$_setTableNavigationMode$(!1);
    }, $_handleKeyupHome$:function($event$$206$$) {
      var $focusedColumnIdx$$2_focusedRowIdx$$6$$ = this.$_getFocusedHeaderColumnIdx$();
      null != $focusedColumnIdx$$2_focusedRowIdx$$6$$ && 0 != $focusedColumnIdx$$2_focusedRowIdx$$6$$ ? this.$_setHeaderColumnFocus$(0, !0, !1, null) : ($focusedColumnIdx$$2_focusedRowIdx$$6$$ = this.$_getFocusedRowIdx$(), null != $focusedColumnIdx$$2_focusedRowIdx$$6$$ && 0 != $focusedColumnIdx$$2_focusedRowIdx$$6$$ && this.$_setRowFocus$(0, !0, !0, null, $event$$206$$));
    }, $_handleKeyupSpacebar$:function($event$$207$$) {
      var $focusedHeaderColumnIdx$$4_focusedRowIdx$$7$$ = this.$_getFocusedRowIdx$();
      null != $focusedHeaderColumnIdx$$4_focusedRowIdx$$7$$ ? this.$_setRowSelection$($focusedHeaderColumnIdx$$4_focusedRowIdx$$7$$, !this.$_getRowSelection$($focusedHeaderColumnIdx$$4_focusedRowIdx$$7$$), null, $event$$207$$, !0) : ($focusedHeaderColumnIdx$$4_focusedRowIdx$$7$$ = this.$_getFocusedHeaderColumnIdx$(), null != $focusedHeaderColumnIdx$$4_focusedRowIdx$$7$$ && (this.$_clearSelectedRows$(), this.$_setHeaderColumnSelection$($focusedHeaderColumnIdx$$4_focusedRowIdx$$7$$, !this.$_getHeaderColumnSelection$($focusedHeaderColumnIdx$$4_focusedRowIdx$$7$$), 
      null, $event$$207$$, !0)));
    }, $_handleMouseEnterSelection$:function($element$$89$$) {
      var $rowIdx$$14$$ = this.$_getTableDomUtils$().$getElementRowIdx$($$$$14$$($element$$89$$));
      if (null != $rowIdx$$14$$ && null != this.$_mouseDownRowIdx$ && this.$_mouseDownRowIdx$ != $rowIdx$$14$$) {
        ...
        if ($rowIdx$$14$$ < $lastSelectedRowIdx$$1$$) {
          var $i$$199$$;
          for ($i$$199$$ = 0;$i$$199$$ < $selectedRowIdxs$$2$$.length;$i$$199$$++) {
            ($selectedRowIdxs$$2$$[$i$$199$$] < $rowIdx$$14$$ || $selectedRowIdxs$$2$$[$i$$199$$] > $lastSelectedRowIdx$$1$$) && this.$_setRowSelection$($selectedRowIdxs$$2$$[$i$$199$$], !1, $element$$89$$, null, !0);
          }
          for ($i$$199$$ = $lastSelectedRowIdx$$1$$;$i$$199$$ >= $rowIdx$$14$$;$i$$199$$--) {
            this.$_setRowSelection$($i$$199$$, !0, $element$$89$$, null, !0), this.$_getTableDomUtils$().$moveTableBodyRowTouchSelectionAffordanceTop$($i$$199$$);
          }
        } else {
          for ($i$$199$$ = 0;$i$$199$$ < $selectedRowIdxs$$2$$.length;$i$$199$$++) {
            ($selectedRowIdxs$$2$$[$i$$199$$] > $rowIdx$$14$$ || $selectedRowIdxs$$2$$[$i$$199$$] < $lastSelectedRowIdx$$1$$) && this.$_setRowSelection$($selectedRowIdxs$$2$$[$i$$199$$], !1, $element$$89$$, null, !0);
          ...
          for ($i$$199$$ = $lastSelectedRowIdx$$1$$;$i$$199$$ <= $rowIdx$$14$$;$i$$199$$++) {
            this.$_setRowSelection$($i$$199$$, !0, $element$$89$$, null, !0), this.$_getTableDomUtils$().$moveTableBodyRowTouchSelectionAffordanceBottom$($i$$199$$);
          }
        }
      }
    ...
    }, $_handleSortTableHeaderColumn$:function($columnIdx$$20$$, $ascending$$, $event$$208$$) {
      this.$_clearSortedHeaderColumn$($columnIdx$$20$$);
      var $column$$7$$ = this.$_getColumnDefs$()[$columnIdx$$20$$];
      this.$_invokeDataSort$(null == $column$$7$$.sortProperty ? $column$$7$$.field : $column$$7$$.sortProperty, $ascending$$, $event$$208$$);
      this.$_sortColumn$ = $column$$7$$;
      this.$_refreshSortTableHeaderColumn$($columnIdx$$20$$, $ascending$$);
    }, $_hasRowOrCellRenderer$:function($columnIdx$$21_i$$200$$) {
      if (null != this.$_getRowRenderer$()) {
        return!0;
      }
      var $cellRenderer$$ = null;
      if (null != $columnIdx$$21_i$$200$$) {
        $cellRenderer$$ = this.$_getColumnRenderer$($columnIdx$$21_i$$200$$, "cell");
      } else {
        var $columnsCount$$3$$ = this.$_getColumnDefs$().length;
        for ($columnIdx$$21_i$$200$$ = 0;$columnIdx$$21_i$$200$$ < $columnsCount$$3$$ && ($cellRenderer$$ = this.$_getColumnRenderer$($columnIdx$$21_i$$200$$, "cell"), null == $cellRenderer$$);$columnIdx$$21_i$$200$$++) {
        }
      }
      ...
      var $self$$102$$ = this, $data$$114$$ = this.$_getData$();
      null != $data$$114$$ && $data$$114$$ instanceof $oj$$14$$.$TableDataSource$ && !($data$$114$$ instanceof $oj$$14$$.$PagingTableDataSource$) ? (this.$_getTableDomUtils$().$getScroller$()[0].scrollTop = 0, this.$_queueTask$(function() {
        return $self$$102$$.$_invokeDataFetchRows$(0, {fetchType:"init"});
      })) : null == $data$$114$$ && this.$_queueTask$(function() {
      ...
      var $initFetch$$1$$ = "init" == $options$$238$$.fetchType ? !0 : !1, $data$$115$$ = this.$_getData$(), $self$$103$$ = this;
      return new Promise(function($resolve$$26$$, $reject$$26$$) {
        null != $data$$115$$ ? ($self$$103$$.$_setDataWaitingState$(), $data$$115$$.fetch($options$$238$$).then(function($result$$36$$) {
          if (null != $result$$36$$ && null != $result$$36$$[$self$$103$$.$_CONST_DATA$]) {
            var $offset$$23$$ = 0;
            $data$$115$$ instanceof $oj$$14$$.$PagingTableDataSource$ && ($offset$$23$$ = $data$$115$$.getStartItemIndex());
            var $indexArray$$1$$ = [], $i$$201$$, $resultDataCount$$ = $result$$36$$[$self$$103$$.$_CONST_DATA$].length;
            for ($i$$201$$ = 0;$i$$201$$ < $resultDataCount$$;$i$$201$$++) {
              $indexArray$$1$$[$i$$201$$] = $i$$201$$ + $offset$$23$$ + $result$$36$$[$self$$103$$.$_CONST_STARTINDEX$];
            }
            $self$$103$$.$_refreshAll$({data:$result$$36$$[$self$$103$$.$_CONST_DATA$], keys:$result$$36$$[$self$$103$$.$_CONST_KEYS$], indexes:$indexArray$$1$$}, $result$$36$$[$self$$103$$.$_CONST_STARTINDEX$], $initFetch$$1$$, $initFetch$$1$$);
          }
          $self$$103$$.$_clearDataWaitingState$();
          $resolve$$26$$(null);
        }, function($error$$30$$) {
          $self$$103$$.$_clearDataWaitingState$();
          $reject$$26$$($error$$30$$);
    ...
    }, $_invokeDataSort$:function($sortField$$2$$, $ascending$$2$$, $event$$209$$) {
      ...
      this._trigger("sort", $event$$209$$, {header:$sortCriteria$$[this.$_CONST_KEY$], direction:$sortCriteria$$.direction});
      $data$$116$$.sort($sortCriteria$$);
      ...
      if (null != this.$_columnDefArray$) {
        ...
        var $i$$202$$, $prop$$61$$, $columnsMetadataCount$$ = $columnsMetadata$$.length;
        for ($i$$202$$ = 0;$i$$202$$ < $columnsMetadataCount$$;$i$$202$$++) {
          for ($prop$$61$$ in $columnsMetadata$$[$i$$202$$]) {
            if ($columnsMetadata$$[$i$$202$$].hasOwnProperty($prop$$61$$) && $columnsMetadata$$[$i$$202$$][$prop$$61$$] != this.$_columnDefArray$[$i$$202$$][$prop$$61$$]) {
              return!0;
            }
          }
        }
      ...
      var $keyboardKeys$$1$$ = this.$_getKeyboardKeys$(), $i$$203$$, $keyboardKeysCount$$1$$ = $keyboardKeys$$1$$.length;
      for ($i$$203$$ = 0;$i$$203$$ < $keyboardKeysCount$$1$$;$i$$203$$++) {
        if ($keyboardKeys$$1$$[$i$$203$$] == $keyCode$$2$$) {
          return!0;
        }
      }
      return!1;
    ...
    }, $_isNodeType$:function($node$$59$$, $type$$79$$) {
      for (var $nodeName$$3$$, $table$$3$$ = this.$_getTableDomUtils$().$getTable$();null != $node$$59$$ && $node$$59$$[0] != $table$$3$$[0] && "TD" != ($nodeName$$3$$ = $node$$59$$.prop("nodeName")) && "TH" != $nodeName$$3$$;) {
        if (3 == $node$$59$$[0].nodeType) {
          ...
          if ($nodeName$$3$$.match($type$$79$$) && -1 != $tabIndex$$) {
            return!0;
          }
      ...
      var $i$$204$$, $footerRenderer$$, $columnsCount$$4$$ = this.$_getColumnDefs$().length;
      for ($i$$204$$ = 0;$i$$204$$ < $columnsCount$$4$$;$i$$204$$++) {
        if ($footerRenderer$$ = this.$_getColumnRenderer$($i$$204$$, "footer"), null != $footerRenderer$$) {
          return!1;
        }
      }
      return!0;
    }, $_isTableHeaderless$:function() {
      var $columns$$8$$ = this.$_getColumnDefs$(), $i$$205$$, $columnsCount$$5$$ = $columns$$8$$.length;
      for ($i$$205$$ = 0;$i$$205$$ < $columnsCount$$5$$;$i$$205$$++) {
        if (null != $columns$$8$$[$i$$205$$].headerText || null != $columns$$8$$[$i$$205$$].headerStyle || null != $columns$$8$$[$i$$205$$].sortable && $columns$$8$$[$i$$205$$].sortable != this.$_OPTION_NONE$ || null != $columns$$8$$[$i$$205$$].sortProperty || null != $columns$$8$$[$i$$205$$].headerRenderer) {
          return!1;
        }
      }
      return!0;
    ...
    }, $_isTableRefreshNeeded$:function($key$$68$$, $value$$209$$) {
      var $currentOptions$$ = this.$_cachedOptions$, $refresh$$ = !1;
      "contextMenu" == $key$$68$$ && $value$$209$$ == "#" + this.$_getTableDomUtils$().$getTableId$() + "_contextmenu" ? $refresh$$ = !1 : "selection" == $key$$68$$ || "currentRow" == $key$$68$$ || $oj$$14$$.$Object$.$compareValues$($value$$209$$, $currentOptions$$[$key$$68$$]) || ($refresh$$ = !0);
      this.$_cachedOptions$ = $$$$14$$.extend(!0, {}, this.options);
      return $refresh$$;
    }, $_isTableSortable$:function() {
      var $columns$$9$$ = this.$_getColumnDefs$(), $i$$206$$, $columnsCount$$6$$ = $columns$$9$$.length;
      for ($i$$206$$ = 0;$i$$206$$ < $columnsCount$$6$$;$i$$206$$++) {
        if (null != $columns$$9$$[$i$$206$$].sortable && $columns$$9$$[$i$$206$$].sortable != this.$_OPTION_NONE$) {
          return!0;
        }
      }
      return!1;
      ...
      if (this.$_isColumnMetadataUpdated$() || !this.$_isTableHeaderColumnsRendered$() && !this.$_isTableHeaderless$()) {
        if (this.$_clearCachedMetadata$(), this.$_refreshTableHeader$(), null != this.$_sortColumn$) {
          var $i$$207$$, $column$$8$$, $foundColumn$$ = !1, $columns$$10$$ = this.$_getColumnDefs$();
          if (null != $columns$$10$$) {
            var $columnsCount$$7$$ = $columns$$10$$.length;
            for ($i$$207$$ = 0;$i$$207$$ < $columnsCount$$7$$;$i$$207$$++) {
              if ($column$$8$$ = $columns$$10$$[$i$$207$$], $oj$$14$$.$Object$.$compareValues$($column$$8$$, this.$_sortColumn$)) {
                $foundColumn$$ = !0;
                break;
              }
            }
      ...
      if (null != $tableBody$$2$$) {
        ...
        var $i$$208_tableBodyRows$$7$$;
        if (0 == $startIndex$$25$$) {
          $oj$$14$$.Components.$subtreeDetached$($tableBody$$2$$[0]), $tableBody$$2$$.empty();
        } else {
          if ($i$$208_tableBodyRows$$7$$ = $tableBody$$2$$.children(), null != $i$$208_tableBodyRows$$7$$ && 0 < $i$$208_tableBodyRows$$7$$.length) {
            for ($i$$208_tableBodyRows$$7$$ = $i$$208_tableBodyRows$$7$$.length - 1;$i$$208_tableBodyRows$$7$$ >= $startIndex$$25$$;$i$$208_tableBodyRows$$7$$--) {
              this.$_getTableDomUtils$().$removeTableBodyRow$($i$$208_tableBodyRows$$7$$);
            }
          }
        }
        this.$_getTableDomUtils$().$clearCachedDomRowData$();
        this.$_hideNoDataMessage$();
        $i$$208_tableBodyRows$$7$$ = $tableBody$$2$$.children();
        if (0 != $resultObject$$2_rows$$3$$.length || null != $i$$208_tableBodyRows$$7$$ && 0 != $i$$208_tableBodyRows$$7$$.length) {
          var $tableBodyDocFrag$$1$$ = $$$$14$$(document.createDocumentFragment()), $row$$10$$, $rowIdx$$15$$, $tableBodyRow$$6$$, $rowsCount$$3$$ = $resultObject$$2_rows$$3$$.length;
          for ($i$$208_tableBodyRows$$7$$ = 0;$i$$208_tableBodyRows$$7$$ < $rowsCount$$3$$;$i$$208_tableBodyRows$$7$$++) {
            $row$$10$$ = $resultObject$$2_rows$$3$$[$i$$208_tableBodyRows$$7$$].row, $rowIdx$$15$$ = $resultObject$$2_rows$$3$$[$i$$208_tableBodyRows$$7$$].$rowIdx$, null != $row$$10$$ && ($tableBodyRow$$6$$ = this.$_getTableDomUtils$().$createTableBodyRow$($rowIdx$$15$$, $row$$10$$[this.$_CONST_KEY$]), this.$_getTableDomUtils$().$styleTableBodyRow$($tableBodyRow$$6$$, !0), this.$_getTableDomUtils$().$insertTableBodyRow$($rowIdx$$15$$, $tableBodyRow$$6$$, $row$$10$$, $tableBodyDocFrag$$1$$), this.$_refreshTableBodyRow$($rowIdx$$15$$, 
            $row$$10$$, $tableBodyRow$$6$$, $tableBodyDocFrag$$1$$, $startIndex$$25$$, !0));
          }
    ...
    }, $_refreshTableBodyRow$:function($moveTableBodyCell_rowIdx$$16$$, $row$$11_swapTableBodyCell$$, $tableBodyRow$$7$$, $docFrag$$1_i$$209$$, $docFragStartIdx$$1_tableBodyCells$$, $context$$60_isNew$$) {
      ...
      var $rowHashCode$$ = this.$_getTableDomUtils$().$hashCode$($row$$11_swapTableBodyCell$$[this.$_CONST_KEY$]);
      if (null == $tableBodyRow$$7$$) {
        if ($tableBodyRow$$7$$ = this.$_getTableDomUtils$().$getTableBodyRow$($moveTableBodyCell_rowIdx$$16$$)) {
          $tableBodyRow$$7$$.empty(), $context$$60_isNew$$ = !0, this.$_getTableDomUtils$().$createTableBodyCellAccSelect$($moveTableBodyCell_rowIdx$$16$$, $row$$11_swapTableBodyCell$$[this.$_CONST_KEY$], $rowHashCode$$, $tableBodyRow$$7$$, $context$$60_isNew$$);
        } else {
          return;
        }
      }
      this.$_hideNoDataMessage$();
      $tableBodyRow$$7$$.data("rowData", $row$$11_swapTableBodyCell$$);
      $context$$60_isNew$$ = {rowContext:$oj$$14$$.$TableRendererUtils$.$getRendererContextObject$(this, $row$$11_swapTableBodyCell$$, $tableBodyRow$$7$$[0]), row:$$$$14$$.extend({}, $row$$11_swapTableBodyCell$$[this.$_CONST_DATA$])};
      if ($rowContent_rowRenderer$$1_tableBodyCell$$2$$) {
        $rowContent_rowRenderer$$1_tableBodyCell$$2$$ = $rowContent_rowRenderer$$1_tableBodyCell$$2$$($context$$60_isNew$$);
        null != $rowContent_rowRenderer$$1_tableBodyCell$$2$$ ? $tableBodyRow$$7$$.append($rowContent_rowRenderer$$1_tableBodyCell$$2$$) : (null == $docFrag$$1_i$$209$$ ? $tableBodyRow$$7$$ = $$$$14$$($tableBody$$3_tableBodyCellsCount$$.children()[$moveTableBodyCell_rowIdx$$16$$]) : ($docFragStartIdx$$1_tableBodyCells$$ = null == $docFragStartIdx$$1_tableBodyCells$$ ? 0 : $docFragStartIdx$$1_tableBodyCells$$, $tableBodyRow$$7$$ = $$$$14$$($docFrag$$1_i$$209$$.children()[$moveTableBodyCell_rowIdx$$16$$ - 
        $docFragStartIdx$$1_tableBodyCells$$])), this.$_getTableDomUtils$().$clearCachedDomRowData$(), this.$_getTableDomUtils$().$setTableBodyRowAttributes$($row$$11_swapTableBodyCell$$, $tableBodyRow$$7$$), this.$_getTableDomUtils$().$styleTableBodyRow$($tableBodyRow$$7$$, !1));
        this.$_getTableDomUtils$().$createTableBodyCellAccSelect$($moveTableBodyCell_rowIdx$$16$$, $row$$11_swapTableBodyCell$$[this.$_CONST_KEY$], $rowHashCode$$, $tableBodyRow$$7$$, !1);
        ...
        for ($docFrag$$1_i$$209$$ = 1;$docFrag$$1_i$$209$$ < $tableBody$$3_tableBodyCellsCount$$;$docFrag$$1_i$$209$$++) {
          $rowContent_rowRenderer$$1_tableBodyCell$$2$$ = $$$$14$$($docFragStartIdx$$1_tableBodyCells$$[$docFrag$$1_i$$209$$]), this.$_getTableDomUtils$().$setTableBodyCellAttributes$($moveTableBodyCell_rowIdx$$16$$, $row$$11_swapTableBodyCell$$[this.$_CONST_KEY$], $rowHashCode$$, $docFrag$$1_i$$209$$ - 1, $rowContent_rowRenderer$$1_tableBodyCell$$2$$), this.$_getTableDomUtils$().$styleTableBodyCell$($docFrag$$1_i$$209$$ - 1, $rowContent_rowRenderer$$1_tableBodyCell$$2$$, !1);
        }
        if (null != this.$_columnsDestMap$) {
          for ($docFrag$$1_i$$209$$ = 0;$docFrag$$1_i$$209$$ < this.$_columnsDestMap$.length - 1;$docFrag$$1_i$$209$$++) {
            this.$_columnsDestMap$[$docFrag$$1_i$$209$$] > $docFrag$$1_i$$209$$ && ($moveTableBodyCell_rowIdx$$16$$ = $$$$14$$($docFragStartIdx$$1_tableBodyCells$$[this.$_columnsDestMap$[$docFrag$$1_i$$209$$] + 1]), $row$$11_swapTableBodyCell$$ = $$$$14$$($docFragStartIdx$$1_tableBodyCells$$[$docFrag$$1_i$$209$$ + 1]), $moveTableBodyCell_rowIdx$$16$$[0].parentNode.insertBefore($moveTableBodyCell_rowIdx$$16$$[0], $row$$11_swapTableBodyCell$$[0]), $docFragStartIdx$$1_tableBodyCells$$ = $tableBodyRow$$7$$.children($oj$$14$$.$TableDomUtils$.$DOM_ELEMENT$.$_TD$))
            ;
          }
        }
      } else {
        $oj$$14$$.$TableRendererUtils$.$tableBodyRowDefaultRenderer$($moveTableBodyCell_rowIdx$$16$$, $row$$11_swapTableBodyCell$$, $context$$60_isNew$$);
      }
    }, $_refreshTableFooter$:function() {
      var $columns$$12_i$$210$$ = this.$_getColumnDefs$(), $tableFooter$$1_tableFooterRow$$1$$ = this.$_getTableDomUtils$().$getTableFooter$();
      ...
      if ($columns$$12_i$$210$$ && 0 < $columns$$12_i$$210$$.length) {
        this.$_getTableDomUtils$().$createTableFooterAccSelect$($tableFooter$$1_tableFooterRow$$1$$);
        for (var $footerCellContent_footerRenderer$$1$$, $footerCell$$, $columnsCount$$8$$ = $columns$$12_i$$210$$.length, $columns$$12_i$$210$$ = 0;$columns$$12_i$$210$$ < $columnsCount$$8$$;$columns$$12_i$$210$$++) {
          $footerCellContent_footerRenderer$$1$$ = this.$_getColumnRenderer$($columns$$12_i$$210$$, "footer"), $footerCell$$ = this.$_getTableDomUtils$().$createTableFooterCell$(), this.$_getTableDomUtils$().$styleTableFooterCell$($columns$$12_i$$210$$, $footerCell$$), this.$_getTableDomUtils$().$insertTableFooterCell$($columns$$12_i$$210$$, $footerCell$$), $footerCellContent_footerRenderer$$1$$ && ($footerCellContent_footerRenderer$$1$$ = $footerCellContent_footerRenderer$$1$$({footerContext:$oj$$14$$.$TableRendererUtils$.$getRendererContextObject$(this, 
          null, $footerCell$$[0]), columnIndex:$columns$$12_i$$210$$}), null != $footerCellContent_footerRenderer$$1$$ ? ($footerCell$$.empty(), $footerCell$$.append($footerCellContent_footerRenderer$$1$$)) : ($footerCell$$ = $$$$14$$($tableFooter$$1_tableFooterRow$$1$$.children(":not(." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_HIDDEN_CONTENT_ACC_CLASS$ + ")")[$columns$$12_i$$210$$]), this.$_getTableDomUtils$().$styleTableFooterCell$($columns$$12_i$$210$$, $footerCell$$)));
        }
      }
      ...
      if ($columns$$13$$ && 0 < $columns$$13$$.length) {
        var $i$$211_tableHeaderAccSelectRowColumn$$ = this.$_getTableDomUtils$().$createTableHeaderAccSelectRowColumn$();
        $tableHeader$$1_tableHeaderRow$$1$$.append($i$$211_tableHeaderAccSelectRowColumn$$);
        for (var $column$$10_headerColumnContent$$, $headerRenderer$$, $headerColumn$$3$$, $context$$61_headerContext$$, $columnsCount$$9$$ = $columns$$13$$.length, $i$$211_tableHeaderAccSelectRowColumn$$ = 0;$i$$211_tableHeaderAccSelectRowColumn$$ < $columnsCount$$9$$;$i$$211_tableHeaderAccSelectRowColumn$$++) {
          $column$$10_headerColumnContent$$ = $columns$$13$$[$i$$211_tableHeaderAccSelectRowColumn$$], $headerRenderer$$ = this.$_getColumnRenderer$($i$$211_tableHeaderAccSelectRowColumn$$, "header"), $headerColumn$$3$$ = this.$_getTableDomUtils$().$createTableHeaderColumn$($i$$211_tableHeaderAccSelectRowColumn$$), $headerRenderer$$ && ($context$$61_headerContext$$ = $oj$$14$$.$TableRendererUtils$.$getRendererContextObject$(this, null, $headerColumn$$3$$[0]), $context$$61_headerContext$$ = {headerContext:$context$$61_headerContext$$, 
          columnIndex:$i$$211_tableHeaderAccSelectRowColumn$$, data:$column$$10_headerColumnContent$$.headerText}, $column$$10_headerColumnContent$$.sortable == $oj$$14$$.$TableDomUtils$.$_OPTION_ENABLED$ ? $context$$61_headerContext$$.columnHeaderSortableIconRenderer = function $$context$$61_headerContext$$$columnHeaderSortableIconRenderer$($options$$240$$, $delegateRenderer$$) {
            $oj$$14$$.$TableRendererUtils$.$columnHeaderSortableIconRenderer$(this, $delegateRenderer$$);
          } : $context$$61_headerContext$$.columnHeaderDefaultRenderer = function $$context$$61_headerContext$$$columnHeaderDefaultRenderer$($options$$241$$, $delegateRenderer$$1$$) {
            $oj$$14$$.$TableRendererUtils$.$columnHeaderDefaultRenderer$(this, $delegateRenderer$$1$$);
          }, $column$$10_headerColumnContent$$ = $headerRenderer$$($context$$61_headerContext$$), null != $column$$10_headerColumnContent$$ ? ($headerColumn$$3$$.empty(), $headerColumn$$3$$.append($column$$10_headerColumnContent$$)) : ($headerColumn$$3$$ = $$$$14$$($tableHeader$$1_tableHeaderRow$$1$$.children(":not(." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_COLUMN_HEADER_ACC_SELECT_ROW_CLASS$ + ")")[$i$$211_tableHeaderAccSelectRowColumn$$]), this.$_getTableDomUtils$().$setTableHeaderColumnAttributes$($i$$211_tableHeaderAccSelectRowColumn$$, 
          $headerColumn$$3$$), this.$_getTableDomUtils$().$styleTableHeaderColumn$($i$$211_tableHeaderAccSelectRowColumn$$, $headerColumn$$3$$, !1))), this.$_getTableDomUtils$().$createTableHeaderColumnAccSelect$($i$$211_tableHeaderAccSelectRowColumn$$, this.$_getColumnSelectionMode$());
        }
      ...
      $jqEventSpecial$$.ojtablebeforecurrentrow = {handle:function $$jqEventSpecial$$$ojtablebeforecurrentrow$handle$($event$$210$$, $JSCompiler_OptimizeArgumentsArray_p1$$) {
        return $event$$210$$.handleObj.handler.apply(this, [$event$$210$$, $JSCompiler_OptimizeArgumentsArray_p1$$]);
      }};
      $jqEventSpecial$$.ojtablesort = {handle:function $$jqEventSpecial$$$ojtablesort$handle$($event$$211$$, $JSCompiler_OptimizeArgumentsArray_p2$$) {
        return $event$$211$$.handleObj.handler.apply(this, [$event$$211$$, $JSCompiler_OptimizeArgumentsArray_p2$$]);
      }};
      ...
      if (null != $data$$117$$) {
        ...
        var $i$$212$$, $ev$$1$$, $dataSourceEventHandlersCount$$ = this.$_dataSourceEventHandlers$.length;
        for ($i$$212$$ = 0;$i$$212$$ < $dataSourceEventHandlersCount$$;$i$$212$$++) {
          ($ev$$1$$ = $data$$117$$.on(this.$_dataSourceEventHandlers$[$i$$212$$].eventType, this.$_dataSourceEventHandlers$[$i$$212$$].eventHandler)) && (this.$_dataSourceEventHandlers$[$i$$212$$].eventHandler = $ev$$1$$);
        }
      }
    }, $_registerDomEventListeners$:function() {
      null != this.$_getTableDomUtils$().$getScroller$() && this.$_getTableDomUtils$().$getScroller$().scroll(function($event$$212$$) {
        this.$_handleScrollerScrollLeft$(this.$_getTableDomUtils$().$getScrollLeft$($event$$212$$.target));
      }.bind(this));
    }, $_registerDomScroller$:function() {
      var $self$$104$$ = this;
      this.$_domScrollerMaxCountFunc$ = function $this$$_domScrollerMaxCountFunc$$($result$$37$$) {
        null != $result$$37$$ && $result$$37$$.maxCountLimit && $self$$104$$.$_handleScrollerMaxRowCount$();
      };
      ...
      var $element$$90$$ = this.$_getTableDomUtils$().$getTableContainer$();
      if (!this.$_resizeListener$) {
        var $self$$105$$ = this;
        this.$_resizeListener$ = function $this$$_resizeListener$$() {
          var $tableContainerHeight$$ = $self$$105$$.$_getTableDomUtils$().$getTableContainer$().outerHeight(), $tableContainerWidth$$ = $self$$105$$.$_getTableDomUtils$().$getTableContainer$().outerWidth();
          $self$$105$$.$_getTableDomUtils$().$refreshTableDimensions$($tableContainerWidth$$, $tableContainerHeight$$);
        };
      }
      this.$_isResizeListenerAdded$ || ($oj$$14$$.$DomUtils$.$addResizeListener$($element$$90$$[0], this.$_resizeListener$, 50), this.$_isResizeListenerAdded$ = !0);
    }, $_removeKeyboardKey$:function($keyCode$$3$$) {
      var $keyboardKeys$$2$$ = this.$_getKeyboardKeys$(), $i$$213$$, $keyboardKeysCount$$2$$ = $keyboardKeys$$2$$.length;
      for ($i$$213$$ = 0;$i$$213$$ < $keyboardKeysCount$$2$$;$i$$213$$++) {
        $keyboardKeys$$2$$[$i$$213$$] == $keyCode$$3$$ && $keyboardKeys$$2$$.splice($i$$213$$, 1);
      }
    ...
    }, $_setCurrentRow$:function($currentRow$$1_errSummary$$13$$, $event$$213$$, $currentFocusedRowIdx_optionChange$$) {
      ...
      if (null == $currentRow$$1_errSummary$$13$$) {
        if (null != $existingCurrentRow_existingCurrentRowIdx_existingCurrentRowIndex_existingCurrentRowKey$$) {
          try {
            $tableBodyRow$$9_updateCurrentRow$$1$$ = this._trigger("beforecurrentrow", $event$$213$$, {currentRow:null, previousCurrentRow:this.$_currentRow$});
          } catch ($err$$15$$) {
          ...
          this.option("currentRow", null, {_context:{$writeback$:!0, originalEvent:$event$$213$$, $internalSet$:!0}});
          null == $event$$213$$ && this.$_setRowFocus$(-1, !0, !1, null, $event$$213$$);
      ...
      var $currentRowChanged_data$$118$$ = this.$_getData$(), $rowIndex$$4$$ = $currentRow$$1_errSummary$$13$$.rowIndex, $rowKey$$5$$ = $currentRow$$1_errSummary$$13$$.rowKey;
      ...
      if (-1 != $errDetail$$6_rowIdx$$18$$ && (!$currentRowChanged_data$$118$$ || 0 == $currentRowChanged_data$$118$$.totalSize() || -1 > $errDetail$$6_rowIdx$$18$$ || null === $errDetail$$6_rowIdx$$18$$ || null === $rowKey$$5$$)) {
      ...
      if ($currentRowChanged_data$$118$$ = !$oj$$14$$.$Object$.$compareValues$(this.$_currentRow$, $currentRow$$1_errSummary$$13$$)) {
        try {
          $tableBodyRow$$9_updateCurrentRow$$1$$ = this._trigger("beforecurrentrow", $event$$213$$, {currentRow:{rowIndex:$rowIndex$$4$$, rowKey:$rowKey$$5$$}, previousCurrentRow:this.$_currentRow$});
        } catch ($err$$16$$) {
        ...
        this.option("currentRow", this.$_currentRow$, {_context:{$writeback$:!0, originalEvent:$event$$213$$, $internalSet$:!0}});
      ...
      ($currentRowChanged_data$$118$$ || $currentFocusedRowIdx_optionChange$$ != $currentRow$$1_errSummary$$13$$.rowIndex) && null == $event$$213$$ && this.$_setRowFocus$($errDetail$$6_rowIdx$$18$$, !0, !1, null, $event$$213$$);
      return!0;
    }, $_setDataWaitingState$:function() {
      this.$_showStatusMessage$();
      this.$_hideNoDataMessage$();
      this.$_dataFetching$ = !0;
    }, $_setHeaderColumnFocus$:function($columnIdx$$25$$, $focused$$4$$, $clearSelectedRows$$, $event$$214$$) {
      var $element$$91$$ = null;
      null != $event$$214$$ && ($element$$91$$ = $event$$214$$.currentTarget);
      if ($focused$$4$$) {
        var $focusedHeaderColumnIdx$$5$$ = this.$_getFocusedHeaderColumnIdx$();
        null != $focusedHeaderColumnIdx$$5$$ && $focusedHeaderColumnIdx$$5$$ != $columnIdx$$25$$ && this.$_setHeaderColumnFocus$($focusedHeaderColumnIdx$$5$$, !1, !1, $event$$214$$);
      ...
      this.$_setHeaderColumnState$($columnIdx$$25$$, {$focused$:$focused$$4$$}, $element$$91$$);
    }, $_setHeaderColumnSelection$:function($accSelectionColumn_columnIdx$$26$$, $selected$$17_selection$$3$$, $element$$92$$, $event$$215$$, $updateSelection$$) {
      ...
      var $i$$214$$, $lastSelectedColumnIdxArrayCount$$ = this.$_lastSelectedColumnIdxArray$.length;
      for ($i$$214$$ = 0;$i$$214$$ < $lastSelectedColumnIdxArrayCount$$;$i$$214$$++) {
        if (this.$_lastSelectedColumnIdxArray$[$i$$214$$] == $columnIdx$$28$$) {
          this.$_lastSelectedColumnIdxArray$.splice($i$$214$$, 1);
          break;
        }
      }
      ...
      var $i$$215$$, $lastSelectedRowIdxArrayCount$$ = this.$_lastSelectedRowIdxArray$.length;
      for ($i$$215$$ = 0;$i$$215$$ < $lastSelectedRowIdxArrayCount$$;$i$$215$$++) {
        if (this.$_lastSelectedRowIdxArray$[$i$$215$$] == $rowIdx$$19$$) {
          this.$_lastSelectedRowIdxArray$.splice($i$$215$$, 1);
          break;
        }
      }
      $selected$$20$$ && this.$_lastSelectedRowIdxArray$.push($rowIdx$$19$$);
    }, $_setRowFocus$:function($rowIdx$$20$$, $focused$$6$$, $rowKey$$6_updateCurrentRow$$2$$, $element$$94$$, $event$$217_updateRowFocus$$) {
      if (-1 == $rowIdx$$20$$) {
        ...
        return $rowKey$$6_updateCurrentRow$$2$$ && ($event$$217_updateRowFocus$$ = this.$_setCurrentRow$(null, $event$$217_updateRowFocus$$), !$event$$217_updateRowFocus$$) ? !1 : !0;
      }
      ...
      if ($focused$$6$$) {
        ...
        null != $focusedRowIdx$$8$$ && $focusedRowIdx$$8$$ != $rowIdx$$20$$ && this.$_setRowFocus$($focusedRowIdx$$8$$, !1, $rowKey$$6_updateCurrentRow$$2$$, $element$$94$$, null);
        if ($rowKey$$6_updateCurrentRow$$2$$ && ($rowKey$$6_updateCurrentRow$$2$$ = this.$_getRowKeyForRowIdx$($rowIdx$$20$$), $event$$217_updateRowFocus$$ = this.$_setCurrentRow$({rowKey:$rowKey$$6_updateCurrentRow$$2$$}, $event$$217_updateRowFocus$$), !$event$$217_updateRowFocus$$)) {
          return!1;
        }
      ...
      return!0;
    }, $_setRowSelection$:function($accSelectionCell_rowIdx$$21$$, $selected$$21_selection$$4$$, $element$$95_tableBodyRow$$11$$, $event$$218_selectionChanged$$, $updateSelection$$1$$) {
      if (this.$_getRowSelectionMode$() == this.$_OPTION_SELECTION_MODES$.$_SINGLE$ || this.$_getRowSelectionMode$() == this.$_OPTION_SELECTION_MODES$.$_MULTIPLE$) {
        if ((isNaN($accSelectionCell_rowIdx$$21$$) || 0 > $accSelectionCell_rowIdx$$21$$) && $oj$$14$$.$Logger$.error("Error: Invalid row selection value: " + $accSelectionCell_rowIdx$$21$$), this.$_getRowSelectionMode$() == this.$_OPTION_SELECTION_MODES$.$_SINGLE$ && $selected$$21_selection$$4$$ && this.$_clearSelectedRows$(), $element$$95_tableBodyRow$$11$$ = this.$_getTableDomUtils$().$getTableBodyRow$($accSelectionCell_rowIdx$$21$$), null != $element$$95_tableBodyRow$$11$$) {
          $event$$218_selectionChanged$$ = !1;
          if ($element$$95_tableBodyRow$$11$$.hasClass($oj$$14$$.$TableDomUtils$.$MARKER_STYLE_CLASSES$.$_SELECTED$) != $selected$$21_selection$$4$$) {
            $selected$$21_selection$$4$$ ? $element$$95_tableBodyRow$$11$$.addClass($oj$$14$$.$TableDomUtils$.$MARKER_STYLE_CLASSES$.$_SELECTED$) : $element$$95_tableBodyRow$$11$$.removeClass($oj$$14$$.$TableDomUtils$.$MARKER_STYLE_CLASSES$.$_SELECTED$);
            $event$$218_selectionChanged$$ = !0;
            var $dragOption$$ = this.options.dnd.drag;
            $dragOption$$ && ("rows" === $dragOption$$ || $dragOption$$.rows) && $element$$95_tableBodyRow$$11$$.prop("draggable", $selected$$21_selection$$4$$);
          }
          $event$$218_selectionChanged$$ && ($selected$$21_selection$$4$$ ? this.$_updateRowStateCellsClass$($accSelectionCell_rowIdx$$21$$, {hover:!1, $focused$:!1, selected:!0}) : this.$_updateRowStateCellsClass$($accSelectionCell_rowIdx$$21$$, {selected:!1}));
          this.$_setLastRowSelection$($accSelectionCell_rowIdx$$21$$, $selected$$21_selection$$4$$);
          $accSelectionCell_rowIdx$$21$$ = this.$_getTableDomUtils$().$getTableBodyCellAccSelect$($element$$95_tableBodyRow$$11$$);
      ...
      if (null == $selection$$5$$) {
        ...
        var $i$$216$$, $endRowIndex_endRowKey_j$$31$$, $endRowIdx_rangeObj$$1$$, $endColumnIdx_startRowIdx_startRowKey$$, $startRowIndex$$, $startColumnIdx$$, $selectionCount$$ = $selection$$5$$.length;
        for ($i$$216$$ = 0;$i$$216$$ < $selectionCount$$;$i$$216$$++) {
          $endRowIdx_rangeObj$$1$$ = $selection$$5$$[$i$$216$$];
    ...
    }, $_setTableNavigationMode$:function($value$$210$$) {
      this.$_tableNavMode$ = $value$$210$$;
      ...
      $parent$$10$$.find("*").each(function() {
        $self$$106$$.$_UnregisterChildNode$(this);
      });
    }, $_unregisterDataSourceEventListeners$:function() {
      var $data$$119$$ = this.$_getData$();
      if (null != this.$_dataSourceEventHandlers$ && null != $data$$119$$) {
        var $i$$217$$, $dataSourceEventHandlersCount$$1$$ = this.$_dataSourceEventHandlers$.length;
        for ($i$$217$$ = 0;$i$$217$$ < $dataSourceEventHandlersCount$$1$$;$i$$217$$++) {
          $data$$119$$.off(this.$_dataSourceEventHandlers$[$i$$217$$].eventType, this.$_dataSourceEventHandlers$[$i$$217$$].eventHandler);
        }
      }
    }, $_unregisterResizeListener$:function() {
      var $element$$96$$ = this.$_getTableDomUtils$().$getTableContainer$();
      $oj$$14$$.$DomUtils$.$removeResizeListener$($element$$96$$[0], this.$_resizeListener$);
      this.$_isResizeListenerAdded$ = !1;
    }, $_updateHeaderColumnStateCellsClass$:function($columnIdx$$30$$) {
      var $selected$$22$$ = this.$_getHeaderColumnState$($columnIdx$$30$$).selected, $selectedRowIdxs$$3$$ = this.$_getSelectedRowIdxs$(), $i$$218_tableBodyRows$$8$$ = this.$_getTableDomUtils$().$getTableBodyRows$();
      if (null != $i$$218_tableBodyRows$$8$$ && 0 < $i$$218_tableBodyRows$$8$$.length) {
        for (var $j$$32$$, $tableBodyCell$$3$$, $rowSelected$$1$$, $selectedRowIdxsCount$$1$$, $tableBodyRowsCount$$4$$ = $i$$218_tableBodyRows$$8$$.length, $i$$218_tableBodyRows$$8$$ = 0;$i$$218_tableBodyRows$$8$$ < $tableBodyRowsCount$$4$$;$i$$218_tableBodyRows$$8$$++) {
          if ($tableBodyCell$$3$$ = this.$_getTableDomUtils$().$getTableBodyCell$($i$$218_tableBodyRows$$8$$, $columnIdx$$30$$), $selected$$22$$) {
            ...
            for ($j$$32$$ = 0;$j$$32$$ < $selectedRowIdxsCount$$1$$;$j$$32$$++) {
              if ($i$$218_tableBodyRows$$8$$ == $selectedRowIdxs$$3$$[$j$$32$$]) {
                $rowSelected$$1$$ = !0;
                break;
              }
            }
      ...
      if ($tableBodyCells$$1$$) {
        if (null != $hover$$) {
          var $i$$219$$, $tableBodyCellsCount$$1$$ = $tableBodyCells$$1$$.length;
          for ($i$$219$$ = 0;$i$$219$$ < $tableBodyCellsCount$$1$$;$i$$219$$++) {
            $hover$$ ? $$$$14$$($tableBodyCells$$1$$[$i$$219$$]).addClass($oj$$14$$.$TableDomUtils$.$MARKER_STYLE_CLASSES$.$_HOVER$) : $$$$14$$($tableBodyCells$$1$$[$i$$219$$]).removeClass($oj$$14$$.$TableDomUtils$.$MARKER_STYLE_CLASSES$.$_HOVER$);
          }
        }
        if (null != $focused$$7$$) {
          for ($tableBodyCellsCount$$1$$ = $tableBodyCells$$1$$.length, $i$$219$$ = 0;$i$$219$$ < $tableBodyCellsCount$$1$$;$i$$219$$++) {
            $focused$$7$$ ? $$$$14$$($tableBodyCells$$1$$[$i$$219$$]).addClass($oj$$14$$.$TableDomUtils$.$MARKER_STYLE_CLASSES$.$_FOCUS$) : $$$$14$$($tableBodyCells$$1$$[$i$$219$$]).removeClass($oj$$14$$.$TableDomUtils$.$MARKER_STYLE_CLASSES$.$_FOCUS$);
          }
        }
        if (null != $selected$$23$$) {
          for ($tableBodyCellsCount$$1$$ = $tableBodyCells$$1$$.length, $i$$219$$ = 0;$i$$219$$ < $tableBodyCellsCount$$1$$;$i$$219$$++) {
            $selected$$23$$ ? $$$$14$$($tableBodyCells$$1$$[$i$$219$$]).addClass($oj$$14$$.$TableDomUtils$.$MARKER_STYLE_CLASSES$.$_SELECTED$) : $$$$14$$($tableBodyCells$$1$$[$i$$219$$]).removeClass($oj$$14$$.$TableDomUtils$.$MARKER_STYLE_CLASSES$.$_SELECTED$);
          }
        }
      }
      ...
      this.$_taskCount$++;
      return this.$_pendingTasks$ = this.$_pendingTasks$.then($task$$1$$.bind($self$$107$$)).then(function($value$$211$$) {
        $self$$107$$.$_taskCount$--;
        0 == $self$$107$$.$_taskCount$ && ($self$$107$$.$_pendingTasks$ = void 0, $self$$107$$.$_finalTask$ && $self$$107$$.$_finalTask$(), $self$$107$$._trigger("ready"));
        return $value$$211$$;
      }, function($error$$31$$) {
        $self$$107$$.$_taskCount$--;
        0 == $self$$107$$.$_taskCount$ && ($self$$107$$.$_pendingTasks$ = void 0, $oj$$14$$.$Logger$.error($error$$31$$));
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$createContextMenu$ = function $$oj$$14$$$$TableDomUtils$$$$createContextMenu$$($handleContextMenuSelect$$) {
    var $menuContainer$$1$$ = null, $self$$108$$ = this;
    if (null != this.options.contextMenu || null != this.$getTable$().attr("contextmenu")) {
      ...
      if (null != $menuContainer$$1$$ && 0 < $menuContainer$$1$$.length) {
        ...
        if (null != $listItems$$1$$ && 0 < $listItems$$1$$.length) {
          ...
          $listItems$$1$$.each(function() {
            0 === $$$$14$$(this).children($oj$$14$$.$TableDomUtils$.$DOM_ELEMENT$.$_A$).length && ($command$$7$$ = $$$$14$$(this).attr("data-oj-command").split("-"), $$$$14$$(this).replaceWith($self$$108$$.$createContextMenuItem$($command$$7$$[$command$$7$$.length - 1])));
          });
      ...
      this.$component$.$_isTableSortable$() && ($menuContainer$$1$$ = $$$$14$$(document.createElement($oj$$14$$.$TableDomUtils$.$DOM_ELEMENT$.$_UL$)), $menuContainer$$1$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_DISPLAY$, $oj$$14$$.$TableDomUtils$.$CSS_VAL$.$_NONE$), $menuContainer$$1$$.attr($oj$$14$$.$TableDomUtils$.$DOM_ATTR$.$_ID$, this.$getTableId$() + "_contextmenu"), this.$getTableContainer$().append($menuContainer$$1$$), $menuContainerId_sortMenu$$1$$ = this.$createContextMenuItem$("sort"), 
      $menuContainer$$1$$.append($menuContainerId_sortMenu$$1$$), $menuContainer$$1$$.ojMenu(), this.$_menuContainer$ = $menuContainer$$1$$, this.$component$.$_contextMenuId$ = "#" + $menuContainer$$1$$.attr($oj$$14$$.$TableDomUtils$.$DOM_ATTR$.$_ID$), $menuContainer$$1$$.on("ojselect", $handleContextMenuSelect$$), this.$component$._setOption("contextMenu", "#" + $menuContainer$$1$$.attr($oj$$14$$.$TableDomUtils$.$DOM_ATTR$.$_ID$)));
    }
  };
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$getElementColumnIdx$ = function $$oj$$14$$$$TableDomUtils$$$$getElementColumnIdx$$($element$$97_tableFooterCell$$2$$) {
    var $tableBodyCell$$5_tableHeaderColumn$$9$$ = this.$getFirstAncestor$($element$$97_tableFooterCell$$2$$, $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_DATA_CELL_CLASS$);
    ...
    $tableBodyCell$$5_tableHeaderColumn$$9$$ = this.$getFirstAncestor$($element$$97_tableFooterCell$$2$$, $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_COLUMN_HEADER_CELL_CLASS$);
    if (null != $tableBodyCell$$5_tableHeaderColumn$$9$$) {
    ...
    $element$$97_tableFooterCell$$2$$ = this.$getFirstAncestor$($element$$97_tableFooterCell$$2$$, $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_FOOTER_CELL_CLASS$);
    return null != $element$$97_tableFooterCell$$2$$ ? $element$$97_tableFooterCell$$2$$.parent().children("." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_FOOTER_CELL_CLASS$).index($element$$97_tableFooterCell$$2$$) : null;
  };
  $oj$$14$$.$TableDomUtils$.prototype.$getElementRowIdx$ = function $$oj$$14$$$$TableDomUtils$$$$getElementRowIdx$$($element$$98_tableBodyRow$$15$$) {
    $element$$98_tableBodyRow$$15$$ = this.$getFirstAncestor$($element$$98_tableBodyRow$$15$$, $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_DATA_ROW_CLASS$);
    return null != $element$$98_tableBodyRow$$15$$ ? $element$$98_tableBodyRow$$15$$.index() : null;
  };
  $oj$$14$$.$TableDomUtils$.prototype.$getFirstAncestor$ = function $$oj$$14$$$$TableDomUtils$$$$getFirstAncestor$$($element$$99$$, $className$$8$$) {
    var $parents$$1$$;
    if (null == $element$$99$$) {
      return null;
    }
    $element$$99$$ = $$$$14$$($element$$99$$);
    if ($element$$99$$.hasClass($className$$8$$)) {
      return $element$$99$$;
    }
    $parents$$1$$ = $element$$99$$.parents("." + $className$$8$$);
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$getScrollLeft$ = function $$oj$$14$$$$TableDomUtils$$$$getScrollLeft$$($element$$100$$) {
    $element$$100$$ = $$$$14$$($element$$100$$);
    var $scrollLeft$$1$$ = $element$$100$$[0].scrollLeft;
    "rtl" === this.$component$.$_GetReadingDirection$() && ($scrollLeft$$1$$ = Math.abs($scrollLeft$$1$$), this.$_isWebkit$() && ($scrollLeft$$1$$ = $element$$100$$[0].scrollWidth - $element$$100$$[0].clientWidth - $scrollLeft$$1$$));
    return $scrollLeft$$1$$;
  };
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$hashCode$ = function $$oj$$14$$$$TableDomUtils$$$$hashCode$$($str$$18$$) {
    ...
    var $charVal$$, $i$$220$$, $strCount$$ = $str$$18$$.length;
    for ($i$$220$$ = 0;$i$$220$$ < $strCount$$;$i$$220$$++) {
      $charVal$$ = $str$$18$$.charCodeAt($i$$220$$), $hash$$1$$ = ($hash$$1$$ << 5) - $hash$$1$$ + $charVal$$, $hash$$1$$ &= $hash$$1$$;
    }
    return $hash$$1$$;
  };
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$insertTableBodyRow$ = function $$oj$$14$$$$TableDomUtils$$$$insertTableBodyRow$$($rowIdx$$33$$, $tableBodyRow$$21$$, $row$$12_tableBody$$12$$, $docFrag$$2_tableBodyRows$$10$$) {
    this.$setTableBodyRowAttributes$($row$$12_tableBody$$12$$, $tableBodyRow$$21$$);
    null == $docFrag$$2_tableBodyRows$$10$$ ? ($row$$12_tableBody$$12$$ = this.$getTableBody$(), $docFrag$$2_tableBodyRows$$10$$ = $row$$12_tableBody$$12$$.children("." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_DATA_ROW_CLASS$), 0 == $rowIdx$$33$$ ? $row$$12_tableBody$$12$$.prepend($tableBodyRow$$21$$) : $docFrag$$2_tableBodyRows$$10$$.length >= $rowIdx$$33$$ ? $$$$14$$($docFrag$$2_tableBodyRows$$10$$.get($rowIdx$$33$$ - 1)).after($tableBodyRow$$21$$) : $row$$12_tableBody$$12$$.append($tableBodyRow$$21$$)) : 
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$moveTableHeaderColumn$ = function $$oj$$14$$$$TableDomUtils$$$$moveTableHeaderColumn$$($columnIdx$$44_columnsDestMapItem$$, $destColIdx_destIdx$$, $columnDef_event$$219$$) {
    var $columns$$16_i$$221$$ = this.$component$.$_getColumnDefs$(), $tableBodyRows$$11_tableHeaderColumn$$11$$ = this.$getTableHeaderColumn$($columnIdx$$44_columnsDestMapItem$$), $tableFooterCell$$4$$ = this.$getTableFooterCell$($columnIdx$$44_columnsDestMapItem$$), $destTableFooterCell_destTableHeaderColumn_tableBodyCell$$7$$ = null, $destTableBodyCell$$ = $destTableFooterCell_destTableHeaderColumn_tableBodyCell$$7$$ = $destTableFooterCell_destTableHeaderColumn_tableBodyCell$$7$$ = null, $colSpan_columnsOption$$ = 
    null, $afterColumn_columnOption$$ = !1;
    $destColIdx_destIdx$$ == $columns$$16_i$$221$$.length && ($destColIdx_destIdx$$ -= 1, $afterColumn_columnOption$$ = !0);
    ...
    if (null != $tableBodyRows$$11_tableHeaderColumn$$11$$) {
      for ($columns$$16_i$$221$$ = 0;$columns$$16_i$$221$$ < $tableBodyRows$$11_tableHeaderColumn$$11$$.length;$columns$$16_i$$221$$++) {
        $destTableFooterCell_destTableHeaderColumn_tableBodyCell$$7$$ = this.$getTableBodyCell$($columns$$16_i$$221$$, $columnIdx$$44_columnsDestMapItem$$, null), null != $destTableFooterCell_destTableHeaderColumn_tableBodyCell$$7$$ && ($destTableBodyCell$$ = this.$getTableBodyCell$($columns$$16_i$$221$$, $destColIdx_destIdx$$, null), $colSpan_columnsOption$$ = $destTableFooterCell_destTableHeaderColumn_tableBodyCell$$7$$.attr($oj$$14$$.$TableDomUtils$.$DOM_ATTR$.$_COLSPAN$), null == $destTableBodyCell$$ || 
    ...
    this.$component$.option("columns", $colSpan_columnsOption$$, {_context:{$writeback$:!0, originalEvent:$columnDef_event$$219$$, $internalSet$:!0}});
    $columnDef_event$$219$$ = this.$component$.$_columnDefArray$.splice($columnIdx$$44_columnsDestMapItem$$, 1);
    this.$component$.$_columnDefArray$.splice($destColIdx_destIdx$$, 0, $columnDef_event$$219$$[0]);
    if (!this.$_columnsDestMap$) {
      for (this.$_columnsDestMap$ = [], $columns$$16_i$$221$$ = 0;$columns$$16_i$$221$$ < $colSpan_columnsOption$$.length;$columns$$16_i$$221$$++) {
        this.$_columnsDestMap$[$columns$$16_i$$221$$] = $columns$$16_i$$221$$;
      }
    }
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$refreshContextMenu$ = function $$oj$$14$$$$TableDomUtils$$$$refreshContextMenu$$() {
    var $self$$109$$ = this, $menuContainer$$2$$ = this.$_menuContainer$;
    $menuContainer$$2$$ && 0 < $menuContainer$$2$$.length && $menuContainer$$2$$.find("[data-oj-command]").each(function() {
      ...
      if (0 < $contextMenuLabel$$1$$.length) {
        ...
        "sort" == $command$$11$$ ? $commandString$$1$$ = $self$$109$$.$component$.$getTranslatedString$("labelSort") : "sortAsc" == $command$$11$$ ? $commandString$$1$$ = $self$$109$$.$component$.$getTranslatedString$("labelSortAsc") : "sortDsc" == $command$$11$$ && ($commandString$$1$$ = $self$$109$$.$component$.$getTranslatedString$("labelSortDsc"));
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$removeDragOverIndicatorColumn$ = function $$oj$$14$$$$TableDomUtils$$$$removeDragOverIndicatorColumn$$() {
    var $indicatorElements$$ = this.$getTable$().find("." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_COLUMN_HEADER_DRAG_INDICATOR_BEFORE_CLASS$ + ",." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_COLUMN_HEADER_DRAG_INDICATOR_AFTER_CLASS$), $i$$222$$ = 0;
    if ($indicatorElements$$ && 0 < $indicatorElements$$.length) {
      for (var $indicatorElementsCount$$ = $indicatorElements$$.length, $i$$222$$ = 0;$i$$222$$ < $indicatorElementsCount$$;$i$$222$$++) {
        $$$$14$$($indicatorElements$$[$i$$222$$]).removeClass($oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_COLUMN_HEADER_DRAG_INDICATOR_BEFORE_CLASS$), $$$$14$$($indicatorElements$$[$i$$222$$]).removeClass($oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_COLUMN_HEADER_DRAG_INDICATOR_AFTER_CLASS$);
      }
    }
  };
  $oj$$14$$.$TableDomUtils$.prototype.$removeDragOverIndicatorRow$ = function $$oj$$14$$$$TableDomUtils$$$$removeDragOverIndicatorRow$$() {
    ...
    if ($indicatorRowAfterElementsCount_indicatorRowBeforeElements$$ && 0 < $indicatorRowAfterElementsCount_indicatorRowBeforeElements$$.length) {
      for (var $indicatorRowBeforeElementsCount$$ = $indicatorRowAfterElementsCount_indicatorRowBeforeElements$$.length, $i$$223$$ = 0;$i$$223$$ < $indicatorRowBeforeElementsCount$$;$i$$223$$++) {
        $$$$14$$($indicatorRowAfterElementsCount_indicatorRowBeforeElements$$[$i$$223$$]).remove();
      }
    }
    if ($indicatorRowAfterElements_tableBody$$15$$ && 0 < $indicatorRowAfterElements_tableBody$$15$$.length) {
      for ($indicatorRowAfterElementsCount_indicatorRowBeforeElements$$ = $indicatorRowAfterElements_tableBody$$15$$.length, $i$$223$$ = 0;$i$$223$$ < $indicatorRowAfterElementsCount_indicatorRowBeforeElements$$;$i$$223$$++) {
        $$$$14$$($indicatorRowAfterElements_tableBody$$15$$[$i$$223$$]).remove();
      }
    }
  };
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$removeTableBodyRowTouchSelectionAffordance$ = function $$oj$$14$$$$TableDomUtils$$$$removeTableBodyRowTouchSelectionAffordance$$() {
    ...
    if (null != $touchAffordance$$ && 0 < $touchAffordance$$.length) {
      var $i$$224$$;
      for ($i$$224$$ = 0;$i$$224$$ < $touchAffordance$$.length;$i$$224$$++) {
        $touchAffordance$$[$i$$224$$].remove();
      }
    }
  };
  $oj$$14$$.$TableDomUtils$.prototype.$removeTableHeaderColumnDragImage$ = function $$oj$$14$$$$TableDomUtils$$$$removeTableHeaderColumnDragImage$$() {
    ...
    if ($headerDragImage$$ && 0 < $headerDragImage$$.length) {
      var $i$$225$$, $headerDragImageCount$$ = $headerDragImage$$.length;
      for ($i$$225$$ = 0;$i$$225$$ < $headerDragImageCount$$;$i$$225$$++) {
        $$$$14$$($headerDragImage$$[$i$$225$$]).remove();
      }
    }
  };
  $oj$$14$$.$TableDomUtils$.prototype.$setScrollLeft$ = function $$oj$$14$$$$TableDomUtils$$$$setScrollLeft$$($element$$101$$, $scrollLeft$$2$$) {
    $element$$101$$ = $$$$14$$($element$$101$$);
    "rtl" === this.$component$.$_GetReadingDirection$() && ($scrollLeft$$2$$ = Math.abs($scrollLeft$$2$$), this.$_isWebkit$() ? $scrollLeft$$2$$ = $element$$101$$[0].scrollWidth - $element$$101$$[0].clientWidth - $scrollLeft$$2$$ : this.$_isFF$() && ($scrollLeft$$2$$ *= -1));
    $element$$101$$[0].scrollLeft != $scrollLeft$$2$$ && ($element$$101$$[0].scrollLeft = $scrollLeft$$2$$);
  };
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$setTableBodyRowAttributes$ = function $$oj$$14$$$$TableDomUtils$$$$setTableBodyRowAttributes$$($row$$13$$, $tableBodyRow$$25$$) {
    $tableBodyRow$$25$$.data("rowKey", $row$$13$$.key);
  };
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$setTableColumnCellsClass$ = function $$oj$$14$$$$TableDomUtils$$$$setTableColumnCellsClass$$($columnIdx$$47_tableBodyCells$$5$$, $add$$7$$, $styleClass$$2$$) {
    var $i$$226_tableBodyRows$$12$$ = this.$getTableBodyRows$();
    if (null != $i$$226_tableBodyRows$$12$$ && 0 < $i$$226_tableBodyRows$$12$$.length) {
      if (null === $columnIdx$$47_tableBodyCells$$5$$) {
        if ($columnIdx$$47_tableBodyCells$$5$$ = null, $columnIdx$$47_tableBodyCells$$5$$ = $add$$7$$ ? this.$getTableBody$().find("[td]") : this.$getTableBody$().find("." + $styleClass$$2$$), null != $columnIdx$$47_tableBodyCells$$5$$ && 0 < $columnIdx$$47_tableBodyCells$$5$$.length) {
          for (var $tableBodyCell$$9_tableBodyCellsCount$$2$$ = $columnIdx$$47_tableBodyCells$$5$$.length, $i$$226_tableBodyRows$$12$$ = 0;$i$$226_tableBodyRows$$12$$ < $tableBodyCell$$9_tableBodyCellsCount$$2$$;$i$$226_tableBodyRows$$12$$++) {
            $add$$7$$ ? $$$$14$$($columnIdx$$47_tableBodyCells$$5$$[$i$$226_tableBodyRows$$12$$]).addClass($styleClass$$2$$) : $$$$14$$($columnIdx$$47_tableBodyCells$$5$$[$i$$226_tableBodyRows$$12$$]).removeClass($styleClass$$2$$);
          }
        }
      } else {
        for (var $tableBodyRowsCount$$5$$ = $i$$226_tableBodyRows$$12$$.length, $i$$226_tableBodyRows$$12$$ = 0;$i$$226_tableBodyRows$$12$$ < $tableBodyRowsCount$$5$$;$i$$226_tableBodyRows$$12$$++) {
          $tableBodyCell$$9_tableBodyCellsCount$$2$$ = this.$getTableBodyCell$($i$$226_tableBodyRows$$12$$, $columnIdx$$47_tableBodyCells$$5$$, null), $add$$7$$ ? $$$$14$$($tableBodyCell$$9_tableBodyCellsCount$$2$$).addClass($styleClass$$2$$) : $$$$14$$($tableBodyCell$$9_tableBodyCellsCount$$2$$).removeClass($styleClass$$2$$);
        }
      }
    }
  };
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$_getColspanLogicalElements$ = function $$oj$$14$$$$TableDomUtils$$$$_getColspanLogicalElements$$($elementArray$$) {
    var $i$$227$$, $j$$33$$, $indexedElementArrayNum$$ = 0, $indexedElementArray$$ = [], $elementArrayCount$$ = $elementArray$$.length;
    for ($i$$227$$ = 0;$i$$227$$ < $elementArrayCount$$;$i$$227$$++) {
      var $colSpan$$1$$ = $$$$14$$($elementArray$$[$i$$227$$]).attr($oj$$14$$.$TableDomUtils$.$DOM_ATTR$.$_COLSPAN$);
      if (null != $colSpan$$1$$) {
        $colSpan$$1$$ = parseInt($colSpan$$1$$, 10);
        for ($j$$33$$ = 0;$j$$33$$ < $colSpan$$1$$;$j$$33$$++) {
          $indexedElementArray$$[$indexedElementArrayNum$$ + $j$$33$$] = $elementArray$$[$i$$227$$];
        }
        $indexedElementArrayNum$$ += $colSpan$$1$$;
      } else {
        $indexedElementArray$$[$indexedElementArrayNum$$++] = $elementArray$$[$i$$227$$];
      }
    }
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$_removeHeaderColumnAndCellColumnWidths$ = function $$oj$$14$$$$TableDomUtils$$$$_removeHeaderColumnAndCellColumnWidths$$() {
    var $i$$228_tableBodyRows$$14$$, $headerColumn$$9_tableBodyCell$$11$$, $columnCount$$2$$ = this.$component$.$_getColumnDefs$().length;
    for ($i$$228_tableBodyRows$$14$$ = 0;$i$$228_tableBodyRows$$14$$ < $columnCount$$2$$;$i$$228_tableBodyRows$$14$$++) {
      $headerColumn$$9_tableBodyCell$$11$$ = this.$getTableHeaderColumn$($i$$228_tableBodyRows$$14$$), null != $headerColumn$$9_tableBodyCell$$11$$ && $headerColumn$$9_tableBodyCell$$11$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_MIN_WIDTH$, "");
    }
    $i$$228_tableBodyRows$$14$$ = this.$getTableBodyRows$();
    if (null != $i$$228_tableBodyRows$$14$$ && 0 < $i$$228_tableBodyRows$$14$$.length) {
      for ($i$$228_tableBodyRows$$14$$ = 0;$i$$228_tableBodyRows$$14$$ < $columnCount$$2$$;$i$$228_tableBodyRows$$14$$++) {
        $headerColumn$$9_tableBodyCell$$11$$ = this.$getTableBodyCell$(0, $i$$228_tableBodyRows$$14$$, null), null != $headerColumn$$9_tableBodyCell$$11$$ && $headerColumn$$9_tableBodyCell$$11$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_MIN_WIDTH$, "");
      }
    }
  };
  $oj$$14$$.$TableDomUtils$.prototype.$_removeTableBodyRowBottomBorder$ = function $$oj$$14$$$$TableDomUtils$$$$_removeTableBodyRowBottomBorder$$($underflow$$) {
    if (this.$_isHorizontalGridEnabled$()) {
      ...
      if (null != $lastTableBodyRow_tableBodyRows$$15$$ && 0 < $lastTableBodyRow_tableBodyRows$$15$$.length) {
        var $i$$229$$, $tableBodyRowsCount$$6$$ = $lastTableBodyRow_tableBodyRows$$15$$.length;
        for ($i$$229$$ = 0;$i$$229$$ < $tableBodyRowsCount$$6$$;$i$$229$$++) {
          $$$$14$$($lastTableBodyRow_tableBodyRows$$15$$[$i$$229$$]).hasClass($oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_HGRID_LINES_CLASS$) || $$$$14$$($lastTableBodyRow_tableBodyRows$$15$$[$i$$229$$]).addClass($oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_HGRID_LINES_CLASS$);
        }
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$_removeTableDimensionsStyling$ = function $$oj$$14$$$$TableDomUtils$$$$_removeTableDimensionsStyling$$() {
    var $table$$16$$ = this.$getTable$(), $headerColumnTextDivs_tableHeader$$9$$ = this.$getTableHeader$(), $i$$230_tableHeaderRow$$8$$ = this.$getTableHeaderRow$(), $tableFooter$$9$$ = this.$getTableFooter$(), $tableFooterRow$$8$$ = this.$getTableFooterRow$(), $tableBody$$20$$ = this.$getTableBody$();
    if (null != $headerColumnTextDivs_tableHeader$$9$$ && ($headerColumnTextDivs_tableHeader$$9$$.attr($oj$$14$$.$TableDomUtils$.$DOM_ATTR$.$_STYLE$, ""), $i$$230_tableHeaderRow$$8$$.attr($oj$$14$$.$TableDomUtils$.$DOM_ATTR$.$_STYLE$, ""), ($headerColumnTextDivs_tableHeader$$9$$ = $i$$230_tableHeaderRow$$8$$.find("." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_COLUMN_HEADER_TEXT_CLASS$)) && 0 < $headerColumnTextDivs_tableHeader$$9$$.length)) {
      for (var $headerColumnTextDivsCount$$ = $headerColumnTextDivs_tableHeader$$9$$.length, $i$$230_tableHeaderRow$$8$$ = 0;$i$$230_tableHeaderRow$$8$$ < $headerColumnTextDivsCount$$;$i$$230_tableHeaderRow$$8$$++) {
        $$$$14$$($headerColumnTextDivs_tableHeader$$9$$[$i$$230_tableHeaderRow$$8$$]).css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_WIDTH$, "");
      }
    }
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$_setColumnWidths$ = function $$oj$$14$$$$TableDomUtils$$$$_setColumnWidths$$() {
    var $columnWidths$$ = [], $columnPaddingWidths$$ = [], $adjustedColumnWidth_cellRenderer$$1_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCellPaddingWidth_tableBodyCellStyle$$ = null, $adjustedColumnWidths_defaultColumnPaddingWidth$$, $defaultTableBodyCellPaddingWidth_footerCell$$1$$, $headerColumnTextDivHeight_headerRenderer$$1_tableBodyCell$$12$$, $adjustedColumnWidth_cellRenderer$$1_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCellPaddingWidth_tableBodyCellStyle$$ = 
    null, $i$$231_tableBodyRows$$16$$, $headerColumnCellStyle_headerColumnTextDiv$$, $columnsCount$$10$$ = this.$component$.$_getColumnDefs$().length;
    for ($i$$231_tableBodyRows$$16$$ = 0;$i$$231_tableBodyRows$$16$$ < $columnsCount$$10$$;$i$$231_tableBodyRows$$16$$++) {
      $adjustedColumnWidth_cellRenderer$$1_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCellPaddingWidth_tableBodyCellStyle$$ = this.$getTableHeaderColumn$($i$$231_tableBodyRows$$16$$), null != $adjustedColumnWidth_cellRenderer$$1_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCellPaddingWidth_tableBodyCellStyle$$ && ($headerColumnCellStyle_headerColumnTextDiv$$ = window.getComputedStyle($adjustedColumnWidth_cellRenderer$$1_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCellPaddingWidth_tableBodyCellStyle$$[0]), 
      $columnWidths$$[$i$$231_tableBodyRows$$16$$] = parseInt($headerColumnCellStyle_headerColumnTextDiv$$[$oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_WIDTH$], 10), $headerColumnTextDivHeight_headerRenderer$$1_tableBodyCell$$12$$ = this.$component$.$_getColumnRenderer$($i$$231_tableBodyRows$$16$$, "header"), $adjustedColumnWidths_defaultColumnPaddingWidth$$ || null != $headerColumnTextDivHeight_headerRenderer$$1_tableBodyCell$$12$$ ? $columnPaddingWidths$$[$i$$231_tableBodyRows$$16$$] = null != $headerColumnTextDivHeight_headerRenderer$$1_tableBodyCell$$12$$ ? 
      ...
      10), $columnPaddingWidths$$[$i$$231_tableBodyRows$$16$$] = $adjustedColumnWidths_defaultColumnPaddingWidth$$), $headerColumnTextDivHeight_headerRenderer$$1_tableBodyCell$$12$$ = null, ($headerColumnCellStyle_headerColumnTextDiv$$ = $adjustedColumnWidth_cellRenderer$$1_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCellPaddingWidth_tableBodyCellStyle$$.find("." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_COLUMN_HEADER_TEXT_CLASS$)) && 0 < $headerColumnCellStyle_headerColumnTextDiv$$.length && 
      ($headerColumnTextDivHeight_headerRenderer$$1_tableBodyCell$$12$$ = $headerColumnCellStyle_headerColumnTextDiv$$.get(0).clientHeight), null != $headerColumnTextDivHeight_headerRenderer$$1_tableBodyCell$$12$$ && ($adjustedColumnWidth_cellRenderer$$1_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCellPaddingWidth_tableBodyCellStyle$$ = $adjustedColumnWidth_cellRenderer$$1_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCellPaddingWidth_tableBodyCellStyle$$.find("." + 
      $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_COLUMN_HEADER_CLASS$), $adjustedColumnWidth_cellRenderer$$1_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCellPaddingWidth_tableBodyCellStyle$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_MIN_HEIGHT$, $headerColumnTextDivHeight_headerRenderer$$1_tableBodyCell$$12$$ + $oj$$14$$.$TableDomUtils$.$CSS_VAL$.$_PX$)));
    }
    $adjustedColumnWidths_defaultColumnPaddingWidth$$ = [];
    $i$$231_tableBodyRows$$16$$ = this.$getTableBodyRows$();
    if (null != $i$$231_tableBodyRows$$16$$ && 0 < $i$$231_tableBodyRows$$16$$.length) {
      for ($i$$231_tableBodyRows$$16$$ = 0;$i$$231_tableBodyRows$$16$$ < $columnsCount$$10$$;$i$$231_tableBodyRows$$16$$++) {
        $headerColumnTextDivHeight_headerRenderer$$1_tableBodyCell$$12$$ = this.$getTableBodyCell$(0, $i$$231_tableBodyRows$$16$$, null), null != $headerColumnTextDivHeight_headerRenderer$$1_tableBodyCell$$12$$ && ($adjustedColumnWidth_cellRenderer$$1_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCellPaddingWidth_tableBodyCellStyle$$ = this.$component$.$_getColumnRenderer$($i$$231_tableBodyRows$$16$$, "cell"), $defaultTableBodyCellPaddingWidth_footerCell$$1$$ || this.$component$.$_hasRowOrCellRenderer$($i$$231_tableBodyRows$$16$$) ? 
        null != $adjustedColumnWidth_cellRenderer$$1_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCellPaddingWidth_tableBodyCellStyle$$ ? ($adjustedColumnWidth_cellRenderer$$1_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCellPaddingWidth_tableBodyCellStyle$$ = window.getComputedStyle($headerColumnTextDivHeight_headerRenderer$$1_tableBodyCell$$12$$[0]), $adjustedColumnWidth_cellRenderer$$1_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCellPaddingWidth_tableBodyCellStyle$$ = 
        parseInt($adjustedColumnWidth_cellRenderer$$1_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCellPaddingWidth_tableBodyCellStyle$$[$oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_PADDING_RIGHT$], 10) + parseInt($adjustedColumnWidth_cellRenderer$$1_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCellPaddingWidth_tableBodyCellStyle$$[$oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_PADDING_LEFT$], 10)) : $adjustedColumnWidth_cellRenderer$$1_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCellPaddingWidth_tableBodyCellStyle$$ = 
        $defaultTableBodyCellPaddingWidth_footerCell$$1$$ : ($adjustedColumnWidth_cellRenderer$$1_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCellPaddingWidth_tableBodyCellStyle$$ = window.getComputedStyle($headerColumnTextDivHeight_headerRenderer$$1_tableBodyCell$$12$$[0]), $adjustedColumnWidth_cellRenderer$$1_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCellPaddingWidth_tableBodyCellStyle$$ = $defaultTableBodyCellPaddingWidth_footerCell$$1$$ = parseInt($adjustedColumnWidth_cellRenderer$$1_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCellPaddingWidth_tableBodyCellStyle$$[$oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_PADDING_RIGHT$], 
        10) + parseInt($adjustedColumnWidth_cellRenderer$$1_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCellPaddingWidth_tableBodyCellStyle$$[$oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_PADDING_LEFT$], 10)), $adjustedColumnWidth_cellRenderer$$1_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCellPaddingWidth_tableBodyCellStyle$$ = $adjustedColumnWidth_cellRenderer$$1_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCellPaddingWidth_tableBodyCellStyle$$ > 
        $columnPaddingWidths$$[$i$$231_tableBodyRows$$16$$] ? $columnWidths$$[$i$$231_tableBodyRows$$16$$] - $adjustedColumnWidth_cellRenderer$$1_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCellPaddingWidth_tableBodyCellStyle$$ + $columnPaddingWidths$$[$i$$231_tableBodyRows$$16$$] : $columnWidths$$[$i$$231_tableBodyRows$$16$$] + $columnPaddingWidths$$[$i$$231_tableBodyRows$$16$$] - $adjustedColumnWidth_cellRenderer$$1_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCellPaddingWidth_tableBodyCellStyle$$, 
        $adjustedColumnWidths_defaultColumnPaddingWidth$$[$i$$231_tableBodyRows$$16$$] = $adjustedColumnWidth_cellRenderer$$1_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCellPaddingWidth_tableBodyCellStyle$$);
      }
    }
    for ($i$$231_tableBodyRows$$16$$ = 0;$i$$231_tableBodyRows$$16$$ < $columnsCount$$10$$;$i$$231_tableBodyRows$$16$$++) {
      $adjustedColumnWidth_cellRenderer$$1_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCellPaddingWidth_tableBodyCellStyle$$ = this.$getTableHeaderColumn$($i$$231_tableBodyRows$$16$$), null != $adjustedColumnWidth_cellRenderer$$1_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCellPaddingWidth_tableBodyCellStyle$$ && $adjustedColumnWidth_cellRenderer$$1_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCellPaddingWidth_tableBodyCellStyle$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_MIN_WIDTH$, 
      $columnWidths$$[$i$$231_tableBodyRows$$16$$] + $oj$$14$$.$TableDomUtils$.$CSS_VAL$.$_PX$), $headerColumnTextDivHeight_headerRenderer$$1_tableBodyCell$$12$$ = this.$getTableBodyCell$(0, $i$$231_tableBodyRows$$16$$, null), null != $headerColumnTextDivHeight_headerRenderer$$1_tableBodyCell$$12$$ && $headerColumnTextDivHeight_headerRenderer$$1_tableBodyCell$$12$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_MIN_WIDTH$, $adjustedColumnWidths_defaultColumnPaddingWidth$$[$i$$231_tableBodyRows$$16$$] + 
      $oj$$14$$.$TableDomUtils$.$CSS_VAL$.$_PX$), $defaultTableBodyCellPaddingWidth_footerCell$$1$$ = this.$getTableFooterCell$($i$$231_tableBodyRows$$16$$), null != $defaultTableBodyCellPaddingWidth_footerCell$$1$$ && ($adjustedColumnWidth_cellRenderer$$1_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCellPaddingWidth_tableBodyCellStyle$$ = parseInt($defaultTableBodyCellPaddingWidth_footerCell$$1$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_PADDING_RIGHT$), 10) + parseInt($defaultTableBodyCellPaddingWidth_footerCell$$1$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_PADDING_LEFT$), 
      10), $adjustedColumnWidth_cellRenderer$$1_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCellPaddingWidth_tableBodyCellStyle$$ = $adjustedColumnWidth_cellRenderer$$1_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCellPaddingWidth_tableBodyCellStyle$$ > $columnPaddingWidths$$[$i$$231_tableBodyRows$$16$$] ? $columnWidths$$[$i$$231_tableBodyRows$$16$$] - $adjustedColumnWidth_cellRenderer$$1_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCellPaddingWidth_tableBodyCellStyle$$ + 
      $columnPaddingWidths$$[$i$$231_tableBodyRows$$16$$] : $columnWidths$$[$i$$231_tableBodyRows$$16$$] + $columnPaddingWidths$$[$i$$231_tableBodyRows$$16$$] - $adjustedColumnWidth_cellRenderer$$1_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCellPaddingWidth_tableBodyCellStyle$$, $defaultTableBodyCellPaddingWidth_footerCell$$1$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_MIN_WIDTH$, $adjustedColumnWidth_cellRenderer$$1_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCellPaddingWidth_tableBodyCellStyle$$ + 
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$_setHeaderColumnOverflowWidths$ = function $$oj$$14$$$$TableDomUtils$$$$_setHeaderColumnOverflowWidths$$() {
    var $columns$$19$$ = this.$component$.$_getColumnDefs$(), $i$$232$$, $column$$17_headerColumnTextDivWidth$$, $headerColumnCell$$2_newHeaderColumnTextDivWidth$$, $headerColumnDiv$$1$$, $headerColumnTextDiv$$1$$, $sortPlaceHolderDivWidth$$, $columnsCount$$11$$ = $columns$$19$$.length;
    for ($i$$232$$ = 0;$i$$232$$ < $columnsCount$$11$$;$i$$232$$++) {
      $column$$17_headerColumnTextDivWidth$$ = $columns$$19$$[$i$$232$$], $headerColumnCell$$2_newHeaderColumnTextDivWidth$$ = this.$getTableHeaderColumn$($i$$232$$), null != $headerColumnCell$$2_newHeaderColumnTextDivWidth$$ && ($headerColumnDiv$$1$$ = $headerColumnCell$$2_newHeaderColumnTextDivWidth$$.children("." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_COLUMN_HEADER_CLASS$), 0 < $headerColumnDiv$$1$$.length && ($headerColumnDiv$$1$$ = $$$$14$$($headerColumnDiv$$1$$[0]), ($headerColumnTextDiv$$1$$ = 
  ...
  $oj$$14$$.$TableDndContext$.prototype.$_removeDragMarkerClass$ = function $$oj$$14$$$$TableDndContext$$$$_removeDragMarkerClass$$() {
    ...
    if (null != $dragColumns$$ && 0 < $dragColumns$$.length) {
      var $i$$233$$, $dragColumnsCount$$ = $dragColumns$$.length;
      for ($i$$233$$ = 0;$i$$233$$ < $dragColumnsCount$$;$i$$233$$++) {
        $$$$14$$($dragColumns$$[$i$$233$$]).removeClass($oj$$14$$.$TableDomUtils$.$MARKER_STYLE_CLASSES$.$_DRAG$);
      }
    }
  ...
  $oj$$14$$.$TableDndContext$.prototype.$_getEventColumnIndex$ = function $$oj$$14$$$$TableDndContext$$$$_getEventColumnIndex$$($event$$220$$) {
    return this.$_getTableDomUtils$().$getElementColumnIdx$($$$$14$$($event$$220$$.currentTarget));
  };
  $oj$$14$$.$TableDndContext$.prototype.$_getOverRowIndex$ = function $$oj$$14$$$$TableDndContext$$$$_getOverRowIndex$$($context$$62_event$$221$$) {
    var $newRowIndex_overRow_tableBodyRows$$17$$;
    $newRowIndex_overRow_tableBodyRows$$17$$ = $$$$14$$($context$$62_event$$221$$.target).closest("tr");
    $newRowIndex_overRow_tableBodyRows$$17$$ = ($context$$62_event$$221$$ = this.$component$.getContextByNode($context$$62_event$$221$$.target)) && "oj-table-cell" == $context$$62_event$$221$$.subId ? $context$$62_event$$221$$.rowIndex : $newRowIndex_overRow_tableBodyRows$$17$$ && $newRowIndex_overRow_tableBodyRows$$17$$.hasClass($oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_DATA_ROW_DRAG_INDICATOR_BEFORE_CLASS$) ? this.$_dropRowIndex$ : ($newRowIndex_overRow_tableBodyRows$$17$$ = this.$_getTableDomUtils$().$getTableBodyRows$()) ? 
  ...
  $oj$$14$$.$TableDndContext$.prototype.$handleColumnDragStart$ = function $$oj$$14$$$$TableDndContext$$$$handleColumnDragStart$$($event$$222$$) {
    if (this.$_isColumnReorderEnabled$()) {
      var $columnIdx$$52$$ = this.$_getEventColumnIndex$($event$$222$$);
      this.$_dragStartColumnIdx$ = $columnIdx$$52$$;
      this.$_setReorderColumnsDataTransfer$($event$$222$$, $columnIdx$$52$$);
  ...
  $oj$$14$$.$TableDndContext$.prototype.$handleColumnDragEnter$ = function $$oj$$14$$$$TableDndContext$$$$handleColumnDragEnter$$($event$$224$$) {
    if (!this.$_isColumnReordering$()) {
      var $columnIdx$$53$$ = this.$_getEventColumnIndex$($event$$224$$);
      return this.$_invokeDropCallback$("columns", "dragEnter", $event$$224$$, {columnIndex:$columnIdx$$53$$});
    }
  };
  $oj$$14$$.$TableDndContext$.prototype.$handleColumnReorderDragOver$ = function $$oj$$14$$$$TableDndContext$$$$handleColumnReorderDragOver$$($event$$225$$) {
    var $columnIdx$$54$$ = this.$_getEventColumnIndex$($event$$225$$), $dragStartColumnIdx$$ = this.$_dragStartColumnIdx$;
    null != $dragStartColumnIdx$$ && $dragStartColumnIdx$$ != $columnIdx$$54$$ && ((this.$_currentDropColumnBefore$ = this.$_isDragOverBeforeColumn$($event$$225$$)) && $dragStartColumnIdx$$ == $columnIdx$$54$$ - 1 || !this.$_currentDropColumnBefore$ && $dragStartColumnIdx$$ == $columnIdx$$54$$ + 1 || this.$_getTableDomUtils$().$displayDragOverIndicatorColumn$($columnIdx$$54$$, this.$_currentDropColumnBefore$), $event$$225$$.preventDefault());
  };
  $oj$$14$$.$TableDndContext$.prototype.$handleColumnDragOver$ = function $$oj$$14$$$$TableDndContext$$$$handleColumnDragOver$$($event$$226$$) {
    if (this.$_isColumnReordering$()) {
      return this.$handleColumnReorderDragOver$($event$$226$$);
    }
    var $columnIdx$$55$$ = this.$_getEventColumnIndex$($event$$226$$);
    this.$_currentDropColumnBefore$ = this.$_isDragOverBeforeColumn$($event$$226$$);
    var $returnValue$$1$$ = this.$_invokeDropCallback$("columns", "dragOver", $event$$226$$, {columnIndex:$columnIdx$$55$$});
    (!1 === $returnValue$$1$$ || $event$$226$$.isDefaultPrevented()) && this.$_getTableDomUtils$().$displayDragOverIndicatorColumn$($columnIdx$$55$$, this.$_isDragOverBeforeColumn$($event$$226$$));
    return $returnValue$$1$$;
  };
  $oj$$14$$.$TableDndContext$.prototype.$handleColumnDragLeave$ = function $$oj$$14$$$$TableDndContext$$$$handleColumnDragLeave$$($event$$227$$) {
    if (!this.$_isColumnReordering$()) {
      this.$_getTableDomUtils$().$removeDragOverIndicatorColumn$();
      var $columnIdx$$56$$ = this.$_getEventColumnIndex$($event$$227$$);
      return this.$_invokeDndCallback$("drop", "columns", "dragLeave", $event$$227$$, {columnIndex:$columnIdx$$56$$});
    }
  };
  $oj$$14$$.$TableDndContext$.prototype.$handleColumnReorderDrop$ = function $$oj$$14$$$$TableDndContext$$$$handleColumnReorderDrop$$($event$$228$$) {
    var $columnIdx$$57$$ = this.$_getEventColumnIndex$($event$$228$$);
    this.$_currentDropColumnBefore$ || $columnIdx$$57$$++;
    this.$component$.$_columnsDestMap$ = this.$_getTableDomUtils$().$moveTableHeaderColumn$(this.$_dragStartColumnIdx$, $columnIdx$$57$$, $event$$228$$);
    $event$$228$$.preventDefault();
  };
  $oj$$14$$.$TableDndContext$.prototype.$handleColumnDrop$ = function $$oj$$14$$$$TableDndContext$$$$handleColumnDrop$$($event$$229$$) {
    if (this.$_isColumnReordering$()) {
      return this.$handleColumnReorderDrop$($event$$229$$);
    }
    this.$_getTableDomUtils$().$removeDragOverIndicatorColumn$();
    var $columnIdx$$58$$ = this.$_getEventColumnIndex$($event$$229$$);
    this.$_currentDropColumnBefore$ || $columnIdx$$58$$++;
    return this.$_invokeDropCallback$("columns", "drop", $event$$229$$, {columnIndex:$columnIdx$$58$$});
  };
  $oj$$14$$.$TableDndContext$.prototype.$handleRowDragStart$ = function $$oj$$14$$$$TableDndContext$$$$handleRowDragStart$$($event$$230$$) {
    var $dragOption$$1_ui$$6$$ = this.options.dnd.drag;
    if ($dragOption$$1_ui$$6$$ && $dragOption$$1_ui$$6$$.rows) {
      return($dragOption$$1_ui$$6$$ = this.$_setDragRowsDataTransfer$($event$$230$$, $dragOption$$1_ui$$6$$.rows.dataTypes, this.$component$.$_getSelectedRowIdxs$())) ? this.$_invokeDndCallback$("drag", "rows", "dragStart", $event$$230$$, $dragOption$$1_ui$$6$$) : !1;
    }
  };
  $oj$$14$$.$TableDndContext$.prototype.$handleRowDrag$ = function $$oj$$14$$$$TableDndContext$$$$handleRowDrag$$($event$$231$$) {
    return this.$_invokeDndCallback$("drag", "rows", "drag", $event$$231$$);
  };
  $oj$$14$$.$TableDndContext$.prototype.$handleRowDragEnd$ = function $$oj$$14$$$$TableDndContext$$$$handleRowDragEnd$$($event$$232$$) {
    this.$_destroyDragImage$();
    return this.$_invokeDndCallback$("drag", "rows", "dragEnd", $event$$232$$);
  };
  $oj$$14$$.$TableDndContext$.prototype.$handleRowDragEnter$ = function $$oj$$14$$$$TableDndContext$$$$handleRowDragEnter$$($event$$233$$) {
    var $newRowIndex$$1$$ = this.$_getOverRowIndex$($event$$233$$), $returnValue$$2$$ = this.$_invokeDropCallback$("rows", "dragEnter", $event$$233$$, {rowIndex:$newRowIndex$$1$$});
    (!1 === $returnValue$$2$$ || $event$$233$$.isDefaultPrevented()) && this.$_updateDragRowsState$($event$$233$$, $newRowIndex$$1$$);
    return $returnValue$$2$$;
  };
  $oj$$14$$.$TableDndContext$.prototype.$handleRowDragOver$ = function $$oj$$14$$$$TableDndContext$$$$handleRowDragOver$$($event$$234$$) {
    return this.$_invokeDropCallback$("rows", "dragOver", $event$$234$$, {rowIndex:this.$_dropRowIndex$});
  };
  $oj$$14$$.$TableDndContext$.prototype.$handleRowDragLeave$ = function $$oj$$14$$$$TableDndContext$$$$handleRowDragLeave$$($event$$235$$) {
    var $returnValue$$3$$ = this.$_invokeDndCallback$("drop", "rows", "dragLeave", $event$$235$$, {rowIndex:this.$_dropRowIndex$});
    this.$_isDndEventInElement$($event$$235$$, $event$$235$$.currentTarget) || (this.$_getTableDomUtils$().$removeDragOverIndicatorRow$(), this.$_dropRowIndex$ = null);
    return $returnValue$$3$$;
  };
  $oj$$14$$.$TableDndContext$.prototype.$handleRowDrop$ = function $$oj$$14$$$$TableDndContext$$$$handleRowDrop$$($event$$236$$) {
    var $dropRowIndex$$ = this.$_dropRowIndex$;
    this.$_getTableDomUtils$().$removeDragOverIndicatorRow$();
    this.$_dropRowIndex$ = null;
    return this.$_invokeDropCallback$("rows", "drop", $event$$236$$, {rowIndex:$dropRowIndex$$});
  };
  $oj$$14$$.$TableDndContext$.prototype.$_hideUnselectedRows$ = function $$oj$$14$$$$TableDndContext$$$$_hideUnselectedRows$$($bodyClone$$1$$, $selArray$$) {
    ...
    for (var $i$$234$$ = 0;$i$$234$$ < $bodyRows$$.length;$i$$234$$++) {
      -1 == $selArray$$.indexOf($i$$234$$) && $$$$14$$($bodyRows$$[$i$$234$$]).css("visibility", "hidden");
    }
  };
  $oj$$14$$.$TableDndContext$.prototype.$_invokeDndCallback$ = function $$oj$$14$$$$TableDndContext$$$$_invokeDndCallback$$($dndOption_dndType$$, $callback$$91_itemType$$, $callbackType$$, $event$$237$$, $ui$$7$$) {
    ...
    if ($dndOption_dndType$$ && $dndOption_dndType$$[$callback$$91_itemType$$] && ($callback$$91_itemType$$ = $dndOption_dndType$$[$callback$$91_itemType$$][$callbackType$$]) && "function" == typeof $callback$$91_itemType$$) {
      try {
        $event$$237$$.dataTransfer = $event$$237$$.originalEvent.dataTransfer, $returnValue$$4$$ = $callback$$91_itemType$$($event$$237$$, $ui$$7$$);
      } catch ($e$$90$$) {
  ...
  $oj$$14$$.$TableDndContext$.prototype.$_invokeDropCallback$ = function $$oj$$14$$$$TableDndContext$$$$_invokeDropCallback$$($itemType$$1$$, $callbackType$$1_returnValue$$5$$, $event$$238$$, $ui$$8$$) {
    $callbackType$$1_returnValue$$5$$ = this.$_invokeDndCallback$("drop", $itemType$$1$$, $callbackType$$1_returnValue$$5$$, $event$$238$$, $ui$$8$$);
    void 0 === $callbackType$$1_returnValue$$5$$ && this.$_matchDragDataType$($event$$238$$, $itemType$$1$$) && $event$$238$$.preventDefault();
  ...
  $oj$$14$$.$TableDndContext$.prototype.$_isDndEventInElement$ = function $$oj$$14$$$$TableDndContext$$$$_isDndEventInElement$$($event$$239$$, $element$$102$$) {
    var $rect$$1$$ = $element$$102$$.getBoundingClientRect(), $domEvent$$ = $event$$239$$.originalEvent;
  ...
  $oj$$14$$.$TableDndContext$.prototype.$_isDragOverBeforeColumn$ = function $$oj$$14$$$$TableDndContext$$$$_isDragOverBeforeColumn$$($event$$240_onRightHalf$$) {
    var $columnRect$$ = $event$$240_onRightHalf$$.currentTarget.getBoundingClientRect();
    return null != $event$$240_onRightHalf$$.originalEvent.clientX ? ($event$$240_onRightHalf$$ = $columnRect$$.right - $event$$240_onRightHalf$$.originalEvent.clientX < ($columnRect$$.right - $columnRect$$.left) / 2, "rtl" === $oj$$14$$.$DomUtils$.$getReadingDirection$() ? $event$$240_onRightHalf$$ : !$event$$240_onRightHalf$$) : !1;
  };
  $oj$$14$$.$TableDndContext$.prototype.$_matchDragDataType$ = function $$oj$$14$$$$TableDndContext$$$$_matchDragDataType$$($event$$241$$, $itemType$$2$$) {
    var $dragDataTypes$$ = $event$$241$$.originalEvent.dataTransfer.types, $allowedTypeArray_allowedTypes_dndOption$$2$$ = this.options.dnd.drop;
  ...
  $oj$$14$$.$TableDndContext$.prototype.$_setDragRowsData$ = function $$oj$$14$$$$TableDndContext$$$$_setDragRowsData$$($dataTransfer_nativeEvent$$, $dataTypes$$2$$, $jsonStr$$1_rowDataArray$$) {
    ...
    if ("string" == typeof $dataTypes$$2$$) {
      ...
      if ($dataTypes$$2$$) {
        for (var $i$$236$$ = 0;$i$$236$$ < $dataTypes$$2$$.length;$i$$236$$++) {
          $dataTransfer_nativeEvent$$.setData($dataTypes$$2$$[$i$$236$$], $jsonStr$$1_rowDataArray$$);
        }
      }
    }
  };
  $oj$$14$$.$TableDndContext$.prototype.$_setDragRowsDataTransfer$ = function $$oj$$14$$$$TableDndContext$$$$_setDragRowsDataTransfer$$($event$$242$$, $dataTypes$$3$$, $selArray$$1$$) {
    for (var $rowDataArray$$1$$ = [], $i$$237$$ = 0;$i$$237$$ < $selArray$$1$$.length;$i$$237$$++) {
      var $row$$14$$ = this.$component$.getDataForVisibleRow($selArray$$1$$[$i$$237$$]);
      $row$$14$$ && $rowDataArray$$1$$.push($row$$14$$);
    }
    return $rowDataArray$$1$$.length ? (this.$_setDragRowsData$($event$$242$$.originalEvent, $dataTypes$$3$$, $rowDataArray$$1$$), this.$_dragImage$ = this.$_setDragRowsImage$($event$$242$$.originalEvent, $$$$14$$($event$$242$$.currentTarget).closest("tbody"), $selArray$$1$$), {rows:$rowDataArray$$1$$}) : null;
  };
  ...
  $oj$$14$$.$TableDndContext$.prototype.$_setReorderColumnsDataTransfer$ = function $$oj$$14$$$$TableDndContext$$$$_setReorderColumnsDataTransfer$$($event$$243$$, $columnIdx$$59$$) {
    var $dataTransfer$$1$$ = $event$$243$$.originalEvent.dataTransfer, $dragImage_tableIdHashCode$$ = this.$_getTableDomUtils$().$hashCode$(this.$_getTableDomUtils$().$getTableUID$());
  ...
  $oj$$14$$.$TableDndContext$.prototype.$setTableHeaderColumnDraggable$ = function $$oj$$14$$$$TableDndContext$$$$setTableHeaderColumnDraggable$$($columnIdx$$60$$, $draggable$$1$$) {
    if (this.$_isColumnReorderEnabled$()) {
      ...
      if (null != $headerColumns$$1$$ && 0 < $headerColumns$$1$$.length) {
        var $i$$238$$;
        for ($i$$238$$ = 0;$i$$238$$ < $headerColumns$$1$$.length;$i$$238$$++) {
          var $headerColumn$$12$$ = $headerColumns$$1$$[$i$$238$$];
          null != $columnIdx$$60$$ && $i$$238$$ == $columnIdx$$60$$ ? this.$_setHeaderColumnDraggable$($headerColumn$$12$$, $draggable$$1$$) : this.$_clearHeaderColumnDraggable$($headerColumn$$12$$);
        }
      }
    }
  };
  $oj$$14$$.$TableDndContext$.prototype.$_updateDragRowsState$ = function $$oj$$14$$$$TableDndContext$$$$_updateDragRowsState$$($event$$244$$, $newRowIndex$$2$$) {
    if (this.$_dropRowIndex$ != $newRowIndex$$2$$) {
      var $overRow$$1$$ = $$$$14$$($event$$244$$.target).closest("tr");
  ...
  $oj$$14$$.$TableRendererUtils$.$columnHeaderDefaultRenderer$ = function $$oj$$14$$$$TableRendererUtils$$$columnHeaderDefaultRenderer$$($context$$63$$, $delegateRenderer$$2$$) {
    var $headerContentDiv_parentElement$$1$$ = $$$$14$$($context$$63$$.headerContext.parentElement), $headerColumnDiv$$2$$ = $$$$14$$(document.createElement("div"));
    ...
    null != $delegateRenderer$$2$$ ? $delegateRenderer$$2$$($headerContentDiv_parentElement$$1$$) : this.$columnHeaderDefaultTextRenderer$($headerContentDiv_parentElement$$1$$, $context$$63$$);
  };
  $oj$$14$$.$TableRendererUtils$.$columnHeaderSortableIconRenderer$ = function $$oj$$14$$$$TableRendererUtils$$$columnHeaderSortableIconRenderer$$($context$$64$$, $delegateRenderer$$3$$) {
    var $component$$18_headerContentDiv$$1$$ = $context$$64$$.headerContext.component, $headerColumnAscDiv_headerColumnDscDiv_headerColumnSortPlaceholderDiv_parentElement$$2$$ = $$$$14$$($context$$64$$.headerContext.parentElement), $headerColumnDiv$$3$$ = $$$$14$$(document.createElement("div"));
    ...
    null != $delegateRenderer$$3$$ ? $delegateRenderer$$3$$($component$$18_headerContentDiv$$1$$) : this.$columnHeaderDefaultTextRenderer$($component$$18_headerContentDiv$$1$$, $context$$64$$);
  };
  $oj$$14$$.$TableRendererUtils$.$columnHeaderDefaultTextRenderer$ = function $$oj$$14$$$$TableRendererUtils$$$columnHeaderDefaultTextRenderer$$($headerContentDiv$$2$$, $context$$65$$) {
    var $column$$19_columnIdx$$61$$ = $context$$65$$.columnIndex, $column$$19_columnIdx$$61$$ = $context$$65$$.headerContext.component.$_getColumnDefs$()[$column$$19_columnIdx$$61$$];
    $headerContentDiv$$2$$.text($column$$19_columnIdx$$61$$.headerText);
  };
  $oj$$14$$.$TableRendererUtils$.$tableBodyRowDefaultRenderer$ = function $$oj$$14$$$$TableRendererUtils$$$tableBodyRowDefaultRenderer$$($rowIdx$$38$$, $row$$15$$, $context$$66$$) {
    var $component$$20_j$$34$$ = $context$$66$$.rowContext.component, $columnsCount$$12_tableBodyRow$$27$$ = $$$$14$$($context$$66$$.rowContext.parentElement), $rowHashCode$$4$$ = $component$$20_j$$34$$.$_getTableDomUtils$().$hashCode$($row$$15$$.key), $columns$$20$$ = $component$$20_j$$34$$.$_getColumnDefs$();
    $component$$20_j$$34$$.$_getTableDomUtils$().$setTableBodyRowAttributes$($row$$15$$, $columnsCount$$12_tableBodyRow$$27$$);
    ...
    for ($component$$20_j$$34$$ = 0;$component$$20_j$$34$$ < $columnsCount$$12_tableBodyRow$$27$$;$component$$20_j$$34$$++) {
      this.$tableBodyCellDefaultRenderer$($rowIdx$$38$$, $component$$20_j$$34$$, $row$$15$$, $rowHashCode$$4$$, $context$$66$$);
    }
  };
  $oj$$14$$.$TableRendererUtils$.$tableBodyCellDefaultRenderer$ = function $$oj$$14$$$$TableRendererUtils$$$tableBodyCellDefaultRenderer$$($rowIdx$$39$$, $columnIdx$$62$$, $row$$16$$, $rowHashCode$$5$$, $context$$67_tableBodyRow$$28$$) {
    var $component$$21$$ = $context$$67_tableBodyRow$$28$$.rowContext.component;
    $context$$67_tableBodyRow$$28$$ = $$$$14$$($context$$67_tableBodyRow$$28$$.rowContext.parentElement);
    ...
    $component$$21$$.$_getTableDomUtils$().$insertTableBodyCell$($rowIdx$$39$$, $row$$16$$.key, $rowHashCode$$5$$, $columnIdx$$62$$, $tableBodyCell$$13$$, $context$$67_tableBodyRow$$28$$);
    var $cellColumnContent_data$$120$$ = null;
    null != $cellRenderer$$2_column$$20$$.field && ($cellColumnContent_data$$120$$ = $row$$16$$.data[$cellRenderer$$2_column$$20$$.field]);
    if ($cellRenderer$$2_column$$20$$ = $component$$21$$.$_getColumnRenderer$($columnIdx$$62$$, "cell")) {
      var $cellContext$$ = this.$getRendererContextObject$($component$$21$$, $row$$16$$, $tableBodyCell$$13$$[0]), $cellColumnContent_data$$120$$ = $cellRenderer$$2_column$$20$$({cellContext:$cellContext$$, columnIndex:$columnIdx$$62$$, data:$cellColumnContent_data$$120$$, row:$$$$14$$.extend({}, $row$$16$$.data)});
      null != $cellColumnContent_data$$120$$ ? $tableBodyCell$$13$$.append($cellColumnContent_data$$120$$) : ($tableBodyCell$$13$$ = $$$$14$$($context$$67_tableBodyRow$$28$$.children(":not(." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_DATA_CELL_ACC_SELECT_CLASS$ + ")")[$columnIdx$$62$$]), $component$$21$$.$_getTableDomUtils$().$setTableBodyCellAttributes$($rowIdx$$39$$, $row$$16$$.key, $rowHashCode$$5$$, $columnIdx$$62$$, $tableBodyCell$$13$$), $component$$21$$.$_getTableDomUtils$().$styleTableBodyCell$($columnIdx$$62$$, 
      $tableBodyCell$$13$$, !1));
    } else {
      $tableBodyCell$$13$$.text($cellColumnContent_data$$120$$);
    }
  };
  $oj$$14$$.$TableRendererUtils$.$getRendererContextObject$ = function $$oj$$14$$$$TableRendererUtils$$$getRendererContextObject$$($component$$22_rowContext$$1$$, $row$$17$$, $parentElement$$3$$) {
    var $context$$68$$ = {};
    $context$$68$$.component = $component$$22_rowContext$$1$$;
    ...
    $context$$68$$.datasource = $dataSource$$;
    $context$$68$$.parentElement = $parentElement$$3$$;
    if (null != $row$$17$$ && ($context$$68$$.status = this.$getRendererStatusObject$($component$$22_rowContext$$1$$, $row$$17$$), $dataSource$$ instanceof $oj$$14$$.$FlattenedTreeTableDataSource$)) {
      $component$$22_rowContext$$1$$ = $dataSource$$.$_getMetadata$($row$$17$$.index);
      for (var $i$$239$$ in $component$$22_rowContext$$1$$) {
        $component$$22_rowContext$$1$$.hasOwnProperty($i$$239$$) && ($context$$68$$[$i$$239$$] = $component$$22_rowContext$$1$$[$i$$239$$]);
      }
    }
    return $context$$68$$;
  };
  $oj$$14$$.$TableRendererUtils$.$getRendererStatusObject$ = function $$oj$$14$$$$TableRendererUtils$$$getRendererStatusObject$$($component$$23$$, $row$$18$$) {
    return{rowIndex:$row$$18$$.index, rowKey:$row$$18$$.key, currentRow:$$$$14$$.extend({}, $component$$23$$.$_getCurrentRow$())};
  };
});
