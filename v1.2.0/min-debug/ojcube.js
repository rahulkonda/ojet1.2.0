...
define(["ojs/ojcore", "jquery", "promise", "ojs/ojdatasource-common"], function($oj$$18$$, $$$$17$$) {
  ...
  $oj$$18$$.$Cube$.prototype.$getAxes$ = function $$oj$$18$$$$Cube$$$$getAxes$$() {
    var $cube_i$$260$$ = this.$_getPinnedCube$(), $axes$$ = [];
    Array.prototype.push.apply($axes$$, $cube_i$$260$$ ? $cube_i$$260$$.$getAxes$() : this.$_axes$);
    for ($cube_i$$260$$ = 2;$cube_i$$260$$ < this.$_axes$.length;$cube_i$$260$$++) {
      $axes$$.push(this.$_axes$[$cube_i$$260$$]);
    }
    return $axes$$;
  };
  ...
  $oj$$18$$.$Cube$.prototype.$pivot$ = function $$oj$$18$$$$Cube$$$$pivot$$($axisFrom_axisToObj_levelFromObj$$, $levelFrom$$, $axisTo_levelsFrom$$, $levelTo$$, $type$$82$$) {
    ...
    $levelTo$$ >= $layout$$1_levelsTo$$.length ? ($layout$$1_levelsTo$$.push($axisFrom_axisToObj_levelFromObj$$), $axisTo_levelsFrom$$.splice($levelFrom$$, 1)) : $type$$82$$ === $oj$$18$$.$Cube$.$PivotType$.SWAP ? ($axisTo_levelsFrom$$[$levelFrom$$] = $layout$$1_levelsTo$$[$levelTo$$], $layout$$1_levelsTo$$[$levelTo$$] = $axisFrom_axisToObj_levelFromObj$$) : ($type$$82$$ === $oj$$18$$.$Cube$.$PivotType$.AFTER && $levelTo$$++, $layout$$1_levelsTo$$.splice($levelTo$$, 0, $axisFrom_axisToObj_levelFromObj$$), 
  ...
  $oj$$18$$.$Cube$.prototype.$_findAxisInLayout$ = function $$oj$$18$$$$Cube$$$$_findAxisInLayout$$($axis$$4$$) {
    for (var $i$$261$$ = 0;$i$$261$$ < this.$_layout$.length;$i$$261$$++) {
      if (this.$_layout$[$i$$261$$].axis === $axis$$4$$) {
        return this.$_layout$[$i$$261$$];
      }
    }
    return null;
  };
  ...
  $oj$$18$$.$Cube$.prototype.$_normalizeIndices$ = function $$oj$$18$$$$Cube$$$$_normalizeIndices$$($indices$$3$$) {
    ...
    for (var $numAxes$$ = Math.min($indices$$3$$.length, this.$_axes$.length), $a$$100$$ = 0;$a$$100$$ < $numAxes$$;$a$$100$$++) {
      var $index$$113$$ = $indices$$3$$[$a$$100$$];
      $index$$113$$ instanceof Object && ($index$$113$$.hasOwnProperty("start") || $index$$113$$.hasOwnProperty("count")) ? $index$$113$$.hasOwnProperty("start") ? $index$$113$$.hasOwnProperty("count") ? $ind$$1$$.push(this.$_generateIndex$($index$$113$$.start, $index$$113$$.count, $a$$100$$)) : $ind$$1$$.push(this.$_generateIndex$($index$$113$$.start, 1, $a$$100$$)) : $ind$$1$$.push(this.$_generateIndex$(0, $index$$113$$.count, $a$$100$$)) : $ind$$1$$.push(this.$_generateIndex$($index$$113$$, 1, 
      $a$$100$$));
    }
    return $ind$$1$$;
  };
  $oj$$18$$.$Cube$.prototype.$_generateIndex$ = function $$oj$$18$$$$Cube$$$$_generateIndex$$($start$$31$$, $count$$32$$, $axis$$5_trueCount$$) {
    $axis$$5_trueCount$$ = this.$getAxes$()[$axis$$5_trueCount$$].$getExtent$();
    if ($start$$31$$ >= $axis$$5_trueCount$$ || 0 > $start$$31$$) {
      $start$$31$$ = 0;
    }
    $count$$32$$ = Math.min($count$$32$$, $axis$$5_trueCount$$ - $start$$31$$);
  ...
  $oj$$18$$.$Cube$.prototype.$GenerateAxes$ = function $$oj$$18$$$$Cube$$$$GenerateAxes$$() {
    ...
    this.$_pin$ = [];
    for (var $i$$262$$ = 0;$i$$262$$ < $nonPageLayout_pageLayout$$.length;$i$$262$$++) {
      this.$_getAxis$($nonPageLayout_pageLayout$$[$i$$262$$].axis, $nonPageLayout_pageLayout$$[$i$$262$$].levels), this.$_pin$.push({axis:$nonPageLayout_pageLayout$$[$i$$262$$].axis, index:0});
    }
    if (0 === $nonPageLayout_pageLayout$$.length) {
      for ($nonPageLayout_pageLayout$$ = this.$_getNonPageLayout$(), $i$$262$$ = 0;$i$$262$$ < $nonPageLayout_pageLayout$$.length;$i$$262$$++) {
        this.$_getAxis$($nonPageLayout_pageLayout$$[$i$$262$$].axis, $nonPageLayout_pageLayout$$[$i$$262$$].levels);
      }
    }
  };
  $oj$$18$$.$Cube$.prototype.$_getPageLayout$ = function $$oj$$18$$$$Cube$$$$_getPageLayout$$() {
    for (var $pageOnlyLayout$$ = [], $i$$263$$ = 0;$i$$263$$ < this.$_layout$.length;$i$$263$$++) {
      1 < this.$_layout$[$i$$263$$].axis && $pageOnlyLayout$$.push(this.$_layout$[$i$$263$$]);
    }
    return $pageOnlyLayout$$;
  };
  $oj$$18$$.$Cube$.prototype.$_getNonPageLayout$ = function $$oj$$18$$$$Cube$$$$_getNonPageLayout$$() {
    for (var $nonPageLayout$$1$$ = [], $i$$264$$ = 0;$i$$264$$ < this.$_layout$.length;$i$$264$$++) {
      2 > this.$_layout$[$i$$264$$].axis && $nonPageLayout$$1$$.push(this.$_layout$[$i$$264$$]);
    }
  ...
  $oj$$18$$.$Cube$.prototype.$BuildCube$ = function $$oj$$18$$$$Cube$$$$BuildCube$$() {
    ...
    this.$GenerateAxes$();
    if (null !== this.$_rows$) {
      for (var $row$$19$$ = 0;$row$$19$$ < this.$_rows$.length;$row$$19$$++) {
        for (var $pageHashObj_pageKey$$ = new $oj$$18$$.$CubeKeys$, $axis$$8_hash$$3_pageHash$$ = 2;$axis$$8_hash$$3_pageHash$$ < this.$_axes$.length;$axis$$8_hash$$3_pageHash$$++) {
          $pageHashObj_pageKey$$ = this.$_axes$[$axis$$8_hash$$3_pageHash$$].$ProcessRow$(this.$_rows$[$row$$19$$], $pageHashObj_pageKey$$);
        }
        for (var $pageHashObj_pageKey$$ = $pageHashObj_pageKey$$.$GetHashCodes$(), $ph$$ = 0;$ph$$ < $pageHashObj_pageKey$$.length;$ph$$++) {
          var $axis$$8_hash$$3_pageHash$$ = $pageHashObj_pageKey$$[$ph$$].key, $cube$$2$$ = this.$_cubes$[$axis$$8_hash$$3_pageHash$$];
          $cube$$2$$ || ($cube$$2$$ = this.$_cubes$[$axis$$8_hash$$3_pageHash$$] = this.$GenerateCube$(this.$_getNonPageLayout$()));
          for (var $dataHash_keys$$11$$ = new $oj$$18$$.$CubeKeys$, $h$$5_maxAxes$$ = $cube$$2$$.$_axes$.length, $axis$$8_hash$$3_pageHash$$ = 0;$axis$$8_hash$$3_pageHash$$ < $h$$5_maxAxes$$;$axis$$8_hash$$3_pageHash$$++) {
            $dataHash_keys$$11$$ = $cube$$2$$.$_axes$[$axis$$8_hash$$3_pageHash$$].$ProcessRow$(this.$_rows$[$row$$19$$], $dataHash_keys$$11$$);
          }
          $dataHash_keys$$11$$ = $axis$$8_hash$$3_pageHash$$ = $dataHash_keys$$11$$.$GetHashCodes$();
          if (void 0 !== $pageHashObj_pageKey$$[$ph$$].$dataValue$) {
            for ($dataHash_keys$$11$$ = [], $h$$5_maxAxes$$ = 0;$h$$5_maxAxes$$ < $axis$$8_hash$$3_pageHash$$.length;$h$$5_maxAxes$$++) {
              $dataHash_keys$$11$$.push($pageHashObj_pageKey$$[$ph$$]);
            }
          }
          $cube$$2$$.$_storeData$($axis$$8_hash$$3_pageHash$$, $dataHash_keys$$11$$, this.$_rows$[$row$$19$$]);
        }
      }
    }
  };
  $oj$$18$$.$Cube$.prototype.$_storeData$ = function $$oj$$18$$$$Cube$$$$_storeData$$($hash$$4$$, $dataHash$$1$$, $row$$20$$) {
    for (var $i$$265$$ = 0;$i$$265$$ < $hash$$4$$.length;$i$$265$$++) {
      this.$_data$[$hash$$4$$[$i$$265$$].key] = this.$_aggregate$($dataHash$$1$$[$i$$265$$], this.$_data$[$hash$$4$$[$i$$265$$].key], $row$$20$$);
    }
  };
  ...
  $oj$$18$$.$Cube$.prototype.$_getHashFromPin$ = function $$oj$$18$$$$Cube$$$$_getHashFromPin$$($pin$$1$$) {
    var $keys$$12$$ = new $oj$$18$$.$CubeKeys$;
    if ($pin$$1$$ && 0 < $pin$$1$$.length) {
      $pin$$1$$.sort(function($a$$101$$, $b$$63$$) {
        return $a$$101$$.axis - $b$$63$$.axis;
      });
      for (var $axes$$1$$ = this.$_axes$, $i$$266$$ = 0;$i$$266$$ < $pin$$1$$.length;$i$$266$$++) {
        $keys$$12$$ = $axes$$1$$[$pin$$1$$[$i$$266$$].axis].$GetCubeKeys$($pin$$1$$[$i$$266$$].index, $keys$$12$$);
      }
    }
    return $keys$$12$$.$GetHashCodes$()[0].key;
  };
  $oj$$18$$.$Cube$.$_isValid$ = function $$oj$$18$$$$Cube$$$_isValid$$($value$$228$$) {
    return $value$$228$$ ? void 0 !== $value$$228$$.value && null !== $value$$228$$.value : !1;
  };
  $oj$$18$$.$Cube$.prototype.$_createAggValue$ = function $$oj$$18$$$$Cube$$$$_createAggValue$$($value$$229$$, $aggType$$, $rows$$4$$, $retObj$$12_row$$21$$, $props$$14$$) {
    $rows$$4$$.push($retObj$$12_row$$21$$);
    $retObj$$12_row$$21$$ = {};
    for (var $p$$4$$ in $props$$14$$) {
      $props$$14$$.hasOwnProperty($p$$4$$) && ($retObj$$12_row$$21$$[$p$$4$$] = $props$$14$$[$p$$4$$]);
    }
    $retObj$$12_row$$21$$.value = $value$$229$$;
    $retObj$$12_row$$21$$.$aggType$ = $aggType$$;
    $retObj$$12_row$$21$$.rows = $rows$$4$$;
    return $retObj$$12_row$$21$$;
  };
  $oj$$18$$.$Cube$.$_isNumber$ = function $$oj$$18$$$$Cube$$$_isNumber$$($value$$230$$) {
    return $oj$$18$$.$StringUtils$.$isString$($value$$230$$.value) ? !1 : !isNaN($value$$230$$.value);
  };
  $oj$$18$$.$Cube$.prototype.$_aggregate$ = function $$oj$$18$$$$Cube$$$$_aggregate$$($hash$$5_val$$41$$, $currValue$$2$$, $row$$22$$) {
    ...
    switch($aggType$$1$$) {
      case $oj$$18$$.$CubeAggType$.SUM:
        return $avg_validCurr$$ && $validHash$$ ? $isNumCurr$$ && $isNumHash$$ ? this.$_createAggValue$($currValue$$2$$.value + $hash$$5_val$$41$$.value, $aggType$$1$$, $currValue$$2$$.rows, $row$$22$$, {}) : this.$_createAggValue$(NaN, $aggType$$1$$, $currValue$$2$$.rows, $row$$22$$, {}) : $validHash$$ && !$avg_validCurr$$ ? $isNumHash$$ ? this.$_createAggValue$($hash$$5_val$$41$$.value, $aggType$$1$$, [], $row$$22$$, {}) : this.$_createAggValue$(NaN, $aggType$$1$$, [], $row$$22$$, {}) : $currValue$$2$$;
      case $oj$$18$$.$CubeAggType$.AVERAGE:
        return $avg_validCurr$$ && $validHash$$ ? $isNumCurr$$ && $isNumHash$$ ? this.$_createAggValue$(($currValue$$2$$.$sum$ + $hash$$5_val$$41$$.value) / ($currValue$$2$$.rows.length + 1), $aggType$$1$$, $currValue$$2$$.rows, $row$$22$$, {$sum$:$currValue$$2$$.$sum$ + $hash$$5_val$$41$$.value}) : this.$_createAggValue$(NaN, $aggType$$1$$, $currValue$$2$$.rows, $row$$22$$, {$sum$:$currValue$$2$$.$sum$}) : $validHash$$ && !$avg_validCurr$$ ? $isNumHash$$ ? this.$_createAggValue$($hash$$5_val$$41$$.value, 
        $aggType$$1$$, [], $row$$22$$, {$sum$:$hash$$5_val$$41$$.value}) : this.$_createAggValue$(NaN, $aggType$$1$$, [], $row$$22$$, {$sum$:NaN}) : $currValue$$2$$;
      case $oj$$18$$.$CubeAggType$.VARIANCE:
      ;
      case $oj$$18$$.$CubeAggType$.STDDEV:
        return $avg_validCurr$$ && $validHash$$ ? $isNumCurr$$ && $isNumHash$$ ? ($avg_validCurr$$ = $currValue$$2$$.value + ($hash$$5_val$$41$$.value - $currValue$$2$$.value) / ($currValue$$2$$.rows.length + 1), this.$_createAggValue$($avg_validCurr$$, $aggType$$1$$, $currValue$$2$$.rows, $row$$22$$, {$square$:$currValue$$2$$.$square$ + ($hash$$5_val$$41$$.value - $currValue$$2$$.value) * ($hash$$5_val$$41$$.value - $avg_validCurr$$)})) : this.$_createAggValue$(NaN, $aggType$$1$$, $currValue$$2$$.rows, 
        $row$$22$$, {$square$:NaN}) : $validHash$$ && !$avg_validCurr$$ ? $isNumHash$$ ? this.$_createAggValue$($hash$$5_val$$41$$.value, $aggType$$1$$, [], $row$$22$$, {$square$:0}) : this.$_createAggValue$(NaN, $aggType$$1$$, [], $row$$22$$, {$square$:NaN}) : $currValue$$2$$;
      case $oj$$18$$.$CubeAggType$.NONE:
        return this.$_createAggValue$(null, $aggType$$1$$, $avg_validCurr$$ ? $currValue$$2$$.rows : [], $row$$22$$, {});
      case $oj$$18$$.$CubeAggType$.FIRST:
        return $avg_validCurr$$ ? this.$_createAggValue$($currValue$$2$$.value, $aggType$$1$$, $currValue$$2$$.rows, $row$$22$$, {}) : $validHash$$ ? this.$_createAggValue$($hash$$5_val$$41$$.value, $aggType$$1$$, [], $row$$22$$, {}) : $currValue$$2$$;
      case $oj$$18$$.$CubeAggType$.MIN:
        return $avg_validCurr$$ && $validHash$$ ? $isNumCurr$$ && $isNumHash$$ ? this.$_createAggValue$(Math.min($currValue$$2$$.value, $hash$$5_val$$41$$.value), $aggType$$1$$, $currValue$$2$$.rows, $row$$22$$, {}) : this.$_createAggValue$(NaN, $aggType$$1$$, $currValue$$2$$.rows, $row$$22$$, {}) : $validHash$$ && !$avg_validCurr$$ ? $isNumHash$$ ? this.$_createAggValue$($hash$$5_val$$41$$.value, $aggType$$1$$, [], $row$$22$$, {}) : this.$_createAggValue$(NaN, $aggType$$1$$, [], $row$$22$$, {}) : 
        $currValue$$2$$;
      case $oj$$18$$.$CubeAggType$.MAX:
        return $avg_validCurr$$ && $validHash$$ ? $isNumCurr$$ && $isNumHash$$ ? this.$_createAggValue$(Math.max($currValue$$2$$.value, $hash$$5_val$$41$$.value), $aggType$$1$$, $currValue$$2$$.rows, $row$$22$$, {}) : this.$_createAggValue$(NaN, $aggType$$1$$, $currValue$$2$$.rows, $row$$22$$, {}) : $validHash$$ && !$avg_validCurr$$ ? $isNumHash$$ ? this.$_createAggValue$($hash$$5_val$$41$$.value, $aggType$$1$$, [], $row$$22$$, {}) : this.$_createAggValue$(NaN, $aggType$$1$$, [], $row$$22$$, {}) : 
        $currValue$$2$$;
      case $oj$$18$$.$CubeAggType$.COUNT:
        return $avg_validCurr$$ && $validHash$$ ? this.$_createAggValue$($currValue$$2$$.value + 1, $aggType$$1$$, $currValue$$2$$.rows, $row$$22$$, {}) : $validHash$$ && !$avg_validCurr$$ ? this.$_createAggValue$(1, $aggType$$1$$, [], $row$$22$$, {}) : $currValue$$2$$;
      case $oj$$18$$.$CubeAggType$.CUSTOM:
        return $hash$$5_val$$41$$ = $aggObj$$.$callback$.call(this, $avg_validCurr$$ ? $currValue$$2$$.value : void 0, $validHash$$ ? $hash$$5_val$$41$$.value : void 0), this.$_createAggValue$($hash$$5_val$$41$$, $aggType$$1$$, $avg_validCurr$$ ? $currValue$$2$$.rows : [], $row$$22$$, {});
    }
  };
  $oj$$18$$.$Cube$.prototype.$_getAxis$ = function $$oj$$18$$$$Cube$$$$_getAxis$$($axis$$9$$, $levels$$) {
    $axis$$9$$ >= this.$_axes$.length && Array.prototype.push.apply(this.$_axes$, Array($axis$$9$$ - this.$_axes$.length + 1));
    this.$_axes$[$axis$$9$$] || (this.$_axes$[$axis$$9$$] = new $oj$$18$$.$CubeAxis$($levels$$, $axis$$9$$, this));
    return this.$_axes$[$axis$$9$$];
  };
  $oj$$18$$.$Cube$.prototype.$_createCubeKeys$ = function $$oj$$18$$$$Cube$$$$_createCubeKeys$$($indices$$5$$) {
    for (var $axes$$2$$ = this.$getAxes$(), $keys$$13$$ = new $oj$$18$$.$CubeKeys$, $a$$102$$ = 0;$a$$102$$ < $indices$$5$$.length;$a$$102$$++) {
      $keys$$13$$ = $axes$$2$$[$a$$102$$].$GetCubeKeys$($indices$$5$$[$a$$102$$], $keys$$13$$);
    }
    return $keys$$13$$;
  };
  ...
  $oj$$18$$.$CubeAxisValue$ = function $$oj$$18$$$$CubeAxisValue$$($value$$231$$, $label$$10$$, $level$$15$$, $parent$$12$$) {
    this.Init();
    this.$_children$ = [];
    this.$_parent$ = $parent$$12$$;
    this.$_cubeLevel$ = $level$$15$$;
    this.$_data$ = {};
    this.$_data$.value = $value$$231$$;
  ...
  $oj$$18$$.$CubeAxisValue$.prototype.$_findChild$ = function $$oj$$18$$$$CubeAxisValue$$$$_findChild$$($index$$115$$, $start$$33$$, $end$$10$$) {
    ...
    var $mid$$1$$ = Math.floor(($start$$33$$ + $end$$10$$) / 2), $value$$232$$ = this.$_children$[$mid$$1$$], $valStart$$ = $value$$232$$.$getStart$();
    return $valStart$$ > $index$$115$$ ? this.$_findChild$($index$$115$$, $start$$33$$, $mid$$1$$ - 1) : $valStart$$ + $value$$232$$.$getExtent$() - 1 < $index$$115$$ ? this.$_findChild$($index$$115$$, $mid$$1$$ + 1, $end$$10$$) : $value$$232$$;
  };
  $oj$$18$$.$CubeAxisValue$.prototype.$AddNode$ = function $$oj$$18$$$$CubeAxisValue$$$$AddNode$$($newValue$$19_value$$233$$, $label$$11$$, $level$$16$$) {
    for (var $c$$43$$ = 0;$c$$43$$ < this.$_children$.length;$c$$43$$++) {
      if (this.$_children$[$c$$43$$].$getValue$() === $newValue$$19_value$$233$$) {
        return this.$_children$[$c$$43$$];
      }
    }
    $newValue$$19_value$$233$$ = new $oj$$18$$.$CubeAxisValue$($newValue$$19_value$$233$$, $label$$11$$, $level$$16$$, this);
    this.$_children$.push($newValue$$19_value$$233$$);
    return $newValue$$19_value$$233$$;
  };
  ...
  $oj$$18$$.$CubeAxis$ = function $$oj$$18$$$$CubeAxis$$($levels$$2$$, $axis$$11_i$$267$$, $cube$$3$$) {
    this.Init();
    this.axis = $axis$$11_i$$267$$;
    this.$_levels$ = [];
    for ($axis$$11_i$$267$$ = 0;$axis$$11_i$$267$$ < $levels$$2$$.length;$axis$$11_i$$267$$++) {
      this.$_levels$.push($cube$$3$$.$GenerateLevel$($levels$$2$$[$axis$$11_i$$267$$], this));
    }
    this.$_cube$ = $cube$$3$$;
  ...
  $oj$$18$$.$CubeAxis$.prototype.$GetCubeKeys$ = function $$oj$$18$$$$CubeAxis$$$$GetCubeKeys$$($index$$117$$, $keys$$15$$) {
    return this.$GetPartialCubeKeys$($index$$117$$, this.$getLevels$().length - 1, $keys$$15$$);
  };
  $oj$$18$$.$CubeAxis$.prototype.$GetPartialCubeKeys$ = function $$oj$$18$$$$CubeAxis$$$$GetPartialCubeKeys$$($index$$118_values$$9$$, $level$$17_stopLevel$$, $keys$$16$$) {
    $index$$118_values$$9$$ = this.$getValues$($index$$118_values$$9$$);
    $level$$17_stopLevel$$ = this.$getLevels$()[$level$$17_stopLevel$$];
    for (var $v$$ = 0;$v$$ < $index$$118_values$$9$$.length;$v$$++) {
      var $val$$44$$ = $index$$118_values$$9$$[$v$$];
      $val$$44$$.$getLevel$().$isDataValue$() ? $keys$$16$$.$AddDataValue$($val$$44$$.$getValue$()) : $keys$$16$$.$UpdateKeys$($val$$44$$);
      if ($val$$44$$.$getLevel$() === $level$$17_stopLevel$$) {
        break;
      }
    }
    return $keys$$16$$;
  };
  $oj$$18$$.$CubeAxis$.prototype.$ProcessRow$ = function $$oj$$18$$$$CubeAxis$$$$ProcessRow$$($row$$24$$, $keys$$17$$) {
    return this.$_cube$.$ProcessLevel$(this, 0, this.$_values$, $row$$24$$, $keys$$17$$, !0);
  };
  $oj$$18$$.$CubeDataValue$ = function $$oj$$18$$$$CubeDataValue$$($value$$234$$, $indices$$6$$, $aggType$$2$$, $rows$$5$$, $square$$) {
    this.Init();
    this.$_data$ = {};
    this.$_data$.value = $value$$234$$;
  ...
  $oj$$18$$.$CubeCellSet$.prototype.getData = function $$oj$$18$$$$CubeCellSet$$$getData$($cell$$2_indexes$$1$$) {
    return($cell$$2_indexes$$1$$ = this.$_values$[$cell$$2_indexes$$1$$.column - this.$_starts$.column][$cell$$2_indexes$$1$$.row - this.$_starts$.row]) ? $cell$$2_indexes$$1$$.$getValue$() : null;
  };
  ...
  $oj$$18$$.$CubeCellSet$.prototype.$_getAxisMetadata$ = function $$oj$$18$$$$CubeCellSet$$$$_getAxisMetadata$$($indexes$$3$$, $axis$$12$$, $keys$$18_len$$18$$) {
    var $axes$$3$$ = this.$_cube$.$getAxes$();
    return void 0 !== $indexes$$3$$[$axis$$12$$] && $axes$$3$$.length >= $keys$$18_len$$18$$ ? ($keys$$18_len$$18$$ = new $oj$$18$$.$CubeKeys$, $keys$$18_len$$18$$ = $axes$$3$$[$oj$$18$$.$CubeDataGridDataSource$.$_convertAxes$($axis$$12$$)].$GetCubeKeys$($indexes$$3$$[$axis$$12$$], $keys$$18_len$$18$$), $keys$$18_len$$18$$.$GetHashCodes$()[0].key) : null;
  };
  $oj$$18$$.$CubeCellSet$.prototype.$getStart$ = function $$oj$$18$$$$CubeCellSet$$$$getStart$$($axis$$13$$) {
    return this.$_starts$[$axis$$13$$];
  };
  $oj$$18$$.$Object$.$exportPrototypeSymbol$("CubeCellSet.prototype.getStart", {$getStart$:$oj$$18$$.$CubeCellSet$.prototype.$getStart$});
  $oj$$18$$.$CubeCellSet$.prototype.$getCount$ = function $$oj$$18$$$$CubeCellSet$$$$getCount$$($axis$$14$$) {
    return this.$_counts$[$axis$$14$$];
  };
  ...
  $oj$$18$$.$DataValueAttributeCube$.prototype.$GenerateLevel$ = function $$oj$$18$$$$DataValueAttributeCube$$$$GenerateLevel$$($level$$18$$, $axis$$15$$) {
    return $level$$18$$.dataValue ? new $oj$$18$$.$CubeLevel$(null, $axis$$15$$, !0) : new $oj$$18$$.$CubeLevel$($level$$18$$.attribute, $axis$$15$$, !1);
  };
  ...
  $oj$$18$$.$DataValueAttributeCube$.prototype.$ProcessLevel$ = function $$oj$$18$$$$DataValueAttributeCube$$$$ProcessLevel$$($axis$$16$$, $levelNum$$1$$, $currNode$$1_node$$63$$, $row$$26$$, $keys$$19$$, $addKeys$$1$$) {
    if ($levelNum$$1$$ >= $axis$$16$$.$getLevels$().length) {
      return $keys$$19$$;
    }
    var $level$$19$$ = $axis$$16$$.$getLevels$()[$levelNum$$1$$];
    if ($level$$19$$.$isDataValue$()) {
      return this.$_processDataValue$($axis$$16$$, $currNode$$1_node$$63$$, $row$$26$$, $levelNum$$1$$, $keys$$19$$);
    }
    $currNode$$1_node$$63$$ = $currNode$$1_node$$63$$.$AddNode$($row$$26$$[$level$$19$$.attribute], null, $level$$19$$);
    $addKeys$$1$$ && $keys$$19$$.$UpdateKeys$($currNode$$1_node$$63$$);
    return this.$ProcessLevel$($axis$$16$$, $levelNum$$1$$ + 1, $currNode$$1_node$$63$$, $row$$26$$, $keys$$19$$, $addKeys$$1$$);
  };
  $oj$$18$$.$DataValueAttributeCube$.prototype.$_processDataValue$ = function $$oj$$18$$$$DataValueAttributeCube$$$$_processDataValue$$($axis$$17$$, $node$$64$$, $row$$27$$, $levelNum$$2$$, $keys$$20$$) {
    for (var $dsKeysAdded$$ = !0, $d$$6$$ = 0;$d$$6$$ < this.$_dataValues$.length;$d$$6$$++) {
      ...
      $row$$27$$.hasOwnProperty($dvAttr$$) && ($currNode$$2_dvLabel$$ = $node$$64$$.$AddNode$($dvAttr$$, $currNode$$2_dvLabel$$, $axis$$17$$.$getLevels$()[$levelNum$$2$$]), $keys$$20$$.$AddDataValue$($dvAttr$$, $row$$27$$[$dvAttr$$]), this.$ProcessLevel$($axis$$17$$, $levelNum$$2$$ + 1, $currNode$$2_dvLabel$$, $row$$27$$, $keys$$20$$, $dsKeysAdded$$), $dsKeysAdded$$ = !1);
    }
    return $keys$$20$$;
  };
  $oj$$18$$.$DataValueAttributeCube$.prototype.$_buildAggTypeLookup$ = function $$oj$$18$$$$DataValueAttributeCube$$$$_buildAggTypeLookup$$() {
    ...
    for (var $i$$268$$ = 0;$i$$268$$ < this.$_dataValues$.length;$i$$268$$++) {
      var $dv$$ = this.$_dataValues$[$i$$268$$];
  ...
  $oj$$18$$.$CubeKeys$.prototype.$AddDataValue$ = function $$oj$$18$$$$CubeKeys$$$$AddDataValue$$($name$$108$$, $value$$236$$) {
    this.$_data$.push({name:$name$$108$$, value:$value$$236$$});
  };
  ...
  $oj$$18$$.$CubeHeaderSet$ = function $$oj$$18$$$$CubeHeaderSet$$($axis$$18$$, $cube$$5$$, $start$$34$$, $count$$34$$) {
    this.$_cube$ = $cube$$5$$;
    this.$_axis$ = $axis$$18$$;
  ...
  $oj$$18$$.$CubeHeaderSet$.prototype.getData = function $$oj$$18$$$$CubeHeaderSet$$$getData$($index$$119$$, $level$$20$$) {
    var $val$$45$$ = this.$_getValue$($index$$119$$, $level$$20$$);
  ...
  $oj$$18$$.$CubeHeaderSet$.prototype.getMetadata = function $$oj$$18$$$$CubeHeaderSet$$$getMetadata$($index$$120$$, $level$$21$$) {
    var $hash$$6_keys$$21$$ = new $oj$$18$$.$CubeKeys$, $hash$$6_keys$$21$$ = this.$_axis$.$GetPartialCubeKeys$($index$$120$$, $level$$21$$, $hash$$6_keys$$21$$);
    return($hash$$6_keys$$21$$ = $hash$$6_keys$$21$$.$GetHashCodes$()) && 0 < $hash$$6_keys$$21$$.length ? {key:$hash$$6_keys$$21$$[0].key} : null;
  };
  ...
  $oj$$18$$.$CubeHeaderSet$.prototype.$getExtent$ = function $$oj$$18$$$$CubeHeaderSet$$$$getExtent$$($index$$121$$, $level$$22$$) {
    var $start$$35_val$$46$$ = this.$_getValue$($index$$121$$, $level$$22$$), $extent$$ = $start$$35_val$$46$$.$getExtent$(), $start$$35_val$$46$$ = $start$$35_val$$46$$.$getStart$(), $end$$11$$ = $start$$35_val$$46$$ + $extent$$ - 1, $after$$ = $index$$121$$ < $start$$35_val$$46$$ + $extent$$ - 1;
  ...
  $oj$$18$$.$CubeHeaderSet$.prototype.$getDepth$ = function $$oj$$18$$$$CubeHeaderSet$$$$getDepth$$($index$$122$$, $level$$23$$) {
    return this.$_getValue$($index$$122$$, $level$$23$$).$getDepth$();
  };
  ...
  $oj$$18$$.$CubeHeaderSet$.prototype.$_getValue$ = function $$oj$$18$$$$CubeHeaderSet$$$$_getValue$$($index$$123$$, $level$$24$$) {
    void 0 === $level$$24$$ && ($level$$24$$ = 0);
    var $values$$10$$ = this.$_axis$.$getValues$($index$$123$$);
    return $values$$10$$ && $values$$10$$.length > $level$$24$$ ? $values$$10$$[$level$$24$$] : null;
  };
  ...
  $oj$$18$$.$CubeDataGridDataSource$.prototype.$getCount$ = function $$oj$$18$$$$CubeDataGridDataSource$$$$getCount$$($axis$$19_axisObj$$) {
    return($axis$$19_axisObj$$ = this.$_getAxis$($axis$$19_axisObj$$)) ? $axis$$19_axisObj$$.$getExtent$() : 0;
  };
  ...
  $oj$$18$$.$CubeDataGridDataSource$.prototype.$fetchCells$ = function $$oj$$18$$$$CubeDataGridDataSource$$$$fetchCells$$($cellRange$$1$$, $callbacks$$5$$, $callbackObjects$$1$$) {
    for (var $cubecells_obj$$54$$ = {}, $i$$269$$ = 0;$i$$269$$ < $cellRange$$1$$.length;$i$$269$$++) {
      var $start$$36$$ = void 0 === $cellRange$$1$$[$i$$269$$].start ? 0 : $cellRange$$1$$[$i$$269$$].start;
      if ("row" === $cellRange$$1$$[$i$$269$$].axis) {
        var $count$$35$$ = void 0 === $cellRange$$1$$[$i$$269$$].count ? this.data.$getAxes$()[1].$getExtent$() : $cellRange$$1$$[$i$$269$$].count;
        $cubecells_obj$$54$$.row = {start:$start$$36$$, count:$count$$35$$};
      }
      "column" === $cellRange$$1$$[$i$$269$$].axis && ($count$$35$$ = void 0 === $cellRange$$1$$[$i$$269$$].count ? this.data.$getAxes$()[0].$getExtent$() : $cellRange$$1$$[$i$$269$$].count, $cubecells_obj$$54$$.column = {start:$start$$36$$, count:$count$$35$$});
    }
  ...
  $oj$$18$$.$CubeDataGridDataSource$.prototype.$_getKey$ = function $$oj$$18$$$$CubeDataGridDataSource$$$$_getKey$$($indexes$$5_item$$14$$, $axis$$21$$, $retObj$$14$$) {
    var $axisObj$$1$$ = this.$_getAxis$($axis$$21$$);
    $indexes$$5_item$$14$$ = $indexes$$5_item$$14$$[$axis$$21$$];
    var $keys$$22$$ = new $oj$$18$$.$CubeKeys$, $keys$$22$$ = $axisObj$$1$$ ? $axisObj$$1$$.$GetCubeKeys$($indexes$$5_item$$14$$, $keys$$22$$) : "";
    $retObj$$14$$[$axis$$21$$] = $keys$$22$$.$GetHashCodes$()[0].key;
    return $retObj$$14$$;
  };
  $oj$$18$$.$CubeDataGridDataSource$.prototype.$indexes$ = function $$oj$$18$$$$CubeDataGridDataSource$$$$indexes$$($keys$$23$$) {
    var $retObj$$15$$ = {}, $retObj$$15$$ = this.$_getIndex$($keys$$23$$, "row", $retObj$$15$$), $retObj$$15$$ = this.$_getIndex$($keys$$23$$, "column", $retObj$$15$$);
  ...
  $oj$$18$$.$CubeDataGridDataSource$.prototype.$_getIndex$ = function $$oj$$18$$$$CubeDataGridDataSource$$$$_getIndex$$($keys$$24$$, $axis$$22$$, $retObj$$16$$) {
    $retObj$$16$$[$axis$$22$$] = this.$_getAxis$($axis$$22$$).$getIndex$($keys$$24$$[$axis$$22$$]);
    return $retObj$$16$$;
  };
  ...
  $oj$$18$$.$CubeDataGridDataSource$.$_convertAxes$ = function $$oj$$18$$$$CubeDataGridDataSource$$$_convertAxes$$($axis$$23$$) {
    return "row" === $axis$$23$$ ? 1 : 0;
  };
  $oj$$18$$.$CubeDataGridDataSource$.prototype.$_getAxis$ = function $$oj$$18$$$$CubeDataGridDataSource$$$$_getAxis$$($axis$$24_axisNum$$) {
    $axis$$24_axisNum$$ = $oj$$18$$.$CubeDataGridDataSource$.$_convertAxes$($axis$$24_axisNum$$);
    var $axes$$4$$ = this.data.$getAxes$();
    return $axes$$4$$.length > $axis$$24_axisNum$$ ? $axes$$4$$[$axis$$24_axisNum$$] : null;
  };
  ...
  $oj$$18$$.$DataColumnCube$.prototype.$GenerateLevel$ = function $$oj$$18$$$$DataColumnCube$$$$GenerateLevel$$($level$$25$$, $axis$$25$$) {
    return $level$$25$$.attribute === this.$_labelAttr$ ? new $oj$$18$$.$CubeLevel$($level$$25$$.attribute, $axis$$25$$, !0) : new $oj$$18$$.$CubeLevel$($level$$25$$.attribute, $axis$$25$$, !1);
  };
  $oj$$18$$.$DataColumnCube$.prototype.$ProcessLevel$ = function $$oj$$18$$$$DataColumnCube$$$$ProcessLevel$$($axis$$26$$, $levelNum$$3$$, $currNode$$3_node$$66$$, $row$$28$$, $keys$$25$$, $addKeys$$2$$) {
    if ($levelNum$$3$$ >= $axis$$26$$.$getLevels$().length) {
      return $keys$$25$$;
    }
    var $level$$26$$ = $axis$$26$$.$getLevels$()[$levelNum$$3$$], $value$$237$$ = $row$$28$$[$level$$26$$.attribute];
    $currNode$$3_node$$66$$ = $currNode$$3_node$$66$$.$AddNode$($value$$237$$, null, $level$$26$$);
    $level$$26$$.$isDataValue$() ? $keys$$25$$.$AddDataValue$($value$$237$$, $row$$28$$[this.$_valueAttr$]) : $keys$$25$$.$UpdateKeys$($currNode$$3_node$$66$$);
    return this.$ProcessLevel$($axis$$26$$, $levelNum$$3$$ + 1, $currNode$$3_node$$66$$, $row$$28$$, $keys$$25$$, $addKeys$$2$$);
  };
  ...
  $oj$$18$$.$DataColumnCube$.prototype.$_buildAggTypeLookup$ = function $$oj$$18$$$$DataColumnCube$$$$_buildAggTypeLookup$$() {
    ...
    if (this.$_aggregation$) {
      for (var $i$$270$$ = 0;$i$$270$$ < this.$_aggregation$.length;$i$$270$$++) {
        var $dv$$1$$ = this.$_aggregation$[$i$$270$$], $agg$$2$$ = $dv$$1$$.aggregation;
        this.$_dataValueAggType$[$dv$$1$$.value] = $agg$$2$$ ? {$aggregation$:$agg$$2$$, $callback$:$dv$$1$$.callback} : this.$_defaultAggregation$;
      }
    }
  };
  $oj$$18$$.$CubeLevel$ = function $$oj$$18$$$$CubeLevel$$($attribute$$4$$, $axis$$27$$, $dataValue$$3$$) {
    this.Init();
    this.attribute = $attribute$$4$$;
    this.$_axisObj$ = $axis$$27$$;
    this.axis = $axis$$27$$.axis;
