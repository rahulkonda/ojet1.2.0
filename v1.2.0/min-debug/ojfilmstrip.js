 ...
 */
"use strict";
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "promise"], function($oj$$72$$, $$$$67$$) {
  $oj$$72$$.$FilmStripPagingModel$ = function $$oj$$72$$$$FilmStripPagingModel$$() {
    this.Init();
  };
  $oj$$72$$.$Object$.$createSubclass$($oj$$72$$.$FilmStripPagingModel$, $oj$$72$$.$EventSource$, "oj.FilmStripPagingModel");
  $oj$$72$$.$FilmStripPagingModel$.prototype.Init = function $$oj$$72$$$$FilmStripPagingModel$$$Init$() {
    $oj$$72$$.$FilmStripPagingModel$.$superclass$.Init.call(this);
    this.$_page$ = -1;
    this.$_totalSize$ = 0;
    this.$_pageSize$ = -1;
  };
  $oj$$72$$.$Object$.$exportPrototypeSymbol$("FilmStripPagingModel.prototype.Init", {Init:$oj$$72$$.$FilmStripPagingModel$.prototype.Init});
  $oj$$72$$.$FilmStripPagingModel$.prototype.$setTotalSize$ = function $$oj$$72$$$$FilmStripPagingModel$$$$setTotalSize$$($totalSize$$7$$) {
    this.$_totalSize$ = $totalSize$$7$$;
  };
  $oj$$72$$.$FilmStripPagingModel$.prototype.getPage = function $$oj$$72$$$$FilmStripPagingModel$$$getPage$() {
    return this.$_page$;
  };
  $oj$$72$$.$Object$.$exportPrototypeSymbol$("FilmStripPagingModel.prototype.getPage", {getPage:$oj$$72$$.$FilmStripPagingModel$.prototype.getPage});
  $oj$$72$$.$FilmStripPagingModel$.prototype.setPage = function $$oj$$72$$$$FilmStripPagingModel$$$setPage$($page$$8$$, $options$$373$$) {
    $page$$8$$ = parseInt($page$$8$$, 10);
    try {
      var $prevPageCount$$ = this.getPageCount(), $prevPage$$ = this.$_page$, $prevPageSize$$ = this.$_pageSize$, $pageSize$$8$$ = $prevPageSize$$;
      $options$$373$$ && $options$$373$$.pageSize && ($pageSize$$8$$ = $options$$373$$.pageSize);
      var $newPageCount$$ = Math.ceil(this.$_totalSize$ / $pageSize$$8$$);
      if (0 > $page$$8$$ || $page$$8$$ > $newPageCount$$ - 1) {
        throw Error("JET FilmStrip: Invalid 'page' set: " + $page$$8$$);
      }
      var $bFiredBeforePageEvent$$ = !1;
      if ($page$$8$$ != $prevPage$$ || $pageSize$$8$$ != $prevPageSize$$) {
      ...
      this.$_page$ = $page$$8$$;
      this.$_pageSize$ = $pageSize$$8$$;
      var $pageCount$$1$$ = this.getPageCount(), $self$$204$$ = this;
      return new Promise(function($resolve$$60$$) {
        $prevPageCount$$ != $pageCount$$1$$ && $self$$204$$.handleEvent("pageCount", {pageCount:$pageCount$$1$$, previousPageCount:$prevPageCount$$});
        $bFiredBeforePageEvent$$ && $self$$204$$.handleEvent("page", {page:$page$$8$$, previousPage:$prevPage$$});
        $resolve$$60$$(null);
      });
    } catch ($e$$134$$) {
      return Promise.reject($e$$134$$);
    }
  };
  $oj$$72$$.$Object$.$exportPrototypeSymbol$("FilmStripPagingModel.prototype.setPage", {setPage:$oj$$72$$.$FilmStripPagingModel$.prototype.setPage});
  $oj$$72$$.$FilmStripPagingModel$.prototype.getStartItemIndex = function $$oj$$72$$$$FilmStripPagingModel$$$getStartItemIndex$() {
    return this.$_page$ * this.$_pageSize$;
  };
  $oj$$72$$.$Object$.$exportPrototypeSymbol$("FilmStripPagingModel.prototype.getStartItemIndex", {getStartItemIndex:$oj$$72$$.$FilmStripPagingModel$.prototype.getStartItemIndex});
  $oj$$72$$.$FilmStripPagingModel$.prototype.getEndItemIndex = function $$oj$$72$$$$FilmStripPagingModel$$$getEndItemIndex$() {
    return Math.min(this.getStartItemIndex() + this.$_pageSize$, this.$_totalSize$) - 1;
  };
  $oj$$72$$.$Object$.$exportPrototypeSymbol$("FilmStripPagingModel.prototype.getEndItemIndex", {getEndItemIndex:$oj$$72$$.$FilmStripPagingModel$.prototype.getEndItemIndex});
  $oj$$72$$.$FilmStripPagingModel$.prototype.getPageCount = function $$oj$$72$$$$FilmStripPagingModel$$$getPageCount$() {
    return Math.ceil(this.$_totalSize$ / this.$_pageSize$);
  };
  $oj$$72$$.$Object$.$exportPrototypeSymbol$("FilmStripPagingModel.prototype.getPageCount", {getPageCount:$oj$$72$$.$FilmStripPagingModel$.prototype.getPageCount});
  $oj$$72$$.$FilmStripPagingModel$.prototype.totalSize = function $$oj$$72$$$$FilmStripPagingModel$$$totalSize$() {
    return this.$_totalSize$;
  };
  $oj$$72$$.$Object$.$exportPrototypeSymbol$("FilmStripPagingModel.prototype.totalSize", {totalSize:$oj$$72$$.$FilmStripPagingModel$.prototype.totalSize});
  $oj$$72$$.$FilmStripPagingModel$.prototype.totalSizeConfidence = function $$oj$$72$$$$FilmStripPagingModel$$$totalSizeConfidence$() {
    return "actual";
  };
  $oj$$72$$.$Object$.$exportPrototypeSymbol$("FilmStripPagingModel.prototype.totalSizeConfidence", {totalSizeConfidence:$oj$$72$$.$FilmStripPagingModel$.prototype.totalSizeConfidence});
  (function() {
    ...
    $oj$$72$$.$__registerWidget$("oj.ojFilmStrip", $$$$67$$.oj.baseComponent, {defaultElement:"\x3cdiv\x3e", widgetEventPrefix:"oj", options:{maxItemsPerPage:0, orientation:"horizontal", currentItem:0, arrowPlacement:"adjacent", arrowVisibility:"auto"}, _ComponentCreate:function() {
      this._super();
      var $elem$$124_options$$374$$ = this.element;
      $elem$$124_options$$374$$.addClass("oj-filmstrip oj-component").attr("tabindex", 0).attr("role", "region");
      $elem$$124_options$$374$$.uniqueId();
      $elem$$124_options$$374$$ = this.options;
      $elem$$124_options$$374$$.disabled && $oj$$72$$.$Logger$.warn($_WARNING_DISABLED_OPTION$$1$$);
      if ($elem$$124_options$$374$$.orientation !== $_HORIZONTAL$$ && $elem$$124_options$$374$$.orientation !== $_VERTICAL$$) {
        throw Error($_ERROR_INVALID_ORIENTATION$$ + $elem$$124_options$$374$$.orientation);
      }
      if ($elem$$124_options$$374$$.arrowPlacement !== $_ADJACENT$$ && $elem$$124_options$$374$$.arrowPlacement !== $_OVERLAY$$) {
        throw Error($_ERROR_INVALID_NAV_ARROW_PLACEMENT$$ + $elem$$124_options$$374$$.arrowPlacement);
      }
      if ($elem$$124_options$$374$$.arrowVisibility !== $_VISIBLE$$ && $elem$$124_options$$374$$.arrowVisibility !== $_HIDDEN$$1$$ && $elem$$124_options$$374$$.arrowVisibility !== $_HOVER$$ && $elem$$124_options$$374$$.arrowVisibility !== $_AUTO$$) {
        throw Error($_ERROR_INVALID_NAV_ARROW_VISIBILITY$$ + $elem$$124_options$$374$$.arrowVisibility);
      }
      ...
      if (this.$_canCalculateSizes$()) {
        ...
        this.$_bTouchSupported$ = $oj$$72$$.$DomUtils$.$isTouchSupported$();
        var $elem$$125_oldIsInit$$1$$ = this.element, $self$$205$$ = this;
        $isInit$$1_pagingModel$$ ? (this.$_itemsPerPage$ = 0, this.$_handlePageFunc$ = function $this$$_handlePageFunc$$($event$$609$$) {
          $self$$205$$.$_handlePage$($event$$609$$);
        }, this.$_pagingModel$ = new $oj$$72$$.$FilmStripPagingModel$, this.$_componentSize$ = 0, this.$_itemSize$ = -1, this.$_handleTransitionEndFunc$ = function $this$$_handleTransitionEndFunc$$() {
          $self$$205$$.$_handleTransitionEnd$();
        }, this.$_handleResizeFunc$ = function $this$$_handleResizeFunc$$() {
          $self$$205$$.$_handleResize$();
        }, this.$_bTouchSupported$ && (this.$_handleTouchStartFunc$ = function $this$$_handleTouchStartFunc$$($event$$611$$) {
          $self$$205$$.$_handleTouchStart$($event$$611$$);
        }, this.$_handleTouchMoveFunc$ = function $this$$_handleTouchMoveFunc$$($event$$612$$) {
          $self$$205$$.$_handleTouchMove$($event$$612$$);
        }, this.$_handleTouchEndFunc$ = function $this$$_handleTouchEndFunc$$($event$$613$$) {
          $self$$205$$.$_handleTouchEnd$($event$$613$$);
        }, this.$_addTouchListeners$()), this.$_handleMouseDownFunc$ = function $this$$_handleMouseDownFunc$$($event$$614$$) {
          $self$$205$$.$_handleMouseDown$($event$$614$$);
        }, this.$_handleMouseMoveFunc$ = function $this$$_handleMouseMoveFunc$$($event$$615$$) {
          $self$$205$$.$_handleMouseMove$($event$$615$$);
        }, this.$_handleMouseUpFunc$ = function $this$$_handleMouseUpFunc$$($event$$616$$) {
          $self$$205$$.$_handleMouseUp$($event$$616$$);
        }, this.$_addMouseListeners$(), this.$_handleKeyDownFunc$ = function $this$$_handleKeyDownFunc$$($event$$617$$) {
          $self$$205$$.$_handleKeyDown$($event$$617$$);
        }, this.$_addKeyListeners$()) : this.$_destroyInternal$();
        for (var $originalItems$$ = $elem$$125_oldIsInit$$1$$.children(), $i$$456$$ = 0;$i$$456$$ < $originalItems$$.length;$i$$456$$++) {
          $oj$$72$$.Components.$subtreeDetached$($originalItems$$[$i$$456$$]);
        }
        ...
        this.$_wrapChildren$();
        this.$_adjustSizes$();
        for ($i$$456$$ = 0;$i$$456$$ < $originalItems$$.length;$i$$456$$++) {
          $oj$$72$$.Components.$subtreeAttached$($originalItems$$[$i$$456$$]);
        }
        $oj$$72$$.$DomUtils$.$addResizeListener$($elem$$125_oldIsInit$$1$$[0], this.$_handleResizeFunc$);
      } else {
        $elem$$125_oldIsInit$$1$$ = !1, this.$_needsSetup$ && ($elem$$125_oldIsInit$$1$$ = this.$_needsSetup$[0]), this.$_needsSetup$ = [$isInit$$1_pagingModel$$ || $elem$$125_oldIsInit$$1$$];
      }
    }, _destroy:function() {
      ...
      $elem$$126$$.removeClass("oj-filmstrip oj-component " + $_OJ_FILMSTRIP_HOVER$$).removeAttr("tabindex role");
      $elem$$126$$.removeUniqueId();
      this._super();
    }, $_destroyInternal$:function() {
      $oj$$72$$.$DomUtils$.$removeResizeListener$(this.element[0], this.$_handleResizeFunc$);
      this.$_itemSize$ = -1;
      this.$_queuedHandleResize$ && (clearTimeout(this.$_queuedHandleResize$), this.$_queuedHandleResize$ = null);
      for (var $originalItems$$1$$ = this.$_getItems$(), $i$$457$$ = 0;$i$$457$$ < $originalItems$$1$$.length;$i$$457$$++) {
        $oj$$72$$.Components.$subtreeDetached$($originalItems$$1$$[$i$$457$$]);
      }
      this.$_clearCalculatedSizes$();
      this.$_getItemContainers$().unwrap();
      this.$_unwrapChildren$();
      for ($i$$457$$ = 0;$i$$457$$ < $originalItems$$1$$.length;$i$$457$$++) {
        $oj$$72$$.Components.$subtreeAttached$($originalItems$$1$$[$i$$457$$]);
      }
    }, _setOption:function($key$$182$$, $value$$294$$, $flags$$54$$) {
      ...
      switch($key$$182$$) {
        case "disabled":
          $oj$$72$$.$Logger$.warn($_WARNING_DISABLED_OPTION$$1$$);
          break;
        case "orientation":
          if ($value$$294$$ !== $_HORIZONTAL$$ && $value$$294$$ !== $_VERTICAL$$) {
            throw Error($_ERROR_INVALID_ORIENTATION$$ + $value$$294$$);
          }
          $bRefresh$$ = $options$$375$$.orientation != $value$$294$$;
          break;
        case "maxItemsPerPage":
          $bRefresh$$ = $options$$375$$.maxItemsPerPage != $value$$294$$;
          break;
        case "arrowPlacement":
          if ($value$$294$$ !== $_ADJACENT$$ && $value$$294$$ !== $_OVERLAY$$) {
            throw Error($_ERROR_INVALID_NAV_ARROW_PLACEMENT$$ + $value$$294$$);
          }
          $bRefresh$$ = $options$$375$$.arrowPlacement != $value$$294$$;
          break;
        case "arrowVisibility":
          if ($value$$294$$ !== $_VISIBLE$$ && $value$$294$$ !== $_HIDDEN$$1$$ && $value$$294$$ !== $_HOVER$$ && $value$$294$$ !== $_AUTO$$) {
            throw Error($_ERROR_INVALID_NAV_ARROW_VISIBILITY$$ + $value$$294$$);
          }
          $bRefresh$$ = $options$$375$$.arrowVisibility != $value$$294$$;
          break;
        case $_CURRENT_ITEM$$:
          if ($options$$375$$.currentItem != $value$$294$$ && ($newPageIndex$$ = this.$_findPage$($value$$294$$), 0 > $newPageIndex$$ || $newPageIndex$$ >= $pagingModel$$1$$.getPageCount())) {
            throw Error($_ERROR_CURRENT_ITEM_NOT_FOUND$$ + $value$$294$$);
          }
        ;
      }
      this._super($key$$182$$, $value$$294$$, $flags$$54$$);
      switch($key$$182$$) {
        case $_CURRENT_ITEM$$:
      ...
      if (!this.$_bHandlingResize$) {
        ...
        if (!this.$_queuedHandleResize$) {
          ...
          this.$_queuedHandleResize$ = setTimeout(function() {
            $self$$206$$.$_queuedHandleResize$ = null;
            $self$$206$$.$_handleResize$();
          }, 0);
        }
      }
      ...
      var $div$$12$$ = document.createElement("div"), $elem$$128_style$$21$$ = $div$$12$$.style;
      $elem$$128_style$$21$$.position = "absolute";
      $elem$$128_style$$21$$.width = "10px";
      $elem$$128_style$$21$$.height = "10px";
      $elem$$128_style$$21$$ = this.element[0];
      $elem$$128_style$$21$$.appendChild($div$$12$$);
      var $bCanCalcSizes$$1$$ = !1;
      try {
        $bCanCalcSizes$$1$$ = 0 < $div$$12$$.offsetWidth && 0 < $div$$12$$.offsetHeight;
      } catch ($e$$135$$) {
      }
      $elem$$128_style$$21$$.removeChild($div$$12$$);
      return $bCanCalcSizes$$1$$;
    }, $_wrapChildren$:function() {
      var $elem$$129$$ = this.element, $bHorizontal$$2$$ = this.$_isHorizontal$();
      $elem$$129$$.children().addClass($_OJ_FILMSTRIP_ITEM$$).wrap("\x3cdiv class\x3d'" + $_OJ_FILMSTRIP_CONTAINER$$ + " " + $_OJ_FILMSTRIP_ITEM_CONTAINER$$ + "'\x3e\x3c/div\x3e");
      var $cssAttr_pagesWrapper$$ = this.$_getCssPositionAttr$();
      this.$_pagesWrapper$ = $cssAttr_pagesWrapper$$ = $elem$$129$$.children().wrapAll("\x3cdiv class\x3d'" + $_OJ_FILMSTRIP_CONTAINER$$ + " " + $_OJ_FILMSTRIP_PAGES_CONTAINER$$ + "' style\x3d'" + $cssAttr_pagesWrapper$$ + ": 0px;'\x3e\x3c/div\x3e").parent();
      ...
      $elem$$129$$.addClass($_OJ_FILMSTRIP_CONTAINER$$);
      $bHorizontal$$2$$ || $elem$$129$$.addClass($_OJ_FILMSTRIP_VERTICAL$$);
      $options$$377$$.arrowVisibility !== $_HIDDEN$$1$$ && (this.$_prevButton$ = this.$_createPrevNavArrow$(), this.$_nextButton$ = this.$_createNextNavArrow$(), this.$_navArrowsShownOnHover$() && this.$_setupNavArrowsHoverable$());
    }, $_unwrapChildren$:function() {
      var $elem$$130$$ = this.element, $originalItems$$3$$ = this.$_getItems$();
      ...
      var $navArrowContainers$$ = $elem$$130$$.children($_PERIOD$$ + $_OJ_FILMSTRIP_ARROW_CONTAINER$$);
      ...
      $elem$$130$$.removeClass($_OJ_FILMSTRIP_CONTAINER$$ + " " + $_OJ_FILMSTRIP_VERTICAL$$);
    }, $_setupNavArrowsHoverable$:function() {
      this.element.on("mouseenter" + this.$navArrowHoverableEventNamespace$, function($event$$618$$) {
        $$$$67$$($event$$618$$.currentTarget).hasClass("oj-disabled") || $$$$67$$($event$$618$$.currentTarget).addClass($_OJ_FILMSTRIP_HOVER$$);
      }).on("mouseleave" + this.$navArrowHoverableEventNamespace$, function($event$$619$$) {
        $$$$67$$($event$$619$$.currentTarget).removeClass($_OJ_FILMSTRIP_HOVER$$);
      });
      ...
      var $elem$$133_label$$16$$ = this.element, $locationMarker_navArrow$$ = this.$_isHorizontal$() ? $_OJ_START$$ : $_OJ_TOP$$, $container$$31$$ = this.$_createNavigationArrowContainer$($locationMarker_navArrow$$);
      this.options.arrowPlacement === $_OVERLAY$$ ? $elem$$133_label$$16$$.append($container$$31$$) : $elem$$133_label$$16$$.prepend($container$$31$$);
      var $elem$$133_label$$16$$ = $_escapeHtml$$(this.$getTranslatedString$("labelAccArrowPreviousPage")), $tooltip$$ = $_escapeHtml$$(this.$getTranslatedString$("tipArrowPreviousPage")), $locationMarker_navArrow$$ = this.$_createNavigationArrow$($container$$31$$, $locationMarker_navArrow$$, $elem$$133_label$$16$$, $tooltip$$), $self$$207$$ = this;
      $locationMarker_navArrow$$.on("click", function() {
        $self$$207$$.$_prevPage$();
      });
      return $locationMarker_navArrow$$;
    }, $_createNextNavArrow$:function() {
      var $elem$$134_label$$17$$ = this.element, $locationMarker$$1_navArrow$$1$$ = this.$_isHorizontal$() ? $_OJ_END$$ : $_OJ_BOTTOM$$, $container$$32$$ = this.$_createNavigationArrowContainer$($locationMarker$$1_navArrow$$1$$);
      $elem$$134_label$$17$$.append($container$$32$$);
      var $elem$$134_label$$17$$ = $_escapeHtml$$(this.$getTranslatedString$("labelAccArrowNextPage")), $tooltip$$1$$ = $_escapeHtml$$(this.$getTranslatedString$("tipArrowNextPage")), $locationMarker$$1_navArrow$$1$$ = this.$_createNavigationArrow$($container$$32$$, $locationMarker$$1_navArrow$$1$$, $elem$$134_label$$17$$, $tooltip$$1$$), $self$$208$$ = this;
      ...
      return $container$$33$$;
    }, $_createNavigationArrow$:function($arrowElem_parentElem$$4$$, $elemId$$3_locationMarker$$3$$, $label$$18$$, $tooltip$$2$$) {
      ...
      this.$_clearCalculatedSizes$();
      var $currPage_options$$384$$ = this.options, $arrowSize_bCreatePages_bHorizontal$$5_calcFitCount$$ = this.$_isHorizontal$(), $fitCount_itemsPerPage$$ = $currPage_options$$384$$.maxItemsPerPage, $bCalcItemsPerPage_fitItemSize_newPageCount$$1$$ = 1 > $fitCount_itemsPerPage$$, $elem$$136_firstArrowContainer_pagingModel$$7$$ = this.element, $items$$11$$ = this.$_getItemContainers$();
      if (0 > this.$_itemSize$) {
        ...
        $oj$$72$$.Components.$subtreeShown$($optionItem_pages$$2$$[0]);
      ...
      $componentSize_optionItemContainer_optionItemIndex$$ = $arrowSize_bCreatePages_bHorizontal$$5_calcFitCount$$ ? $elem$$136_firstArrowContainer_pagingModel$$7$$.width() : $elem$$136_firstArrowContainer_pagingModel$$7$$.height();
      $currPage_options$$384$$.arrowVisibility !== $_HIDDEN$$1$$ && $currPage_options$$384$$.arrowPlacement === $_ADJACENT$$ && ($elem$$136_firstArrowContainer_pagingModel$$7$$ = $elem$$136_firstArrowContainer_pagingModel$$7$$.children($_PERIOD$$ + $_OJ_FILMSTRIP_ARROW_CONTAINER$$).eq(0), $arrowSize_bCreatePages_bHorizontal$$5_calcFitCount$$ = $arrowSize_bCreatePages_bHorizontal$$5_calcFitCount$$ ? $elem$$136_firstArrowContainer_pagingModel$$7$$.width() : $elem$$136_firstArrowContainer_pagingModel$$7$$.height(), 
      ...
      $elem$$136_firstArrowContainer_pagingModel$$7$$ = this.$_pagingModel$;
      if ($elem$$136_firstArrowContainer_pagingModel$$7$$.getPageCount() != $bCalcItemsPerPage_fitItemSize_newPageCount$$1$$ || this.$_itemsPerPage$ != $fitCount_itemsPerPage$$ || !$optionItem_pages$$2$$ || 1 > $optionItem_pages$$2$$.length) {
        $arrowSize_bCreatePages_bHorizontal$$5_calcFitCount$$ = !0;
        if ($bNotifyAttach_contentWrapper_newPageIndex$$1$$) {
          for (var $i$$458$$ = 0;$i$$458$$ < $items$$11$$.length;$i$$458$$++) {
            $oj$$72$$.Components.$subtreeDetached$($items$$11$$[$i$$458$$]);
          }
        }
        $optionItem_pages$$2$$ && 0 < $optionItem_pages$$2$$.length && $items$$11$$.unwrap();
        for ($i$$458$$ = 0;$i$$458$$ < $items$$11$$.length;$i$$458$$ += $fitCount_itemsPerPage$$) {
          $items$$11$$.slice($i$$458$$, $i$$458$$ + $fitCount_itemsPerPage$$).wrapAll("\x3cdiv class\x3d'" + $_OJ_FILMSTRIP_CONTAINER$$ + " " + $_OJ_FILMSTRIP_PAGE$$ + "' style\x3d'" + $_DISPLAY$$ + ": " + $_NONE$$1$$ + ";' " + $_ARIA_HIDDEN$$ + "\x3d'true'\x3e\x3c/div\x3e");
        }
        if ($bNotifyAttach_contentWrapper_newPageIndex$$1$$) {
          for ($i$$458$$ = 0;$i$$458$$ < $items$$11$$.length;$i$$458$$++) {
            $oj$$72$$.Components.$subtreeAttached$($items$$11$$[$i$$458$$]);
          }
        }
      }
      $optionItem_pages$$2$$ = this.$_getPages$();
      ...
      $elem$$136_firstArrowContainer_pagingModel$$7$$.getPageCount() != $bCalcItemsPerPage_fitItemSize_newPageCount$$1$$ || this.$_itemsPerPage$ != $fitCount_itemsPerPage$$ || $elem$$136_firstArrowContainer_pagingModel$$7$$.getPage() != $bNotifyAttach_contentWrapper_newPageIndex$$1$$ ? $elem$$136_firstArrowContainer_pagingModel$$7$$.setPage($bNotifyAttach_contentWrapper_newPageIndex$$1$$, {pageSize:$fitCount_itemsPerPage$$}) : $arrowSize_bCreatePages_bHorizontal$$5_calcFitCount$$ && ($currPage_options$$384$$ = 
      $elem$$136_firstArrowContainer_pagingModel$$7$$.getPage(), this.$_handlePage$({previousPage:$currPage_options$$384$$, page:$currPage_options$$384$$}));
    }, $_handlePage$:function($event$$620_pagesWrapper$$6$$) {
      var $pageIndex$$1$$ = $event$$620_pagesWrapper$$6$$.page, $prevPageIndex$$ = $event$$620_pagesWrapper$$6$$.previousPage;
      $event$$620_pagesWrapper$$6$$ = this.$_pagesWrapper$;
      var $pages$$3$$ = this.$_getPages$(), $oldPage_pageSize$$9$$ = this.$_pagingModel$.$_pageSize$, $bImmediate$$ = 0 > $prevPageIndex$$ || $prevPageIndex$$ == $pageIndex$$1$$ || this.$_itemsPerPage$ != $oldPage_pageSize$$9$$;
      this.$_itemsPerPage$ = $oldPage_pageSize$$9$$;
      $oldPage_pageSize$$9$$ = null;
      $bImmediate$$ || ($oldPage_pageSize$$9$$ = $$$$67$$($pages$$3$$[$prevPageIndex$$]));
      ...
      -1 < $prevPageIndex$$ && !$bImmediate$$ && ($bDeferScroll$$ = !0, $event$$620_pagesWrapper$$6$$.css(this.$_getCssSizeAttr$(), 2 * this.$_componentSize$), $pageIndex$$1$$ < $prevPageIndex$$ && $bPageHidden$$ && $event$$620_pagesWrapper$$6$$.css($cssAttr$$1$$, -this.$_componentSize$ + $_PX$$1$$), $pageIndex$$1$$ > $prevPageIndex$$ ? ($oldPage_pageSize$$9$$.addClass($_OJ_FILMSTRIP_TRANSITION_NEXT_OLDPAGE_FROM$$), $newPage$$.addClass($_OJ_FILMSTRIP_TRANSITION_NEXT_NEWPAGE_FROM$$)) : ($oldPage_pageSize$$9$$.addClass($_OJ_FILMSTRIP_TRANSITION_PREV_OLDPAGE_FROM$$), 
      $newPage$$.addClass($_OJ_FILMSTRIP_TRANSITION_PREV_NEWPAGE_FROM$$)));
      if ($bDeferScroll$$) {
        var $self$$209$$ = this, $bDragInit$$ = this.$_bDragInit$;
        $bDragInit$$ && 0 > $prevPageIndex$$ && $pages$$3$$.filter($_VISIBLE_SELECTOR$$).addClass($_OJ_FILMSTRIP_TRANSITION$$);
        setTimeout(function() {
          $self$$209$$.$_finishHandlePage$($pageIndex$$1$$, $prevPageIndex$$, $bImmediate$$, $bDragInit$$);
        }, 25);
      } else {
      ...
      var $newFirstItem_pageIndex$$3_pagesWrapper$$8$$ = this.$_pagesWrapper$, $cssAttr$$2_elem$$137_focusElem$$ = this.$_getCssPositionAttr$();
      $newFirstItem_pageIndex$$3_pagesWrapper$$8$$.off(this.eventNamespace).css(this.$_getCssSizeAttr$(), this.$_componentSize$).css($cssAttr$$2_elem$$137_focusElem$$, "0px");
      $cssAttr$$2_elem$$137_focusElem$$ = null;
      if ($oj$$72$$.$FocusUtils$.$containsFocus$($newFirstItem_pageIndex$$3_pagesWrapper$$8$$[0]) || this.$_nextButton$ && $oj$$72$$.$FocusUtils$.$containsFocus$(this.$_nextButton$[0]) || this.$_prevButton$ && $oj$$72$$.$FocusUtils$.$containsFocus$(this.$_prevButton$[0])) {
        $cssAttr$$2_elem$$137_focusElem$$ = document.activeElement;
      }
      for (var $newFirstItem_pageIndex$$3_pagesWrapper$$8$$ = this.$_pagingModel$.getPage(), $firstTabStop_pages$$5$$ = this.$_getPages$(), $i$$459$$ = 0;$i$$459$$ < $firstTabStop_pages$$5$$.length;$i$$459$$++) {
        $i$$459$$ != $newFirstItem_pageIndex$$3_pagesWrapper$$8$$ && this.$_hidePage$($$$$67$$($firstTabStop_pages$$5$$[$i$$459$$]));
      }
      ...
      $cssAttr$$2_elem$$137_focusElem$$ && $$$$67$$($cssAttr$$2_elem$$137_focusElem$$).is($_HIDDEN_SELECTOR$$) && ($cssAttr$$2_elem$$137_focusElem$$ = this.element, ($firstTabStop_pages$$5$$ = $oj$$72$$.$FocusUtils$.$getFirstTabStop$($firstTabStop_pages$$5$$[$newFirstItem_pageIndex$$3_pagesWrapper$$8$$])) ? $oj$$72$$.$FocusUtils$.$focusElement$($firstTabStop_pages$$5$$) : $oj$$72$$.$FocusUtils$.$focusElement$($cssAttr$$2_elem$$137_focusElem$$[0]));
    ...
    }, $_getItemIndex$:function($item$$123$$) {
      var $itemIndex$$2$$ = -1, $items$$12$$ = this.$_getItems$();
      if ("number" === typeof $item$$123$$) {
        0 <= $item$$123$$ && $item$$123$$ < $items$$12$$.length && ($itemIndex$$2$$ = $item$$123$$);
      } else {
        if ("string" === typeof $item$$123$$ && $oj$$72$$.$DomUtils$.$isValidIdentifier$($item$$123$$)) {
          for (var $i$$460$$ = 0;$i$$460$$ < $items$$12$$.length;$i$$460$$++) {
            var $itemId$$ = $items$$12$$[$i$$460$$].id;
            if ($itemId$$ && 0 < $itemId$$.length && $itemId$$ === $item$$123$$) {
              $itemIndex$$2$$ = $i$$460$$;
              break;
            }
          }
      ...
      return $itemIndex$$2$$;
    }, $_findPage$:function($item$$124$$, $itemsPerPage$$1$$) {
      var $itemIndex$$3$$ = this.$_getItemIndex$($item$$124$$), $pageIndex$$4$$ = -1;
      ...
      $oj$$72$$.Components.$subtreeHidden$($page$$9$$[0]);
      ...
      $oj$$72$$.Components.$subtreeShown$($page$$10$$[0]);
    ...
    }, $_handleMouseDown$:function($event$$622$$) {
      this.$_dragScrollStart$($event$$622$$.originalEvent);
    }, $_handleMouseMove$:function($event$$623$$) {
      this.$_dragScrollMove$($event$$623$$, $event$$623$$.originalEvent);
    }, $_handleMouseUp$:function() {
      this.$_dragScrollEnd$();
    }, $_handleTouchStart$:function($event$$625_eventTouches$$) {
      $event$$625_eventTouches$$ = $event$$625_eventTouches$$.originalEvent.touches;
      1 === $event$$625_eventTouches$$.length && this.$_dragScrollStart$($event$$625_eventTouches$$[0]);
    }, $_handleTouchMove$:function($event$$626$$) {
      this.$_dragScrollMove$($event$$626$$, $event$$626$$.originalEvent.touches[0]);
      (this.$_bTouch$ || this.$_scrolledForThisTouch$) && $event$$626$$.preventDefault();
      ...
      0 < $pagingModel$$13$$.getPage() && (this.$_unhidePage$($$$$67$$($pages$$6$$[$pagingModel$$13$$.getPage() - 1])), $pagesWrapper$$9$$.css($coordsObj$$1_cssAttr$$3$$, -this.$_componentSize$ + $_PX$$1$$), $pageCountToShow$$++);
    ...
    }, $_dragScrollMove$:function($event$$628$$, $coordsObj$$2$$) {
      if (this.$_bTouch$) {
        ...
        if (this.$_bDragInit$) {
          ...
          if ($bNext$$1$$ && $pageIndex$$7_pageToHide$$ < $pagingModel$$14_scrollVal_transform$$1$$.getPageCount() - 1 || !$bNext$$1$$ && 0 < $pageIndex$$7_pageToHide$$) {
            var $currScroll_elem$$144_pages$$7$$ = this.element[0], $threshold$$3$$ = Math.min($_DRAG_SCROLL_THRESHOLD$$ * ($bHorizontal$$8_newPageIndex$$3$$ ? $currScroll_elem$$144_pages$$7$$.offsetWidth : $currScroll_elem$$144_pages$$7$$.offsetHeight), $_DRAG_SCROLL_MAX_THRESHOLD$$), $cssAttr$$4$$ = this.$_getCssPositionAttr$(), $pagesWrapper$$10$$ = this.$_pagesWrapper$, $currScroll_elem$$144_pages$$7$$ = this.$_getPages$();
            Math.abs($diff$$) >= $threshold$$3$$ ? ($bHorizontal$$8_newPageIndex$$3$$ = $bNext$$1$$ ? $pageIndex$$7_pageToHide$$ + 1 : $pageIndex$$7_pageToHide$$ - 1, this.$_getFirstItemOnPage$($bHorizontal$$8_newPageIndex$$3$$), $pageIndex$$7_pageToHide$$ = $bNext$$1$$ ? $pageIndex$$7_pageToHide$$ - 1 : $pageIndex$$7_pageToHide$$ + 1, -1 < $pageIndex$$7_pageToHide$$ && $pageIndex$$7_pageToHide$$ < $pagingModel$$14_scrollVal_transform$$1$$.getPageCount() && this.$_hidePage$($$$$67$$($currScroll_elem$$144_pages$$7$$[$pageIndex$$7_pageToHide$$])), 
            $bNext$$1$$ && -1 < $pageIndex$$7_pageToHide$$ && ($currScroll_elem$$144_pages$$7$$ = parseInt($pagesWrapper$$10$$.css($cssAttr$$4$$), 10), $pagesWrapper$$10$$.css($cssAttr$$4$$, $currScroll_elem$$144_pages$$7$$ + this.$_componentSize$ + $_PX$$1$$)), $pagesWrapper$$10$$.css(this.$_getCssSizeAttr$(), 2 * this.$_componentSize$), this.$_bTouch$ = !1, $pagingModel$$14_scrollVal_transform$$1$$.setPage($bHorizontal$$8_newPageIndex$$3$$)) : ($pagingModel$$14_scrollVal_transform$$1$$ = $bHorizontal$$8_newPageIndex$$3$$ && 
            this.$_bRTL$ ? -$diff$$ : $diff$$, $pagingModel$$14_scrollVal_transform$$1$$ = $bHorizontal$$8_newPageIndex$$3$$ ? "translate3d(" + $pagingModel$$14_scrollVal_transform$$1$$ + "px, 0, 0)" : "translate3d(0, " + $pagingModel$$14_scrollVal_transform$$1$$ + "px, 0)", $_applyTransform$$($currScroll_elem$$144_pages$$7$$.filter($_VISIBLE_SELECTOR$$), $pagingModel$$14_scrollVal_transform$$1$$));
            this.$_scrolledForThisTouch$ = !0;
          }
          this.$_scrolledForThisTouch$ && ($event$$628$$.preventDefault(), $event$$628$$.stopPropagation());
        } else {
    ...
    }, getSubIdByNode:function($currentNode$$4_node$$164$$) {
      for (var $startArrow$$ = this.getNodeBySubId({subId:"oj-filmstrip-start-arrow"}), $endArrow$$ = this.getNodeBySubId({subId:"oj-filmstrip-end-arrow"}), $topArrow$$ = this.getNodeBySubId({subId:"oj-filmstrip-top-arrow"}), $bottomArrow$$ = this.getNodeBySubId({subId:"oj-filmstrip-bottom-arrow"}), $elem$$145$$ = this.element[0];$currentNode$$4_node$$164$$ && $currentNode$$4_node$$164$$ != $elem$$145$$;) {
        if ($currentNode$$4_node$$164$$ === $startArrow$$) {
          return{subId:"oj-filmstrip-start-arrow"};
        }
        if ($currentNode$$4_node$$164$$ === $endArrow$$) {
          return{subId:"oj-filmstrip-end-arrow"};
        }
        if ($currentNode$$4_node$$164$$ === $topArrow$$) {
          return{subId:"oj-filmstrip-top-arrow"};
        }
        if ($currentNode$$4_node$$164$$ === $bottomArrow$$) {
          return{subId:"oj-filmstrip-bottom-arrow"};
        }
        $currentNode$$4_node$$164$$ = $currentNode$$4_node$$164$$.parentElement;
      }
      return null;
    }});
