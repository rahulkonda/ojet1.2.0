...
define(["ojs/ojcore", "jquery", "ojs/ojdatasource-common", "ojs/ojmodel"], function($oj$$60$$) {
  ...
  $oj$$60$$.$CollectionNodeSet$.prototype.$FetchChildNodeSet$ = function $$oj$$60$$$$CollectionNodeSet$$$$FetchChildNodeSet$$($index$$255$$, $callbacks$$36$$) {
    var $model$$78_parentKey$$7$$ = this.$collection$.at($index$$255$$);
    if (this.$treeDataSource$.$parseMetadata$($model$$78_parentKey$$7$$).leaf) {
      this.$childNodeSet$[$index$$255$$] = null, $callbacks$$36$$.success(null);
    } else {
      var $collection$$36$$ = this.$treeDataSource$.$GetChildCollection$($model$$78_parentKey$$7$$), $model$$78_parentKey$$7$$ = this.$treeDataSource$.$parseMetadata$($model$$78_parentKey$$7$$).key, $self$$175$$ = this;
      this.$treeDataSource$.$FetchCollection$($collection$$36$$, 0, -1, {success:function($nodeSet$$23$$) {
        $self$$175$$.$childNodeSet$[$index$$255$$] = $nodeSet$$23$$;
  ...
  $oj$$60$$.$CollectionNodeSet$.prototype.getMetadata = function $$oj$$60$$$$CollectionNodeSet$$$getMetadata$($index$$258_model$$79_parse$$6$$) {
    this.$_checkRange$($index$$258_model$$79_parse$$6$$);
    var $metadata$$14$$ = {};
    $index$$258_model$$79_parse$$6$$ = this.$collection$.at($index$$258_model$$79_parse$$6$$);
    $index$$258_model$$79_parse$$6$$ = this.$treeDataSource$.$parseMetadata$($index$$258_model$$79_parse$$6$$);
    $metadata$$14$$.key = $index$$258_model$$79_parse$$6$$.key;
    $metadata$$14$$.leaf = $index$$258_model$$79_parse$$6$$.leaf;
    $metadata$$14$$.depth = $index$$258_model$$79_parse$$6$$.depth;
    return $metadata$$14$$;
  };
  ...
  $oj$$60$$.$CollectionTreeDataSource$.prototype.$getChildCount$ = function $$oj$$60$$$$CollectionTreeDataSource$$$$getChildCount$$($parent$$33$$) {
    var $childColl$$ = this.$cache$[$parent$$33$$];
    if ($childColl$$ && 0 < $childColl$$.length) {
      return $childColl$$.length;
    }
    this.$getChildCollection$($parent$$33$$, {success:function($coll$$3$$) {
  ...
  $oj$$60$$.$CollectionTreeDataSource$.prototype.$getChildCollection$ = function $$oj$$60$$$$CollectionTreeDataSource$$$$getChildCollection$$($key$$160$$, $callbacks$$37$$) {
    this.$fetchChildren$($key$$160$$, null, {success:function($nodeSet$$24$$) {
  ...
  $oj$$60$$.$CollectionTreeDataSource$.prototype.$fetchChildren$ = function $$oj$$60$$$$CollectionTreeDataSource$$$$fetchChildren$$($parent$$34$$, $range$$17$$, $callbacks$$38$$) {
    $range$$17$$ = $range$$17$$ || {};
    ...
    if (null === $parent$$34$$) {
      ...
      var $self$$176$$ = this;
      this.$_getModelForId$(this.$rootCollection$, $parent$$34$$, 0).then(function($collection$$37_parentModel$$) {
        if ($collection$$37_parentModel$$) {
          $collection$$37_parentModel$$ = $self$$176$$.$GetChildCollection$($collection$$37_parentModel$$.$model$);
          try {
            $self$$176$$.$FetchCollection$($collection$$37_parentModel$$, $start$$54$$, $count$$55$$, $callbacks$$38$$, $parent$$34$$);
          } catch ($error$$42$$) {
            $callbacks$$38$$ && $callbacks$$38$$.error && $callbacks$$38$$.error({status:$error$$42$$.message});
          }
        } else {
          $callbacks$$38$$ && $callbacks$$38$$.error && $callbacks$$38$$.error($parent$$34$$);
        }
      });
    }
  };
  ...
  $oj$$60$$.$CollectionTreeDataSource$.prototype.$ModelAdded$ = function $$oj$$60$$$$CollectionTreeDataSource$$$$ModelAdded$$($event$$538_model$$81$$, $collection$$38_parents$$5$$, $options$$331$$) {
    var $index$$260$$ = 0;
    $options$$331$$ && $options$$331$$.at && ($index$$260$$ = $options$$331$$.at);
    $collection$$38_parents$$5$$ = this.$_getParentChain$($collection$$38_parents$$5$$);
    $event$$538_model$$81$$ = this.$_createEvent$(this, "insert", $index$$260$$, $collection$$38_parents$$5$$, this.$_putModelInNodeSet$(null != $collection$$38_parents$$5$$ && 0 < $collection$$38_parents$$5$$.length ? $collection$$38_parents$$5$$[$collection$$38_parents$$5$$.length - 1] : null, $event$$538_model$$81$$));
    this.handleEvent("change", $event$$538_model$$81$$);
  };
  $oj$$60$$.$CollectionTreeDataSource$.prototype.$ModelRemoved$ = function $$oj$$60$$$$CollectionTreeDataSource$$$$ModelRemoved$$($event$$539_model$$82$$, $collection$$39$$, $options$$332$$) {
    var $index$$261$$ = 0;
    $options$$332$$ && $options$$332$$.index && ($index$$261$$ = $options$$332$$.index);
    this.$_removeCollectionFromCache$($event$$539_model$$82$$);
    $event$$539_model$$82$$ = this.$_createEvent$(this, "delete", $index$$261$$, this.$_getParentChain$($collection$$39$$), null);
    this.handleEvent("change", $event$$539_model$$82$$);
  };
  $oj$$60$$.$CollectionTreeDataSource$.prototype.$ModelUpdated$ = function $$oj$$60$$$$CollectionTreeDataSource$$$$ModelUpdated$$($event$$540_model$$83$$) {
    var $collectionForModel$$ = this.$_getCollectionForModel$($event$$540_model$$83$$), $index$$262$$ = null, $parents$$6$$ = null;
    $collectionForModel$$ && ($index$$262$$ = $collectionForModel$$.index, $parents$$6$$ = this.$_getParentChain$($collectionForModel$$.$collection$));
    $event$$540_model$$83$$ = this.$_createEvent$(this, "update", $index$$262$$, $parents$$6$$, this.$_putModelInNodeSet$(null != $parents$$6$$ && 0 < $parents$$6$$.length ? $parents$$6$$[$parents$$6$$.length - 1] : null, $event$$540_model$$83$$));
    this.handleEvent("change", $event$$540_model$$83$$);
  };
  $oj$$60$$.$CollectionTreeDataSource$.prototype.$CollectionRefreshed$ = function $$oj$$60$$$$CollectionTreeDataSource$$$$CollectionRefreshed$$($collection$$40_event$$541$$) {
    $collection$$40_event$$541$$ = this.$_createEvent$(this, "refresh", null, this.$_getParentChain$($collection$$40_event$$541$$), null);
    this.handleEvent("refresh", $collection$$40_event$$541$$);
  };
  $oj$$60$$.$CollectionTreeDataSource$.prototype.$_putModelInNodeSet$ = function $$oj$$60$$$$CollectionTreeDataSource$$$$_putModelInNodeSet$$($parent$$37$$, $model$$84$$) {
    var $collection$$41$$ = new $oj$$60$$.$Collection$;
    $collection$$41$$.add($model$$84$$);
    return this.$_getNodeSet$($collection$$41$$, $parent$$37$$, 0, 1);
  };
  $oj$$60$$.$CollectionTreeDataSource$.prototype.$_getParentChain$ = function $$oj$$60$$$$CollectionTreeDataSource$$$$_getParentChain$$($coll$$4_collection$$42$$) {
    var $parents$$7$$ = [], $parent$$38$$ = null;
    do {
      $parent$$38$$ = this.$_getParentOfCollection$($coll$$4_collection$$42$$), null !== $parent$$38$$ && ($parent$$38$$ !== $oj$$60$$.$CollectionTreeDataSource$.$ROOT_CACHE_KEY$ && $parents$$7$$.unshift($parent$$38$$), $coll$$4_collection$$42$$ = this.$_getCollectionOfKey$($parent$$38$$));
    } while (null != $parent$$38$$);
    return $parents$$7$$;
  };
  ...
  $oj$$60$$.$CollectionTreeDataSource$.prototype.$_getCacheKey$ = function $$oj$$60$$$$CollectionTreeDataSource$$$$_getCacheKey$$($model$$85$$) {
    var $key$$161$$ = $model$$85$$ instanceof $oj$$60$$.$Model$ ? this.$parseMetadata$($model$$85$$).key : $model$$85$$;
    return $model$$85$$ ? $key$$161$$ : $oj$$60$$.$CollectionTreeDataSource$.$ROOT_CACHE_KEY$;
  };
  ...
  $oj$$60$$.$CollectionTreeDataSource$.prototype.$_removeCollectionFromCache$ = function $$oj$$60$$$$CollectionTreeDataSource$$$$_removeCollectionFromCache$$($key$$162_model$$88$$) {
    $key$$162_model$$88$$ = this.$_getCacheKey$($key$$162_model$$88$$);
    for (var $prop$$67$$ in this.$cache$) {
      if (this.$cache$.hasOwnProperty($prop$$67$$) && $prop$$67$$ === $key$$162_model$$88$$) {
        this.$cache$[$key$$162_model$$88$$].off(null, null, this);
        delete this.$cache$[$key$$162_model$$88$$];
        break;
      }
    }
  };
  $oj$$60$$.$CollectionTreeDataSource$.prototype.$_keyInCollection$ = function $$oj$$60$$$$CollectionTreeDataSource$$$$_keyInCollection$$($key$$163$$, $collection$$44$$) {
    for (var $count$$56$$ = $collection$$44$$.length, $i$$379$$ = 0;$i$$379$$ < $count$$56$$;$i$$379$$++) {
      var $currKey$$ = this.$_getCacheKey$($collection$$44$$.at($i$$379$$));
      if ($key$$163$$ === $currKey$$) {
        return!0;
      }
    }
  ...
  $oj$$60$$.$CollectionTreeDataSource$.prototype.$_getCollectionForModel$ = function $$oj$$60$$$$CollectionTreeDataSource$$$$_getCollectionForModel$$($model$$89$$) {
    for (var $prop$$68$$ in this.$cache$) {
      if (this.$cache$.hasOwnProperty($prop$$68$$)) {
        for (var $collection$$45$$ = this.$cache$[$prop$$68$$], $i$$380$$ = 0;$i$$380$$ < $collection$$45$$.length;$i$$380$$++) {
          if ($collection$$45$$.at($i$$380$$) === $model$$89$$) {
            return{index:$i$$380$$, $collection$:$collection$$45$$};
          }
        }
      }
    }
  ...
  $oj$$60$$.$CollectionTreeDataSource$.prototype.$_getCollectionOfKey$ = function $$oj$$60$$$$CollectionTreeDataSource$$$$_getCollectionOfKey$$($key$$164$$) {
    for (var $prop$$69$$ in this.$cache$) {
      if (this.$cache$.hasOwnProperty($prop$$69$$)) {
        var $collection$$46$$ = this.$cache$[$prop$$69$$];
        if (this.$_keyInCollection$($key$$164$$, $collection$$46$$)) {
  ...
  $oj$$60$$.$CollectionTreeDataSource$.prototype.$_createEvent$ = function $$oj$$60$$$$CollectionTreeDataSource$$$$_createEvent$$($source$$11$$, $operation$$6$$, $index$$263$$, $parent$$39$$, $data$$165$$) {
    return{source:$source$$11$$, operation:$operation$$6$$, index:$index$$263$$, parent:$parent$$39$$, data:$data$$165$$};
  };
  $oj$$60$$.$CollectionTreeDataSource$.prototype.$FetchCollection$ = function $$oj$$60$$$$CollectionTreeDataSource$$$$FetchCollection$$($collection$$49$$, $start$$55$$, $count$$57$$, $callbacks$$39$$, $parent$$40$$) {
    var $self$$177$$ = this;
    null === $collection$$49$$ && (($collection$$49$$ = this.$__getParentsChildCollectionFromCache$(null)) ? $collection$$49$$ = {$collection$:$collection$$49$$, $cached$:!0} : ($collection$$49$$ = {$collection$:$self$$177$$.$rootCollection$, $cached$:!1}, $self$$177$$.$_setCollectionInCache$(null, this.$rootCollection$)));
    $collection$$49$$ && $self$$177$$.$_fetch$($collection$$49$$, function($coll$$5$$) {
      $callbacks$$39$$.success && $callbacks$$39$$.success($self$$177$$.$_getNodeSet$($coll$$5$$, $parent$$40$$, $start$$55$$, $count$$57$$));
    }, $callbacks$$39$$.error);
  };
  $oj$$60$$.$CollectionTreeDataSource$.prototype.$_getNodeSet$ = function $$oj$$60$$$$CollectionTreeDataSource$$$$_getNodeSet$$($collection$$50$$, $parent$$41$$, $start$$56$$, $count$$58$$) {
    return new $oj$$60$$.$CollectionNodeSet$($parent$$41$$, $collection$$50$$, this, $start$$56$$, $count$$58$$);
  };
  $oj$$60$$.$CollectionTreeDataSource$.prototype.$_scanForKey$ = function $$oj$$60$$$$CollectionTreeDataSource$$$$_scanForKey$$($collection$$51$$, $key$$165$$) {
    var $self$$178$$ = this;
    return new Promise(function($resolve$$45$$) {
      function $checkNext$$($index$$264$$, $collection$$52$$, $key$$166$$) {
        $index$$264$$ < $collection$$52$$.length ? $collection$$52$$.at($index$$264$$, {deferred:!0}).then(function($model$$90$$) {
          if ($model$$90$$) {
            var $parse$$7$$ = $self$$178$$.$parseMetadata$($model$$90$$);
            if ($key$$166$$ === $parse$$7$$.key) {
              $resolve$$45$$($model$$90$$);
              return;
            }
          }
          $index$$264$$++;
          $checkNext$$($index$$264$$, $collection$$52$$, $key$$166$$);
        }) : $resolve$$45$$(null);
      }
      $checkNext$$(0, $collection$$51$$, $key$$165$$);
    });
  };
  $oj$$60$$.$CollectionTreeDataSource$.prototype.$_getModelForId$ = function $$oj$$60$$$$CollectionTreeDataSource$$$$_getModelForId$$($collection$$53$$, $key$$167$$, $depth$$25$$) {
    var $self$$179$$ = this;
    return new Promise(function($resolve$$46$$) {
      $self$$179$$.$_scanForKey$($collection$$53$$, $key$$167$$).then(function($model$$91$$) {
        function $getNextCollection$$($index$$265$$, $tds$$) {
          if ($index$$265$$ < $max$$9$$) {
            ...
            $childColl$$1$$.$collection$ ? $tds$$.$_fetch$($childColl$$1$$, function($fetchColl$$) {
              $tds$$.$_getModelForId$($fetchColl$$, $key$$167$$, $depth$$25$$ + 1).then(function($childModel$$) {
                $childModel$$ ? $resolve$$46$$($childModel$$) : ($index$$265$$++, $getNextCollection$$($index$$265$$, $tds$$));
              });
        ...
        if ($model$$91$$) {
          $resolve$$46$$({$model$:$model$$91$$, depth:$depth$$25$$});
        } else {
          var $max$$9$$ = $collection$$53$$.length;
          $getNextCollection$$(0, $self$$179$$);
        }
      });
    });
  };
  $oj$$60$$.$CollectionTreeDataSource$.prototype.$_fetch$ = function $$oj$$60$$$$CollectionTreeDataSource$$$$_fetch$$($collectionCacheObj$$, $success$$15$$, $error$$43$$) {
  ...
  $oj$$60$$.$CollectionTreeDataSource$.prototype.$fetchDescendants$ = function $$oj$$60$$$$CollectionTreeDataSource$$$$fetchDescendants$$($parent$$42$$, $callbacks$$40$$) {
    var $self$$180$$ = this;
    null === $parent$$42$$ ? this.$FetchCollection$(null, 0, -1, {success:function($nodeSet$$25$$) {
      $nodeSet$$25$$.$FetchDescendants$({success:function() {
        $callbacks$$40$$.success && $callbacks$$40$$.success($nodeSet$$25$$);
      }});
    }}, null) : this.$_getModelForId$(this.$rootCollection$, $parent$$42$$, 0).then(function($collection$$54_parentModel$$2$$) {
      $collection$$54_parentModel$$2$$ && ($collection$$54_parentModel$$2$$ = $self$$180$$.$GetChildCollection$($collection$$54_parentModel$$2$$.$model$), $self$$180$$.$FetchCollection$($collection$$54_parentModel$$2$$, 0, -1, {success:function($nodeSet$$26$$) {
  ...
  $oj$$60$$.$CollectionTreeDataSource$.prototype.sort = function $$oj$$60$$$$CollectionTreeDataSource$$$sort$($criteria$$4$$, $callbacks$$41$$) {
    var $key$$168$$ = $criteria$$4$$.key, $dir$$1$$ = $criteria$$4$$.direction, $needSort$$2$$ = !1;
    $key$$168$$ !== this.$sortkey$ && (this.$sortkey$ = $key$$168$$, $needSort$$2$$ = !0);
