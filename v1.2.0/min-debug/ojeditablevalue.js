...
define(["ojs/ojcore", "jquery", "hammerjs", "ojs/ojjquery-hammer", "ojs/ojcomponentcore", "ojs/ojvalidation", "ojs/ojpopup"], function($oj$$4$$, $$$$4$$, $Hammer$$1$$) {
  ...
  $oj$$4$$.$EditableValueUtils$.$getAttributeValue$ = function $$oj$$4$$$$EditableValueUtils$$$getAttributeValue$$($element$$34$$, $attribute$$2$$) {
    var $attrVal_result$$4$$, $propVal$$, $returnVal$$ = {};
    if ($element$$34$$ && $attribute$$2$$) {
      switch($attribute$$2$$) {
        case "disabled":
          $attrVal_result$$4$$ = void 0 !== $element$$34$$.attr("disabled") ? !!$element$$34$$.prop("disabled") : void 0;
          break;
        case "pattern":
          $attrVal_result$$4$$ = $element$$34$$.prop("pattern") || void 0;
          break;
        case "placeholder":
          $attrVal_result$$4$$ = $element$$34$$.prop("placeholder") || void 0;
          break;
        case "readonly":
          $attrVal_result$$4$$ = void 0 !== $element$$34$$.attr("readonly") ? !!$element$$34$$.prop("readonly") : void 0;
          break;
        case "required":
          $attrVal_result$$4$$ = $element$$34$$.attr("required");
          $propVal$$ = $element$$34$$.prop("required");
          $attrVal_result$$4$$ = void 0 !== $attrVal_result$$4$$ ? void 0 !== $propVal$$ ? !!$propVal$$ : !!$attrVal_result$$4$$ : void 0;
          break;
        case "title":
          $attrVal_result$$4$$ = void 0 !== $element$$34$$.attr("title") ? $element$$34$$.prop("title") : void 0;
          break;
        case "value":
          $attrVal_result$$4$$ = $element$$34$$.val() || void 0;
          break;
        default:
          $attrVal_result$$4$$ = $element$$34$$.attr($attribute$$2$$) || void 0;
      }
    }
  ...
  $oj$$4$$.$EditableValueUtils$.$initializeOptionsFromDom$ = function $$oj$$4$$$$EditableValueUtils$$$initializeOptionsFromDom$$($props$$5$$, $constructorOptions$$4$$, $comp$$1$$, $postprocessCallback$$) {
    for (var $initializedOptions$$ = {}, $i$$92$$ = 0;$i$$92$$ < $props$$5$$.length;$i$$92$$++) {
      ...
      var $option$$1$$ = $finalValue_prop$$53$$.option || $attribute$$3_result$$5$$, $coerceDomValue_valueToValidate$$ = $finalValue_prop$$53$$.$coerceDomValue$, $validateOption$$ = $finalValue_prop$$53$$.$validateOption$, $element$$35$$ = $comp$$1$$.element, $previousValue$$ = $comp$$1$$.options[$option$$1$$];
      void 0 === $constructorOptions$$4$$[$option$$1$$] && ($previousValue$$ = $comp$$1$$.options[$option$$1$$], $attribute$$3_result$$5$$ = $oj$$4$$.$EditableValueUtils$.$getAttributeValue$($element$$35$$, $attribute$$3_result$$5$$), $attribute$$3_result$$5$$.$fromDom$ ? ($finalValue_prop$$53$$ = $attribute$$3_result$$5$$.value, $coerceDomValue_valueToValidate$$ && ("boolean" === typeof $coerceDomValue_valueToValidate$$ ? $finalValue_prop$$53$$ = $oj$$4$$.$EditableValueUtils$.$coerceDomValueForOption$($option$$1$$, 
  ...
  $oj$$4$$.$PopupMessagingStrategy$.prototype.$_popupOpenCallback$ = function $$oj$$4$$$$PopupMessagingStrategy$$$$_popupOpenCallback$$($event$$38$$) {
    var $target$$74$$ = $$$$4$$($event$$38$$.target), $self$$46$$ = this;
  ...
  $oj$$4$$.$PopupMessagingStrategy$.prototype.$_popupCloseCallback$ = function $$oj$$4$$$$PopupMessagingStrategy$$$$_popupCloseCallback$$($event$$39_target$$75$$) {
    $event$$39_target$$75$$ = $$$$4$$($event$$39_target$$75$$.target);
    $oj$$4$$.Components.$isComponentInitialized$($event$$39_target$$75$$) && ($event$$39_target$$75$$.ojPopup("option", "autoDismiss", "none"), $event$$39_target$$75$$.ojPopup("option", "open", null), $event$$39_target$$75$$.ojPopup("option", "close", null));
    delete this.$$messagingContentRoot$;
    $event$$39_target$$75$$.children().remove();
  };
  ...
  (function() {
    $oj$$4$$.$__registerWidget$("oj._ojLabel", $$$$4$$.oj.baseComponent, {version:"1.0.0", defaultElement:"\x3clabel\x3e", widgetEventPrefix:"oj", options:{ariaRequiredUnsupported:!1, describedById:null, help:{definition:null, source:null}, required:!1, rootAttributes:null}, $_BUNDLE_KEY$:{$_TOOLTIP_HELP$:"tooltipHelp", $_TOOLTIP_REQUIRED$:"tooltipRequired"}, widget:function() {
      ...
      this.$_drawOnCreate$();
    }, $_SaveAttributes$:function($element$$36$$) {
      this.$_savedClasses$ = $element$$36$$.attr("class");
      ...
      if (0 != $helpIcon$$.length) {
        ...
        var $self$$47$$ = this;
        this.$_openPopupForHelpDefCallbackListener$ || (this.$_openPopupForHelpDefCallbackListener$ = function $this$$_openPopupForHelpDefCallbackListener$$($event$$41$$) {
          $self$$47$$.$_handleOpenPopupForHelpDef$($event$$41$$, $$helpDefPopupDiv$$, $helpIcon$$, !1);
        });
    ...
    }, $_handleOpenPopupForHelpDef$:function($event$$42$$, $helpDefPopupDiv$$1$$, $helpIcon$$1$$, $inMouseDown$$1$$) {
      if ("mousedown" === $event$$42$$.type) {
        $inMouseDown$$1$$ = !0;
      } else {
        if ("focusin" === $event$$42$$.type && $inMouseDown$$1$$) {
          $inMouseDown$$1$$ = !1;
        } else {
          if (this.$_bTouchSupported$) {
            if ("press" === $event$$42$$.type) {
      ...
      var $element$$38$$ = this.element, $helpDef$$3$$ = this.options.help.definition, $title$$7$$;
      $helpDef$$3$$ && ($element$$38$$.addClass("oj-label-help-def"), ($title$$7$$ = $element$$38$$.attr("title")) ? $element$$38$$.attr("title", $title$$7$$ + " " + $helpDef$$3$$) : $element$$38$$.attr("title", $helpDef$$3$$));
  ...
  $oj$$4$$.$__registerWidget$("oj.editableValue", $$$$4$$.oj.baseComponent, {widgetEventPrefix:"oj", options:{disabled:!1, displayOptions:void 0, help:{definition:null, source:null}, messagesCustom:void 0, messagesHidden:void 0, messagesShown:void 0, required:!1, title:"", validators:void 0, value:void 0}, getNodeBySubId:function($locator$$5$$) {
    ...
    this.$_SaveAllAttributes$($element$$39$$);
  }, $_RestoreAttributes$:function($element$$40$$) {
    this.$_RestoreAllAttributes$($element$$40$$);
  ...
  }, $_HandleChangeEvent$:function($event$$44$$) {
    var $submittedValue$$ = this.$_GetDisplayValue$();
    this.$_SetValue$($submittedValue$$, $event$$44$$);
  }, $_SetRawValue$:function($val$$20$$, $event$$45$$) {
    var $flags$$11$$ = {};
    $flags$$11$$._context = {originalEvent:$event$$45$$, $writeback$:!0, $internalSet$:!0};
  ...
  }, $_SetValue$:function($newValue_parsed$$, $event$$46$$, $options$$130$$) {
    ...
    if ($doValueChangeCheck$$ && $newValue_parsed$$ === this.$_getLastDisplayValue$()) {
      ...
      if ($newValue_parsed$$ = this.$_Validate$($newValue_parsed$$, $event$$46$$, $options$$130$$), void 0 !== $newValue_parsed$$ && this.isValid()) {
        var $updateContext$$;
        $options$$130$$ && $options$$130$$._context && ($updateContext$$ = $options$$130$$._context);
        this.$_updateValueOption$($newValue_parsed$$, $event$$46$$, $options$$130$$ && $options$$130$$.$validationContext$, $updateContext$$);
        return!0;
      }
    }
    return!1;
  }, $_Validate$:function($newValue$$1$$, $event$$47$$, $doNotClearMessages$$1_options$$131$$) {
    ...
    if (void 0 === $newValue$$1$$) {
      ...
      if (this.$_CanSetValue$()) {
        $doNotClearMessages$$1_options$$131$$ || this.$_clearAllMessages$($event$$47$$);
        this.$_setLastSubmittedValue$($newValue$$1$$);
        try {
          return this.$_runNormalValidation$($newValue$$1$$, $mode$$11$$, $context$$36$$, $event$$47$$);
        } catch ($e$$32$$) {
        }
      } else {
    ...
    return "";
  }, $_MESSAGING_CONTENT_UPDATE_TYPE$:{$ALL$:1, $VALIDITY_STATE$:2, $CONVERTER_HINT$:3, $VALIDATOR_HINTS$:4, $TITLE$:5}, $_OPTION_TO_CSS_MAPPING$:{disabled:"oj-disabled", required:"oj-required"}, $_clearAllMessages$:function($event$$48$$, $doNotSetOption$$) {
    $doNotSetOption$$ ? (this.options.messagesHidden = [], this.options.messagesShown = [], this.options.messagesCustom = []) : (this.$_clearMessages$("messagesHidden", $event$$48$$), this.$_clearMessages$("messagesShown", $event$$48$$), this.$_clearMessages$("messagesCustom", $event$$48$$));
  ...
  }, $_setMessagesOption$:function($key$$36$$, $value$$86$$, $event$$49$$, $changed$$1$$) {
    var $flags$$12$$ = {}, $bothEmpty$$ = 0 === $value$$86$$.length && 0 === this.options[$key$$36$$].length;
    if ($changed$$1$$ || !$bothEmpty$$) {
      $flags$$12$$._context = {originalEvent:$event$$49$$, $writeback$:!0, $internalSet$:!0}, $flags$$12$$.changed = $changed$$1$$ || !$bothEmpty$$, this.$_resetValid$(), this.option($key$$36$$, $value$$86$$, $flags$$12$$), this.$_updateMessagingContent$();
    }
  }, $_clearMessages$:function($option$$10$$, $event$$50$$) {
    this.$_setMessagesOption$($option$$10$$, [], $event$$50$$);
  ...
  }, $_updateMessagesOption$:function($option$$11$$, $newMsgs$$, $event$$51$$) {
    ...
    this.$_setMessagesOption$($option$$11$$, $msgs$$1$$, $event$$51$$, !0);
  }, $_updateMessagingContent$:function() {
    this.$_getComponentMessaging$().update(this.$_getMessagingContent$());
  }, $_updateValueOption$:function($newValue$$2$$, $event$$52$$, $validationContext$$, $context$$39_updateContext$$1$$) {
    $context$$39_updateContext$$1$$ = $context$$39_updateContext$$1$$ || {};
    $event$$52$$ && ($context$$39_updateContext$$1$$.originalEvent = $event$$52$$);
  ...
  }, $_runNormalValidation$:function($newMsgs$$2_value$$94$$, $mode$$12$$, $context$$42$$, $event$$53$$) {
    ...
    try {
      ...
      throw $newMsgs$$2_value$$94$$ = this.$_processValidationErrors$($ve$$1$$, $context$$42$$), this.$_updateMessagesOption$("messagesShown", $newMsgs$$2_value$$94$$, $event$$53$$), $ve$$1$$;
    }
    return $newValue$$4$$;
  ...
  }, $_updateElementDisplayValue$:function($modelValue$$1$$, $event$$54$$) {
    ...
    try {
      ...
      $newMsgs$$3$$ = this.$_processValidationErrors$($e$$35$$), this.$_updateMessagesOption$("messagesShown", $newMsgs$$3$$, $event$$54$$);
    }
  ...
  $oj$$4$$.$InlineMessagingStrategy$.prototype.$_refreshInlineMessage$ = function $$oj$$4$$$$InlineMessagingStrategy$$$$_refreshInlineMessage$$() {
    ...
    this.$_doesMessageContentRootDomExist$() || (this.$$messagingContentRoot$ = $$$$4$$("\x3cdiv class\x3d'oj-messaging-inline-container'\x3e\x3c/div\x3e"), this.$_addAriaDescribedBy$(this.$$messagingContentRoot$), $domNode$$2_widget$$3$$.append(this.$$messagingContentRoot$));
  ...
  $oj$$4$$.$InlineMessagingStrategy$.prototype.$_removeMessagingContentRootDom$ = function $$oj$$4$$$$InlineMessagingStrategy$$$$_removeMessagingContentRootDom$$() {
    this.$_doesMessageContentRootDomExist$() && this.$$messagingContentRoot$ && (this.$_removeAriaDescribedBy$(this.$$messagingContentRoot$), this.$$messagingContentRoot$.remove(), this.$$messagingContentRoot$ = null);
  };
  ...
  $oj$$4$$.$InlineMessagingStrategy$.prototype.$_removeAriaDescribedBy$ = function $$oj$$4$$$$InlineMessagingStrategy$$$$_removeAriaDescribedBy$$($index$$87_messagingRoot$$1_messagingRootId$$1$$) {
    var $launcher$$6$$ = this.$GetLauncher$();
    $oj$$4$$.$Assert$.$assertPrototype$($launcher$$6$$, jQuery);
    $oj$$4$$.$Assert$.$assertPrototype$($index$$87_messagingRoot$$1_messagingRootId$$1$$, jQuery);
    $index$$87_messagingRoot$$1_messagingRootId$$1$$ = $index$$87_messagingRoot$$1_messagingRootId$$1$$.attr("id");
    ...
    $index$$87_messagingRoot$$1_messagingRootId$$1$$ = $$$$4$$.inArray($index$$87_messagingRoot$$1_messagingRootId$$1$$, $describedby$$1_tokens$$2$$);
    -1 !== $index$$87_messagingRoot$$1_messagingRootId$$1$$ && $describedby$$1_tokens$$2$$.splice($index$$87_messagingRoot$$1_messagingRootId$$1$$, 1);
