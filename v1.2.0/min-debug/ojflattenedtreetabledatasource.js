...
define(["ojs/ojcore", "jquery", "ojs/ojdatasource-common"], function($oj$$78$$) {
  $oj$$78$$.$FlattenedTreeTableDataSource$ = function $$oj$$78$$$$FlattenedTreeTableDataSource$$($data$$183$$, $options$$404$$) {
    ...
    this.$_data$.$insertRows$ = function $this$$_data$$$insertRows$$($insertAtIndex$$2$$, $i$$482_insertAtKey$$1$$, $nodeSet$$35$$) {
      ...
      for ($i$$482_insertAtKey$$1$$ = 0;$i$$482_insertAtKey$$1$$ < $nodeSet$$35$$.$getCount$();$i$$482_insertAtKey$$1$$++) {
        $row$$51$$ = $nodeSet$$35$$.getData($i$$482_insertAtKey$$1$$), $rowKey$$41$$ = $nodeSet$$35$$.getMetadata($i$$482_insertAtKey$$1$$).key, $rowIdx$$41$$ = $insertAtIndex$$2$$ + $i$$482_insertAtKey$$1$$, $self$$216$$.$_nodeSetList$[$rowIdx$$41$$] = {}, $self$$216$$.$_nodeSetList$[$rowIdx$$41$$].nodeSet = $nodeSet$$35$$, $self$$216$$.$_nodeSetList$[$rowIdx$$41$$].startIndex = $insertAtIndex$$2$$, $rowArray$$14$$.push($row$$51$$), $keyArray$$6$$.push($rowKey$$41$$), $indexArray$$5$$.push($rowIdx$$41$$), 
        $self$$216$$.$_rows$.data.splice($rowIdx$$41$$, 0, $row$$51$$), $self$$216$$.$_rows$.keys.splice($rowIdx$$41$$, 0, $rowKey$$41$$), $self$$216$$.$_rows$.indexes.splice($rowIdx$$41$$, 0, $rowIdx$$41$$);
      }
      $self$$216$$.$_pageSize$ || $oj$$78$$.$TableDataSource$.$superclass$.handleEvent.call($self$$216$$, $oj$$78$$.$TableDataSource$.$EventType$.ADD, {data:$rowArray$$14$$, keys:$keyArray$$6$$, indexes:$indexArray$$5$$});
      $self$$216$$.$_realignRowIndices$();
      $self$$216$$.$_pageSize$ && setTimeout(function() {
        $self$$216$$.fetch();
      }, 0);
    };
    this.$_data$.$removeRows$ = function $this$$_data$$$removeRows$$($rowKeys$$2$$) {
      ...
      for ($i$$483$$ = 0;$i$$483$$ < $rowKeys$$2$$.length;$i$$483$$++) {
        $rowIdx$$42$$ = $rowKeys$$2$$[$i$$483$$].index - $i$$483$$, $rowArray$$15$$.push(""), $keyArray$$7$$.push(""), $indexArray$$6$$.push($rowIdx$$42$$), $self$$216$$.$_rows$.data.splice($rowIdx$$42$$, 1), $self$$216$$.$_rows$.keys.splice($rowIdx$$42$$, 1), $self$$216$$.$_rows$.indexes.splice($rowIdx$$42$$, 1);
      }
      $self$$216$$.$_pageSize$ || $oj$$78$$.$TableDataSource$.$superclass$.handleEvent.call($self$$216$$, $oj$$78$$.$TableDataSource$.$EventType$.REMOVE, {data:$rowArray$$15$$, keys:$keyArray$$7$$, indexes:$indexArray$$6$$});
      $self$$216$$.$_realignRowIndices$();
      $self$$216$$.$_pageSize$ && setTimeout(function() {
        $self$$216$$.fetch();
      }, 0);
  ...
  $oj$$78$$.$FlattenedTreeTableDataSource$.prototype.sort = function $$oj$$78$$$$FlattenedTreeTableDataSource$$$sort$($criteria$$12$$) {
    ...
    return new Promise(function($resolve$$62$$, $reject$$60$$) {
      $self$$218$$.$_data$.getWrappedDataSource().sort($criteria$$12$$, {success:function() {
        setTimeout(function() {
          $self$$218$$.$_data$.refresh();
          $self$$218$$.$_rows$ = null;
          var $result$$79$$ = {header:$criteria$$12$$.key, direction:$criteria$$12$$.direction};
          $oj$$78$$.$TableDataSource$.$superclass$.handleEvent.call($self$$218$$, $oj$$78$$.$TableDataSource$.$EventType$.SORT, $result$$79$$);
          $resolve$$62$$($result$$79$$);
        }, 0);
  ...
  $oj$$78$$.$FlattenedTreeTableDataSource$.prototype.$_fetchInternal$ = function $$oj$$78$$$$FlattenedTreeTableDataSource$$$$_fetchInternal$$($options$$408$$) {
    ...
    if (null != this.$_rows$) {
      if (null != this.$_pageSize$) {
        var $endIndex$$8_result$$80$$ = this.$_rows$.data.length - 1;
        if (this.$_startIndex$ + this.$_pageSize$ - 1 <= $endIndex$$8_result$$80$$) {
          var $endIndex$$8_result$$80$$ = $oj$$78$$.$FlattenedTreeTableDataSource$.$_getEndIndex$(this.$_rows$, this.$_startIndex$, this.$_pageSize$), $rangeCount$$1_rowArray$$16$$ = [], $keyArray$$8_startIndex$$32$$ = [], $i$$484$$;
          for ($i$$484$$ = this.$_startIndex$;$i$$484$$ <= $endIndex$$8_result$$80$$;$i$$484$$++) {
            $rangeCount$$1_rowArray$$16$$[$i$$484$$ - this.$_startIndex$] = this.$_rows$.data[$i$$484$$], $keyArray$$8_startIndex$$32$$[$i$$484$$ - this.$_startIndex$] = "";
          }
          $endIndex$$8_result$$80$$ = {data:$rangeCount$$1_rowArray$$16$$, keys:$keyArray$$8_startIndex$$32$$, startIndex:this.$_startIndex$};
          this.$_endFetch$($options$$408$$, $endIndex$$8_result$$80$$, null);
          return Promise.resolve($endIndex$$8_result$$80$$);
        }
        this.$_startIndex$ <= $endIndex$$8_result$$80$$ && ($keyArray$$8_startIndex$$32$$ = $endIndex$$8_result$$80$$ + 1);
      } else {
        this.$_data$.refresh(), this.$_rows$ = null;
      }
    }
    var $rangeOption$$ = {start:$keyArray$$8_startIndex$$32$$, count:$rangeCount$$1_rowArray$$16$$}, $self$$219$$ = this;
    return new Promise(function($resolve$$63$$, $reject$$61$$) {
      $self$$219$$.$_data$.$fetchRows$($rangeOption$$, {success:function($nodeSet$$37_result$$81$$) {
        $self$$219$$.$_handleFetchRowsSuccess$($nodeSet$$37_result$$81$$);
        $options$$408$$.refresh = !0;
        var $endIndex$$9$$ = $oj$$78$$.$FlattenedTreeTableDataSource$.$_getEndIndex$($self$$219$$.$_rows$, $self$$219$$.$_startIndex$, $self$$219$$.$_pageSize$), $rowArray$$17$$ = [], $keyArray$$9$$ = [], $i$$485$$;
        for ($i$$485$$ = $self$$219$$.$_startIndex$;$i$$485$$ <= $endIndex$$9$$;$i$$485$$++) {
          $rowArray$$17$$[$i$$485$$ - $self$$219$$.$_startIndex$] = $self$$219$$.$_rows$.data[$i$$485$$], $keyArray$$9$$[$i$$485$$ - $self$$219$$.$_startIndex$] = $nodeSet$$37_result$$81$$.getMetadata($i$$485$$).key;
        }
        $nodeSet$$37_result$$81$$ = {data:$rowArray$$17$$, keys:$keyArray$$9$$, startIndex:$self$$219$$.$_startIndex$};
        $self$$219$$.$_endFetch$($options$$408$$, $nodeSet$$37_result$$81$$, null);
        $resolve$$63$$($nodeSet$$37_result$$81$$);
      }.bind(this), error:function($error$$51$$) {
        $self$$219$$.$_endFetch$($options$$408$$, null, $error$$51$$);
        $reject$$61$$($error$$51$$);
      }.bind(this)});
    });
  };
  ...
  $oj$$78$$.$FlattenedTreeTableDataSource$.prototype.$_endFetch$ = function $$oj$$78$$$$FlattenedTreeTableDataSource$$$$_endFetch$$($options$$410$$, $result$$82$$, $error$$52$$) {
    null != $error$$52$$ ? $oj$$78$$.$TableDataSource$.$superclass$.handleEvent.call(this, $oj$$78$$.$TableDataSource$.$EventType$.ERROR, $error$$52$$) : $options$$410$$.silent || $oj$$78$$.$TableDataSource$.$superclass$.handleEvent.call(this, $oj$$78$$.$TableDataSource$.$EventType$.SYNC, $result$$82$$);
  };
  $oj$$78$$.$FlattenedTreeTableDataSource$.$_getEndIndex$ = function $$oj$$78$$$$FlattenedTreeTableDataSource$$$_getEndIndex$$($rows$$8$$, $startIndex$$33$$, $pageSize$$10$$) {
    var $endIndex$$10$$ = $rows$$8$$.data.length - 1;
    0 < $pageSize$$10$$ && ($endIndex$$10$$ = $startIndex$$33$$ + $pageSize$$10$$ - 1, $endIndex$$10$$ = $endIndex$$10$$ > $rows$$8$$.data.length - 1 ? $rows$$8$$.data.length - 1 : $endIndex$$10$$);
    return $endIndex$$10$$;
  };
