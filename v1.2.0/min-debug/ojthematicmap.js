...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojdvt-base", "ojs/internal-deps/dvt/DvtThematicMap"], function($oj$$55$$, $$$$50$$, $comp$$14$$, $base$$13$$, $dvt$$10$$) {
  $oj$$55$$.$__registerWidget$("oj.ojThematicMap", $$$$50$$.oj.dvtBaseComponent, {widgetEventPrefix:"oj", options:{load:null, optionChange:null}, $_currentLocale$:"", $_loadedBasemaps$:[], $_supportedLocales$:{ar:"ar", cs:"cs", da:"da", de:"de", el:"el", es:"es", fi:"fi", fr:"fr", "fr-ca":"fr_CA", he:"iw", hu:"hu", it:"it", ja:"ja", ko:"ko", nl:"nl", no:"no", pl:"pl", pt:"pt_BR", "pt-pt":"pt", ro:"ro", ru:"ru", sk:"sk", sv:"sv", th:"th", tr:"tr", "zh-hans":"zh_CN", "zh-hant":"zh_TW"}, _ComponentCreate:function() {
  ...
  }, $_CreateDvtComponent$:function($context$$152$$, $callback$$119$$, $callbackObj$$13$$) {
    return $dvt$$10$$.DvtThematicMap.newInstance($context$$152$$, $callback$$119$$, $callbackObj$$13$$);
    ...
    var $thisRef$$ = this;
    return function($context$$153_elem$$76$$) {
      var $dummyDiv$$ = document.createElement("div");
      $dummyDiv$$.style.display = "none";
      $dummyDiv$$.$_dvtcontext$ = $thisRef$$.$_context$;
      $thisRef$$.element.append($dummyDiv$$);
      $templateFunction$$({parentElement:$dummyDiv$$, data:$context$$153_elem$$76$$.data});
      return($context$$153_elem$$76$$ = $dummyDiv$$.children[0]) ? "http://www.w3.org/2000/svg" === $context$$153_elem$$76$$.namespaceURI ? ($$$$50$$($dummyDiv$$).remove(), $context$$153_elem$$76$$) : $thisRef$$.$_GetDvtComponent$($context$$153_elem$$76$$) : null;
    };
  ...
  }, renderDefaultHover:function($context$$155$$) {
    $context$$155$$.previousState && $context$$155$$.state.hovered == $context$$155$$.previousState.hovered || this.$_component$.processDefaultHoverEffect($context$$155$$.id, $context$$155$$.state.hovered);
  }, renderDefaultSelection:function($context$$156$$) {
    $context$$156$$.previousState && $context$$156$$.state.selected == $context$$156$$.previousState.selected || this.$_component$.processDefaultSelectionEffect($context$$156$$.id, $context$$156$$.state.selected);
  }, renderDefaultFocus:function($context$$157$$) {
    $context$$157$$.previousState && $context$$157$$.state.focused == $context$$157$$.previousState.focused || this.$_component$.processDefaultFocusEffect($context$$157$$.id, $context$$157$$.state.focused);
  ...
  }, $_HandleEvent$:function($event$$525$$) {
    var $selection$$15$$, $id$$52$$;
    if (($event$$525$$ && $event$$525$$.getType ? $event$$525$$.getType() : null) === $dvt$$10$$.DvtSelectionEvent.TYPE) {
      $selection$$15$$ = {};
      $id$$52$$ = $event$$525$$.getParamValue("clientId");
      $selection$$15$$[$id$$52$$] = $event$$525$$.getSelection();
      if (this.options.selection) {
        for (var $dataLayerId$$ in this.options.selection) {
          $id$$52$$ !== $dataLayerId$$ && ($selection$$15$$[$dataLayerId$$] = this.options.selection[$dataLayerId$$]);
        }
      }
      this.$_UserOptionChange$("selection", $selection$$15$$);
    } else {
      this._super($event$$525$$);
    }
    ...
    return $ret$$58$$;
  }, getContextByNode:function($context$$158_node$$106$$) {
    return($context$$158_node$$106$$ = this.getSubIdByNode($context$$158_node$$106$$)) && "oj-thematicmap-tooltip" !== $context$$158_node$$106$$.subId ? $context$$158_node$$106$$ : null;
