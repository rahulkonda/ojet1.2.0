...
define(["ojs/ojcore", "jquery", "ojs/ojeditablevalue"], function($oj$$52$$, $$$$47$$) {
  $oj$$52$$.$__registerWidget$("oj._ojRadioCheckbox", $$$$47$$.oj.baseComponent, {version:"1.0.0", defaultElement:"\x3cinput\x3e", widgetEventPrefix:"oj", options:{disabled:null, checked:null, type:null}, label:function() {
    ...
    this._super();
    var $type$$97$$ = this.options.type;
    "checkbox" == $type$$97$$ ? (this.$uiRadioCheckbox$ = this.element.addClass("oj-checkbox oj-component"), this.$$label$ = this.$_getLabelsForElement$(), this.$$label$.addClass("oj-checkbox-label")) : "radio" == $type$$97$$ && (this.$uiRadioCheckbox$ = this.element.addClass("oj-radio oj-component"), this.$$label$ = this.$_getLabelsForElement$(), this.$$label$.addClass("oj-radio-label"));
    ...
    this.$_setup$();
  }, $_SaveAttributes$:function($element$$137$$) {
    this.$_savedClasses$ = $element$$137$$.attr("class");
  ...
  }, _setOption:function($key$$152$$, $value$$277$$) {
    this._superApply(arguments);
    "disabled" === $key$$152$$ && ($value$$277$$ = !!$value$$277$$, this.$_renderDisabled$($value$$277$$));
    "checked" === $key$$152$$ && (this.$_setCheckedOnDom$($value$$277$$), this.element.toggleClass("oj-selected", $value$$277$$), this.$$label$.toggleClass("oj-selected", $value$$277$$), this.$$choiceRow$ && this.$$choiceRow$.toggleClass("oj-selected", $value$$277$$));
    ...
    var $node$$104$$ = this._super($locator$$54_subId$$58$$);
    $node$$104$$ || ($locator$$54_subId$$58$$ = $locator$$54_subId$$58$$.subId, "oj-radiocheckbox-input" === $locator$$54_subId$$58$$ && ($node$$104$$ = this.element[0]), "oj-radiocheckbox-label" === $locator$$54_subId$$58$$ && ($node$$104$$ = this.label()[0]));
    return $node$$104$$ || null;
  }, _destroy:function() {
    var $ret$$55$$ = this._super(), $type$$98$$ = this.options.type;
    "checkbox" == $type$$98$$ ? this.$$label$.removeClass("oj-enabled oj-disabled oj-selected oj-checkbox-label") : "radio" == $type$$98$$ && this.$$label$.removeClass("oj-enabled oj-disabled oj-selected oj-radio-label");
