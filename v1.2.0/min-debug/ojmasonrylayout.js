...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojdnd"], function($oj$$66$$, $$$$61$$) {
  function $MasonryLayoutCommon$$($elem$$80$$, $rtl$$4_sizeDivWrapper$$, $automationEnabled_style$$9$$, $selectors$$8_sizeDiv$$, $styles$$2$$, $callbackInfo$$) {
    ...
    var $self$$194$$ = this;
    this.$_handleTransitionEndFunc$ = function $this$$_handleTransitionEndFunc$$($event$$579$$) {
      $self$$194$$.$_handleTransitionEnd$($event$$579$$);
    };
    this.$_hideTilesFunc$ = function $this$$_hideTilesFunc$$() {
      $self$$194$$.$_hideTiles$();
    };
    this.$_handleHideTransitionEndFunc$ = function $this$$_handleHideTransitionEndFunc$$($event$$580$$) {
      $self$$194$$.$_handleHideTransitionEnd$($event$$580$$);
    };
    this.$_handleShowTransitionEndFunc$ = function $this$$_handleShowTransitionEndFunc$$($event$$581$$) {
      $self$$194$$.$_handleShowTransitionEnd$($event$$581$$);
    };
  }
  (function() {
    ...
    $oj$$66$$.$__registerWidget$("oj.ojMasonryLayout", $$$$61$$.oj.baseComponent, {defaultElement:"\x3cdiv\x3e", widgetEventPrefix:"oj", options:{reorderHandle:null, beforeInsert:null, insert:null, beforeRemove:null, remove:null, beforeResize:null, resize:null, beforeReorder:null, reorder:null}, _ComponentCreate:function() {
      ...
      this._super();
      this.$_needsSetup$ && this.$_setup$(this.$_needsSetup$[0]);
    }, $_NotifyContextMenuGesture$:function($menu$$21$$, $event$$582$$, $eventType$$51$$) {
      this.$_prepareContextMenuBeforeOpen$($event$$582$$);
      this.$_OpenContextMenu$($event$$582$$, $eventType$$51$$, {launcher:$$$$61$$($event$$582$$.target).closest(":tabbable")});
      ...
      if (this.$_canCalculateSizes$()) {
        ...
        if ($isInit$$) {
          ...
          this.$_handleDragStartFunc$ = function $this$$_handleDragStartFunc$$($event$$583$$) {
            $self$$195$$.$_handleDragStart$($event$$583$$);
          };
          this.$_handleDragEnterFunc$ = function $this$$_handleDragEnterFunc$$($event$$584$$) {
            $self$$195$$.$_handleDragEnter$($event$$584$$);
          };
          this.$_handleDragOverFunc$ = function $this$$_handleDragOverFunc$$($event$$585$$) {
            $self$$195$$.$_handleDragOver$($event$$585$$);
          };
          this.$_handleDragLeaveFunc$ = function $this$$_handleDragLeaveFunc$$($event$$586$$) {
            $self$$195$$.$_handleDragLeave$($event$$586$$);
          };
          this.$_handleDragEndFunc$ = function $this$$_handleDragEndFunc$$($event$$587$$) {
            $self$$195$$.$_handleDragEnd$($event$$587$$);
          };
          this.$_handleDropFunc$ = function $this$$_handleDropFunc$$($event$$588$$) {
            $self$$195$$.$_handleDrop$($event$$588$$);
          };
      ...
      this._super();
    }, _setOption:function($key$$178$$, $value$$287$$, $flags$$53$$) {
      ...
      this._super($key$$178$$, $value$$287$$, $flags$$53$$);
      ...
      if (this.$_menu$ && this.$_menu$.$usermenu$ && this.options.reorderHandle) {
        var $$menuContainer$$2$$ = this.$_menu$.$$container$, $self$$196$$ = this;
        ...
        $$menuContainer$$2$$.find("[data-oj-command]").each(function() {
          if (0 === $$$$61$$(this).children("a").length) {
            ...
            $$$$61$$(this).replaceWith($self$$196$$.$_buildContextMenuItem$($command$$14$$));
    ...
    }, $_prepareContextMenuBeforeOpen$:function($e$$133_tile$$5$$) {
      $e$$133_tile$$5$$ = $_findContainingTile$$($e$$133_tile$$5$$.originalEvent.target, this.element[0]);
      this.$_menu$.tile = $e$$133_tile$$5$$;
      if (this.$_menu$.$usermenu$) {
        ...
        if ($elemCut_elemPasteAfter_elemPasteBefore$$) {
          ...
          $cutTile$$ && $e$$133_tile$$5$$ === $cutTile$$ && ($bDisable$$ = !0);
        ...
        if ($elemCut_elemPasteAfter_elemPasteBefore$$ = this.$_menu$.$$elemPasteAfter$) {
          $cutDisabled_pasteAfterDisabled_pasteBeforeDisabled$$ = $elemCut_elemPasteAfter_elemPasteBefore$$.hasClass($_OJ_DISABLED$$), $bDisable$$ = !1, $cutTile$$ && $cutTile$$ !== $e$$133_tile$$5$$ && $cutTile$$ !== $_getNextElement$$($e$$133_tile$$5$$) || ($bDisable$$ = !0), $bDisable$$ && !$cutDisabled_pasteAfterDisabled_pasteBeforeDisabled$$ ? ($elemCut_elemPasteAfter_elemPasteBefore$$.addClass($_OJ_DISABLED$$), $bRefreshMenu$$ = !0) : !$bDisable$$ && $cutDisabled_pasteAfterDisabled_pasteBeforeDisabled$$ && 
          ($elemCut_elemPasteAfter_elemPasteBefore$$.removeClass($_OJ_DISABLED$$), $bRefreshMenu$$ = !0);
        }
        $bRefreshMenu$$ && this.$_menu$.$$container$.ojMenu("refresh");
      }
    }, $_buildContextMenuItem$:function($cmd$$5_transKey$$) {
      var $id$$61$$ = $_MENU_CMD_MAP$$[$cmd$$5_transKey$$];
      ...
      $label$$15$$.wrap("\x3cli id\x3d" + $id$$61$$ + "\x3e\x3c/li\x3e");
    ...
    }, $_handleContextMenuSelect$:function($ev$$8$$, $ui$$48$$) {
      var $id$$62$$ = $ui$$48$$ ? $ui$$48$$.item.attr("id") : void 0;
      $id$$62$$ === $_OJMASONRYLAYOUTCUT$$ ? this.$_menuCut$(this.$_menu$.tile) : $id$$62$$ === $_OJMASONRYLAYOUTPASTEBEFORE$$ ? this.$_menuPaste$(this.$_menu$.tile, !0) : $id$$62$$ === $_OJMASONRYLAYOUTPASTEAFTER$$ && this.$_menuPaste$(this.$_menu$.tile, !1);
    ...
    }, $_handleDragStart$:function($event$$589_originalEvent$$5$$) {
      if (this.options.reorderHandle && !this.$_bDragging$) {
        var $tile$$7$$ = $_findContainingTile$$($event$$589_originalEvent$$5$$.target, this.element[0]);
        if ($tile$$7$$) {
          ...
          !1 !== this._trigger("beforeReorder", null, $eventData$$28_index$$273$$) && ($event$$589_originalEvent$$5$$ = $event$$589_originalEvent$$5$$.originalEvent, this.$_dragStart$($tile$$7$$, $event$$589_originalEvent$$5$$.pageX, $event$$589_originalEvent$$5$$.pageY, $event$$589_originalEvent$$5$$.dataTransfer));
        }
      }
    }, $_handleDragEnter$:function($event$$590_originalEvent$$6$$) {
      $event$$590_originalEvent$$6$$ = $event$$590_originalEvent$$6$$.originalEvent;
      var $elemUnderPoint_relatedTarget$$ = $event$$590_originalEvent$$6$$.relatedTarget, $elem$$100$$ = this.element[0], $enteringMasonryLayout$$ = !1;
      $elemUnderPoint_relatedTarget$$ ? $enteringMasonryLayout$$ = $elem$$100$$ != $elemUnderPoint_relatedTarget$$ && !$oj$$66$$.$DomUtils$.$isAncestor$($elem$$100$$, $elemUnderPoint_relatedTarget$$) : this.$_dragLeftMasonryLayout$ && ($enteringMasonryLayout$$ = ($elemUnderPoint_relatedTarget$$ = document.elementFromPoint($event$$590_originalEvent$$6$$.clientX, $event$$590_originalEvent$$6$$.clientY)) && ($elemUnderPoint_relatedTarget$$ == $elem$$100$$ || $oj$$66$$.$DomUtils$.$isAncestor$($elem$$100$$, 
      $elemUnderPoint_relatedTarget$$)));
      $enteringMasonryLayout$$ && ((this.$_dragLeftMasonryLayout$ = !1, this.$_draggedTile$) ? this.$_dropSite$ && ($$$$61$$(this.$_dropSite$).css("display", ""), this.$_mlCommon$.$setup$(!1, !0)) : $event$$590_originalEvent$$6$$.dataTransfer.dropEffect = "none");
    }, $_handleDragOver$:function($event$$591$$) {
      var $originalEvent$$7$$ = $event$$591$$.originalEvent;
      ...
      return!1;
    }, $_handleDragLeave$:function($elem$$101_event$$592$$) {
      var $elemUnderPoint$$1_originalEvent$$8$$ = $elem$$101_event$$592$$.originalEvent, $relatedTarget$$1$$ = $elemUnderPoint$$1_originalEvent$$8$$.relatedTarget;
      $elem$$101_event$$592$$ = this.element[0];
      var $leavingMasonryLayout$$ = !1;
      $leavingMasonryLayout$$ = $relatedTarget$$1$$ ? $elem$$101_event$$592$$ != $relatedTarget$$1$$ && !$oj$$66$$.$DomUtils$.$isAncestor$($elem$$101_event$$592$$, $relatedTarget$$1$$) : ($elemUnderPoint$$1_originalEvent$$8$$ = document.elementFromPoint($elemUnderPoint$$1_originalEvent$$8$$.clientX, $elemUnderPoint$$1_originalEvent$$8$$.clientY)) && $elemUnderPoint$$1_originalEvent$$8$$ != $elem$$101_event$$592$$ && !$oj$$66$$.$DomUtils$.$isAncestor$($elem$$101_event$$592$$, $elemUnderPoint$$1_originalEvent$$8$$);
    ...
    }, $_handleDrop$:function($event$$594$$) {
      ...
      this.$_dragStartHideTileTimeout$ = setTimeout(function() {
        $self$$197$$.$_bDragStartTileHidden$ = !0;
        $tileStyle$$.display = $_NONE$$;
        $$$$61$$($tile$$8$$).removeClass("oj-drag");
        $self$$197$$.$_dragStartHideTileTimeout$ = null;
    ...
    }, getSubIdByNode:function($node$$159$$) {
      return this._super($node$$159$$);
    }});
  ...
  $MasonryLayoutCommon$$.$_addBubbleEventListener$ = function $$MasonryLayoutCommon$$$$_addBubbleEventListener$$($node$$160$$, $type$$104$$, $listener$$40$$) {
    $node$$160$$.addEventListener ? $node$$160$$.addEventListener($type$$104$$, $listener$$40$$, !1) : $node$$160$$.attachEvent && $node$$160$$.attachEvent("on" + $type$$104$$, $listener$$40$$);
  };
  $MasonryLayoutCommon$$.$_removeBubbleEventListener$ = function $$MasonryLayoutCommon$$$$_removeBubbleEventListener$$($node$$161$$, $type$$105$$, $listener$$41$$) {
    $node$$161$$.removeEventListener ? $node$$161$$.removeEventListener($type$$105$$, $listener$$41$$, !1) : $node$$161$$.detachEvent && $node$$161$$.detachEvent("on" + $type$$105$$, $listener$$41$$);
  };
  $MasonryLayoutCommon$$.$_arrayIndexOf$ = function $$MasonryLayoutCommon$$$$_arrayIndexOf$$($array$$17$$, $item$$122$$) {
    if ($array$$17$$) {
      for (var $i$$433$$ = 0;$i$$433$$ < $array$$17$$.length;$i$$433$$++) {
        if ($array$$17$$[$i$$433$$] == $item$$122$$) {
          return $i$$433$$;
        }
      }
    }
  ...
  $MasonryLayoutCommon$$.prototype.$_handleTransitionEnd$ = function $$MasonryLayoutCommon$$$$$_handleTransitionEnd$$($event$$595_i$$441$$) {
    var $arInfoletsToResize$$2_doneTransitioning$$ = !0;
    if (this.$_arMovedInfolets$) {
      var $arMovedInfolets$$1$$ = this.$_arMovedInfolets$;
      if ($event$$595_i$$441$$) {
        var $target$$97$$ = $event$$595_i$$441$$.target;
        for ($event$$595_i$$441$$ = 0;$event$$595_i$$441$$ < $arMovedInfolets$$1$$.length;$event$$595_i$$441$$++) {
          if ($target$$97$$ === $arMovedInfolets$$1$$[$event$$595_i$$441$$]) {
            $arMovedInfolets$$1$$.splice($event$$595_i$$441$$, 1);
            break;
          }
        }
      } else {
    ...
    if ($arInfoletsToResize$$2_doneTransitioning$$) {
      if (this.$_arInfoletsToResize$ && ($arInfoletsToResize$$2_doneTransitioning$$ = this.$_arInfoletsToResize$, this.$_arInfoletsToResize$ = null, this.$isAnimationEnabled$())) {
        for ($event$$595_i$$441$$ = 0;$event$$595_i$$441$$ < $arInfoletsToResize$$2_doneTransitioning$$.length;$event$$595_i$$441$$ += 2) {
          this.$_removeStyleClassNameFunc$($arInfoletsToResize$$2_doneTransitioning$$[$event$$595_i$$441$$], this.$_transitionResizeToStyleClass$);
        }
      }
    ...
    if (this.$_arInfoletsToHide$ && this.$isAnimationEnabled$()) {
      ...
      this.$_hideTilesInternalTimeout$ = setTimeout(function() {
        for (var $i$$443$$ = 0;$i$$443$$ < $arInfoletsToHide$$1$$.length;$i$$443$$++) {
          ...
          $self$$199$$.$_removeStyleClassNameFunc$($infolet$$6$$, $self$$199$$.$_transitionHideFromStyleClass$);
          $self$$199$$.$_addStyleClassNameFunc$($infolet$$6$$, $self$$199$$.$_transitionHideToStyleClass$);
        }
      }, 0);
    } else {
  ...
  $MasonryLayoutCommon$$.prototype.$_handleHideTransitionEnd$ = function $$MasonryLayoutCommon$$$$$_handleHideTransitionEnd$$($event$$596_infolet$$7$$) {
    this.$_hideTilesInternalTimeout$ && (clearTimeout(this.$_hideTilesInternalTimeout$), this.$_hideTilesInternalTimeout$ = null);
    if ($event$$596_infolet$$7$$) {
      $event$$596_infolet$$7$$.preventDefault();
      $event$$596_infolet$$7$$.stopPropagation();
      $event$$596_infolet$$7$$ = $event$$596_infolet$$7$$.target;
      this.$_removeStyleClassNameFunc$($event$$596_infolet$$7$$, this.$_transitionHideToStyleClass$);
      $MasonryLayoutCommon$$.$_removeBubbleEventListener$($event$$596_infolet$$7$$, "transitionend", this.$_handleHideTransitionEndFunc$);
      $MasonryLayoutCommon$$.$_removeBubbleEventListener$($event$$596_infolet$$7$$, "webkitTransitionEnd", this.$_handleHideTransitionEndFunc$);
      ...
      if ($arInfoletsToHide$$2_newSizeStyleClass_style$$20$$) {
        for (var $i$$444$$ = 0;$i$$444$$ < $arInfoletsToHide$$2_newSizeStyleClass_style$$20$$.length;$i$$444$$++) {
          ...
          if ($oldSizeStyleClass$$1_tmpInfolet$$ === $event$$596_infolet$$7$$) {
            ...
            $arFireHideOnEnd_arInfoletsToResize$$3$$.push($event$$596_infolet$$7$$);
            break;
          }
        }
    ...
    if (!this.$_arInfoletsToHide$) {
      if (this.$_arFireHideOnEnd$) {
        ...
        for ($i$$444$$ = 0;$i$$444$$ < $arFireHideOnEnd_arInfoletsToResize$$3$$.length;$i$$444$$++) {
          $event$$596_infolet$$7$$ = $arFireHideOnEnd_arInfoletsToResize$$3$$[$i$$444$$], this.$isAnimationEnabled$() && this.$_removeStyleClassNameFunc$($event$$596_infolet$$7$$, this.$_transitionHideToStyleClass$), $arInfoletsToHide$$2_newSizeStyleClass_style$$20$$ = $event$$596_infolet$$7$$.style, this.$_rtl$ ? $arInfoletsToHide$$2_newSizeStyleClass_style$$20$$.right = "" : $arInfoletsToHide$$2_newSizeStyleClass_style$$20$$.left = "", $arInfoletsToHide$$2_newSizeStyleClass_style$$20$$.top = "", 
          this.$_hideTileOnEndFunc$ && this.$_hideTileOnEndFunc$($event$$596_infolet$$7$$);
        }
      ...
      if (this.$_arInfoletsToResize$) {
        for ($arFireHideOnEnd_arInfoletsToResize$$3$$ = this.$_arInfoletsToResize$, $i$$444$$ = 0;$i$$444$$ < $arFireHideOnEnd_arInfoletsToResize$$3$$.length;$i$$444$$ += 2) {
          $event$$596_infolet$$7$$ = $arFireHideOnEnd_arInfoletsToResize$$3$$[$i$$444$$], $arInfoletsToHide$$2_newSizeStyleClass_style$$20$$ = $arFireHideOnEnd_arInfoletsToResize$$3$$[$i$$444$$ + 1], $oldSizeStyleClass$$1_tmpInfolet$$ = this.$_getSizeStyleClassNameFunc$($event$$596_infolet$$7$$), this.$_removeStyleClassNameFunc$($event$$596_infolet$$7$$, $oldSizeStyleClass$$1_tmpInfolet$$), this.$_addStyleClassNameFunc$($event$$596_infolet$$7$$, $arInfoletsToHide$$2_newSizeStyleClass_style$$20$$), 
          this.$isAnimationEnabled$() && (this.$_addStyleClassNameFunc$($event$$596_infolet$$7$$, this.$_transitionResizeToStyleClass$), $event$$596_infolet$$7$$.$_afrOldSizeStyleClass$ = $oldSizeStyleClass$$1_tmpInfolet$$);
        }
      }
  ...
  $MasonryLayoutCommon$$.prototype.$_handleShowTransitionEnd$ = function $$MasonryLayoutCommon$$$$$_handleShowTransitionEnd$$($event$$597_infolet$$9$$) {
    if ($event$$597_infolet$$9$$) {
      $event$$597_infolet$$9$$.preventDefault();
      $event$$597_infolet$$9$$.stopPropagation();
      $event$$597_infolet$$9$$ = $event$$597_infolet$$9$$.target;
      this.$_removeStyleClassNameFunc$($event$$597_infolet$$9$$, this.$_transitionShowToStyleClass$);
      $MasonryLayoutCommon$$.$_removeBubbleEventListener$($event$$597_infolet$$9$$, "transitionend", this.$_handleShowTransitionEndFunc$);
      $MasonryLayoutCommon$$.$_removeBubbleEventListener$($event$$597_infolet$$9$$, "webkitTransitionEnd", this.$_handleShowTransitionEndFunc$);
      ...
      if ($arInfoletsToShow$$2$$) {
        for (var $i$$446$$ = 0;$i$$446$$ < $arInfoletsToShow$$2$$.length;$i$$446$$++) {
          ...
          if ($tmpInfolet$$1$$ === $event$$597_infolet$$9$$) {
            $arInfoletsToShow$$2$$.splice($i$$446$$, 1);
            this.$_showTileOnEndFunc$ && this.$_showTileOnEndFunc$($event$$597_infolet$$9$$);
            break;
          }
        }
