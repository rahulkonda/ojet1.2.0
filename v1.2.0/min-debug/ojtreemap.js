...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojdvt-base", "ojs/internal-deps/dvt/DvtTreemap"], function($oj$$41$$, $$$$38$$, $comp$$11$$, $base$$10$$, $dvt$$7$$) {
  $oj$$41$$.$__registerWidget$("oj.ojTreemap", $$$$38$$.oj.dvtBaseComponent, {widgetEventPrefix:"oj", options:{optionChange:null}, $_CreateDvtComponent$:function($context$$125$$, $callback$$113$$, $callbackObj$$9$$) {
    return $dvt$$7$$.DvtTreemap.newInstance($context$$125$$, $callback$$113$$, $callbackObj$$9$$);
    ...
    return $ret$$42$$;
  }, $_HandleEvent$:function($event$$463_isolatedNode$$) {
    var $isolatedNodes_type$$93$$ = $event$$463_isolatedNode$$ && $event$$463_isolatedNode$$.getType ? $event$$463_isolatedNode$$.getType() : null;
    $isolatedNodes_type$$93$$ === $dvt$$7$$.DvtSelectionEvent.TYPE ? this.$_UserOptionChange$("selection", $event$$463_isolatedNode$$.getSelection()) : $isolatedNodes_type$$93$$ === $dvt$$7$$.DvtTreemapIsolateEvent.TYPE ? ($isolatedNodes_type$$93$$ = this.options.$_isolatedNodes$, $isolatedNodes_type$$93$$ || (this.options.$_isolatedNodes$ = [], $isolatedNodes_type$$93$$ = this.options.$_isolatedNodes$), ($event$$463_isolatedNode$$ = $event$$463_isolatedNode$$.getId()) ? ($isolatedNodes_type$$93$$.push($event$$463_isolatedNode$$), 
    this.$_UserOptionChange$("isolatedNode", $event$$463_isolatedNode$$)) : ($isolatedNodes_type$$93$$.pop(), this.$_UserOptionChange$("isolatedNode", 0 < $isolatedNodes_type$$93$$.length ? $isolatedNodes_type$$93$$[$isolatedNodes_type$$93$$.length] : null))) : this._super($event$$463_isolatedNode$$);
  ...
  }, getContextByNode:function($context$$126_node$$91$$) {
    return($context$$126_node$$91$$ = this.getSubIdByNode($context$$126_node$$91$$)) && "oj-treemap-tooltip" !== $context$$126_node$$91$$.subId ? $context$$126_node$$91$$ : null;
