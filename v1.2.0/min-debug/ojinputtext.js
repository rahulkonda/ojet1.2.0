...
define(["ojs/ojcore", "jquery", "ojs/ojeditablevalue"], function($oj$$5$$, $$$$5$$) {
  ...
  _INPUT_HELPER_KEY:"", $_BLUR_HANDLER_KEY$:"blur", $_KEYDOWN_HANDLER_KEY$:"keydown", $_INPUT_HANDLER_KEY$:"input", $_DROP_HANDLER_KEY$:"drop", options:{converter:void 0, placeholder:void 0, rawValue:void 0, readOnly:!1}, $_SaveAttributes$:function($element$$41$$) {
  ...
  }, $_onBlurHandler$:function __onBlurHandler($event$$55$$) {
    this.$_SetValue$(this.$_GetDisplayValue$(), $event$$55$$);
  }, $_onKeyDownHandler$:function __onKeyDownHandler($event$$56$$) {
    $event$$56$$.keyCode === $$$$5$$.ui.keyCode.ENTER && this.$_SetValue$(this.$_GetDisplayValue$(), $event$$56$$);
  }, $_onInputHandler$:function __onInputHandler($event$$57$$) {
    this.$_SetRawValue$(this.$_GetContentElement$().val(), $event$$57$$);
