...
define(["ojs/ojcore", "jquery", "ojs/ojdatasource-common"], function($oj$$61$$) {
  ...
  $oj$$61$$.$PagingTableDataSource$.prototype.setPage = function $$oj$$61$$$$PagingTableDataSource$$$setPage$($value$$284$$, $options$$337$$) {
    $options$$337$$ = $options$$337$$ || {};
    $value$$284$$ = parseInt($value$$284$$, 10);
    try {
      $oj$$61$$.$PagingTableDataSource$.$superclass$.handleEvent.call(this, $oj$$61$$.$PagingModel$.$EventType$.BEFOREPAGE, {page:$value$$284$$, previousPage:this.$_getPageFromStartIndex$()});
    } catch ($err$$23$$) {
    ...
    $options$$337$$.startIndex = $value$$284$$ * this.$_pageSize$;
    this.$_startIndex$ = null == $options$$337$$.startIndex ? this.$_startIndex$ : $options$$337$$.startIndex;
    this.$_fetchType$ = "page";
    var $self$$181$$ = this;
    return new Promise(function($resolve$$47$$, $reject$$45$$) {
      0 < $self$$181$$.$_pageSize$ ? $self$$181$$.$dataSource$.fetch($options$$337$$).then(function($result$$65$$) {
        $result$$65$$.startIndex = 0;
        $self$$181$$.$_updateEndIndex$();
        $oj$$61$$.$PagingTableDataSource$.$superclass$.handleEvent.call($self$$181$$, $oj$$61$$.$PagingModel$.$EventType$.PAGE, {page:$self$$181$$.$_getPageFromStartIndex$(), previousPage:$previousPage$$1$$});
        $resolve$$47$$(null);
      }, function() {
        $self$$181$$.$_startIndex$ = $previousPage$$1$$ * $self$$181$$.$_pageSize$;
        $reject$$45$$(null);
      }) : $resolve$$47$$(null);
    });
  };
  ...
  $oj$$61$$.$PagingTableDataSource$.prototype.fetch = function $$oj$$61$$$$PagingTableDataSource$$$fetch$($options$$339$$) {
    ...
    var $pageSize$$6$$ = null != $options$$339$$.pageSize ? $options$$339$$.pageSize : this.$_pageSize$;
    $options$$339$$.pageSize = $pageSize$$6$$;
    $options$$339$$.startIndex = this.$_startIndex$;
    var $self$$182$$ = this;
    return new Promise(function($resolve$$48$$, $reject$$46$$) {
      0 < $pageSize$$6$$ ? $self$$182$$.$dataSource$.fetch($options$$339$$).then(function($result$$66$$) {
        $self$$182$$.$_updateEndIndex$();
        $resolve$$48$$($result$$66$$);
      }, function($e$$100$$) {
        $reject$$46$$($e$$100$$);
      }) : $resolve$$48$$(null);
    });
  ...
  $oj$$61$$.$PagingTableDataSource$.prototype.get = function $$oj$$61$$$$PagingTableDataSource$$$get$($id$$54$$, $options$$340$$) {
    return this.$dataSource$.get($id$$54$$, $options$$340$$);
  };
  ...
  $oj$$61$$.$PagingTableDataSource$.prototype.on = function $$oj$$61$$$$PagingTableDataSource$$$on$($eventType$$47$$, $eventHandler$$3$$) {
    var $self$$183$$ = this, $dataSource$$4$$ = this.$dataSource$;
    if ($eventType$$47$$ == $oj$$61$$.$TableDataSource$.$EventType$.SYNC) {
      var $ev$$4$$ = function $$ev$$4$$$($event$$542$$) {
        $self$$183$$.$_handleSyncEvent$($event$$542$$, $eventHandler$$3$$);
      };
    ...
    if ($eventType$$47$$ == $oj$$61$$.$TableDataSource$.$EventType$.ADD || $eventType$$47$$ == $oj$$61$$.$TableDataSource$.$EventType$.REMOVE || $eventType$$47$$ == $oj$$61$$.$TableDataSource$.$EventType$.CHANGE) {
      return $ev$$4$$ = function $$ev$$4$$$($event$$543$$) {
        $self$$183$$.$_handleRowEvent$($event$$543$$, $eventHandler$$3$$);
    ...
    if ($eventType$$47$$ == $oj$$61$$.$TableDataSource$.$EventType$.REFRESH || $eventType$$47$$ == $oj$$61$$.$TableDataSource$.$EventType$.RESET) {
      return $ev$$4$$ = function $$ev$$4$$$($event$$544$$) {
        $self$$183$$.$_startIndex$ = 0;
        $eventHandler$$3$$($event$$544$$);
      }, $dataSource$$4$$.on($eventType$$47$$, $ev$$4$$), $ev$$4$$;
    }
  ...
  $oj$$61$$.$PagingTableDataSource$.prototype.$_handleRowEvent$ = function $$oj$$61$$$$PagingTableDataSource$$$$_handleRowEvent$$($event$$545$$, $eventHandler$$5$$) {
    var $ignoreRows$$ = [], $i$$381$$;
    for ($i$$381$$ = 0;$i$$381$$ < $event$$545$$.indexes.length;$i$$381$$++) {
      var $rowIdx$$40$$ = $event$$545$$.indexes[$i$$381$$];
      void 0 !== $rowIdx$$40$$ && ($rowIdx$$40$$ -= this.$_startIndex$, (0 > $rowIdx$$40$$ || $rowIdx$$40$$ >= this.$_startIndex$ + this.$_pageSize$) && $ignoreRows$$.push($i$$381$$));
    }
    if (0 < $ignoreRows$$.length) {
      for ($ignoreRows$$.sort(function($a$$115$$, $b$$73$$) {
        return $a$$115$$ - $b$$73$$;
      }), $i$$381$$ = $ignoreRows$$.length - 1;0 <= $i$$381$$;$i$$381$$--) {
        $event$$545$$.data.splice($ignoreRows$$[$i$$381$$], 1), $event$$545$$.indexes.splice($ignoreRows$$[$i$$381$$], 1), $event$$545$$.keys.splice($ignoreRows$$[$i$$381$$], 1);
      }
    }
    this.$_updateEndIndex$();
    $event$$545$$.startIndex = this.$_startIndex$;
    $eventHandler$$5$$($event$$545$$);
  };
  $oj$$61$$.$PagingTableDataSource$.prototype.$_handleSyncEvent$ = function $$oj$$61$$$$PagingTableDataSource$$$$_handleSyncEvent$$($event$$546$$, $eventHandler$$6$$) {
    $event$$546$$.startIndex != this.$_startIndex$ && (this.$_startIndex$ = $event$$546$$.startIndex);
    this.$_updateEndIndex$();
    if ("page" == this.$_fetchType$) {
      var $clonedEvent$$ = {};
      $oj$$61$$.$CollectionUtils$.$copyInto$($clonedEvent$$, $event$$546$$);
      $clonedEvent$$.startIndex = 0;
      $eventHandler$$6$$($clonedEvent$$);
    } else {
      $eventHandler$$6$$($event$$546$$);
    }
  };
  $oj$$61$$.$PagingTableDataSource$.prototype.$_updateEndIndex$ = function $$oj$$61$$$$PagingTableDataSource$$$$_updateEndIndex$$() {
