...
define(["ojs/ojcore", "knockout", "ojs/ojmodel"], function($oj$$74$$, $ko$$9$$) {
  ...
  $oj$$74$$.$KnockoutUtils$.map = function $$oj$$74$$$$KnockoutUtils$$map$($m$$26$$, $callback$$132$$, $array$$18_data$$180_updateObservable_updateObservableArrayRemove$$) {
    ...
    if ($m$$26$$ instanceof $oj$$74$$.$Collection$) {
      ...
      if ($array$$18_data$$180_updateObservable_updateObservableArrayRemove$$) {
        for ($i$$461_prealloc_prop$$74_updateCollection_updateObservableArrayAdd$$ = 0;$i$$461_prealloc_prop$$74_updateCollection_updateObservableArrayAdd$$ < $m$$26$$.$_modelIndices$.length;$i$$461_prealloc_prop$$74_updateCollection_updateObservableArrayAdd$$++) {
          $converted_index$$285_updateObservableArrayReset$$ = $m$$26$$.$_modelIndices$[$i$$461_prealloc_prop$$74_updateCollection_updateObservableArrayAdd$$], $koObject$$()[$converted_index$$285_updateObservableArrayReset$$] = $oj$$74$$.$KnockoutUtils$.map($m$$26$$.$_atInternal$($converted_index$$285_updateObservableArrayReset$$, null, !0, !1), $callback$$132$$);
        }
      } else {
        for ($i$$461_prealloc_prop$$74_updateCollection_updateObservableArrayAdd$$ = 0;$i$$461_prealloc_prop$$74_updateCollection_updateObservableArrayAdd$$ < $m$$26$$.$_modelIndices$.length;$i$$461_prealloc_prop$$74_updateCollection_updateObservableArrayAdd$$++) {
          $converted_index$$285_updateObservableArrayReset$$ = $m$$26$$.$_modelIndices$[$i$$461_prealloc_prop$$74_updateCollection_updateObservableArrayAdd$$], $koObject$$[$converted_index$$285_updateObservableArrayReset$$] = $oj$$74$$.$KnockoutUtils$.map($m$$26$$.$_atInternal$($converted_index$$285_updateObservableArrayReset$$, null, !0, !1), $callback$$132$$);
      ...
      $i$$461_prealloc_prop$$74_updateCollection_updateObservableArrayAdd$$ = function $$i$$461_prealloc_prop$$74_updateCollection_updateObservableArrayAdd$$$($changes$$7$$) {
        ...
        try {
          if (!$koObject$$[$oj$$74$$.$KnockoutUtils$.$underUpdateProp$]) {
            ...
            $m$$26$$.comparator && ($koObject$$[$oj$$74$$.$KnockoutUtils$.$underUpdateProp$] = !0, $koObject$$.sort(function($a$$122$$, $b$$76$$) {
              return $oj$$74$$.$KnockoutUtils$.$_callSort$($a$$122$$, $b$$76$$, $m$$26$$.comparator, $m$$26$$, this);
      ...
      $array$$18_data$$180_updateObservable_updateObservableArrayRemove$$ = function $$array$$18_data$$180_updateObservable_updateObservableArrayRemove$$$($model$$95$$, $collection$$61$$, $options$$387$$) {
        var $index$$287$$;
        try {
          !$koObject$$[$oj$$74$$.$KnockoutUtils$.$collUpdatingProp$] && $collection$$61$$ instanceof $oj$$74$$.$Collection$ && ($koObject$$[$oj$$74$$.$KnockoutUtils$.$underUpdateProp$] = !0, $index$$287$$ = $options$$387$$.index, $koObject$$.splice($index$$287$$, 1));
        } catch ($e$$137$$) {
          throw $e$$137$$;
        } finally {
          $koObject$$[$oj$$74$$.$KnockoutUtils$.$underUpdateProp$] = !1;
      ...
      $i$$461_prealloc_prop$$74_updateCollection_updateObservableArrayAdd$$ = function $$i$$461_prealloc_prop$$74_updateCollection_updateObservableArrayAdd$$$($model$$96$$, $collection$$62$$, $options$$388$$) {
        var $index$$288$$, $newObservable$$;
        try {
          if (!$koObject$$[$oj$$74$$.$KnockoutUtils$.$collUpdatingProp$] && $collection$$62$$ instanceof $oj$$74$$.$Collection$ && ($koObject$$[$oj$$74$$.$KnockoutUtils$.$underUpdateProp$] = !0, $index$$288$$ = $collection$$62$$.$_localIndexOf$($model$$96$$), void 0 !== $index$$288$$ && -1 < $index$$288$$)) {
            if ($newObservable$$ = $oj$$74$$.$KnockoutUtils$.map($model$$96$$, $callback$$132$$), $options$$388$$.fillIn) {
              for (var $i$$463$$ = Array.isArray($koObject$$) ? $koObject$$.length : $koObject$$().length;$i$$463$$ < $index$$288$$;$i$$463$$++) {
                $koObject$$.splice($i$$463$$, 0, $oj$$74$$.$KnockoutUtils$.map($collection$$62$$.$_atInternal$($i$$463$$, null, !0, !1), $callback$$132$$));
              }
      ...
      $converted_index$$285_updateObservableArrayReset$$ = function $$converted_index$$285_updateObservableArrayReset$$$($collection$$63$$) {
        try {
          !$koObject$$[$oj$$74$$.$KnockoutUtils$.$collUpdatingProp$] && $collection$$63$$ instanceof $oj$$74$$.$Collection$ && ($koObject$$[$oj$$74$$.$KnockoutUtils$.$underUpdateProp$] = !0, $ko$$9$$.isObservable($koObject$$) ? ($koObject$$[$oj$$74$$.$KnockoutUtils$.$subscriptionProp$] && $koObject$$[$oj$$74$$.$KnockoutUtils$.$subscriptionProp$].dispose(), $koObject$$.removeAll(), $koObject$$[$oj$$74$$.$KnockoutUtils$.$updatingCollectionFunc$] && $koObject$$.subscribe($koObject$$[$oj$$74$$.$KnockoutUtils$.$updatingCollectionFunc$], 
      ...
      $updateModel_updateObservableArraySort$$ = function $$updateModel_updateObservableArraySort$$$($collection$$64$$) {
        try {
          !$koObject$$[$oj$$74$$.$KnockoutUtils$.$collUpdatingProp$] && $collection$$64$$ instanceof $oj$$74$$.$Collection$ && ($koObject$$[$oj$$74$$.$KnockoutUtils$.$underUpdateProp$] = !0, $koObject$$.sort(function($a$$123$$, $b$$77$$) {
            return $oj$$74$$.$KnockoutUtils$.$_callSort$($a$$123$$, $b$$77$$, $m$$26$$.comparator, $collection$$64$$, this);
          }));
        } catch ($e$$140$$) {
          throw $e$$140$$;
        } finally {
      ...
      $oj$$74$$.$KnockoutUtils$.$_storeOriginalObject$($koObject$$, $m$$26$$);
      $callback$$132$$ && $callback$$132$$($koObject$$);
    }
    return $koObject$$;
  };
  ...
  $oj$$74$$.$KnockoutUtils$.$_callSort$ = function $$oj$$74$$$$KnockoutUtils$$$_callSort$$($a$$124$$, $b$$78$$, $comparator$$16$$, $collection$$65$$, $caller$$8$$) {
    return $oj$$74$$.$Collection$.$SortFunc$($oj$$74$$.$KnockoutUtils$.$_getModel$($a$$124$$), $oj$$74$$.$KnockoutUtils$.$_getModel$($b$$78$$), $comparator$$16$$, $collection$$65$$, $caller$$8$$);
  };
