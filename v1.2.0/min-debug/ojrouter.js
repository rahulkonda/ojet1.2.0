...
define(["ojs/ojcore", "knockout", "signals", "promise"], function($oj$$17$$, $ko$$3$$, $signals$$1$$) {
  (function() {
    ...
    function $addStateParam$$($url$$22$$, $extraState$$1$$) {
      if ($extraState$$1$$ && 0 < Object.getOwnPropertyNames($extraState$$1$$).length) {
        ...
        $url$$22$$ = $JSCompiler_temp_const$$6$$ + ($sep$$1$$ + $param$$inline_704$$);
      }
      return $url$$22$$;
    }
    ...
    function $_executeTransition$$($transition$$) {
      ...
      return $transition$$.url ? "sync" === $transition$$.origin ? $parseAndUpdate$$($transition$$.url) : $_canExit$$($transition$$.$router$).then(function($canExit$$2$$) {
    ...
    $oj$$17$$.$Router$ = function $$oj$$17$$$$Router$$($key$$77$$, $parentRouter$$) {
      ...
      Object.defineProperties(this, {parent:{value:this.$_parentRouter$, enumerable:!0}, name:{value:this.$_name$, enumerable:!0}});
    };
    ...
    $oj$$17$$.$Router$.prototype.$createChildRouter$ = function $$oj$$17$$$$Router$$$$createChildRouter$$($childRouter$$1_name$$107$$) {
      ...
      $childRouter$$1_name$$107$$ = $childRouter$$1_name$$107$$.trim();
    ...
    $oj$$17$$.$Router$.prototype.$store$ = function $$oj$$17$$$$Router$$$$store$$($data$$121_extraState$$2$$) {
      this.$_extra$ = $data$$121_extraState$$2$$;
      $data$$121_extraState$$2$$ = {};
      for (var $router$$10$$ = this;$router$$10$$;) {
        $router$$10$$.$_extra$ && ($data$$121_extraState$$2$$[$router$$10$$.$_name$] = $router$$10$$.$_extra$), $router$$10$$ = $router$$10$$.$_parentRouter$;
      }
      for (var $router$$10$$ = this, $nextLevel_url$$26$$, $i$$255$$, $sr$$4$$;$router$$10$$;) {
        for ($i$$255$$ = 0;$i$$255$$ < $router$$10$$.$_childRouters$.length;$i$$255$$++) {
          if ($sr$$4$$ = $router$$10$$.$_childRouters$[$i$$255$$], $router$$10$$.$_stateId$() && $router$$10$$.$_stateId$() === $sr$$4$$.$_parentState$) {
            $sr$$4$$.$_extra$ && ($data$$121_extraState$$2$$[$sr$$4$$.$_name$] = $sr$$4$$.$_extra$);
      ...
      $nextLevel_url$$26$$ = $addStateParam$$($nextLevel_url$$26$$, $data$$121_extraState$$2$$);
    ...
    $oj$$17$$.$Router$.prototype.$dispose$ = function $$oj$$17$$$$Router$$$$dispose$$() {
      ...
      if (this.$_parentRouter$) {
        ...
        $_ojBaseUrl$$ = "", $_urlAdapter$$ = {}, window.removeEventListener("popstate", $handlePopState$$), $oj$$17$$.$Router$.$_transitionedToState$.removeAll(), $_initialized$$ = !1;
      }
    ...
    $oj$$17$$.$Router$.$sync$ = function $$oj$$17$$$$Router$$$sync$$() {
      ...
      if ($oj$$17$$.$Router$.$_updating$) {
        return $oj$$17$$.$Logger$.info("Sync called while updating, waiting for updates to end."), new Promise(function($resolve$$27$$) {
          $oj$$17$$.$Router$.$_transitionedToState$.addOnce(function($result$$45$$) {
            $oj$$17$$.$Logger$.info("Sync updates done.");
            $resolve$$27$$($result$$45$$);
          });
        });
      }
  ...
  (function() {
    ...
    function $_decompress$$($length$$16$$, $getNextValue$$) {
      for (var $dictionary$$ = [], $enlargeIn$$ = 4, $dictSize$$ = 4, $numBits$$ = 3, $bits_entry$$4$$ = "", $i$$259_result$$46$$ = "", $w$$5$$, $resb$$, $maxpower$$, $power$$, $c$$39$$, $data$$122$$ = {val:$getNextValue$$(0), position:32, index:1}, $i$$259_result$$46$$ = 0;3 > $i$$259_result$$46$$;$i$$259_result$$46$$ += 1) {
        $dictionary$$[$i$$259_result$$46$$] = $i$$259_result$$46$$;
      }
      $bits_entry$$4$$ = 0;
      $maxpower$$ = Math.pow(2, 2);
      for ($power$$ = 1;$power$$ != $maxpower$$;) {
        $resb$$ = $data$$122$$.val & $data$$122$$.position, $data$$122$$.position >>= 1, 0 == $data$$122$$.position && ($data$$122$$.position = 32, $data$$122$$.val = $getNextValue$$($data$$122$$.index++)), $bits_entry$$4$$ |= (0 < $resb$$ ? 1 : 0) * $power$$, $power$$ <<= 1;
      }
      switch($bits_entry$$4$$) {
        case 0:
          $bits_entry$$4$$ = 0;
    ...
    $oj$$17$$.$LZString$ = {$compressToEncodedURIComponent$:function $$oj$$17$$$$LZString$$$compressToEncodedURIComponent$$($input$$6$$) {
      return null === $input$$6$$ ? "" : $_compress$$($input$$6$$, function($a$$99$$) {
        return $_keyStrUriSafe$$.charAt($a$$99$$);
      });
    }, $decompressFromEncodedURIComponent$:function $$oj$$17$$$$LZString$$$decompressFromEncodedURIComponent$$($input$$7$$) {
      return null === $input$$7$$ ? "" : "" === $input$$7$$ ? null : $_decompress$$($input$$7$$.length, function($character$$inline_735_index$$112$$) {
        var $alphabet$$inline_734$$ = $_keyStrUriSafe$$;
        $character$$inline_735_index$$112$$ = $input$$7$$.charAt($character$$inline_735_index$$112$$);
        var $i$$inline_736$$;
        $_baseReverseDic$$ || ($_baseReverseDic$$ = {});
        if (!$_baseReverseDic$$[$alphabet$$inline_734$$]) {
          for ($_baseReverseDic$$[$alphabet$$inline_734$$] = {}, $i$$inline_736$$ = 0;$i$$inline_736$$ < $alphabet$$inline_734$$.length;$i$$inline_736$$++) {
            $_baseReverseDic$$[$alphabet$$inline_734$$][$alphabet$$inline_734$$[$i$$inline_736$$]] = $i$$inline_736$$;
          }
        }
        return $_baseReverseDic$$[$alphabet$$inline_734$$][$character$$inline_735_index$$112$$];
      });
    }};
