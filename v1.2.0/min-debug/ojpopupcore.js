...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "jqueryui-amd/position"], function($oj$$28$$, $$$$25$$) {
  ...
  $oj$$28$$.$PositionUtils$.$normalizeHorizontalAlignment$ = function $$oj$$28$$$$PositionUtils$$$normalizeHorizontalAlignment$$($position$$15$$, $isRtl$$2$$) {
    for (var $target$$88$$ = $$$$25$$.extend({}, $position$$15$$), $i$$326$$ = 0;$i$$326$$ < $oj$$28$$.$PositionUtils$.$_ALIGN_RULE_PROPERTIES$.length;$i$$326$$++) {
      var $propName$$4$$ = $oj$$28$$.$PositionUtils$.$_ALIGN_RULE_PROPERTIES$[$i$$326$$], $align$$ = $target$$88$$[$propName$$4$$];
  ...
  $oj$$28$$.$PositionUtils$.$normalizePositionOf$ = function $$oj$$28$$$$PositionUtils$$$normalizePositionOf$$($of$$, $launcher$$8$$, $event$$371$$) {
    return "event" === $of$$ ? $event$$371$$ : null == $of$$ || "launcher" === $of$$ ? $launcher$$8$$ : $of$$;
  };
  $oj$$28$$.$PositionUtils$.$_normalizeEventForPosition$ = function $$oj$$28$$$$PositionUtils$$$_normalizeEventForPosition$$($event$$372$$) {
    $$$$25$$.each(["pageX", "pageY"], function($index$$190$$, $pagePos$$) {
      if ($event$$372$$ && void 0 === $event$$372$$[$pagePos$$] && $event$$372$$.originalEvent) {
        var $firstTouch$$2_originalEvent$$2$$ = $event$$372$$.originalEvent, $touchList_type$$87$$ = $firstTouch$$2_originalEvent$$2$$.type;
        ($touchList_type$$87$$ = "touchstart" === $touchList_type$$87$$ || "touchmove" === $touchList_type$$87$$ ? "touches" : "touchend" === $touchList_type$$87$$ ? "changedTouches" : null) && ($firstTouch$$2_originalEvent$$2$$ = $firstTouch$$2_originalEvent$$2$$[$touchList_type$$87$$][0]) && ($event$$372$$[$pagePos$$] = $firstTouch$$2_originalEvent$$2$$[$pagePos$$]);
      }
    });
  };
  ...
  $oj$$28$$.$PopupServiceImpl$.prototype.$triggerOnDescendents$ = function $$oj$$28$$$$PopupServiceImpl$$$$triggerOnDescendents$$($layer$$1_popup$$7$$, $event$$374$$, $argsArray$$1$$) {
    var $context$$105$$ = {};
    $context$$105$$.event = $event$$374$$;
    $context$$105$$.argsArray = $argsArray$$1$$;
    $layer$$1_popup$$7$$ = $oj$$28$$.$ZOrderUtils$.$getFirstAncestorLayer$($layer$$1_popup$$7$$);
    $oj$$28$$.$ZOrderUtils$.$postOrderVisit$($layer$$1_popup$$7$$, this.$_triggerOnDescendentsVisitCallback$, $context$$105$$);
  };
  $oj$$28$$.$PopupServiceImpl$.prototype.$_triggerOnDescendentsVisitCallback$ = function $$oj$$28$$$$PopupServiceImpl$$$$_triggerOnDescendentsVisitCallback$$($layer$$2$$, $context$$106$$) {
    var $event$$375$$ = $context$$106$$.event, $argsArray$$2$$ = $context$$106$$.argsArray, $events$$4$$ = $oj$$28$$.$ZOrderUtils$.$getEvents$($layer$$2$$);
    $events$$4$$ && $$$$25$$.isFunction($events$$4$$[$event$$375$$]) && $events$$4$$[$event$$375$$].apply(this, $argsArray$$2$$);
  ...
  $oj$$28$$.$PopupServiceImpl$.prototype.$_assertEventSink$ = function $$oj$$28$$$$PopupServiceImpl$$$$_assertEventSink$$() {
    ...
    if (!$docElement_hasPopupsOpen$$ && $callbackEventFilter_simpleTapRecognizer$$) {
      ...
      for (var $i$$327$$ = 0;$i$$327$$ < $oj$$28$$.$PopupServiceImpl$.$_REDISTRIBUTE_EVENTS$.length;$i$$327$$++) {
        var $event$$376$$ = $oj$$28$$.$PopupServiceImpl$.$_REDISTRIBUTE_EVENTS$[$i$$327$$];
        $docElement_hasPopupsOpen$$.removeEventListener($event$$376$$, $callbackEventFilter_simpleTapRecognizer$$, !0);
      }
      ...
      if ($docElement_hasPopupsOpen$$ && !$callbackEventFilter_simpleTapRecognizer$$) {
        ...
        for ($i$$327$$ = 0;$i$$327$$ < $oj$$28$$.$PopupServiceImpl$.$_REDISTRIBUTE_EVENTS$.length;$i$$327$$++) {
          $event$$376$$ = $oj$$28$$.$PopupServiceImpl$.$_REDISTRIBUTE_EVENTS$[$i$$327$$], $docElement_hasPopupsOpen$$.addEventListener($event$$376$$, $callbackEventFilter_simpleTapRecognizer$$, !0);
        }
  ...
  $oj$$28$$.$PopupServiceImpl$.prototype.$_eventFilterCallback$ = function $$oj$$28$$$$PopupServiceImpl$$$$_eventFilterCallback$$($event$$377$$) {
    var $context$$107_target$$89$$ = $$$$25$$($event$$377$$.target);
    if (!$oj$$28$$.$ZOrderUtils$.$hasPopupsOpen$()) {
      this.$_assertEventSink$();
    } else {
      if (!$oj$$28$$.$DomUtils$.$isChromeEvent$($event$$377$$) && ("focus" !== $event$$377$$.type || $context$$107_target$$89$$.is(":focusable"))) {
        var $defaultLayer$$ = $oj$$28$$.$ZOrderUtils$.$getDefaultLayer$();
        if ("keydown" === $event$$377$$.type && $oj$$28$$.$ZOrderUtils$.$hasModalDialogOpen$() && !$oj$$28$$.$DomUtils$.$isAncestor$($defaultLayer$$[0], $context$$107_target$$89$$[0])) {
          $oj$$28$$.$ZOrderUtils$.$eatEvent$($$$$25$$.Event($event$$377$$));
        } else {
          var $props$$16_targetWitinLayer$$ = $oj$$28$$.$ZOrderUtils$.$getFirstAncestorLayer$($context$$107_target$$89$$);
          ...
          if ("focus" !== $event$$377$$.type || "-1" !== $context$$107_target$$89$$.attr("tabindex")) {
            var $context$$107_target$$89$$ = {}, $props$$16_targetWitinLayer$$ = {}, $key$$138$$;
            for ($key$$138$$ in $event$$377$$) {
              $oj$$28$$.$PopupServiceImpl$.$_COPY_SAFE_EVENT_PROPERTIES$[$key$$138$$] && !$$$$25$$.isFunction($event$$377$$[$key$$138$$]) && ($props$$16_targetWitinLayer$$[$key$$138$$] = $event$$377$$[$key$$138$$]);
            }
            $context$$107_target$$89$$.event = $$$$25$$.Event($event$$377$$, $props$$16_targetWitinLayer$$);
            $oj$$28$$.$ZOrderUtils$.$postOrderVisit$($defaultLayer$$, $oj$$28$$.$PopupServiceImpl$.$_redistributeVisitCallback$, $context$$107_target$$89$$);
          }
        }
      }
    }
  };
  $oj$$28$$.$PopupServiceImpl$.$_redistributeVisitCallback$ = function $$oj$$28$$$$PopupServiceImpl$$$_redistributeVisitCallback$$($layer$$3$$, $context$$108$$) {
    var $events$$5$$ = $oj$$28$$.$ZOrderUtils$.$getEvents$($layer$$3$$), $event$$378$$ = $context$$108$$.event;
    if ($events$$5$$ && $$$$25$$.isFunction($events$$5$$[$oj$$28$$.$PopupService$.$EVENT$.$POPUP_AUTODISMISS$])) {
      $events$$5$$[$oj$$28$$.$PopupService$.$EVENT$.$POPUP_AUTODISMISS$]($event$$378$$);
    }
    return $oj$$28$$.$ZOrderUtils$.$VISIT_RESULT$.$ACCEPT$;
  };
  ...
  $oj$$28$$.$PopupServiceImpl$.$_refreshVisitCallback$ = function $$oj$$28$$$$PopupServiceImpl$$$_refreshVisitCallback$$($layer$$4$$, $context$$109$$) {
    if (0 < $context$$109$$.level) {
  ...
  $oj$$28$$.$ZOrderUtils$ = {};
  $oj$$28$$.$ZOrderUtils$.$getFirstAncestorLayer$ = function $$oj$$28$$$$ZOrderUtils$$$getFirstAncestorLayer$$($launcher$$10_parent$$31$$) {
    if (!$launcher$$10_parent$$31$$) {
      return $oj$$28$$.$ZOrderUtils$.$getDefaultLayer$();
    }
    for (;$launcher$$10_parent$$31$$ && 0 < $launcher$$10_parent$$31$$.length && $launcher$$10_parent$$31$$.attr("oj.ZOrderUtils._SURROGATE_ATTR") !== $oj$$28$$.$ZOrderUtils$.$_DEFAULT_LAYER_ID$;) {
      if ($oj$$28$$.$ZOrderUtils$.$_hasSurrogate$($launcher$$10_parent$$31$$[0])) {
        return $launcher$$10_parent$$31$$;
      }
      $launcher$$10_parent$$31$$ = $launcher$$10_parent$$31$$.parent();
    }
    return $oj$$28$$.$ZOrderUtils$.$getDefaultLayer$();
  };
  ...
  $oj$$28$$.$ZOrderUtils$.$_closeDescendantPopupsCallback$ = function $$oj$$28$$$$ZOrderUtils$$$_closeDescendantPopupsCallback$$($layer$$11$$, $context$$110$$) {
    if (0 < $context$$110$$.level) {
      return $oj$$28$$.$ZOrderUtils$.$VISIT_RESULT$.$REJECT$;
    }
  ...
  $oj$$28$$.$ZOrderUtils$.$hasModalDialogOpen$ = function $$oj$$28$$$$ZOrderUtils$$$hasModalDialogOpen$$() {
    for (var $children$$8$$ = $oj$$28$$.$ZOrderUtils$.$getDefaultLayer$().children(), $i$$328$$ = $children$$8$$.length - 1;-1 < $i$$328$$;$i$$328$$--) {
      if ($$$$25$$($children$$8$$[$i$$328$$]).hasClass($oj$$28$$.$ZOrderUtils$.$_OVERLAY_SELECTOR$)) {
        return!0;
      }
    }
    return!1;
  ...
  $oj$$28$$.$ZOrderUtils$.$postOrderVisit$ = function $$oj$$28$$$$ZOrderUtils$$$postOrderVisit$$($layer$$15$$, $callback$$103$$, $context$$111$$) {
    $context$$111$$ || ($context$$111$$ = {});
    $context$$111$$.level = 0;
    $context$$111$$.type = $oj$$28$$.$ZOrderUtils$.$_VISIT_TRAVERSAL$.$POST_ORDER$;
    $oj$$28$$.$ZOrderUtils$.$_visitTree$($layer$$15$$, $callback$$103$$, $context$$111$$);
  };
  $oj$$28$$.$ZOrderUtils$.$preOrderVisit$ = function $$oj$$28$$$$ZOrderUtils$$$preOrderVisit$$($layer$$16$$, $callback$$104$$, $context$$112$$) {
    $context$$112$$ || ($context$$112$$ = {});
    $context$$112$$.level = 0;
    $context$$112$$.type = $oj$$28$$.$ZOrderUtils$.$_VISIT_TRAVERSAL$.$PRE_ORDER$;
    $oj$$28$$.$ZOrderUtils$.$_visitTree$($layer$$16$$, $callback$$104$$, $context$$112$$);
  };
  $oj$$28$$.$ZOrderUtils$.$_visitTree$ = function $$oj$$28$$$$ZOrderUtils$$$_visitTree$$($children$$9_layer$$17$$, $callback$$105$$, $context$$113$$) {
    var $level$$29$$ = $context$$113$$.level;
    $children$$9_layer$$17$$ = $children$$9_layer$$17$$.children();
    for (var $i$$329$$ = $children$$9_layer$$17$$.length - 1;-1 < $i$$329$$;$i$$329$$--) {
      var $child$$8$$ = $$$$25$$($children$$9_layer$$17$$[$i$$329$$]);
      if ($oj$$28$$.$ZOrderUtils$.$_hasSurrogate$($child$$8$$[0])) {
        var $vrtn$$;
        if ($context$$113$$.type === $oj$$28$$.$ZOrderUtils$.$_VISIT_TRAVERSAL$.$PRE_ORDER$) {
          $vrtn$$ = $callback$$105$$($child$$8$$, $context$$113$$);
        ...
        $context$$113$$.level = $level$$29$$ + 1;
        $vrtn$$ = $oj$$28$$.$ZOrderUtils$.$_visitTree$($child$$8$$, $callback$$105$$, $context$$113$$);
        $context$$113$$.level = $level$$29$$;
        if ($vrtn$$ === $oj$$28$$.$ZOrderUtils$.$VISIT_RESULT$.$COMPLETE$) {
          return $vrtn$$;
        }
        if ($context$$113$$.type === $oj$$28$$.$ZOrderUtils$.$_VISIT_TRAVERSAL$.$POST_ORDER$) {
          $vrtn$$ = $callback$$105$$($child$$8$$, $context$$113$$);
          if ($vrtn$$ === $oj$$28$$.$ZOrderUtils$.$VISIT_RESULT$.$COMPLETE$) {
            return $vrtn$$;
          }
  ...
  $oj$$28$$.$ZOrderUtils$.$_hasSurrogate$ = function $$oj$$28$$$$ZOrderUtils$$$_hasSurrogate$$($element$$119$$) {
    return 1 === $element$$119$$.nodeType && $element$$119$$.hasAttribute($oj$$28$$.$ZOrderUtils$.$_SURROGATE_ATTR$) ? !0 : !1;
  };
  ...
  $oj$$28$$.$ZOrderUtils$.$getOpenPopupCount$ = function $$oj$$28$$$$ZOrderUtils$$$getOpenPopupCount$$() {
    var $context$$114$$ = {popupCount:0}, $defaultLayer$$5$$ = $oj$$28$$.$ZOrderUtils$.$getDefaultLayer$();
    $oj$$28$$.$ZOrderUtils$.$preOrderVisit$($defaultLayer$$5$$, $oj$$28$$.$ZOrderUtils$.$_openPopupCountCallback$, $context$$114$$);
    return $context$$114$$.popupCount;
  };
  $oj$$28$$.$ZOrderUtils$.$_openPopupCountCallback$ = function $$oj$$28$$$$ZOrderUtils$$$_openPopupCountCallback$$($layer$$18$$, $context$$115$$) {
    $context$$115$$.popupCount += 1;
    return $oj$$28$$.$ZOrderUtils$.$VISIT_RESULT$.$ACCEPT$;
  };
  $oj$$28$$.$ZOrderUtils$.$findOpenPopups$ = function $$oj$$28$$$$ZOrderUtils$$$findOpenPopups$$() {
    var $context$$116$$ = {}, $defaultLayer$$6_popups$$2$$ = [];
    $context$$116$$.popups = $defaultLayer$$6_popups$$2$$;
    $defaultLayer$$6_popups$$2$$ = $oj$$28$$.$ZOrderUtils$.$getDefaultLayer$();
    $oj$$28$$.$ZOrderUtils$.$preOrderVisit$($defaultLayer$$6_popups$$2$$, $oj$$28$$.$ZOrderUtils$.$_openPopupsCallback$, $context$$116$$);
    $defaultLayer$$6_popups$$2$$ = $context$$116$$.popups;
    return $$$$25$$($defaultLayer$$6_popups$$2$$);
  };
  $oj$$28$$.$ZOrderUtils$.$_openPopupsCallback$ = function $$oj$$28$$$$ZOrderUtils$$$_openPopupsCallback$$($layer$$19$$, $context$$117$$) {
    $context$$117$$.popups.push($layer$$19$$[0]);
    return $oj$$28$$.$ZOrderUtils$.$VISIT_RESULT$.$ACCEPT$;
  };
  $oj$$28$$.$ZOrderUtils$.$compareStackingContexts$ = function $$oj$$28$$$$ZOrderUtils$$$compareStackingContexts$$($el1$$1$$, $el2$$1$$) {
    function $describeStackingContext$$($element$$120$$, $allLevels$$) {
      for (var $positions$$ = ["absolute", "relative", "fixed"], $parents$$4$$ = $element$$120$$.parents(), $stack_tmp$$2$$ = [], $i$$331$$ = $parents$$4$$.length - 1;-1 < $i$$331$$;$i$$331$$--) {
        $stack_tmp$$2$$.push($$$$25$$($parents$$4$$[$i$$331$$]));
      }
      $parents$$4$$ = $stack_tmp$$2$$;
      $parents$$4$$.push($element$$120$$);
      for (var $stack_tmp$$2$$ = [], $level$$30$$ = 0, $i$$331$$ = 0;$i$$331$$ < $parents$$4$$.length;$i$$331$$++) {
        var $order_parent$$32$$ = $parents$$4$$[$i$$331$$], $position$$21$$ = $order_parent$$32$$.css("position"), $opacity$$1$$ = $oj$$28$$.$DomUtils$.$getCSSLengthAsFloat$($order_parent$$32$$.css("opacity")), $zindex$$ = $oj$$28$$.$DomUtils$.$getCSSLengthAsInt$($order_parent$$32$$.css("z-index")), $order_parent$$32$$ = $$$$25$$.inArray($order_parent$$32$$[0], $order_parent$$32$$.parent().children());
        -1 < $$$$25$$.inArray($position$$21$$, $positions$$) ? $stack_tmp$$2$$.push({weight:[$level$$30$$++, $zindex$$, $order_parent$$32$$], order:[$order_parent$$32$$]}) : 1 > $opacity$$1$$ ? $stack_tmp$$2$$.push({weight:[$level$$30$$++, 1, $order_parent$$32$$], order:[$order_parent$$32$$]}) : $allLevels$$ && $stack_tmp$$2$$.push({weight:[0, 0, $order_parent$$32$$], order:[$order_parent$$32$$]});
      }
      return $stack_tmp$$2$$;
    }
    function $compareSets$$($n1$$3$$, $n2$$3$$) {
      for (var $maxLen$$1$$ = Math.max($n1$$3$$.length, $n2$$3$$.length), $i$$332$$ = 0;$i$$332$$ < $maxLen$$1$$;$i$$332$$++) {
        var $e1$$1$$ = $i$$332$$ < $n1$$3$$.length ? $n1$$3$$[$i$$332$$] : -1, $e2$$1$$ = $i$$332$$ < $n2$$3$$.length ? $n2$$3$$[$i$$332$$] : -1;
        if ($e1$$1$$ !== $e2$$1$$) {
    ...
    for (var $n1$$2$$ = $describeStackingContext$$($el1$$1$$, !1), $n2$$2$$ = $describeStackingContext$$($el2$$1$$, !1), $maxLen$$ = Math.max($n1$$2$$.length, $n2$$2$$.length), $i$$330$$ = 0;$i$$330$$ < $maxLen$$;$i$$330$$++) {
      var $c$$45_e1$$ = $i$$330$$ < $n1$$2$$.length ? $n1$$2$$[$i$$330$$].weight : [-1], $e2$$ = $i$$330$$ < $n2$$2$$.length ? $n2$$2$$[$i$$330$$].weight : [-1], $c$$45_e1$$ = $compareSets$$($c$$45_e1$$, $e2$$);
      if (0 !== $c$$45_e1$$) {
        return $c$$45_e1$$;
      }
    }
    ...
    for ($i$$330$$ = 0;$i$$330$$ < $maxLen$$;$i$$330$$++) {
      if ($c$$45_e1$$ = $i$$330$$ < $n1$$2$$.length ? $n1$$2$$[$i$$330$$].order : [-1], $e2$$ = $i$$330$$ < $n2$$2$$.length ? $n2$$2$$[$i$$330$$].order : [-1], $c$$45_e1$$ = $compareSets$$($c$$45_e1$$, $e2$$), 0 !== $c$$45_e1$$) {
        return $c$$45_e1$$;
      }
    }
    return 0;
  };
  $oj$$28$$.$ZOrderUtils$.$eatEvent$ = function $$oj$$28$$$$ZOrderUtils$$$eatEvent$$($event$$380$$) {
    $event$$380$$.stopPropagation();
  ...
  $oj$$28$$.$SimpleTapRecognizer$.prototype.Init = function $$oj$$28$$$$SimpleTapRecognizer$$$Init$() {
    ...
    for (var $eventHandlerCallback$$ = this.$_eventHandlerCallback$ = $$$$25$$.proxy(this.$_eventHandler$, this), $docElement$$1$$ = document.documentElement, $i$$333$$ = 0;$i$$333$$ < $oj$$28$$.$SimpleTapRecognizer$.$_TOUCHEVENTS$.length;$i$$333$$++) {
      $docElement$$1$$.addEventListener($oj$$28$$.$SimpleTapRecognizer$.$_TOUCHEVENTS$[$i$$333$$], $eventHandlerCallback$$, !0);
    }
  };
  $oj$$28$$.$SimpleTapRecognizer$.prototype.$_eventHandler$ = function $$oj$$28$$$$SimpleTapRecognizer$$$$_eventHandler$$($event$$381_tapStart$$) {
    var $tapCallback$$1$$ = this.$_tapCallback$, $eventType$$42$$ = $event$$381_tapStart$$.type;
    "touchstart" === $eventType$$42$$ ? (this.$_touchStartEvent$ = $event$$381_tapStart$$, this.$_touchStartEvent$.$_tapStart$ = (new Date).getTime()) : "touchmove" === $eventType$$42$$ || "touchcancel" === $eventType$$42$$ ? delete this.$_touchStartEvent$ : "touchend" === $eventType$$42$$ && (this.$_touchStartEvent$ && ($event$$381_tapStart$$ = this.$_touchStartEvent$.$_tapStart$, isNaN($event$$381_tapStart$$) ? $tapCallback$$1$$(this.$_touchStartEvent$) : (new Date).getTime() - $event$$381_tapStart$$ < 
  ...
  $oj$$28$$.$SimpleTapRecognizer$.prototype.destroy = function $$oj$$28$$$$SimpleTapRecognizer$$$destroy$() {
    ...
    for (var $docElement$$2$$ = document.documentElement, $i$$334$$ = 0;$i$$334$$ < $oj$$28$$.$SimpleTapRecognizer$.$_TOUCHEVENTS$.length;$i$$334$$++) {
      $docElement$$2$$.removeEventListener($oj$$28$$.$SimpleTapRecognizer$.$_TOUCHEVENTS$[$i$$334$$], $eventHandlerCallback$$1$$, !0);
    }
  };
  ...
  $oj$$28$$.$PopupSkipLink$ = function $$oj$$28$$$$PopupSkipLink$$($sibling$$, $message$$35$$, $callback$$106$$, $id$$42$$) {
    $oj$$28$$.$Assert$.$assertPrototype$($sibling$$, jQuery);
    $oj$$28$$.$Assert$.$assertString$($message$$35$$);
    $oj$$28$$.$Assert$.$assertFunction$($callback$$106$$);
    $oj$$28$$.$Assert$.$assertStringOrNull$($id$$42$$);
    this.$_sibling$ = $sibling$$;
    this.$_message$ = $message$$35$$;
    this.$_callback$ = $callback$$106$$;
  ...
  $oj$$28$$.$PopupSkipLink$.prototype.Init = function $$oj$$28$$$$PopupSkipLink$$$Init$() {
    ...
    var $sibling$$1$$ = this.$_sibling$, $callback$$107$$ = this.$_callback$, $message$$36$$ = this.$_message$;
