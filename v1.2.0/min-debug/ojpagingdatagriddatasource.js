...
define(["ojs/ojcore", "jquery", "ojs/ojpagingtabledatasource"], function($oj$$70$$) {
  ...
  $oj$$70$$.$PagingHeaderSet$.prototype.getData = function $$oj$$70$$$$PagingHeaderSet$$$getData$($index$$281$$, $level$$44$$) {
    return this.$m_headerSet$.getData($index$$281$$ + this.$m_startIndex$, $level$$44$$);
  };
  $oj$$70$$.$Object$.$exportPrototypeSymbol$("PagingHeaderSet.prototype.getData", {getData:$oj$$70$$.$PagingHeaderSet$.prototype.getData});
  $oj$$70$$.$PagingHeaderSet$.prototype.getMetadata = function $$oj$$70$$$$PagingHeaderSet$$$getMetadata$($index$$282$$, $level$$45$$) {
    return this.$m_headerSet$.getMetadata($index$$282$$ + this.$m_startIndex$, $level$$45$$);
  };
  ...
  $oj$$70$$.$PagingHeaderSet$.prototype.$getExtent$ = function $$oj$$70$$$$PagingHeaderSet$$$$getExtent$$($index$$283$$, $level$$46$$) {
    return this.$m_headerSet$.$getExtent$($index$$283$$ + this.$m_startIndex$, $level$$46$$);
  };
  ...
  $oj$$70$$.$PagingHeaderSet$.prototype.$getDepth$ = function $$oj$$70$$$$PagingHeaderSet$$$$getDepth$$($index$$284$$, $level$$47$$) {
    return this.$m_headerSet$.$getDepth$($index$$284$$ + this.$m_startIndex$, $level$$47$$);
  };
  ...
  $oj$$70$$.$PagingDataGridDataSource$.prototype.setPage = function $$oj$$70$$$$PagingDataGridDataSource$$$setPage$($value$$292$$, $options$$365$$) {
    ...
    var $self$$201$$ = this;
    return new Promise(function($resolve$$57$$, $reject$$55$$) {
      $self$$201$$.$_fetchInternal$($options$$365$$).then(function() {
        $resolve$$57$$(null);
      }, function() {
        $self$$201$$.$_page$ = $previousPage$$3$$;
        $self$$201$$.$_startIndex$ = $self$$201$$.$_page$ * $self$$201$$.$_pageSize$;
        $reject$$55$$(null);
      });
    });
  };
  ...
  $oj$$70$$.$PagingDataGridDataSource$.prototype.$_fetchInternal$ = function $$oj$$70$$$$PagingDataGridDataSource$$$$_fetchInternal$$($options$$366$$) {
    ...
    return new Promise(function($resolve$$58$$) {
      $self$$202$$.handleEvent("change", {operation:"sync", pageSize:$self$$202$$.$_pageSize$});
      $resolve$$58$$(void 0);
    });
  };
  ...
  $oj$$70$$.$PagingDataGridDataSource$.prototype.$getCount$ = function $$oj$$70$$$$PagingDataGridDataSource$$$$getCount$$($axis$$52$$) {
  ...
  $oj$$70$$.$PagingDataGridDataSource$.prototype.$getCountPrecision$ = function $$oj$$70$$$$PagingDataGridDataSource$$$$getCountPrecision$$($axis$$53$$) {
  ...
  $oj$$70$$.$PagingDataGridDataSource$.prototype.$_handleRowHeaderFetchSuccess$ = function $$oj$$70$$$$PagingDataGridDataSource$$$$_handleRowHeaderFetchSuccess$$($headerSet$$7$$, $headerRange$$11$$) {
    var $pagingHeaderSet$$, $callback$$128$$, $callbackObject$$;
    ...
    $callback$$128$$ = this.$_pendingRowHeaderCallback$.callbacks.success;
    $callbackObject$$ = this.$_pendingRowHeaderCallback$.callbackObjects.success;
    this.$_pendingRowHeaderCallback$ = null;
    $callback$$128$$.call($callbackObject$$, $pagingHeaderSet$$, $headerRange$$11$$);
  };
  $oj$$70$$.$PagingDataGridDataSource$.prototype.$_handleRowHeaderFetchError$ = function $$oj$$70$$$$PagingDataGridDataSource$$$$_handleRowHeaderFetchError$$($error$$48$$) {
    var $callback$$129$$, $callbackObject$$1$$;
    $callback$$129$$ = this.$_pendingRowHeaderCallback$.callbacks.error;
    $callbackObject$$1$$ = this.$_pendingRowHeaderCallback$.callbackObjects.error;
    this.$_pendingRowHeaderCallback$ = null;
    $callback$$129$$.call($callbackObject$$1$$, $error$$48$$);
  };
  ...
  $oj$$70$$.$PagingDataGridDataSource$.prototype.$_handleCellsFetchSuccess$ = function $$oj$$70$$$$PagingDataGridDataSource$$$$_handleCellsFetchSuccess$$($cellSet$$5$$, $cellRanges$$10$$) {
    var $i$$453_pagedCellSet$$, $callback$$130$$, $callbackObject$$2$$;
    ...
    $callback$$130$$ = this.$_pendingCellCallback$.callbacks.success;
    ...
    $callback$$130$$.call($callbackObject$$2$$, $i$$453_pagedCellSet$$, $cellRanges$$10$$);
  };
  $oj$$70$$.$PagingDataGridDataSource$.prototype.$_handleCellsFetchError$ = function $$oj$$70$$$$PagingDataGridDataSource$$$$_handleCellsFetchError$$($error$$49$$) {
    var $callback$$131$$, $callbackObject$$3$$;
    $callback$$131$$ = this.$_pendingCellCallback$.callbacks.error;
    $callbackObject$$3$$ = this.$_pendingCellCallback$.callbackObjects.error;
    this.$_pendingCellCallback$ = null;
    $callback$$131$$.call($callbackObject$$3$$, $error$$49$$);
  };
  ...
  $oj$$70$$.$PagingCellSet$.prototype.$getCount$ = function $$oj$$70$$$$PagingCellSet$$$$getCount$$($axis$$54$$) {
    return this.$m_cellSet$.$getCount$($axis$$54$$);
  };
